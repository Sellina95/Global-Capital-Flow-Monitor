...
PIT_PANEL = (
    ...
    / "backtest"
    / "pit_safe"
    / "master_panel_pit_safe_final.csv"
)
...
OUT_PATH = (
    ...
    / "backtest"
    / "results"
    / "daily_positions_pit_safe_final.csv"
)
...
def main():
    ...
    # Full historical PIT replay.
    # Override canonical runner's temporary smoke-test date window
    # only inside this isolated research runner.
    rb.START_DATE = rb.pd.Timestamp("2008-01-01")
    rb.END_DATE = rb.pd.Timestamp("2026-06-19")
