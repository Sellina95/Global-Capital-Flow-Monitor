...
FRED_SERIES = {
    ...
    "REAL_RATE": "DFII10",  # 10Y TIPS / real yield proxy
}
...
out_df.to_csv("data/fred_macro_extras.csv", index=False, encoding="utf-8-sig")
print("Saved: data/fred_macro_extras.csv")