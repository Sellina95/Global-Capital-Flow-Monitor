...
- **Final Action:** **REDUCE**
- **Final Exposure:** **30%**
- **Base Context:** phase=RISK-ON (부분 정렬) / narrative=REDUCE / base_exposure=30%
- **SEW:** STABLE / NORMAL
...
- **달러 인덱스**: 98.227  (+0.01% vs 98.220)
- **WTI 유가**: 84.000  (-11.29% vs 94.690)
...
- **Execution View:** **REDUCE** *(final exposure: 30%)*
...
- **Strategic View:** REDUCE (30%) | **Execution View:** REDUCE (30%)
- **Context:** phase=RISK-ON (부분 정렬) / liquidity=UP-MID / credit_calm=True / geo=NORMAL

### 🔹 Base Case
- 조건: 현재 Execution View=REDUCE 유지 / SEW=STABLE / Divergence=ALIGNED / Warning Score 1 지속
- 전략: 실행 노출 30% 유지, 전략 기준과 실행 기준이 정렬된 상태에서 운용

### 🔼 Bull Case
- 조건: Warning Score ≤ 1 / SEW: STABLE 유지 / Divergence: ALIGNED 유지 / NET_LIQ 우호 / 크레딧 안정 지속
- 전략: 실행 노출 30% 유지 또는 추가 확장 검토, 성장/리스크 자산 베타 우호

### 🔻 Bear Case
- 조건: SEW WATCH/ALERT/DEADMAN 재발 / HY OAS 4% 상회 또는 급등 / VIX 22 이상 또는 급등 전환 / 상관관계 붕괴 심화 / Divergence 비정렬 전환
- 전략: 실행 노출 30% 이하 방어 유지, 현금/방어자산 중심으로 생존 우선
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-18 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-18 (FRED last available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.007 / US10YΔ -0.063**
...
- **Cosine Similarity Score:** -0.099
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.099
  - China_Trade_2018: -0.134
  - Red_Sea: -0.189
- **Top Drivers:**
  - WTI: z_used=-2.10 (z1d=-2.37, z5d=-1.70, raw_w=0.10, norm_w=0.08) → contrib=-0.16
  - EMB: z_used=-1.42 (z1d=+1.56, z5d=+1.21, raw_w=0.12, norm_w=0.09) → contrib=-0.13
  - EEM: z_used=-1.08 (z1d=+0.98, z5d=+1.21, raw_w=0.10, norm_w=0.08) → contrib=-0.08
  - VIX: z_used=-0.50 (z1d=-0.35, z5d=-0.73, raw_w=0.18, norm_w=0.14) → contrib=-0.07
...
**핵심 신호:** 장단기차(55.00bp) | 실질금리(1.93%) | DXY(98.23)
*(as of: RealRate: 2026-04-18 / FRED last available)*
...
- **Today snapshot:** US10Y(4.246), DXY(98.227), VIX(17.48)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.007 / US10YΔ -0.063 (시스템위기)
...
- **Narrative:** 구조=MIXED(시스템위기) / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=1.53 → Phase=RISK-ON (부분 정렬)
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `RISK-ON` | **VIX:** `17.48`
...
**Context:** phase=RISK-ON (부분 정렬) / T10Y2Y=0.55 (MODERATE STEEP) / VIX=17.48 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
- **Total Target Exposure:** **30.0%** (from Filter 15)
