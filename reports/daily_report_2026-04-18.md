...
- **Final Action:** **HOLD**
- **Final Exposure:** **68%**
- **Base Context:** phase=N/A / narrative=HOLD / base_exposure=68%
- **SEW:** STABLE / NORMAL
...
- **GOLD:** 15m=-0.14825588205161777 / 30m=-0.3616210736850256 / 1H=-0.5353317127730461 / 4H=-0.8099835887962814 / 1D=1.3374012894649567 / 5D=1.8375018751850103
...
- **Risk Budget:** 68
- **Action:** HOLD
- **Narrative:** 구조=Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.120 / US10YΔ -0.063 / 심리=NEUTRAL / 매크로=강한 우호 / 유동성=UP/MID / 크레딧=안정 / 드리프트=⚡ TREND FORMING (초기 흐름 감지) (DISINFLATION_RISK_ON) (+3) / 수급=1.53 ⚠️ 다소 과열 → Phase=RISK-ON (완화 기대·리스크 선호)
...
| :--- | :---: | :---: | :---: | :--- |
| Financials | +1 | ALIGNED | **21.2%** | STRONG BUY |
| Industrials | +0.7 | ALIGNED | **14.9%** | ACCUMULATE |
| Technology | +1.5 | ALIGNED | **31.9%** | STRONG BUY |
...
| :--- | :---: | :---: | :--- |
| Financials | XLF | 21.2% | PRIMARY |
| Industrials | XLI | 14.9% | ADD |
| Technology | XLK | 31.9% | PRIMARY |
