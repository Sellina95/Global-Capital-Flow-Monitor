...
- **미국 10년물 금리**: 4.245  (+0.00% vs 4.245)
- **WTI 유가**: 94.740  (-0.05% vs 94.790)
- **변동성 지수 (VIX)**: 25.770  (+0.00% vs 25.770)
- **원/달러 환율**: 1493.080  (+0.03% vs 1492.580)
...
- **Context:** phase=WAITING / RANGE (대기·박스권) / liquidity=UP-HIGH / credit_calm=True / geo=NORMAL
...
- **VIX 레벨:** 25.77 → **High (Risk-off bias)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-03-11 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(↓) | as of: 2026-03-11 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.030 / FCIΔ +0.000 / DXYΔ N/A / US10YΔ +0.000**
...
- **Spread as of:** 2026-03-11 (FRED latest)
- **HY_OAS level:** 3.09% → **WARM (경계)**
- **방향(전일 대비):** HY_OAS(↓) / -3.13%
- **판정:** **CREDIT WATCH**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 79.525 / prev 79.520 / pct 0.01%
- **LQD:** today 108.825 / prev 108.820 / pct 0.00%
- **판정:** **CREDIT NEUTRAL**
...
- DEBUG: pct XLK=0.02881983490775839, XLF=0.0, XLE=0.008519833143874788, XLRE=0.011767219094669119
...
- **Top Drivers:**
  ...
  - USDCNH: z_used=+0.39 (z1d=+0.22, z5d=+0.64, raw_w=0.18, norm_w=0.13) → contrib=+0.05
  - EMB: z_used=+0.52 (z1d=+0.10, z5d=-1.44, raw_w=0.12, norm_w=0.09) → contrib=+0.05
...
- **Today snapshot:** US10Y(4.245), DXY(N/A), VIX(25.77)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.030 / FCIΔ +0.000 / DXYΔ N/A / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 29.851480426635224 (FEAR)
...
- **Narrative:** 구조=TIGHTENING / 심리=FEAR / 유동성=증가/높음 / 크레딧=안정 → Phase=WAITING / RANGE (대기·박스권)
...
- **Context:** phase=WAITING / RANGE (대기·박스권) / liquidity=UP-HIGH / structure=TIGHTENING / credit_calm=True
- **Overweight:** **Financials, Industrials, Consumer Discretionary**
- **Underweight:** **Real Estate, Utilities, Communication Services**

- **Rationale (top drivers):**
  - OW Financials: +1: 유동성 공급 → 리스크 선호 회복 구간 우호
  - OW Industrials: +2: 유동성 공급 → 경기순환(투자/생산) 우호
  - OW Consumer Discretionary: +2: 유동성 공급 → 경기민감 섹터 우호
  - UW Real Estate: -2: 긴축 → 금리 민감/레버리지 비용 부담
  - UW Utilities: -1: 유동성 공급 → 방어 섹터 상대매력 감소
  - UW Communication Services: -1: 긴축 → 성장/멀티플 부담
