...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 60%**
- **Final Exposure (실행 기준): 60%**
...
- **Final Action:** **HOLD**
- **Final Exposure:** **60%**
- **Base Context:** phase=N/A / narrative=HOLD / base_exposure=60%
- **SEW:** STABLE / NORMAL
...
- **미국 10년물 금리**: 4.246  (+0.00% vs 4.246)
- **달러 인덱스**: 98.100  (+0.00% vs 98.100)
- **WTI 유가**: 82.590  (-1.50% vs 83.850)
- **변동성 지수 (VIX)**: 17.480  (+0.00% vs 17.480)
- **원/달러 환율**: 1465.680  (+0.00% vs 1465.680)

---

## 🧭 So What? (Decision Layer)
- **Strategic View:** **HOLD** *(base exposure: 60%)*
- **Execution View:** **HOLD** *(final exposure: 60%)*
...
- **VIX 레벨:** 17.48 → **Mid (Neutral/Mixed)**
...
- **Spread as of:** 2026-04-16 (FRED latest)
...
- **방향(전일 대비):** HYG(→) / LQD(→)
- **HYG:** today 80.650 / prev 80.650 / pct 0.00%
- **LQD:** today 110.040 / prev 110.040 / pct 0.00%
- **판정:** **CREDIT NEUTRAL**
...
- **Cosine Similarity Score:** 0.107
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.107
  - China_Trade_2018: 0.075
  - Ukraine_2022: -0.092
- **Top Drivers:**
  - WTI: z_used=-1.05 (z1d=-0.43, z5d=-1.98, raw_w=0.10, norm_w=0.08) → contrib=-0.08
  - VIX: z_used=-0.32 (z1d=-0.06, z5d=-0.69, raw_w=0.18, norm_w=0.14) → contrib=-0.04
  - IL10Y_SPREAD: z_used=-0.92 (mode=level, raw_w=0.05, norm_w=0.04) → contrib=-0.04
  - GOLD: z_used=+0.30 (z1d=+0.17, z5d=+0.49, raw_w=0.12, norm_w=0.09) → contrib=+0.03
...
- **강도:** US10Y(Noise) / DXY(Noise) / WTI(Strong) / VIX(Noise)
...
- **Meaningful Move Check:** DXY=0.0 / GOLD=0.45289854161965304 / US10Y=0.0 / VIX=0.0 / WTI=-1.5026859381748796
- **판정:** **NEUTRAL**
...
- **Risk Budget:** 68
- **Action:** HOLD
- **Narrative:** 구조=Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.000 / US10YΔ +0.000 / 심리=NEUTRAL / 매크로=우호 / 유동성=UP/MID / 크레딧=안정 / 드리프트=🔥 STRONG TREND (방향성 자금 흐름 감지) (DISINFLATION_RISK_ON) (+4) / 수급=1.53 ⚠️ 다소 과열 → Phase=WAITING / RANGE (대기·박스권)
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `MIXED` | **VIX:** `17.48`
- **Positioning Data:** Z-Score: `1.53` (>1.8 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Risk Budget:** 68 | **Phase Cap:** 60
- **VIX Level:** 17.48 (NORMAL) | **Change:** +0.00%
...
**Overweight:** Financials, Industrials, Real Estate, Technology
...
- OW Real Estate: +1: Relative Strength 강세 (vs SPY) → 자금 유입 확인
...
- **Total Target Exposure:** **60.0%** (from Filter 15)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Financials | +1 | ALIGNED | **14.3%** | ACCUMULATE |
| Industrials | +0.7 | ALIGNED | **10.0%** | ACCUMULATE |
| Real Estate | +1 | ALIGNED | **14.3%** | ACCUMULATE |
| Technology | +1.5 | ALIGNED | **21.4%** | STRONG BUY |
| **Cash & Hedge** | - | - | **40.0%** | DEFENSIVE |
...
| :--- | :---: | :---: | :--- |
| Financials | XLF | 14.3% | ADD |
| Industrials | XLI | 10.0% | ADD |
| Real Estate | XLRE | 14.3% | ADD |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9835529034094324
- **Z-Score (5d):** 1.2128452810671693

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.5295979425044417
- **Z-Score (5d):** 0.7886127250805051
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.45854475365948005
- **Z-Score (5d):** 0.548405684414304

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.837336465141396
- **Z-Score (5d):** 1.5918365856384002

### GLD
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.4945130693287123
- **Z-Score (5d):** 0.2950568117905188

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.2058336375602838
- **Z-Score (5d):** 2.0984286989629792

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.29062681611003016
- **Z-Score (5d):** -0.8887940289204644
