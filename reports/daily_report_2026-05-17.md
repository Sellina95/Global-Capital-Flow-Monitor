...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 25%**
- **Final Exposure (실행 기준): 23%**

- **Portfolio Stance:** STRONG REDUCE / 23%
...
- **Final Exposure:** **23%**
- **Base Context:** phase=SOFT RISK-OFF (경계 강화) / narrative=STRONG REDUCE / base_exposure=25%
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 1 → 경미한 이상신호, 모니터링 강화 → Tactical=REDUCE / Flow=🌱 LIGHT TRACE(2) / Drift=👀 EARLY DRIFT(3) / Gamma=🟡 TRANSITION → Tactical REDUCE → 방어 기조 유지 / 익스포저 5% 추가 축소
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-05-17 (FRED last available)
- **유인(Real Rates):** level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-05-17 (FRED last available)
...
- **WTI:** 🟡 PULLBACK | Short-term: MIXED | 1D=-0.15% / 5D=+5.87% | Strength: MEDIUM
- **DXY:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.39% / 5D=+1.46% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT UP | 1D=-2.48% / 5D=-3.36% | Strength: MEDIUM
...
- **3D Avg Score:** -0.15
- **Geo Momentum:** +0.32 *(Status: RISING)*

**Historical Pattern Match (Cosine Similarity):**
- **Closest Historical Match:** China_Trade_2018
- **Cosine Similarity Score:** 0.555
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - China_Trade_2018: 0.555
  - Taiwan_Tension: 0.507
  - Ukraine_2022: 0.408
- **Top Drivers:**
  - USDCNH: z_used=+1.03 (z1d=+1.27, z5d=+0.66, raw_w=0.18, norm_w=0.14) → contrib=+0.14
...
- **Dealer Gamma Bias:** 1.57 (STABILIZING / dealer gamma proxy supportive)
...
*(as of: RealRate: 2026-05-17 / FRED last available)*
...
- **Phase:** SOFT RISK-OFF (경계 강화) (Cap: 30)
...
- **Narrative:** 구조=TIGHTENING(스태그플레이션) / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=2.15 ⚠️ 수급 과열 감지 → Phase=SOFT RISK-OFF (경계 강화)
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `SOFT RISK-OFF` | **Bucket:** `RISK-OFF` | **VIX:** `18.43`
- **Positioning Data:** Z-Score: `2.15` (>1.8 시 Run) | Gamma: `1.57` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.15), Positive Gamma(1.57)
- **Brake Drivers:** ⚠️ Extreme Positioning Heat, VIX Spike, Medium-Low Confidence
...
**Macro Inputs Debug:** phase=SOFT RISK-OFF (경계 강화) / us10y_pct=+3.00% / dxy_pct=+0.39% / wti_pct=+4.20% / vix=18.43 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=2

**Flow Overlay:** flow_score=2 / flow_state=🌱 LIGHT TRACE / drift_label=NEUTRAL / gamma=🟡 TRANSITION

**Overweight:** Industrials, Technology, Energy, Consumer Discretionary, Materials

**Underweight:** Financials, Real Estate, Utilities

**Scoreboard:**
- Industrials: +1.0  (+1.5 LIQ, +1 CURVE, = +1.0)
- Technology: +1.0  (+2 LIQ, -1 PHASE, +2 MOM, = +1.0)
- Energy: +0.9  (+1.5 PHASE, +1 MOM, = +0.9)
...
- OW Energy: +1.5: Stagflation Stress → 유가/인플레 압력 수혜
...
**Regime Controller:**
- DISLOCATION (avg_divergence=-0.65, dispersion=1.57)
...
- Industrials: FLOW_WEAK (theory=+2.5, flow=+0.0, final=+1.0)
...
- **Strategic Exposure (15):** **25.0%** → **Regime Adjusted:** **21.2%**
- **Exposure Override:** DISLOCATION → 섹터 괴리 확대, 총노출 15% 축소

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +1.5 | ALIGNED | **10.7%** | HOLD |
| Energy | +0.9 | ALIGNED | **6.5%** | HOLD |
| Industrials | +0.7 | NEGATIVE_DIVERGENCE | **1.8%** | HOLD |
| Materials | +0.2 | ALIGNED | **1.5%** | HOLD |
| Consumer Discretionary | +0.1 | ALIGNED | **0.8%** | HOLD |
| **Cash & Hedge** | - | - | **78.7%** | DEFENSIVE |
...
1. Industrials (priority_score=6.17, score=0.6699999999999999, weight=1.8%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Discretionary (priority_score=-0.05, score=0.10999999999999999, weight=0.8%, div=ALIGNED, mom=0)
3. Materials (priority_score=-0.1, score=0.21, weight=1.5%, div=ALIGNED, mom=0)
4. Energy (priority_score=-1.11, score=0.89, weight=6.5%, div=ALIGNED, mom=1)
5. Technology (priority_score=-1.77, score=1.47, weight=10.7%, div=ALIGNED, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=4.47, score=1.47, weight=10.7%, div=ALIGNED, mom=2)
2. Energy (priority_score=2.39, score=0.89, weight=6.5%, div=ALIGNED, mom=1)
3. Materials (priority_score=0.21, score=0.21, weight=1.5%, div=ALIGNED, mom=0)
4. Consumer Discretionary (priority_score=0.11, score=0.10999999999999999, weight=0.8%, div=ALIGNED, mom=0)
5. Industrials (priority_score=-2.33, score=0.6699999999999999, weight=1.8%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 10.7% | CONTROLLED_ADD | ALIGNED | ALIGNED |
| Energy | XLE | 6.5% | SMALL | ALIGNED | ALIGNED |
| Industrials | XLI | 1.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Materials | XLB | 1.5% | MICRO | ALIGNED | ALIGNED |
| Consumer Discretionary | XLY | 0.8% | MICRO | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** HIGH
- **Z-Score (1d):** -1.9490013480990345
- **Z-Score (5d):** -2.0607913376726397
