...
- **WTI 유가**: 101.020  (-0.15% vs 101.170)
...
- **Meaningful Move Check:** DXY=0.3944168694189266 / GOLD=-2.483918532882972 / US10Y=3.003806894310716 / VIX=6.77867937878783 / WTI=-0.1482668069524234
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.390 / US10YΔ +0.134 (정상)
...
**Overweight:** Technology, Industrials, Health Care, Consumer Discretionary, Consumer Staples, Energy

**Underweight:** Utilities, Real Estate, Financials

**Scoreboard:**
- Technology: +2.2  (+2 LIQ, +0.5 PHASE, +2 MOM, = +2.2)
- Industrials: +1.1  (+1.5 LIQ, +1 CURVE, -0.5 PHASE, = +1.1)
- Health Care: +0.7  (+1.2 PHASE, = +0.7)
- Consumer Discretionary: +0.6  (+1.5 LIQ, -0.5 PHASE, = +0.6)
- Consumer Staples: +0.5  (+0.8 PHASE, = +0.5)
- Energy: +0.3  (+1 MOM, = +0.3)
- Financials: -0.3  (+1 LIQ, +2 CURVE, -2 MOM, = -0.3)
- Real Estate: -0.4  (-2 MOM, = -0.4)
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.93, dispersion=1.40)
...
- Technology: HIGH_CONVICTION_ALIGNED (theory=+2.5, flow=+1.4, final=+2.2)
- Industrials: FLOW_WEAK (theory=+2.0, flow=+0.0, final=+1.1)
...
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.7 | ALIGNED | **19.1%** | REBALANCE |
| Industrials | +0.8 | NEGATIVE_DIVERGENCE | **1.8%** | HOLD |
| Health Care | +0.7 | ALIGNED | **4.4%** | NEW |
| Consumer Staples | +0.5 | ALIGNED | **2.9%** | NEW |
| Consumer Discretionary | +0.3 | ALIGNED | **0.8%** | HOLD |
| Energy | +0.3 | POSITIVE_DIVERGENCE | **2.0%** | SMALL ADJUST |
| **Cash & Hedge** | - | - | **69.0%** | DEFENSIVE |
...
1. Industrials (priority_score=6.11, score=0.78, weight=1.8%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Discretionary (priority_score=-0.14, score=0.29, weight=0.8%, div=ALIGNED, mom=0)
3. Consumer Staples (priority_score=-0.23, score=0.47, weight=2.9%, div=ALIGNED, mom=0)
4. Health Care (priority_score=-0.35, score=0.7, weight=4.4%, div=ALIGNED, mom=0)
5. Energy (priority_score=-3.14, score=0.28, weight=2.0%, div=POSITIVE_DIVERGENCE, mom=1)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=7.67, score=2.67, weight=19.1%, div=ALIGNED, mom=2)
2. Energy (priority_score=2.78, score=0.28, weight=2.0%, div=POSITIVE_DIVERGENCE, mom=1)
3. Health Care (priority_score=0.70, score=0.7, weight=4.4%, div=ALIGNED, mom=0)
4. Consumer Staples (priority_score=0.47, score=0.47, weight=2.9%, div=ALIGNED, mom=0)
5. Consumer Discretionary (priority_score=0.29, score=0.29, weight=0.8%, div=ALIGNED, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 19.1% | CONTROLLED_LEADER | ALIGNED | HIGH_CONVICTION_ALIGNED |
| Industrials | XLI | 1.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 4.4% | DEFENSIVE_QUALITY | ALIGNED | ALIGNED |
| Consumer Staples | XLP | 2.9% | DEFENSIVE_BUFFER | ALIGNED | ALIGNED |
| Consumer Discretionary | XLY | 0.8% | MICRO | ALIGNED | ALIGNED |
| Energy | XLE | 2.0% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
