...
🧭 1. Executive Summary
Markets are operating in a RISK-ON / LIQUIDITY regime as liquidity conditions remain up and volatility pressures have increased. Participation remains ⚡ BUILDING, while positioning risk sits at 2.2. Maintain disciplined exposure and avoid adding marginal risk.
...
Current market is best described as 'POLICY_EASING'.
...
Recommendation: HOLD (POS_OVERHEATED) / NONE
Confidence: LOW
Rationale:
...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 72%**
- **Final Exposure (실행 기준): 72%**

- **Portfolio Stance:** HOLD (POS_OVERHEATED) / 72%
...
- **Final Exposure:** **72%**
- **Base Context:** phase=RISK-ON / LIQUIDITY / narrative=HOLD (POS_OVERHEATED) / base_exposure=72%
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 1 → 경미한 이상신호, 모니터링 강화 → Tactical=HOLD / Flow=⚡ BUILDING(5) / Drift=⚡ STRUCTURAL DRIFT(7) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음

### 🚩 Market Regime Status
- **Operational Phase:** ✅ **RISK-ON / LIQUIDITY**
...
- **달러 인덱스**: 99.600  (-0.36% vs 99.960)
- **WTI 유가**: 78.180  (+0.18% vs 78.040)
...
- **현실(FCI):** value=-0.529 / level=EASY (완화) / update=low-frequency | as of: 2026-08-09 (latest available)
- **유인(Real Rates):** value=2.430 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-09 (latest available)
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCI value=-0.529 (low-frequency) / DXYΔ -0.360 / US10YΔ -0.010**
...
- **WTI:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+1.15% / 5D=-7.67% | Strength: MEDIUM
- **DXY:** 🔴 DOWN | Short-term: MIXED | 1D=-0.37% / 5D=-0.20% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: MIXED | 1D=+3.72% / 5D=+8.66% | Strength: HIGH
...
- **Top Drivers:**
  ...
  - GOLD: z_used=+1.23 (z1d=+0.39, z5d=+2.49, raw_w=0.12, norm_w=0.09) → contrib=+0.11
...
*(as of: RealRate: 2026-08-09 / FRED last available)*
...
- **강도:** US10Y(Strong) / DXY(Strong) / WTI(Mild) / VIX(Clear)
...
- **Today snapshot:** US10Y(4.660), DXY(99.600), VIX(14.90)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↓) / DXY(↓) / GOLD(↑) / VIX(↓) / WTI(↑)
- **Meaningful Move Check:** DXY=-0.3601446715173924 / GOLD=0.48382775984943965 / US10Y=-0.214137659924237 / VIX=-1.6501650580520142 / WTI=0.1793943977524766
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.659999847412109, RealYield=2.43, T10Y2Y=0.46, WTI=78.18000030517578, DXY=99.5999984741211, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.71, DriftLabel=NEUTRAL, FredAsof=2026-08-07
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCI value=-0.529 (low-frequency) / DXYΔ -0.360 / US10YΔ -0.010 (정상)
...
- **Narrative:** 구조=EASING / 심리=GREED / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=2.21 ⚠️ 수급 과열 감지 → Phase=RISK-ON / LIQUIDITY
...
- **Structure(3번):** `EASING` | **Price(Regime):** `RISK-ON` | **Bucket:** `RISK-ON` | **VIX:** `14.90`
- **Positioning Data:** Z-Score: `2.21` (>2.2 시 Run) | Gamma: `0.99` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Final Multiplier:** 0.85x (VIX x Positioning x Credit/Convexity)
- **Slope Intensity:** 0.0550
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.21)
- **Brake Drivers:** ⚠️ Extreme Positioning Heat

- **📊 Recommended Exposure:** **72%**
...
**Context:** phase=RISK-ON / LIQUIDITY / T10Y2Y=0.46 (MODERATE STEEP) / VIX=14.90 (VOLATILITY CALM) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** DISINFLATION_RISK_ON
**Macro Inputs Debug:** phase=RISK-ON / LIQUIDITY / us10y_pct=-0.21% / dxy_pct=-0.36% / wti_pct=+0.18% / vix=14.90 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=5
...
**Overweight:** Technology, Industrials, Financials, Communication Services

**Underweight:** Utilities, Consumer Discretionary, Real Estate

**Scoreboard:**
- Technology: +2.6  (+2 VOL, +2 LIQ, +1.5 PHASE, +1.5 FLOW, = +2.6)
- Industrials: +1.1  (+1.5 LIQ, +1 CURVE, +1 FLOW, = +1.1)
- Financials: +0.9  (+1 LIQ, +2 CURVE, +1 MOM, = +0.9)
- Communication Services: +0.2  (+0.5 PHASE, = +0.2)
- Real Estate: -0.3  (-1 MOM, = -0.3)
- Consumer Discretionary: -0.8  (+1 VOL, +1.5 LIQ, +1 PHASE, -1 MOM, = -0.8)
- Utilities: -1.0  (-1 VOL, -1 LIQ, -0.5 PHASE, = -1.0)
...
- OW Communication Services: +0.5: Disinflation Risk-On → 플랫폼/성장 섹터 우호
- UW Utilities: -1: VOLATILITY CALM → 방어주 상대매력 둔화 (absolute mode: VIX 14.9)
- UW Utilities: -1: 유동성 완화 → 방어주 상대매력 저하

**Regime Controller:**
- DISLOCATION (avg_divergence=-1.13, dispersion=2.05)
...
- Technology: FLOW_WEAK (theory=+5.5, flow=+0.5, final=+2.6)
...
- Consumer Discretionary: THEORY_TRAP (theory=+3.5, flow=-0.7, final=-0.8)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **72.0%** → **Regime Adjusted:** **72.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.6 | NEGATIVE_DIVERGENCE | **15.0%** | DELEVERAGE |
| Industrials | +1.1 | NEGATIVE_DIVERGENCE | **10.0%** | DELEVERAGE |
| Financials | +0.9 | NEGATIVE_DIVERGENCE | **10.0%** | DELEVERAGE |
| Communication Services | +0.2 | ALIGNED | **6.2%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **58.8%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** DISINFLATION_RISK_ON
- **Participation / Quality Cap Applied:**
  - Industrials: 18.9% → 15.0% (-3.9%)
  - Technology: 30.4% → 15.0% (-15.4%)
  - Industrials: 15.0% → 10.0% (-5.0%)
  - Financials: 16.6% → 10.0% (-6.6%)
- **Strategic Cash (15):** 28.0%
- **Tactical Reserve (Cap / Unallocated):** 30.8%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Industrials (priority_score=3.46, score=1.07, weight=10.0%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Technology (priority_score=2.71, score=2.57, weight=15.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.53, score=0.94, weight=10.0%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Communication Services (priority_score=-0.1, score=0.21, weight=6.2%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Communication Services (priority_score=0.21, score=0.21, weight=6.2%, div=ALIGNED, mom=0)
2. Technology (priority_score=-0.43, score=2.57, weight=15.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=-0.56, score=0.94, weight=10.0%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Industrials (priority_score=-1.93, score=1.07, weight=10.0%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| Communication Services | XLC | 6.2% | SMALL | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8438378019259152
- **Z-Score (5d):** 1.2247480709583412
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8186783194111423
- **Z-Score (5d):** 1.3256451809894516
