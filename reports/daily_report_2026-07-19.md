...
🧭 1. Executive Summary
Markets are operating in a TRANSITION / MIXED regime as liquidity conditions remain up and volatility pressures have increased. Participation remains 🌱 LIGHT TRACE, while positioning risk sits at 1.6. Maintain disciplined exposure and avoid adding marginal risk.
...
- **WTI 유가**: 81.780  (+3.45% vs 79.050)
- **변동성 지수 (VIX)**: 18.770 (+12.19% vs 16.730)
- **원/달러 환율**: 1487.460  (+0.08% vs 1486.200)
...
- **현실(FCI):** value=-0.538 / level=EASY (완화) / update=low-frequency | as of: 2026-07-19 (latest available)
- **유인(Real Rates):** value=2.350 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-07-19 (latest available)
...
- WTI **(Strong, +3.45%)** → 인플레 재자극 가능성
- VIX **(Strong, +12.19%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Mild, +0.08%)** → 원화 약세/수급 부담
...
- **WTI:** 🟢 UP | Short-term: SHORT UP | 1D=+3.58% / 5D=+14.52% | Strength: HIGH
- **DXY:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.02% / 5D=-0.21% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.83% / 5D=-2.08% | Strength: LOW
...
*(as of: RealRate: 2026-07-19 / FRED last available)*
...
- **Meaningful Move Check:** DXY=-0.03373212333722538 / GOLD=0.46748708070659856 / US10Y=-0.6128229230839395 / VIX=12.193669882519634 / WTI=3.453504898350989
...
- **Input Check:** US10Y=4.540999889373779, RealYield=2.35, T10Y2Y=0.37, WTI=81.77999877929688, DXY=100.75, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.71, DriftLabel=NEUTRAL, FredAsof=2026-07-17
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=1.65 ⚠️ 수급 다소 과열 → Phase=TRANSITION / MIXED
...
- **Positioning Data:** Z-Score: `1.65` (>1.8 시 Run) | Gamma: `0.90` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Positioning Heat(1.65)
...
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=-0.61% / dxy_pct=-0.03% / wti_pct=+3.45% / vix=18.77 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=2
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2907475399521488
- **Z-Score (5d):** 0.3457101959803786
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.20364273148169398
- **Z-Score (5d):** -0.6855960843697108
