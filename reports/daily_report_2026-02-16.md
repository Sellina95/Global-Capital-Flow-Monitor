...
- **달러 인덱스**: 97.049  (-0.02% vs 97.069)
- **WTI 유가**: 63.020  (-0.03% vs 63.040)
- **변동성 지수 (VIX)**: 20.630  (+0.44% vs 20.540)
- **원/달러 환율**: 1442.190  (+0.06% vs 1441.370)
...
- **VIX 레벨:** 20.63 → **High (Risk-off bias)**
...
- **Today snapshot:** US10Y(4.056), DXY(97.049), VIX(20.63)
