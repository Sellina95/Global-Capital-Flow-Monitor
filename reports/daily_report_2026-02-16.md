...
- **달러 인덱스**: 97.069  (+0.01% vs 97.059)
- **WTI 유가**: 63.040  (-0.08% vs 63.090)
- **변동성 지수 (VIX)**: 20.540  (-0.29% vs 20.600)
- **원/달러 환율**: 1441.370  (+0.03% vs 1440.890)
...
- **VIX 레벨:** 20.54 → **High (Risk-off bias)**
...
- **Today snapshot:** US10Y(4.056), DXY(97.069), VIX(20.54)
