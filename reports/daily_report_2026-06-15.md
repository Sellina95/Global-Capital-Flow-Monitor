...
🧭 1. Executive Summary
Markets are operating in a TRANSITION / MIXED regime as liquidity conditions remain up and volatility pressures have increased. Participation remains ⚡ BUILDING, while positioning risk sits at 2.1. Maintain disciplined exposure and avoid adding marginal risk.
...
Recommendation: REDUCE (POS_OVERHEATED) / NONE
Confidence: LOW
Rationale:
...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 58%**
- **Final Exposure (실행 기준): 58%**

- **Portfolio Stance:** REDUCE (POS_OVERHEATED) / 58%

- **[14번 구조·수급 괴리]:** 🚨 **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.10). 반전 가능성 상존.
### 🟢 Current SEW Status
...
- **Final Exposure:** **58%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=REDUCE (POS_OVERHEATED) / base_exposure=58%
- **SEW:** STABLE / NORMAL
- **Divergence:** N/A / **MONITOR REVERSAL (RUN 액션 준비)**
- **Drift:** 🔥 EXTREME DRIFT / NEUTRAL / 🟢 EARLY FLOW WITHOUT SHOCK / score=9
- **Flow:** ⚡ BUILDING / score=5
- **Gamma:** 🟡 POSITIVE-TRANSITION
- **Tactical Action:** HOLD / NONE / LOW
- **Positioning:** pos_z=2.10
- **Warning Score:** 4 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 3+ → 공격적 확장 금지 / 총노출 추가 감산 없이 방어적 배분 → Tactical=HOLD / Flow=⚡ BUILDING(5) / Drift=🔥 EXTREME DRIFT(9) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 4.487  (+0.54% vs 4.463)
- **달러 인덱스**: 99.750  (-0.11% vs 99.860)
- **WTI 유가**: 84.880  (-3.23% vs 87.710)
- **변동성 지수 (VIX)**: 17.680 (-9.05% vs 19.440)
- **원/달러 환율**: 1517.380  (-0.50% vs 1525.050)
...
- **VIX 레벨:** 17.68 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.506 / level=EASY (완화) / update=low-frequency | as of: 2026-06-15 (latest available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ N/A / FCI value=-0.506 (low-frequency) / DXYΔ -0.110 / US10YΔ +0.024**
...
- **Liquidity as of:** 2026-06-10 (FRED latest)
- **NET_LIQ level:** 5897274.6
- **TGA level:** 828122.0
- **RRP level:** 0.387
...
- **Spread as of:** 2026-06-11 (FRED latest)
- **HY_OAS level:** 2.78% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -0.71%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(→) / LQD(↓)
- **HYG:** today 79.940 / prev 79.940 / pct 0.00%
- **LQD:** today 109.010 / prev 109.080 / pct -0.06%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +0.54%)** → 완화 기대 약화/금리 부담
- DXY **(Mild, -0.11%)** → 달러 약세/리스크 선호
- WTI **(Strong, -3.23%)** → 물가 부담 완화
- VIX **(Strong, -9.05%)** → 심리 개선/리스크온
...
- **SPY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.53% / 5D=+0.56% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-4.95% / 5D=-11.63% | Strength: HIGH
- **DXY:** 🔴 DOWN | Short-term: SHORT UP | 1D=-0.25% / 5D=-0.55% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+2.68% / 5D=-0.18% | Strength: LOW
...
- **Cosine Similarity Score:** -0.200
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.200
  - Israel_2023: -0.358
  - China_Trade_2018: -0.365
- **Top Drivers:**
  - VIX: z_used=-1.14 (z1d=-1.09, z5d=-1.22, raw_w=0.18, norm_w=0.14) → contrib=-0.16
  - GOLD: z_used=+0.94 (z1d=+1.81, z5d=-0.36, raw_w=0.12, norm_w=0.09) → contrib=+0.09
  - USDCNH: z_used=+0.48 (z1d=+0.46, z5d=+0.51, raw_w=0.18, norm_w=0.14) → contrib=+0.07
  - WTI: z_used=-0.67 (z1d=-0.66, z5d=-0.67, raw_w=0.10, norm_w=0.08) → contrib=-0.05
...
- **Dealer Gamma Bias:** 1.03 (NEUTRAL / transition zone)
- **Bias:** VIX는 안정적이나 Drift가 형성 중
- **Strategy:** 초기 방향성 관찰 / 과도한 추격 금지

- **Drift Score:** 9 (🔥 EXTREME DRIFT)
...
**핵심 신호:** 장단기차(0.00bp) | 실질금리(0.00%) | DXY(99.75)
...
- **Today snapshot:** US10Y(4.487), DXY(99.750), VIX(17.68)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↓) / GOLD(↑) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=-0.11015482643624154 / GOLD=3.048674906076919 / US10Y=0.5377586558555082 / VIX=-9.053498871043908 / WTI=-3.226544134756107
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.486999988555908, RealYield=nan, T10Y2Y=nan, WTI=84.87999725341797, DXY=99.75, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.78, DriftLabel=NEUTRAL, FredAsof=2026-06-12
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=2.83 → healthy contango / stable structure
- Short-Term Hedge: VIX9D/VIX=0.98 → neutral short-term hedge
...
- **Breadth Note:** RSP-SPY return spread=0.37%p → broad participation
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=0.59%p → broad Nasdaq participation
- **Positioning / Gamma:** -2
...
**Leadership Notes**
- QQQ-SPY spread=0.05%p → neutral growth leadership
- SMH-QQQ spread=1.14%p → semiconductor participation strong
- SOXX-QQQ spread=1.00%p → SOX proxy confirms chip breadth
- IWM-SPY spread=0.33%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=0.83%p → sector diffusion positive
- XLI-SPY spread=0.05%p → sector diffusion neutral
- XLY-SPY spread=-0.28%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ N/A / FCI value=-0.506 (low-frequency) / DXYΔ -0.110 / US10YΔ +0.024 (정상)
- **Sentiment (Fear&Greed):** 56.61605525725201 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=🔥 EXTREME DRIFT (NEUTRAL) / 수급=2.10 ⚠️ 수급 과열 감지 → Phase=TRANSITION / MIXED
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `TRANSITION / MIXED` | **Bucket:** `MIXED` | **VIX:** `17.68`
- **Positioning Data:** Z-Score: `2.10` (>1.8 시 Run) | Gamma: `1.03` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
- **Status:** **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.10). 반전 가능성 상존.
...
- **VIX Level:** 17.68 (NORMAL) | **Change:** -9.05%
- **⚠️ STATUS:** RISK COMPRESSION
- **Reason:** POS_Z Extreme (2.10)
- **Action:** 신규 추격 금지 / 일부 이익실현 / 베타 노출 축소
- **Final Multiplier:** 0.89x (VIX x Positioning x Credit/Convexity)
- **Slope Intensity:** 0.1300
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.10)
...
**Context:** phase=TRANSITION / MIXED / T10Y2Y=0.00 (FLAT / FRAGILE) / VIX=17.68 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** BALANCED
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=+0.54% / dxy_pct=-0.11% / wti_pct=-3.23% / vix=17.68 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=5
...
**Overweight:** Technology, Consumer Staples, Health Care, Industrials, Financials

**Underweight:** Consumer Discretionary, Utilities, Energy, Real Estate

**Scoreboard:**
- Technology: +2.0  (+2 LIQ, +1.5 FLOW, +2 MOM, = +2.0)
- Consumer Staples: +0.9  (+1 CURVE, +0.5 PHASE, = +0.9)
- Health Care: +0.9  (+1 CURVE, +0.5 PHASE, = +0.9)
- Industrials: +0.8  (+1.5 LIQ, +1 FLOW, -1 MOM, = +0.8)
- Financials: +0.6  (+1 LIQ, +1 MOM, = +0.6)
- Real Estate: -0.2  (= -0.2)
- Energy: -0.4  (-2 MOM, = -0.4)
- Utilities: -0.6  (-1 LIQ, = -0.6)
- Consumer Discretionary: -1.2  (+1.5 LIQ, -1 MOM, = -1.2)
...
- OW Industrials: +0.5: Flow Overlay → 경기민감 확인용 가점
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.72, dispersion=0.97)
- Correlation Break: True / Type=UNCLASSIFIED_SECTOR_BREAK
- Break Reasons: US10Y ↑ but Technology ↑ | US10Y ↑ but SPY ↑ | US10Y ↑ but XLRE ↑ | US10Y ↑ but XLK ↑
- Interpretation: 균형 장세 / 강한 방향성보다 선별적 배분 필요

**Divergence / Classification Monitor (Theory vs Flow alignment: 이론과 실제 자금흐름 정렬 여부)**
- Technology: HIGH_CONVICTION_ALIGNED (theory=+2.0, flow=+1.9, final=+2.0)
- Communication Services: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Materials: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Real Estate: NEUTRAL (theory=+0.0, flow=+0.0, final=-0.2)
- Consumer Discretionary: THEORY_TRAP (theory=+1.5, flow=-0.7, final=-1.2)
...
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.0 | ALIGNED | **15.0%** | DELEVERAGE |
| Consumer Staples | +0.9 | ALIGNED | **9.8%** | DELEVERAGE |
| Health Care | +0.9 | ALIGNED | **9.8%** | DELEVERAGE |
| Industrials | +0.8 | ALIGNED | **5.5%** | DELEVERAGE |
| Financials | +0.6 | ALIGNED | **6.8%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **53.1%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** BALANCED
- **Participation / Quality Cap Applied:**
  - Technology: 26.0% → 15.0% (-11.0%)
- **Strategic Cash (15):** 42.0%
- **Tactical Reserve (Cap / Unallocated):** 11.1%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Industrials (priority_score=1.12, score=0.76, weight=5.5%, div=ALIGNED, mom=-1)
2. Consumer Staples (priority_score=-0.38, score=0.88, weight=9.8%, div=ALIGNED, mom=0)
3. Health Care (priority_score=-0.38, score=0.88, weight=9.8%, div=ALIGNED, mom=0)
4. Financials (priority_score=-1.3, score=0.61, weight=6.8%, div=ALIGNED, mom=1)
5. Technology (priority_score=-7.16, score=2.02, weight=15.0%, div=ALIGNED, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=7.02, score=2.02, weight=15.0%, div=ALIGNED, mom=2)
2. Financials (priority_score=2.11, score=0.61, weight=6.8%, div=ALIGNED, mom=1)
3. Consumer Staples (priority_score=0.88, score=0.88, weight=9.8%, div=ALIGNED, mom=0)
4. Health Care (priority_score=0.88, score=0.88, weight=9.8%, div=ALIGNED, mom=0)
5. Industrials (priority_score=0.76, score=0.76, weight=5.5%, div=ALIGNED, mom=-1)

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action | Divergence | Classification |
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 15.0% | ACCUMULATE | ALIGNED | HIGH_CONVICTION_ALIGNED |
| Consumer Staples | XLP | 9.8% | SMALL | ALIGNED | ALIGNED |
| Health Care | XLV | 9.8% | SMALL | ALIGNED | ALIGNED |
| Industrials | XLI | 5.5% | SMALL | ALIGNED | ALIGNED |
| Financials | XLF | 6.8% | SMALL | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.4626802348997938
- **Z-Score (5d):** 1.0775466549085548

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1307592798416644
- **Z-Score (5d):** 0.988442427174068

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6418453043681058
- **Z-Score (5d):** 0.9862969465461385

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.06775377335443843
- **Z-Score (5d):** 0.777316577234493

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2602736493576507
- **Z-Score (5d):** 0.6042863023566558

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8638007588611726
- **Z-Score (5d):** 0.8185452821729277

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.15362842513613878
- **Z-Score (5d):** -0.2771044970778852

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3613436043258432
- **Z-Score (5d):** -0.14606718707459268

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.1740368158955021
- **Z-Score (5d):** -0.2936905755239369
