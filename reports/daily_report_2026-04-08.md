...
- **WTI 유가**: 95.930  (-0.02% vs 95.950)
- **변동성 지수 (VIX)**: 24.170  (+0.00% vs 24.170)
- **원/달러 환율**: 1476.280  (-2.09% vs 1507.850)
...
- 원/달러(USDKRW) **(Strong, -2.09%)** → 원화 강세/수급 개선
...
- **Top Similarity Matches:**
  ...
  - Ukraine_2022: -0.154
- **Top Drivers:**
  - USDCNH: z_used=-2.68 (z1d=-2.69, z5d=-2.65, raw_w=0.18, norm_w=0.14) → contrib=-0.37
  - USDMXN: z_used=-1.93 (z1d=-1.65, z5d=-2.34, raw_w=0.05, norm_w=0.04) → contrib=-0.07
  - KR10Y_SPREAD: z_used=-1.00 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.06
  - WTI: z_used=-0.61 (z1d=-0.20, z5d=-1.22, raw_w=0.10, norm_w=0.08) → contrib=-0.05
...
- **Sentiment (Fear&Greed):** 37.55389498763412 (NEUTRAL)
- **Credit Calm:** True
