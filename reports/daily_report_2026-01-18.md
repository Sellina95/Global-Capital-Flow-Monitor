...
- **미국 10년물 금리**: 4.231 (+1.05% vs 4.187)
- **달러 인덱스**: 99.375 (+0.65% vs 98.738)
- **WTI 유가**: 59.340 (+4.01% vs 57.050)
- **변동성 지수 (VIX)**: 15.860 (+9.30% vs 14.510)
- **원/달러 환율**: 1468.840 (+1.53% vs 1446.670)
...
- **VIX 레벨:** 15.86 → **Mid (Neutral/Mixed)**
...
- **근거:** 금리↑ + 달러↑ → 정책 긴축 압력 강화 / 정책 불확실성 확대(VIX↑)
...
- DXY **(Strong, +0.65%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +4.01%)** → 인플레 재자극 가능성
- VIX **(Strong, +9.30%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, +1.53%)** → 원화 약세/수급 부담

### 🧩 5) Cross-Asset Filter (연쇄효과 분석)
- **추가 이유:** 한 지표의 변화가 다른 자산군에 어떻게 전파되는지, 즉 연쇄효과를 파악하기 위함

- **금리 상승(US10Y↑)** → **달러 강세(DXY↑)** 및 **유가 하락(WTI↓)** 경향
...
- **금리 상승(US10Y↑)** → **리스크 증가**: 금리 상승은 유동성 축소와 부담 증가
...
- **이득을 보는 주체:**
  - Banks/Financial Institutions (due to higher interest rates)
...
- **판정:** **금리 상승(US10Y 상승) 달러 강세(DXY 상승) 유가 상승(WTI 상승) 변동성 증가(VIX 상승) **
- **이유:** 직접적인 원인 파악

### 🔄 9) Direction Filter
- **질문:** 시장이 어느 방향으로, 얼마나 움직였는가?
- **핵심 신호:** US10Y(Strong, ↑) / DXY(Strong, ↑) / WTI(Strong, ↑) / VIX(Strong, ↑)
- **판정:** **SIGNIFICANT MOVEMENT (의미 있는 움직임)**
- **근거:** 금리나 달러의 변동이 크고 뚜렷함

### ⏳ 10) Timing Filter
- **질문:** 시장 변화가 단기, 중기, 장기 관점에서 어떤 영향을 미치는지?
- **핵심 신호:** US10Y(1.05% short-term, 4.19% medium-term, 4.23% long-term) / DXY(0.65% short-term, 98.74% medium-term, 99.38% long-term) / VIX(9.30% short-term, 14.51% medium-term, 15.86% long-term)
- **판정:** **LONG-TERM RISK TREND (장기적 위험 신호)**
- **근거:** 금리가 계속해서 상승하고 있으며, 장기적인 리스크가 확대되고 있음

### 🏗️ 11) Structural Filter
- **질문:** 이 변화가 글로벌 경제 구조나 패권 구조와 어떻게 연결되는지?
- **핵심 신호:** US10Y(↑) / DXY(↑) / VIX(↑) / WTI(↑)
- **판정:** **TIGHTENING GLOBAL STRUCTURE (글로벌 긴축)**
- **근거:** 금리 상승과 달러 강세는 글로벌 금융 긴축을 예고하며, 신흥국 및 자산 시장에 큰 영향을 미침
