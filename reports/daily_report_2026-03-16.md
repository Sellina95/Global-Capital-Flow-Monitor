...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ N/A / US10YΔ N/A**
...
- **Note:** TECH_PROXY(QQQ/XLK) not available, SPY not available → using available proxies (credit/USD/FX).


No significant correlation break detected.

### ⚠ 6.6) Sector Correlation Break Monitor
- DEBUG: pct XLK=None, XLF=None, XLE=None, XLRE=None
- **Note:** sector ETFs missing today values: XLK, XLF, XLE, XLRE
...
- **Top Similarity Matches:**
  ...
  - Red_Sea: 0.242
- **Top Drivers:**
  - EMB: z_used=+2.00 (z1d=-1.72, z5d=-2.41, raw_w=0.12, norm_w=0.09) → contrib=+0.18
  - SEA: z_used=+2.37 (z1d=-2.26, z5d=-2.54, raw_w=0.05, norm_w=0.04) → contrib=+0.09
  - VIX: z_used=-0.51 (z1d=-0.18, z5d=-1.00, raw_w=0.18, norm_w=0.14) → contrib=-0.07
  - GOLD: z_used=-0.72 (z1d=-0.65, z5d=-0.84, raw_w=0.12, norm_w=0.09) → contrib=-0.07
...
- **강도:** US10Y(N/A) / DXY(N/A) / WTI(N/A) / VIX(N/A)
...
- **Today snapshot:** US10Y(N/A), DXY(N/A), VIX(N/A)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ N/A / US10YΔ N/A
