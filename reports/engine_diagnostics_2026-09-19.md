...
- **Final Action:** **HOLD**
- **Final Exposure:** **67%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=HOLD / base_exposure=67%
- **SEW:** STABLE / NORMAL
...
- **미국 10년물 금리**: 4.998  (+1.03% vs 4.947)
- **달러 인덱스**: 100.220  (+0.00% vs 100.220)
- **WTI 유가**: 100.300  (-1.58% vs 101.910)
- **변동성 지수 (VIX)**: 14.810 (-4.08% vs 15.440)
- **원/달러 환율**: 1379.530  (+0.21% vs 1376.600)
...
- **VIX 레벨:** 14.81 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.560 / level=EASY (완화) / update=low-frequency | as of: 2026-09-19 (latest available)
- **유인(Real Rates):** value=2.610 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-19 (latest available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCI value=-0.560 (low-frequency) / DXYΔ +0.000 / US10YΔ +0.051**
...
- **Liquidity as of:** 2026-09-16 (FRED latest)
- **NET_LIQ level:** 5869514.6
- **TGA level:** 877028.0
- **RRP level:** 5.375
...
- **Spread as of:** 2026-09-17 (FRED latest)
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 78.530 / prev 78.720 / pct -0.24%
- **LQD:** today 104.700 / prev 105.160 / pct -0.44%
- **판정:** **CREDIT NEUTRAL**
...
- WTI **(Strong, -1.58%)** → 물가 부담 완화
- VIX **(Strong, -4.08%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Clear, +0.21%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, -0.24%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Clear, -0.44%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🔴 DOWN | Short-term: SHORT UP | 1D=-0.13% / 5D=-0.35% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: MIXED | 1D=-6.32% / 5D=-4.58% | Strength: HIGH
- **DXY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.00% / 5D=+1.10% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.37% / 5D=+0.16% | Strength: LOW
...
- **Cosine Similarity Score:** -0.345
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Iran_Crisis_2020: -0.345
  - Red_Sea: -0.408
  - Ukraine_2022: -0.412
- **Top Drivers:**
  - USDCNH: z_used=-1.41 (z1d=-2.01, z5d=-0.50, raw_w=0.18, norm_w=0.14) → contrib=-0.19
  - KR10Y_SPREAD: z_used=-1.90 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.12
  - DE10Y_SPREAD: z_used=-1.95 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.09
  - JP10Y_SPREAD: z_used=-1.87 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.09
...
- **Dealer Gamma Bias:** 1.62 (STABILIZING / dealer gamma proxy supportive)
...
**핵심 신호:** 장단기차(25.00bp) | 실질금리(2.61%) | DXY(100.22)
*(as of: RealRate: 2026-09-19 / FRED last available)*
...
- **Today snapshot:** US10Y(4.998), DXY(100.220), VIX(14.81)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(→) / GOLD(↑) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=0.0 / GOLD=0.5727596407159312 / US10Y=1.030930219937885 / VIX=-4.080305556271018 / WTI=-1.5798258782225738
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.998000144958496, RealYield=2.61, T10Y2Y=0.25, WTI=100.3000030517578, DXY=100.22000122070312, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.7, DriftLabel=NEUTRAL, FredAsof=2026-09-18
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=3.43 → healthy contango / stable structure
...
- **Breadth Note:** RSP-SPY return spread=-0.36%p → narrow cap-weight leadership
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.41%p → mega-cap concentrated Nasdaq rally
- **Positioning / Gamma:** 0
...
**Leadership Notes**
- QQQ-SPY spread=0.75%p → growth leadership
- SMH-QQQ spread=1.58%p → semiconductor participation strong
- SOXX-QQQ spread=2.06%p → SOX proxy confirms chip breadth
- IWM-SPY spread=-0.35%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=0.08%p → sector diffusion neutral
- XLI-SPY spread=0.56%p → sector diffusion positive
- XLY-SPY spread=-0.20%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCI value=-0.560 (low-frequency) / DXYΔ +0.000 / US10YΔ +0.051 (정상)
- **Sentiment (Fear&Greed):** 68.18200305388335 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.42 → Phase=TRANSITION / MIXED
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `TRANSITION / MIXED` | **Bucket:** `MIXED` | **VIX:** `14.81`
- **Positioning Data:** Z-Score: `1.42` (>1.8 시 Run) | Gamma: `1.62` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 14.81 (NORMAL) | **Change:** -4.08%
- **Positioning Layer:** ⚠️ Positive Gamma(1.62)
- **Brake Drivers:** None
...
**Context:** phase=TRANSITION / MIXED / T10Y2Y=0.25 (MODERATE STEEP) / VIX=14.81 (VOLATILITY CALM) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** BALANCED
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=+1.03% / dxy_pct=+0.00% / wti_pct=-1.58% / vix=14.81 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=7
...
- UW Consumer Discretionary: +1: VOLATILITY CALM → 경기민감 소비 회복 (absolute mode: VIX 14.8)
...
- UW Industrials: +1: 완만한 스티프닝(0.25) → 성장 기대 반영

**Regime Controller:**
- DISLOCATION (avg_divergence=-1.19, dispersion=1.98)
...
- Technology: HIGH_CONVICTION_ALIGNED (theory=+4.0, flow=+1.1, final=+2.3)
...
- Financials: THEORY_TRAP (theory=+3.0, flow=-0.7, final=-1.2)
- Industrials: THEORY_TRAP (theory=+2.5, flow=-1.1, final=-1.4)
- Consumer Discretionary: THEORY_TRAP (theory=+2.5, flow=-1.4, final=-1.7)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **67.0%** → **Regime Adjusted:** **67.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.3 | ALIGNED | **10.0%** | REBALANCE |
| Energy | +0.7 | POSITIVE_DIVERGENCE | **10.0%** | REBALANCE |
| Consumer Staples | +0.2 | ALIGNED | **3.6%** | NEW |
| Health Care | +0.2 | ALIGNED | **3.6%** | NEW |
| **Cash & Hedge** | - | - | **72.8%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** BALANCED
- **Participation / Quality Cap Applied:**
  - Technology: 46.3% → 10.0% (-36.3%)
  - Energy: 13.5% → 10.0% (-3.5%)
- **Strategic Cash (15):** 33.0%
- **Tactical Reserve (Cap / Unallocated):** 39.8%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=-0.1, score=0.21, weight=3.6%, div=ALIGNED, mom=0)
2. Health Care (priority_score=-0.1, score=0.21, weight=3.6%, div=ALIGNED, mom=0)
3. Energy (priority_score=-3.86, score=0.68, weight=10.0%, div=POSITIVE_DIVERGENCE, mom=2)
4. Technology (priority_score=-6.52, score=2.33, weight=10.0%, div=ALIGNED, mom=1)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=5.83, score=2.33, weight=10.0%, div=ALIGNED, mom=1)
2. Energy (priority_score=4.68, score=0.68, weight=10.0%, div=POSITIVE_DIVERGENCE, mom=2)
3. Consumer Staples (priority_score=0.21, score=0.21, weight=3.6%, div=ALIGNED, mom=0)
4. Health Care (priority_score=0.21, score=0.21, weight=3.6%, div=ALIGNED, mom=0)

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action | Divergence | Classification |
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 10.0% | ACCUMULATE | ALIGNED | HIGH_CONVICTION_ALIGNED |
| Energy | XLE | 10.0% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
| Consumer Staples | XLP | 3.6% | SMALL | ALIGNED | ALIGNED |
| Health Care | XLV | 3.6% | SMALL | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.4287073710147593
- **Z-Score (5d):** 0.2709471769846488

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.11132827252962656
- **Z-Score (5d):** -0.33330347891204887

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.41691099043850394
- **Z-Score (5d):** 0.32540001988588374

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8489186084769822
- **Z-Score (5d):** 0.39273514038336604

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8107748651456907
- **Z-Score (5d):** -0.7877616820103097

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2522758516860026
- **Z-Score (5d):** -0.2918933982981722

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.36285182117071907
- **Z-Score (5d):** 0.06786473566360836

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.0829535934875833
- **Z-Score (5d):** -0.2139885900593873

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.25803499624963844
- **Z-Score (5d):** 0.0784188705357937
