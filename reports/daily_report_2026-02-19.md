...
- **미국 10년물 금리**: 4.079  (+0.30% vs 4.067)
- **달러 인덱스**: 97.721  (+0.45% vs 97.280)
- **WTI 유가**: 64.940  (+1.77% vs 63.810)
- **변동성 지수 (VIX)**: 19.620  (-0.81% vs 19.780)
- **원/달러 환율**: 1442.240  (+0.00% vs 1442.180)
...
- **VIX 레벨:** 19.62 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-02-17 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(↓) | as of: 2026-02-17 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (STRONG, score=+2.5) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.441 / US10YΔ +0.012**
...
- **Spread as of:** 2026-02-17 (FRED latest)
...
- **방향(전일 대비):** HYG(↑) / LQD(↓)
- **HYG:** today 80.910 / prev 80.810 / pct 0.12%
- **LQD:** today 111.590 / prev 111.700 / pct -0.10%
...
- 미국 금리(US10Y) **(Strong, +0.30%)** → 완화 기대 약화/금리 부담
- DXY **(Strong, +0.45%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +1.77%)** → 인플레 재자극 가능성
- VIX **(Mild, -0.81%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Noise, +0.00%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, +0.12%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Noise, -0.10%)** → 우량채 약세(리스크온 성향)
...
- **강도:** US10Y(Strong) / DXY(Strong) / WTI(Strong) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.079), DXY(97.721), VIX(19.62)
...
- **질문:** 오늘 시장이 믿는 스토리(심리)와 구조(거시/크레딧/유동성)는 정렬되는가?
- **추가 이유:** 숫자(구조)와 심리(내러티브)의 불일치는 ‘전환 구간’ 신호가 되기 때문

- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (STRONG, score=+2.5) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.441 / US10YΔ +0.012
- **Sentiment (Fear&Greed):** 35 (NEUTRAL)
- **Credit Calm:** Yes
- **Liquidity Supportive:** Yes
- **Phase:** **TRANSITION**
- **Final Risk Action:** **HOLD**
- **Narrative (1-liner):** 구조=Policy Bias: TIGHTENING (긴축) (STRONG, score=+2.5) / 심리=NEUTRAL / 크레딧=안정 / 유동성=우호 → Phase=TRANSITION