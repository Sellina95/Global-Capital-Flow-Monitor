...
- **달러 인덱스**: 99.573  (-0.08% vs 99.650)
- **WTI 유가**: 98.570  (+0.25% vs 98.320)
- **변동성 지수 (VIX)**: 26.780  (+0.00% vs 26.780)
- **원/달러 환율**: 1508.880  (+1.28% vs 1489.840)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ -0.077 / US10YΔ +0.000**
...
- WTI **(Mild, +0.25%)** → 인플레 재자극 가능성
- VIX **(Noise, +0.00%)** → 변동성 보합(심리 변화 제한)
- 원/달러(USDKRW) **(Strong, +1.28%)** → 원화 약세/수급 부담
...
- **Cosine Similarity Score:** 0.392
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.392
  - Ukraine_2022: 0.313
  - Israel_2023: 0.231
- **Top Drivers:**
  - GOLD: z_used=-1.70 (z1d=-1.23, z5d=-2.41, raw_w=0.12, norm_w=0.09) → contrib=-0.16
...
- **Today snapshot:** US10Y(4.391), DXY(99.573), VIX(26.78)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ -0.077 / US10YΔ +0.000
