...
- **달러 인덱스**: 99.829  (+0.18% vs 99.650)
- **WTI 유가**: 99.620  (+1.32% vs 98.320)
- **변동성 지수 (VIX)**: 26.780  (+0.00% vs 26.780)
- **원/달러 환율**: 1516.540  (+1.79% vs 1489.840)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.179 / US10YΔ +0.000**
...
- WTI **(Strong, +1.32%)** → 인플레 재자극 가능성
- VIX **(Noise, +0.00%)** → 변동성 보합(심리 변화 제한)
- 원/달러(USDKRW) **(Strong, +1.79%)** → 원화 약세/수급 부담
...
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.347
  - Ukraine_2022: 0.268
  - Israel_2023: 0.178
- **Top Drivers:**
  - GOLD: z_used=-2.77 (z1d=-2.61, z5d=-3.01, raw_w=0.12, norm_w=0.09) → contrib=-0.26
  - USDCNH: z_used=+1.16 (z1d=+1.05, z5d=+1.33, raw_w=0.18, norm_w=0.14) → contrib=+0.16
...
- **강도:** US10Y(Noise) / DXY(Clear) / WTI(Strong) / VIX(Noise)
...
- **Today snapshot:** US10Y(4.391), DXY(99.829), VIX(26.78)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.179 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 31.03897322970653 (NEUTRAL)
