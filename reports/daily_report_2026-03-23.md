...
- **달러 인덱스**: 99.651  (+0.15% vs 99.503)
- **WTI 유가**: 98.230  (+0.00% vs 98.230)
- **변동성 지수 (VIX)**: 26.780  (+0.00% vs 26.780)
- **원/달러 환율**: 1504.170  (-0.04% vs 1504.830)
...
- 전략적으로는 공격적 확대보다 45% 내외의 선별적 노출 유지가 적절하다.
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.148 / US10YΔ +0.000**
...
- **Cosine Similarity Score:** 0.402
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.402
  - Ukraine_2022: 0.325
  - Israel_2023: 0.267
- **Top Drivers:**
  - USDCNH: z_used=+0.74 (z1d=+0.29, z5d=+1.41, raw_w=0.18, norm_w=0.14) → contrib=+0.10
  - KR10Y_SPREAD: z_used=-1.00 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.06
  - GOLD: z_used=-0.54 (z1d=-0.02, z5d=-1.33, raw_w=0.12, norm_w=0.09) → contrib=-0.05
...
- **Today snapshot:** US10Y(4.391), DXY(99.651), VIX(26.78)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.148 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 31.991988348509555 (NEUTRAL)
