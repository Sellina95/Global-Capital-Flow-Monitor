...
### 📌 Interpretation
- 금일 시장은 **RISK-OFF (부분 정렬) 환경**이며 유동성과 정책은 완화적 상태
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **31%**
- **Base Context:** phase=RISK-OFF (부분 정렬) / narrative=REDUCE / base_exposure=33%
- **SEW:** STABLE / NORMAL
...
- **Positioning:** pos_z=1.51
- **Warning Score:** 1 (6.6 섹터 상관관계 붕괴)
- **Tactical Why:** Risk-off environment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=REDUCE 반영 → Warning Score 1 → 경미한 이상신호, 모니터링 강화 → Tactical=REDUCE / Flow=NO CLEAR FLOW(2) / Drift=NO DRIFT(0) / Gamma=🟢 POSITIVE GAMMA (WEAK) → Tactical REDUCE → 방어 기조 유지 / 익스포저 5% 추가 축소

### 🚩 Market Regime Status
- **국면 전환 감지:** 🚨 **RISK-OFF (긴축/불안·리스크 회피)** → **RISK-OFF (부분 정렬)**

---

## 📊 Daily Macro Signals

- **미국 10년물 금리**: 4.250  (+0.09% vs 4.246)
- **달러 인덱스**: 98.050  (-0.05% vs 98.100)
- **WTI 유가**: 89.610  (+6.87% vs 83.850)
- **변동성 지수 (VIX)**: 18.870  (+7.95% vs 17.480)
- **원/달러 환율**: 1465.150  (-0.86% vs 1477.920)
...
- **VIX 레벨:** 18.87 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-21 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-21 (FRED last available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.050 / US10YΔ +0.004**
...
- **Liquidity as of:** 2026-04-15 (FRED latest)
- **NET_LIQ level:** 5954341.8
- **TGA level:** 751354.0
- **RRP level:** 0.223
...
- **Spread as of:** 2026-04-17 (FRED latest)
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 80.580 / prev 80.650 / pct -0.09%
- **LQD:** today 110.030 / prev 110.040 / pct -0.01%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Clear, +0.09%)** → 완화 기대 약화/금리 부담
- DXY **(Mild, -0.05%)** → 달러 약세/리스크 선호
- WTI **(Strong, +6.87%)** → 인플레 재자극 가능성
- VIX **(Strong, +7.95%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, -0.86%)** → 원화 강세/수급 개선
...
- **SPY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.20% / 5D=+3.29% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-3.76% / 5D=-5.52% | Strength: MEDIUM
- **DXY:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.09% / 5D=+0.02% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-0.04% / 5D=-0.42% | Strength: LOW
...
- **Geo Stress Score (z-composite):** **+0.11**  *(Level: NORMAL)*
...
- **Cosine Similarity Score:** 0.291
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Iran_Crisis_2020: 0.291
  - Ukraine_2022: 0.256
  - Taiwan_Tension: 0.147
- **Top Drivers:**
  - VIX: z_used=+0.43 (z1d=+0.85, z5d=-0.21, raw_w=0.18, norm_w=0.14) → contrib=+0.06
  - SEA: z_used=+0.62 (z1d=-0.64, z5d=-0.60, raw_w=0.05, norm_w=0.04) → contrib=+0.02
  - JP10Y_SPREAD: z_used=+0.43 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=+0.02
  - USDMXN: z_used=+0.50 (z1d=+0.92, z5d=-0.12, raw_w=0.05, norm_w=0.04) → contrib=+0.02
...
**핵심 신호:** 장단기차(54.00bp) | 실질금리(1.90%) | DXY(98.05)
*(as of: RealRate: 2026-04-21 / FRED last available)*
...
- **강도:** US10Y(Clear) / DXY(Mild) / WTI(Strong) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.250), DXY(98.050), VIX(18.87)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↓) / GOLD(↓) / VIX(↑) / WTI(↑)
- **Meaningful Move Check:** DXY=-0.050963734088624195 / GOLD=-1.0499011646637413 / US10Y=0.09421071823515889 / VIX=7.951952708227809 / WTI=6.869412332795924
- **판정:** **NEUTRAL**
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.050 / US10YΔ +0.004 (정상)
- **Sentiment (Fear&Greed):** 56.21479896850997 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=NO DRIFT (GROWTH_SCARE) / 수급=1.51 ⚠️ 수급 다소 과열 → Phase=RISK-OFF (부분 정렬)
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `RISK-OFF` | **VIX:** `18.87`
- **Positioning Data:** Z-Score: `1.51` (>1.8 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 18.87 (NORMAL) | **Change:** +7.95%
- **Final Multiplier:** 0.85x (Vol x Pos)
...
**Context:** phase=RISK-OFF (부분 정렬) / T10Y2Y=0.54 (MODERATE STEEP) / VIX=18.87 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Flow Overlay:** flow_score=2 / flow_state=NO CLEAR FLOW / drift_label=GROWTH_SCARE / gamma=🟢 POSITIVE GAMMA (WEAK)

**Overweight:** Industrials, Consumer Discretionary, Technology, Consumer Staples, Financials, Health Care, Real Estate
...
- Technology: +2  (+2 LIQ, -1 PHASE, +1 MOM, = +2)
...
- OW Industrials: +1: 완만한 스티프닝(0.54) → 성장 기대 반영
...
- **Total Target Exposure:** **33.0%** (from Filter 15)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Industrials | +2.7 | ALIGNED | **8.4%** | HOLD |
| Consumer Discretionary | +1.7 | ALIGNED | **5.3%** | HOLD |
| Technology | +2.5 | ALIGNED | **7.8%** | HOLD |
| Consumer Staples | +1 | ALIGNED | **3.1%** | HOLD |
| Financials | +1 | NEGATIVE_DIVERGENCE | **2.2%** | HOLD |
| Health Care | +1 | ALIGNED | **3.1%** | HOLD |
| Real Estate | +1 | ALIGNED | **3.1%** | HOLD |
...
| :--- | :---: | :---: | :--- |
| Industrials | XLI | 8.4% | SMALL |
| Consumer Discretionary | XLY | 5.3% | SMALL |
| Technology | XLK | 7.8% | SMALL |
| Consumer Staples | XLP | 3.1% | SMALL |
| Financials | XLF | 2.2% | SMALL |
| Health Care | XLV | 3.1% | SMALL |
| Real Estate | XLRE | 3.1% | SMALL |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.31141487300910403
- **Z-Score (5d):** 0.4489666470293801

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.48558996768521967
- **Z-Score (5d):** 0.7517281727168704

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6026683025723014
- **Z-Score (5d):** 0.6400497248721019

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.2292924466165643
- **Z-Score (5d):** 0.45757766470773736

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6366127075747275
- **Z-Score (5d):** 0.17949032213225852

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.18174105014288566
- **Z-Score (5d):** 1.3781788288161245

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.3313828733688798
- **Z-Score (5d):** 0.22657315222548455

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.27109717390970395
- **Z-Score (5d):** 1.4546157863096196

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.19821948308075407
- **Z-Score (5d):** -0.23982065841218042
