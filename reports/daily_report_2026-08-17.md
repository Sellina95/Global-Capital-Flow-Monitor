...
🧭 1. Executive Summary
Markets are operating in a RISK-ON / REFLATION regime as liquidity conditions remain down and volatility pressures have increased. Participation remains 🌱 LIGHT TRACE, while positioning risk sits at 2.1. Maintain disciplined exposure and avoid adding marginal risk.
...
Current market is best described as 'REFLATION'.
...
Recommendation: REDUCE (POS_OVERHEATED) / 0%
Confidence: LOW
Rationale:
...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 57%**
- **Final Exposure (실행 기준): 57%**

- **Portfolio Stance:** REDUCE (POS_OVERHEATED) / 57%
...
- **Current Reason:** ⚠️ CROWDING RISK: POS_Z Extreme (2.24) → Risk Compression (55%)
...
- **Final Exposure:** **57%**
- **Base Context:** phase=RISK-ON / REFLATION / narrative=REDUCE (POS_OVERHEATED) / base_exposure=57%
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Tactical=WAIT / Flow=🌱 LIGHT TRACE(1) / Drift=👀 EARLY DRIFT(2) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음

### 🚩 Market Regime Status
- **Operational Phase:** ✅ **RISK-ON / REFLATION**
...
- **미국 10년물 금리**: 4.696  (+1.19% vs 4.641)
- **달러 인덱스**: 99.670  (-0.24% vs 99.909)
- **WTI 유가**: 82.400  (+1.38% vs 81.280)
- **변동성 지수 (VIX)**: 14.250 (-2.60% vs 14.630)
- **원/달러 환율**: 1416.850  (+0.03% vs 1416.460)
...
- **VIX 레벨:** 14.25 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.549 / level=EASY (완화) / update=low-frequency | as of: 2026-08-17 (latest available)
- **유인(Real Rates):** value=2.390 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-17 (latest available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCI value=-0.549 (low-frequency) / DXYΔ -0.239 / US10YΔ +0.055**
...
- **Liquidity as of:** 2026-08-12 (FRED latest)
- **NET_LIQ level:** 5796004.3
- **TGA level:** 963950.0
- **RRP level:** 0.725
...
- **Spread as of:** 2026-08-13 (FRED latest)
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.710 / prev 79.790 / pct -0.10%
- **LQD:** today 106.120 / prev 106.550 / pct -0.40%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +1.19%)** → 완화 기대 약화/금리 부담
- DXY **(Clear, -0.24%)** → 달러 약세/리스크 선호
- WTI **(Strong, +1.38%)** → 인플레 재자극 가능성
- VIX **(Strong, -2.60%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Noise, +0.03%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, -0.10%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Clear, -0.40%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.20% / 5D=+0.39% | Strength: LOW
- **WTI:** 🟢 UP | Short-term: SHORT UP | 1D=+0.47% / 5D=+0.80% | Strength: LOW
- **DXY:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-0.16% / 5D=-0.30% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: MIXED | 1D=+1.63% / 5D=+2.07% | Strength: LOW
...
- **Cosine Similarity Score:** 0.493
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: 0.493
  - Ukraine_2022: 0.414
  - China_Trade_2018: 0.412
- **Top Drivers:**
  - EMB: z_used=+0.65 (z1d=-0.93, z5d=-0.22, raw_w=0.12, norm_w=0.09) → contrib=+0.06
  - WTI: z_used=+0.60 (z1d=+0.46, z5d=+0.82, raw_w=0.10, norm_w=0.08) → contrib=+0.05
  - DE10Y_SPREAD: z_used=-0.88 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.04
  - BDRY: z_used=+1.04 (z1d=+1.31, z5d=+0.63, raw_w=0.05, norm_w=0.04) → contrib=+0.04
...
- **Country ETF Crash?** Yes (FXI)
- **Extreme Country Risk:** FXI
...
- **Dealer Gamma Bias:** 1.22 (NEUTRAL / transition zone)
...
**핵심 신호:** 장단기차(51.00bp) | 실질금리(2.39%) | DXY(99.67)
*(as of: RealRate: 2026-08-17 / FRED last available)*
...
- **Today snapshot:** US10Y(4.696), DXY(99.670), VIX(14.25)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↓) / GOLD(↑) / VIX(↓) / WTI(↑)
- **Meaningful Move Check:** DXY=-0.23921610792044853 / GOLD=0.15547385530615654 / US10Y=1.185096048631844 / VIX=-2.5974033593193826 / WTI=1.3779561557613005
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.696000099182129, RealYield=2.39, T10Y2Y=0.51, WTI=82.4000015258789, DXY=99.66999816894533, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.71, DriftLabel=NEUTRAL, FredAsof=2026-08-14
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=4.21 → healthy contango / stable structure
...
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=0.09%p → neutral Nasdaq breadth
- **Positioning / Gamma:** -2
...
- SMH-QQQ spread=-0.08%p → semiconductor participation neutral
- SOXX-QQQ spread=0.08%p → chip breadth neutral
- IWM-SPY spread=0.72%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=0.03%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCI value=-0.549 (low-frequency) / DXYΔ -0.239 / US10YΔ +0.055 (정상)
- **Sentiment (Fear&Greed):** 75.24887394396234 (GREED)
- **Credit Calm:** True
...
- **Drift Score:** 2
- **Flow Score:** 1
- **Flow Continuity:** NO_FLOW_BASE → 🌱 LIGHT TRACE (N/A, tilt=+0)
- **Flow Regime Tilt:** +1 / Flow-Gamma Tilt: +0

- **🎯 Final Risk Action:** **REDUCE (POS_OVERHEATED)**
- **Risk Budget (0~100):** **64**
- **Narrative:** 구조=MIXED / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=2.14 ⚠️ 수급 과열 감지 → Phase=RISK-ON / REFLATION
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `RISK-ON` | **Bucket:** `RISK-ON` | **VIX:** `14.25`
- **Positioning Data:** Z-Score: `2.14` (>2.2 시 Run) | Gamma: `1.22` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Base Risk Budget (13):** 64
- **VIX Level:** 14.25 (NORMAL) | **Change:** -2.60%
...
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.14), Position Unwind
- **Brake Drivers:** ⚠️ Extreme Positioning Heat

- **📊 Recommended Exposure:** **57%**
...
**Context:** phase=RISK-ON / REFLATION / T10Y2Y=0.51 (MODERATE STEEP) / VIX=14.25 (VOLATILITY CALM) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** DISINFLATION_RISK_ON
**Macro Inputs Debug:** phase=RISK-ON / REFLATION / us10y_pct=+1.19% / dxy_pct=-0.24% / wti_pct=+1.38% / vix=14.25 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=1

**Flow Overlay:** flow_score=1 / flow_state=🌱 LIGHT TRACE / drift_label=NEUTRAL / gamma=🟡 POSITIVE-TRANSITION

**Overweight:** Financials, Technology, Consumer Staples, Health Care, Industrials, Communication Services, Energy

**Underweight:** Consumer Discretionary, Real Estate, Utilities

**Scoreboard:**
- Financials: +1.4  (+2 CURVE, +1 MOM, = +1.4)
- Technology: +1.2  (+2 VOL, -2 LIQ, +1.5 PHASE, +1 MOM, = +1.2)
- Consumer Staples: +1.2  (+2 LIQ, = +1.2)
- Health Care: +1.2  (+2 LIQ, = +1.2)
- Industrials: +0.9  (+1 CURVE, +1 MOM, = +0.9)
- Communication Services: +0.3  (+0.5 PHASE, = +0.3)
- Energy: +0.3  (+1 MOM, = +0.3)
- Utilities: -0.3  (-1 VOL, +1 LIQ, -0.5 PHASE, = -0.3)
- Real Estate: -1.0  (-1.5 LIQ, = -1.0)
...
- OW Technology: +2: VOLATILITY CALM → 성장주 베팅 유효 (absolute mode: VIX 14.2)
...
- UW Consumer Discretionary: +1: VOLATILITY CALM → 경기민감 소비 회복 (absolute mode: VIX 14.2)
- UW Consumer Discretionary: +1: Disinflation Risk-On → 소비 베타 우호

**Regime Controller:**
- BALANCED (avg_divergence=-0.54, dispersion=1.10)
...
- **Strategic Exposure (15):** **57.0%** → **Regime Adjusted:** **57.0%**
- **Exposure Override:** BALANCED → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Financials | +1.4 | NEGATIVE_DIVERGENCE | **9.3%** | HOLD |
| Technology | +1.2 | ALIGNED | **10.0%** | HOLD |
| Consumer Staples | +1.2 | NEGATIVE_DIVERGENCE | **8.1%** | HOLD |
| Health Care | +1.2 | NEGATIVE_DIVERGENCE | **8.1%** | HOLD |
| Industrials | +0.9 | ALIGNED | **10.0%** | HOLD |
| Communication Services | +0.3 | ALIGNED | **2.3%** | HOLD |
| Energy | +0.3 | POSITIVE_DIVERGENCE | **5.0%** | HOLD |
| **Cash & Hedge** | - | - | **47.2%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** DISINFLATION_RISK_ON
- **Participation / Quality Cap Applied:**
  - Technology: 13.7% → 10.0% (-3.7%)
  - Industrials: 10.1% → 10.0% (-0.1%)
- **Strategic Cash (15):** 43.0%
- **Tactical Reserve (Cap / Unallocated):** 4.2%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=3.48, score=1.2, weight=8.1%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.48, score=1.2, weight=8.1%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.57, score=1.38, weight=9.3%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Communication Services (priority_score=-0.17, score=0.33, weight=2.3%, div=ALIGNED, mom=0)
5. Industrials (priority_score=-1.08, score=0.9, weight=10.0%, div=ALIGNED, mom=1)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Energy (priority_score=2.81, score=0.31, weight=5.0%, div=POSITIVE_DIVERGENCE, mom=1)
2. Technology (priority_score=2.72, score=1.22, weight=10.0%, div=ALIGNED, mom=1)
3. Industrials (priority_score=2.40, score=0.9, weight=10.0%, div=ALIGNED, mom=1)
4. Communication Services (priority_score=0.33, score=0.33, weight=2.3%, div=ALIGNED, mom=0)
5. Financials (priority_score=-0.12, score=1.38, weight=9.3%, div=NEGATIVE_DIVERGENCE, mom=1)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Financials | XLF | 9.3% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Technology | XLK | 10.0% | ADD | ALIGNED | ALIGNED |
| Consumer Staples | XLP | 8.1% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 8.1% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Industrials | XLI | 10.0% | ADD | ALIGNED | ALIGNED |
| Communication Services | XLC | 2.3% | MICRO | ALIGNED | ALIGNED |
| Energy | XLE | 5.0% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0386277348626762
- **Z-Score (5d):** -0.32142039079880125

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.09429655420267408
- **Z-Score (5d):** 0.33866467938055866

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.11266078571346477
- **Z-Score (5d):** 0.3853659164328284

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.049600642304929
- **Z-Score (5d):** -0.4573240668345662

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.2885553177014363
- **Z-Score (5d):** 0.28307449078936103

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.10236028541073591
- **Z-Score (5d):** -0.9888977129906514

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.4185995199354429
- **Z-Score (5d):** 0.3273022154671052

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.34509474646780713
- **Z-Score (5d):** -0.006321110309884786

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.26849220322257294
- **Z-Score (5d):** -0.40724237553214493
