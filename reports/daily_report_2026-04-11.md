...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=INCREASE 반영 → Warning Score 1 → 경미한 이상신호, 모니터링 강화

### 🚩 Market Regime Status
- **국면 전환 감지:** 🚨 **EVENT-WATCHING (이벤트 관망)** → **RISK-ON (부분 정렬)**

---

- **미국 10년물 금리**: 4.317  (+0.14% vs 4.311)
- **달러 인덱스**: 98.698  (-0.01% vs 98.708)
- **WTI 유가**: 95.630  (-3.23% vs 98.820)
- **변동성 지수 (VIX)**: 19.230  (-2.73% vs 19.770)
- **원/달러 환율**: 1485.410  (+0.09% vs 1484.040)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.010 / US10YΔ +0.006**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.960 / prev 80.055 / pct -0.12%
- **LQD:** today 109.200 / prev 109.265 / pct -0.06%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Clear, +0.14%)** → 완화 기대 약화/금리 부담
- DXY **(Noise, -0.01%)** → 달러 약세/리스크 선호
- WTI **(Strong, -3.23%)** → 물가 부담 완화
- VIX **(Strong, -2.73%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Mild, +0.09%)** → 원화 약세/수급 부담
...
- DEBUG: pct XLK=0.03156105201366254, XLF=0.08121368742400786, XLE=0.1671165519673767, XLRE=0.13704271072301671
...
- **Cosine Similarity Score:** -0.530
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Israel_2023: -0.530
  - Red_Sea: -0.535
  - Taiwan_Tension: -0.560
- **Top Drivers:**
  - VIX: z_used=-1.00 (z1d=-0.37, z5d=-1.95, raw_w=0.18, norm_w=0.14) → contrib=-0.14
  - USDCNH: z_used=-0.86 (z1d=-0.25, z5d=-1.77, raw_w=0.18, norm_w=0.14) → contrib=-0.12
  - WTI: z_used=-1.36 (z1d=-0.89, z5d=-2.07, raw_w=0.10, norm_w=0.08) → contrib=-0.10
  - EMB: z_used=-0.86 (z1d=+0.22, z5d=+1.83, raw_w=0.12, norm_w=0.09) → contrib=-0.08
...
**핵심 신호:** 장단기차(51.00bp) | 실질금리(1.96%) | DXY(98.70)
...
- **강도:** US10Y(Clear) / DXY(Noise) / WTI(Strong) / VIX(Strong)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.010 / US10YΔ +0.006 (정상)
- **Sentiment (Fear&Greed):** 55.11504759763108 (NEUTRAL)
- **Credit Calm:** True
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `RISK-ON` | **VIX:** `19.23`
...
- **VIX Level:** 19.23 (NORMAL) | **Change:** -2.73%
...
**Context:** phase=RISK-ON (부분 정렬) / T10Y2Y=0.51 (MODERATE STEEP) / VIX=19.23 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
