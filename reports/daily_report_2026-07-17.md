...
🧭 1. Executive Summary
Markets are operating in a SOFT RISK-OFF regime as liquidity conditions remain up and volatility pressures have increased. Participation remains ⚡ BUILDING, while positioning risk sits at 1.8. Maintain disciplined exposure and avoid adding marginal risk.
...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 33%**
- **Final Exposure (실행 기준): 33%**

- **Portfolio Stance:** REDUCE / 33%
...
- **Current Reason:** ⚠️ CROWDING RISK: POS_Z Extreme (2.01) → Risk Compression (55%)
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **33%**
- **Base Context:** phase=SOFT RISK-OFF / narrative=REDUCE / base_exposure=33%
- **SEW:** RISK_COMPRESSION / NORMAL
- **Divergence:** ALIGNED / **STAY (포지션 유지)**
- **Drift:** ⚡ STRUCTURAL DRIFT / NEUTRAL / NONE / score=5
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 1 → 경미한 이상신호, 모니터링 강화 → Tactical=REDUCE / Flow=⚡ BUILDING(5) / Drift=⚡ STRUCTURAL DRIFT(5) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화
...
- **미국 10년물 금리**: 4.569  (+0.53% vs 4.545)
- **달러 인덱스**: 100.784  (+0.28% vs 100.499)
- **WTI 유가**: 79.050  (-0.45% vs 79.410)
- **변동성 지수 (VIX)**: 16.730 (+6.76% vs 15.670)
- **원/달러 환율**: 1486.200  (-0.11% vs 1487.880)
...
- **VIX 레벨:** 16.73 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.538 / level=EASY (완화) / update=low-frequency | as of: 2026-07-17 (latest available)
- **유인(Real Rates):** value=2.320 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-07-17 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.538 (low-frequency) / DXYΔ +0.285 / US10YΔ +0.024**
...
- **Spread as of:** 2026-07-15 (FRED latest)
- **HY_OAS level:** 2.71% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -0.37%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.800 / prev 79.810 / pct -0.01%
- **LQD:** today 107.500 / prev 107.580 / pct -0.07%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +0.53%)** → 완화 기대 약화/금리 부담
- DXY **(Clear, +0.28%)** → 달러 강세/신흥국 부담
- WTI **(Mild, -0.45%)** → 물가 부담 완화
- VIX **(Strong, +6.76%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Mild, -0.11%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Noise, -0.01%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Noise, -0.07%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🔴 DOWN | Short-term: SHORT UP | 1D=-0.54% / 5D=-0.13% | Strength: LOW
- **WTI:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.67% / 5D=+9.70% | Strength: HIGH
- **DXY:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.28% / 5D=-0.15% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: MIXED | 1D=-1.08% / 5D=-3.15% | Strength: MEDIUM
...
- **Cosine Similarity Score:** 0.186
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - China_Trade_2018: 0.186
  - Ukraine_2022: 0.164
  - Taiwan_Tension: 0.118
- **Top Drivers:**
  - USDCNH: z_used=-0.75 (z1d=-0.12, z5d=-1.70, raw_w=0.18, norm_w=0.14) → contrib=-0.10
  - VIX: z_used=+0.70 (z1d=+0.86, z5d=+0.47, raw_w=0.18, norm_w=0.14) → contrib=+0.10
  - EEM: z_used=+1.06 (z1d=-1.02, z5d=-1.12, raw_w=0.10, norm_w=0.08) → contrib=+0.08
  - DE10Y_SPREAD: z_used=-1.18 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.05
...
- **Country ETF Crash?** Yes (EEM)
- **Extreme Country Risk:** EEM
...
- **Dealer Gamma Bias:** 0.40 (RUN RISK / dealer gamma proxy weak)
...
**핵심 신호:** 장단기차(41.00bp) | 실질금리(2.32%) | DXY(100.78)
*(as of: RealRate: 2026-07-17 / FRED last available)*
...
- **Today snapshot:** US10Y(4.569), DXY(100.784), VIX(16.73)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↓)
- **Meaningful Move Check:** DXY=0.2835809621559148 / GOLD=-0.9876213451423267 / US10Y=0.5280459979461906 / VIX=6.764514746531394 / WTI=-0.45334415533258243
...
- **Input Check:** US10Y=4.568999767303467, RealYield=2.32, T10Y2Y=0.41, WTI=79.05000305175781, DXY=100.78399658203124, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.71, DriftLabel=NEUTRAL, FredAsof=2026-07-16
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=2.77 → healthy contango / stable structure
- Short-Term Hedge: VIX9D/VIX=0.84 → calm front-end hedge
...
- **Breadth Note:** RSP-SPY return spread=1.52%p → broad participation
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=1.38%p → broad Nasdaq participation
- **Positioning / Gamma:** 1
...
**Leadership Notes**
- QQQ-SPY spread=-1.10%p → growth leadership weak
- SMH-QQQ spread=-2.05%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-2.82%p → chip breadth lagging
- IWM-SPY spread=0.48%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=0.88%p → sector diffusion positive
- XLI-SPY spread=0.59%p → sector diffusion positive
- XLY-SPY spread=0.83%p → sector diffusion positive
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.538 (low-frequency) / DXYΔ +0.285 / US10YΔ +0.024 (정상)
- **Sentiment (Fear&Greed):** 67.96928060275884 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.76 ⚠️ 수급 다소 과열 → Phase=SOFT RISK-OFF
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `SOFT RISK-OFF` | **Bucket:** `RISK-OFF` | **VIX:** `16.73`
- **Positioning Data:** Z-Score: `1.76` (>1.8 시 Run) | Gamma: `0.40` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 16.73 (NORMAL) | **Change:** +6.76%
- **Positioning Layer:** ⚠️ Elevated Positioning Heat(1.76), Negative Gamma(0.40)
- **Brake Drivers:** ⚠️ VIX Spike, Elevated Positioning Heat, Negative Gamma
...
**Context:** phase=SOFT RISK-OFF / T10Y2Y=0.41 (MODERATE STEEP) / VIX=16.73 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** SOFT_RISK_OFF_DISINFLATION
**Macro Inputs Debug:** phase=SOFT RISK-OFF / us10y_pct=+0.53% / dxy_pct=+0.28% / wti_pct=-0.45% / vix=16.73 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=5
...
- OW Industrials: +1: 완만한 스티프닝(0.41) → 성장 기대 반영
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.86, dispersion=0.99)
...
- Technology: FLOW_WEAK (theory=+2.5, flow=+0.5, final=+1.5)
...
- **Strategic Exposure (15):** **33.0%** → **Regime Adjusted:** **33.0%**
- **Exposure Override:** BALANCED → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Financials | +1.7 | NEGATIVE_DIVERGENCE | **8.9%** | DELEVERAGE |
| Technology | +1.5 | NEGATIVE_DIVERGENCE | **7.9%** | DELEVERAGE |
| Industrials | +1.1 | NEGATIVE_DIVERGENCE | **6.0%** | DELEVERAGE |
| Health Care | +0.7 | ALIGNED | **6.1%** | DELEVERAGE |
| Consumer Staples | +0.5 | ALIGNED | **4.1%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **67.0%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** SOFT_RISK_OFF_DISINFLATION
- **Regime Cap Applied:** None
- **Strategic Cash (15):** 67.0%
- **Tactical Reserve (Cap / Unallocated):** 0.0%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Technology (priority_score=3.44, score=1.52, weight=7.9%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Industrials (priority_score=3.43, score=1.14, weight=6.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.49, score=1.71, weight=8.9%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Consumer Staples (priority_score=-0.23, score=0.47, weight=4.1%, div=ALIGNED, mom=0)
5. Health Care (priority_score=-0.35, score=0.7, weight=6.1%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Health Care (priority_score=0.70, score=0.7, weight=6.1%, div=ALIGNED, mom=0)
2. Consumer Staples (priority_score=0.47, score=0.47, weight=4.1%, div=ALIGNED, mom=0)
3. Financials (priority_score=0.21, score=1.71, weight=8.9%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Technology (priority_score=-1.48, score=1.52, weight=7.9%, div=NEGATIVE_DIVERGENCE, mom=0)
5. Industrials (priority_score=-1.86, score=1.14, weight=6.0%, div=NEGATIVE_DIVERGENCE, mom=0)
- **Divergence Adjustment:** Financials, Technology, Industrials penalized in weight sizing

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action | Divergence | Classification |
| :--- | :---: | :---: | :--- | :--- | :--- |
| Financials | XLF | 8.9% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Technology | XLK | 7.9% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Industrials | XLI | 6.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 6.1% | DEFENSIVE_QUALITY | ALIGNED | ALIGNED |
| Consumer Staples | XLP | 4.1% | DEFENSIVE_BUFFER | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.013731650502650515
- **Z-Score (5d):** 0.05376334295899847

### EEM
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -1.0198313475817222
- **Z-Score (5d):** -1.1146569187481206

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.1245621892622912
- **Z-Score (5d):** 0.3188952979180228

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.4082423650834437
- **Z-Score (5d):** -0.566616075531007

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.2684186971893052
- **Z-Score (5d):** -0.8547169482763948

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6604670656811044
- **Z-Score (5d):** 1.34979961489878

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0964600158610929
- **Z-Score (5d):** -0.7361363645868388

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7915918049193577
- **Z-Score (5d):** -0.46556640071065275

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.2537189760198995
- **Z-Score (5d):** 0.42204002838854626
