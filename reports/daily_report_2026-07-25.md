...
🧭 1. Executive Summary
Markets are operating in a TRANSITION / MIXED regime as liquidity conditions remain down and volatility pressures have increased. Participation remains 🔥 BUILDING HARD, while positioning risk sits at 1.4. Maintain disciplined exposure and avoid adding marginal risk.
Rally Confidence: 🔴 LOW
Participation is improving, but liquidity remains tight and positioning risk is elevated. Treat the rally as low-confidence until flow persistence and leadership quality improve.
...
Interpretation:
Nasdaq participation improved while broader market breadth lagged.
Leadership remains concentrated in growth-oriented segments.
...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 52%**
- **Final Exposure (실행 기준): 52%**

- **Portfolio Stance:** HOLD / 52%
...
- **Final Action:** **HOLD**
- **Final Exposure:** **52%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=HOLD / base_exposure=52%
- **SEW:** STABLE / NORMAL
- **Divergence:** ALIGNED / **STAY (포지션 유지)**
- **Drift:** ⚡ STRUCTURAL DRIFT / NEUTRAL / 🟢 EARLY FLOW WITHOUT SHOCK / score=5
- **Flow:** 🔥 BUILDING HARD / score=7
- **Gamma:** 🟡 TRANSITION
- **Tactical Action:** HOLD / NONE / LOW
- **Positioning:** pos_z=1.45
- **Warning Score:** 2 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=HOLD 반영 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=HOLD / Flow=🔥 BUILDING HARD(7) / Drift=⚡ STRUCTURAL DRIFT(5) / Gamma=🟡 TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음

### 🚩 Market Regime Status
- **국면 전환 감지:** 🚨 **SOFT RISK-OFF (경계 강화)** → **TRANSITION / MIXED**
...
- **미국 10년물 금리**: 4.679  (-0.51% vs 4.703)
- **달러 인덱스**: 101.430  (+0.00% vs 101.430)
- **WTI 유가**: 89.310  (-3.12% vs 92.190)
- **변동성 지수 (VIX)**: 18.580 (-0.64% vs 18.700)
- **원/달러 환율**: 1474.040  (-0.11% vs 1475.630)
...
- **VIX 레벨:** 18.58 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.552 / level=EASY (완화) / update=low-frequency | as of: 2026-07-25 (latest available)
- **유인(Real Rates):** value=2.430 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-07-25 (latest available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCI value=-0.552 (low-frequency) / DXYΔ +0.000 / US10YΔ -0.024**
...
- **Liquidity as of:** 2026-07-22 (FRED latest)
- **NET_LIQ level:** 5917754.6
- **TGA level:** 829623.0
- **RRP level:** 0.376
...
- **Spread as of:** 2026-07-23 (FRED latest)
- **HY_OAS level:** 2.77% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↑) / +3.36%
- **판정:** **CREDIT CALM**
...
- **SPY:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.09% / 5D=-0.60% | Strength: LOW
- **WTI:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-1.87% / 5D=+9.67% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.03% / 5D=+0.71% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.22% / 5D=+1.07% | Strength: LOW
...
- **Cosine Similarity Score:** 0.092
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.092
  - Ukraine_2022: 0.079
  - Iran_Crisis_2020: 0.038
- **Top Drivers:**
  - JP10Y_SPREAD: z_used=-2.41 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.11
  - DE10Y_SPREAD: z_used=-2.40 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.11
  - KR10Y_SPREAD: z_used=-1.52 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.09
  - IL10Y_SPREAD: z_used=-2.01 (mode=level, raw_w=0.05, norm_w=0.04) → contrib=-0.08
...
- **Country ETF Crash?** Yes (VXX)
- **Extreme Country Risk:** VXX
...
- **Drift Score:** 5 (⚡ STRUCTURAL DRIFT)
- **VIX:** 18.57999992370605
- **SEW:** STABLE / NORMAL
...
- **Raw Flow State:** **🔥 BUILDING HARD**
- **Transition State:** **TRACE_BUILDING**
- **Flow Delta:** +2 (prev=5 → current=7)
- **Persistence Days:** 2
- **Transition Note:** 기관성 흐름이 전일 대비 강화
- **Confidence:** **HIGH**
- **Action Bias:** **EARLY PREP**
...
**핵심 신호:** 장단기차(36.00bp) | 실질금리(2.43%) | DXY(101.43)
*(as of: RealRate: 2026-07-25 / FRED last available)*
...
- **강도:** US10Y(Strong) / DXY(Noise) / WTI(Strong) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.679), DXY(101.430), VIX(18.58)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↓) / DXY(→) / GOLD(↑) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=0.0 / GOLD=0.5189541712353288 / US10Y=-0.5103161279241635 / VIX=-0.6417156916443839 / WTI=-3.1239882921610165
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.678999900817871, RealYield=2.43, T10Y2Y=0.36, WTI=89.30999755859375, DXY=101.43000030517578, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.77, DriftLabel=NEUTRAL, FredAsof=2026-07-24
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=1.93 → mild contango
- Short-Term Hedge: VIX9D/VIX=0.95 → calm front-end hedge
...
- **Breadth Note:** RSP-SPY return spread=-0.10%p → neutral breadth
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=0.46%p → broad Nasdaq participation
- **Positioning / Gamma:** 0
...
**Leadership Notes**
- QQQ-SPY spread=-1.22%p → growth leadership weak
- SMH-QQQ spread=-2.15%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-3.28%p → chip breadth lagging
- IWM-SPY spread=-0.42%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=0.76%p → sector diffusion positive
- XLI-SPY spread=0.29%p → sector diffusion neutral
- XLY-SPY spread=-0.10%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCI value=-0.552 (low-frequency) / DXYΔ +0.000 / US10YΔ -0.024 (정상)
- **Sentiment (Fear&Greed):** 64.10914747862874 (NEUTRAL)
- **Credit Calm:** True
...
- **Drift Score:** 5
- **Flow Score:** 7
- **Flow Continuity:** EARLY_TRACE → 🔥 BUILDING HARD (FLOW_PERSISTENCE, tilt=+1)
- **Flow Regime Tilt:** +4 / Flow-Gamma Tilt: +2

- **🎯 Final Risk Action:** **HOLD**
- **Risk Budget (0~100):** **58**
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.45 → Phase=TRANSITION / MIXED
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `TRANSITION / MIXED` | **Bucket:** `MIXED` | **VIX:** `18.58`
- **Positioning Data:** Z-Score: `1.45` (>1.8 시 Run) | Gamma: `0.91` (<0.5 시 Run) | CTA: `0.0` (추세 변곡점 확인)
...
- **Base Risk Budget (13):** 58
- **VIX Level:** 18.58 (NORMAL) | **Change:** -0.64%
...
**Context:** phase=TRANSITION / MIXED / T10Y2Y=0.36 (MODERATE STEEP) / VIX=18.58 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** GROWTH_SCARE
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=-0.51% / dxy_pct=+0.00% / wti_pct=-3.12% / vix=18.58 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=7

**Flow Overlay:** flow_score=7 / flow_state=🔥 BUILDING HARD / drift_label=NEUTRAL / gamma=🟡 TRANSITION
**Flow Notes:** NEUTRAL + FLOW ACTIVE → XLK/XLI 소폭 가점 | Gamma TRANSITION → 초기 리더 소폭 가점

**Overweight:** Consumer Staples, Health Care, Utilities, Financials, Energy, Industrials

**Underweight:** Consumer Discretionary, Technology, Real Estate, Communication Services
...
- Energy: +0.7  (+2 MOM, = +0.7)
- Industrials: +0.3  (+1 CURVE, -0.5 PHASE, +0.5 FLOW, = +0.3)
- Communication Services: -0.3  (= -0.3)
- Real Estate: -0.6  (-1.5 LIQ, = -0.6)
- Technology: -1.2  (-2 LIQ, +1 FLOW, = -1.2)
- Consumer Discretionary: -1.5  (-1 LIQ, -0.5 PHASE, -2 MOM, = -1.5)
...
- OW Financials: +2: 완만한 스티프닝(0.36) → 예대마진 개선
...
**Regime Controller:**
- DISLOCATION (avg_divergence=-0.40, dispersion=1.79)
- Correlation Break: True / Type=GROWTH_FAILED_ON_RATE_RELIEF
- Break Reasons: US10Y ↓ but Technology ↓ | US10Y ↓ but XLK ↓
...
- Energy: TACTICAL_MOMENTUM_ONLY (theory=+0.0, flow=+1.4, final=+0.7)
- Materials: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Communication Services: NEUTRAL (theory=+0.0, flow=+0.0, final=-0.3)
- Consumer Discretionary: AVOID (theory=-1.5, flow=-1.4, final=-1.5)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **52.0%** → **Regime Adjusted:** **52.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.8 | NEGATIVE_DIVERGENCE | **8.0%** | SMALL ADJUST |
| Health Care | +1.8 | NEGATIVE_DIVERGENCE | **8.0%** | SMALL ADJUST |
| Utilities | +0.9 | ALIGNED | **11.5%** | NEW |
| Financials | +0.9 | ALIGNED | **1.0%** | HOLD |
| Energy | +0.7 | POSITIVE_DIVERGENCE | **1.9%** | HOLD |
| Industrials | +0.3 | ALIGNED | **0.0%** | NEW |
| **Cash & Hedge** | - | - | **69.6%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** GROWTH_SCARE
- **Participation / Quality Cap Applied:**
  - Financials: 11.3% → 0.0% (-11.3%)
  - Energy: 9.9% → 0.0% (-9.9%)
  - Industrials: 3.3% → 0.0% (-3.3%)
- **Strategic Cash (15):** 48.0%
- **Tactical Reserve (Cap / Unallocated):** 21.6%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=3.56, score=1.76, weight=8.0%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.56, score=1.76, weight=8.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Utilities (priority_score=0.51, score=0.91, weight=11.5%, div=ALIGNED, mom=0)
4. Industrials (priority_score=-0.13, score=0.26, weight=0.0%, div=ALIGNED, mom=0)
5. Financials (priority_score=-1.45, score=0.89, weight=1.0%, div=ALIGNED, mom=1)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Energy (priority_score=4.68, score=0.68, weight=1.9%, div=POSITIVE_DIVERGENCE, mom=2)
2. Financials (priority_score=2.39, score=0.89, weight=1.0%, div=ALIGNED, mom=1)
3. Utilities (priority_score=0.91, score=0.91, weight=11.5%, div=ALIGNED, mom=0)
4. Industrials (priority_score=0.26, score=0.26, weight=0.0%, div=ALIGNED, mom=0)
5. Consumer Staples (priority_score=-1.24, score=1.76, weight=8.0%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 8.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 8.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Utilities | XLU | 11.5% | ADD | ALIGNED | ALIGNED |
| Financials | XLF | 1.0% | MICRO | ALIGNED | ALIGNED |
| Energy | XLE | 1.9% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3896009554910432
- **Z-Score (5d):** -1.3290601450143145

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.9453924218239081
- **Z-Score (5d):** -0.052371629056182076

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1908949690582531
- **Z-Score (5d):** 0.02455990601149078

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.5980441856834564
- **Z-Score (5d):** -1.465108562877376

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8963269872110224
- **Z-Score (5d):** -0.5305485005858481

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1207818237521965
- **Z-Score (5d):** 0.06822186229002812

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1976832687978652
- **Z-Score (5d):** 0.7281063364959623

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.03781109799362421
- **Z-Score (5d):** -0.5958379515814131

### VXX
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 1.7235293270403684
- **Z-Score (5d):** 1.5618954025404346
