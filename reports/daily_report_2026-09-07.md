...
Recommended Exposure  31.0%
Exposure Ceiling      31.0%
Allocated Equity      30.0%
Tactical Reserve      1.0%
Cash                  70.0%
Exposure Control      NORMAL
Macro Allocation      EVENT_TRANSITION

2. EXECUTIVE VIEW
The current strategic phase is EVENT-WATCHING / INFLATION. Liquidity is ↓ Tightening, while flow is 👀 EARLY TRACE. Positioning Z is 1.68 and credit is Calm. The canonical portfolio decision is STRONG REDUCE with an 31% exposure ceiling.
...
Equities             ⚪ No canonical PM state
US10Y Yield          🔴 4.78% · ↑ Rising (+0.46%)
USD                  🟢 99.16 · ↑ Stronger (+0.16%)
Oil                  $91.48 · ↑ Rising (+0.20%)
Volatility           🟢 14.53 · ↑ Rising (+1.47%)
HY OAS               🟢 2.65% · COOL (-0.38%)
...
Rank  Sector                     1D Return   vs SPY     Momentum
   1  Technology                   +0.70%      +1.09%          0
   2  Industrials                  +0.41%      +0.79%         -1
   3  Utilities                    +0.12%      +0.50%          0
   4  Materials                    -0.34%      +0.04%          0
   5  Real Estate                  -0.72%      -0.34%         -1
   6  Financials                   -0.79%      -0.40%          1
   7  Consumer Staples             -0.80%      -0.41%          0
   8  Energy                       -0.87%      -0.48%          2
   9  Health Care                  -1.04%      -0.66%          0
  10  Communication Services       -1.19%      -0.81%          0
  11  Consumer Discretionary       -1.33%      -0.95%         -1

Breadth & Leadership
RSP vs SPY         Today -0.09% | Prev -0.38% | Δ +0.29%
QQQE vs QQQ        Today -0.33% | Prev -0.31% | Δ -0.02%
SMH vs SPY         Today +2.99% | Prev -0.66% | Δ +3.65%
IWM vs SPY         Today +0.66% | Prev -0.65% | Δ +1.31%


6. ALLOCATION CONTEXT
Growth vs Value       VALUE TILT
Duration Tilt         SHORT DURATION FAVORED
Cyclical Defensive    DEFENSIVE FAVORED
...
Consumer Staples | XLP | 11.8% | WATCHLIST_SMALL | FLOW_WEAK | NEGATIVE_DIVERGENCE
Health Care | XLV | 11.8% | WATCHLIST_SMALL | FLOW_WEAK | NEGATIVE_DIVERGENCE
Financials | XLF | 3.0% | WATCHLIST_SMALL | FLOW_WEAK | NEGATIVE_DIVERGENCE
