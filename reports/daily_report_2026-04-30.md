...
### 📌 Interpretation
- 금일 시장은 **RISK-OFF (긴축/불안·리스크 회피) 환경**입니다.
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **22%**
- **Base Context:** phase=RISK-OFF (긴축/불안·리스크 회피) / narrative=REDUCE / base_exposure=32%
- **SEW:** STABLE / NORMAL
...
- **Warning Score:** 5 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
...
- **미국 10년물 금리**: 4.418  (+1.47% vs 4.354)
- **달러 인덱스**: 98.920  (+0.30% vs 98.620)
- **WTI 유가**: 106.880  (+6.95% vs 99.930)
- **변동성 지수 (VIX)**: 18.810  (+5.50% vs 17.830)
- **원/달러 환율**: 1471.990  (-0.07% vs 1473.000)
...
- **VIX 레벨:** 18.81 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-30 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-30 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.300 / US10YΔ +0.064**
...
- **Spread as of:** 2026-04-28 (FRED latest)
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 80.130 / prev 80.400 / pct -0.34%
- **LQD:** today 108.730 / prev 109.340 / pct -0.56%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +1.47%)** → 완화 기대 약화/금리 부담
- DXY **(Clear, +0.30%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +6.95%)** → 인플레 재자극 가능성
- VIX **(Strong, +5.50%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Mild, -0.07%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Mild, -0.34%)** → 크레딧 스트레스↑
...
- **Top Similarity Matches:**
  ...
  - Taiwan_Tension: 0.287
- **Top Drivers:**
  - USDCNH: z_used=+0.94 (z1d=+0.94, z5d=+0.94, raw_w=0.18, norm_w=0.14) → contrib=+0.13
  - WTI: z_used=+1.11 (z1d=+1.15, z5d=+1.04, raw_w=0.10, norm_w=0.08) → contrib=+0.09
  - EMB: z_used=+0.91 (z1d=-0.94, z5d=-0.86, raw_w=0.12, norm_w=0.09) → contrib=+0.08
  - KR10Y_SPREAD: z_used=-1.03 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.06
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(1.92%) | DXY(98.92)
*(as of: RealRate: 2026-04-30 / FRED last available)*
...
- **Today snapshot:** US10Y(4.418), DXY(98.920), VIX(18.81)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↑)
- **Meaningful Move Check:** DXY=0.3041932812901675 / GOLD=-1.0083808055646304 / US10Y=1.4699156718869784 / VIX=5.49635191491706 / WTI=6.9548653327505345
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.300 / US10YΔ +0.064 (정상)
- **Sentiment (Fear&Greed):** 61.6170885737836 (NEUTRAL)
- **Credit Calm:** True
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `RISK-OFF` | **VIX:** `18.81`
- **Positioning Data:** Z-Score: `1.50` (>1.8 시 Run) | Gamma: `0.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 18.81 (NORMAL) | **Change:** +5.50%
- **Final Multiplier:** 0.72x (Vol x Pos)
- **Positioning Brake:** 적용됨 | ⚠️ Low Gamma(0.00)
...
**Context:** phase=RISK-OFF (긴축/불안·리스크 회피) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=18.81 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True
...
**Overweight:** Consumer Staples, Health Care, Industrials, Utilities

**Underweight:** Real Estate, Consumer Discretionary, Energy

**Scoreboard:**
- Consumer Staples: +3  (+2 LIQ, +1 PHASE, = +3)
- Health Care: +3  (+2 LIQ, +1 PHASE, = +3)
...
- **Strategic Exposure (15):** **32.0%**

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +3 | ALIGNED | **10.3%** | DELEVERAGE |
| Health Care | +3 | ALIGNED | **12.2%** | DELEVERAGE |
| Utilities | +1 | ALIGNED | **4.1%** | DELEVERAGE |
| Industrials | +0.7 | ALIGNED | **2.9%** | DELEVERAGE |
| Technology | +0.5 | POSITIVE_DIVERGENCE | **2.6%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **67.9%** | DEFENSIVE |
...
1. Health Care (priority_score=1.99, score=3, weight=12.2%, div=ALIGNED, mom=0)
2. Consumer Staples (priority_score=1.04, score=3, weight=10.3%, div=ALIGNED, mom=0)
3. Industrials (priority_score=-0.21, score=0.7, weight=2.9%, div=ALIGNED, mom=0)
4. Utilities (priority_score=-0.3, score=1, weight=4.1%, div=ALIGNED, mom=0)
5. Technology (priority_score=-2.15, score=0.5, weight=2.6%, div=POSITIVE_DIVERGENCE, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=4.50, score=0.5, weight=2.6%, div=POSITIVE_DIVERGENCE, mom=2)
2. Consumer Staples (priority_score=3.00, score=3, weight=10.3%, div=ALIGNED, mom=0)
3. Health Care (priority_score=3.00, score=3, weight=12.2%, div=ALIGNED, mom=0)
4. Utilities (priority_score=1.00, score=1, weight=4.1%, div=ALIGNED, mom=0)
5. Industrials (priority_score=0.70, score=0.7, weight=2.9%, div=ALIGNED, mom=0)

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action |
| :--- | :---: | :---: | :--- |
| Consumer Staples | XLP | 10.3% | ADD |
| Health Care | XLV | 12.2% | ADD |
| Utilities | XLU | 4.1% | SMALL |
| Industrials | XLI | 2.9% | SMALL |
| Technology | XLK | 2.6% | SMALL |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.32615325601344103
- **Z-Score (5d):** -0.44295608283077054

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.554336161862287
- **Z-Score (5d):** 0.21228092362712092
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.5297037582541289
- **Z-Score (5d):** -0.373209121353619

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3006139845582751
- **Z-Score (5d):** -0.37139150555429423

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.4929442703492384
- **Z-Score (5d):** -0.7418032674561413

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.06555463682666057
- **Z-Score (5d):** -0.09665453425318733

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.4750262066836211
- **Z-Score (5d):** -0.3639014798838836
