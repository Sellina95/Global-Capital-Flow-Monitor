...
- **미국 10년물 금리**: 4.282  (+0.61% vs 4.256)
- **달러 인덱스**: 98.060  (-0.06% vs 98.120)
- **WTI 유가**: 91.290  (+0.01% vs 91.280)
- **변동성 지수 (VIX)**: 18.170  (-1.03% vs 18.360)
- **원/달러 환율**: 1469.420  (-0.50% vs 1476.840)
...
- **VIX 레벨:** 18.17 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.060 / US10YΔ +0.026**
...
- **Geo Stress Score (z-composite):** **-0.21**  *(Level: NORMAL)*
...
- **Cosine Similarity Score:** -0.325
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: -0.325
  - China_Trade_2018: -0.502
  - Iran_Crisis_2020: -0.528
- **Top Drivers:**
  - USDCNH: z_used=-0.83 (z1d=-0.70, z5d=-1.04, raw_w=0.18, norm_w=0.14) → contrib=-0.12
  - VIX: z_used=-0.54 (z1d=-0.18, z5d=-1.08, raw_w=0.18, norm_w=0.14) → contrib=-0.07
  - WTI: z_used=-0.42 (z1d=-0.17, z5d=-0.78, raw_w=0.10, norm_w=0.08) → contrib=-0.03
  - SEA: z_used=+0.65 (z1d=-0.37, z5d=-1.09, raw_w=0.05, norm_w=0.04) → contrib=+0.03
...
**핵심 신호:** 장단기차(53.00bp) | 실질금리(1.89%) | DXY(98.06)
...
- **강도:** US10Y(Strong) / DXY(Mild) / WTI(Noise) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.282), DXY(98.060), VIX(18.17)
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=1.27 → Phase=RISK-ON (부분 정렬)
...
- **Positioning Data:** Z-Score: `1.27` (>2.2 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 18.17 (NORMAL) | **Change:** -1.03%
...
**Context:** phase=RISK-ON (부분 정렬) / T10Y2Y=0.53 (MODERATE STEEP) / VIX=18.17 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
| :--- | :---: | :---: | :---: | :--- |
| Industrials | +4 | ALIGNED | **27.3%** | STRONG BUY |
| Technology | +4 | ALIGNED | **27.3%** | STRONG BUY |
| Consumer Discretionary | +2 | ALIGNED | **13.6%** | ACCUMULATE |
| Financials | +1 | NEGATIVE_DIVERGENCE | **4.8%** | ACCUMULATE |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.295098232709692
- **Z-Score (5d):** 0.15630600047298948
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6745994223195011
- **Z-Score (5d):** 0.36928633955632634
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.02280776279541969
- **Z-Score (5d):** 0.2010518349464309

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9417281160432328
- **Z-Score (5d):** 1.2958399668924363

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.007785842852944835
- **Z-Score (5d):** 0.04004521710392658

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.0030650169824847705
- **Z-Score (5d):** 1.4749131029523292

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.11560417293487754
- **Z-Score (5d):** -0.516463212569338
