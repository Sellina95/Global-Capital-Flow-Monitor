...
- **Final Action:** **REDUCE**
- **Final Exposure:** **48%**
- **Base Context:** phase=TRANSITION / MIXED (전환·혼조) / narrative=HOLD / base_exposure=65%
- **SEW:** STABLE / NORMAL
- **Divergence:** ALIGNED / **STAY (포지션 유지)**
- **Warning Score:** 5 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=HOLD 반영 → Warning Score 3+ → 공격적 확장 금지 / 익스포저 25% haircut
...
- **달러 인덱스**: 98.220  (+0.16% vs 98.060)
- **WTI 유가**: 94.690  (+3.72% vs 91.290)
- **변동성 지수 (VIX)**: 17.940  (-1.27% vs 18.170)
- **원/달러 환율**: 1474.060  (+0.32% vs 1469.420)

---

## 🧭 So What? (Decision Layer)
- **Strategic View:** **HOLD** *(base exposure: 65%)*
- **Execution View:** **REDUCE** *(final exposure: 48%)*
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-17 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-17 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.160 / US10YΔ +0.027**
...
- WTI **(Strong, +3.72%)** → 인플레 재자극 가능성
- VIX **(Clear, -1.27%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Clear, +0.32%)** → 원화 약세/수급 부담
...
- **Cosine Similarity Score:** -0.175
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.175
  - China_Trade_2018: -0.201
  - Red_Sea: -0.298
- **Top Drivers:**
  ...
  - IL10Y_SPREAD: z_used=-0.70 (mode=level, raw_w=0.05, norm_w=0.04) → contrib=-0.03
  - USDCNH: z_used=+0.18 (z1d=+0.27, z5d=+0.05, raw_w=0.18, norm_w=0.14) → contrib=+0.03
...
**핵심 신호:** 장단기차(54.00bp) | 실질금리(1.90%) | DXY(98.22)
*(as of: RealRate: 2026-04-17 / FRED last available)*
...
- **Today snapshot:** US10Y(4.309), DXY(98.220), VIX(17.94)
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=1.39 → Phase=TRANSITION / MIXED (전환·혼조)
...
- **Positioning Data:** Z-Score: `1.39` (>1.8 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
| :--- | :---: | :---: | :--- |
| Industrials | XLI | 22.4% | PRIMARY |
| Technology | XLK | 22.4% | PRIMARY |
| Consumer Discretionary | XLY | 14.9% | ADD |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6323314355331754
- **Z-Score (5d):** -0.016571253052858923
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7178528303883731
- **Z-Score (5d):** 0.3613704297241411
