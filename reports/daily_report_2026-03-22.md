...
- **달러 인덱스**: 99.503  (+0.00% vs 99.503)
- **WTI 유가**: 98.230  (+0.14% vs 98.090)
- **변동성 지수 (VIX)**: 26.780  (+0.00% vs 26.780)
- **원/달러 환율**: 1504.830  (+0.00% vs 1504.830)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.000 / US10YΔ +0.000**
...
- **Top Similarity Matches:**
  - Ukraine_2022: 0.338
  - Taiwan_Tension: 0.334
  - Israel_2023: 0.282
- **Top Drivers:**
  - USDCNH: z_used=-0.60 (z1d=+0.12, z5d=-1.68, raw_w=0.18, norm_w=0.14) → contrib=-0.08
  - EMB: z_used=+0.86 (z1d=+0.18, z5d=-2.42, raw_w=0.12, norm_w=0.09) → contrib=+0.08
  - KR10Y_SPREAD: z_used=-1.00 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.06
  - EEM: z_used=+0.76 (z1d=-0.03, z5d=-1.84, raw_w=0.10, norm_w=0.08) → contrib=+0.06
...
- **Sentiment (Fear&Greed):** 31.480083632888054 (NEUTRAL)
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 → Phase=WAITING / RANGE (대기·박스권)
...
- **Context:** phase=WAITING / RANGE (대기·박스권) / liquidity=DOWN-MID / structure=TIGHTENING / credit_calm=True
