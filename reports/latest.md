...
🧭 1. Executive Summary
Markets are operating in a SOFT RISK-OFF regime as liquidity conditions are tightening and volatility pressures have eased. Participation remains ⚡ BUILDING, while positioning risk sits at 1.7. Maintain disciplined exposure and avoid adding marginal risk.
...
Final Portfolio Decision: REDUCE / 45%
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **45%**
- **Base Context:** phase=SOFT RISK-OFF / narrative=REDUCE / base_exposure=45%
- **SEW:** STABLE / NORMAL
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=REDUCE 반영 → Tactical=REDUCE / Flow=⚡ BUILDING(5) / Drift=👀 EARLY DRIFT(3) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화
...
- **현실(FCI):** value=-0.566 / level=EASY (완화) / update=low-frequency | as of: 2026-08-31 (latest available)
- **유인(Real Rates):** value=2.340 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-31 (latest available)
...
- **WTI:** 🟢 UP | Short-term: SHORT DOWN | 1D=+2.59% / 5D=+0.65% | Strength: LOW
- **DXY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.08% / 5D=+0.63% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.17% / 5D=-3.34% | Strength: LOW
...
- **Cosine Similarity Score:** 0.088
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: 0.088
  - China_Trade_2018: 0.015
  - Taiwan_Tension: -0.104
- **Top Drivers:**
  - GOLD: z_used=-1.42 (z1d=-1.78, z5d=-0.90, raw_w=0.12, norm_w=0.09) → contrib=-0.13
  ...
  - SEA: z_used=+1.14 (z1d=-1.03, z5d=-1.32, raw_w=0.05, norm_w=0.04) → contrib=+0.04
...
*(as of: RealRate: 2026-08-31 / FRED last available)*
...
- **Meaningful Move Check:** DXY=0.5445676343184392 / GOLD=-2.8548515539052013 / US10Y=1.0273942543162848 / VIX=-0.5513433662586605 / WTI=-0.1556294209478534
...
- **Narrative:** 구조=TIGHTENING / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=1.72 ⚠️ 수급 다소 과열 → Phase=SOFT RISK-OFF
...
- **Positioning Data:** Z-Score: `1.72` (>1.8 시 Run) | Gamma: `0.71` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Elevated Positioning Heat(1.72)
...
| :--- | :---: | :---: | :---: | :--- |
| Health Care | +2.1 | NEGATIVE_DIVERGENCE | **11.9%** | HOLD |
| Consumer Staples | +1.8 | NEGATIVE_DIVERGENCE | **10.9%** | SMALL ADJUST |
| Financials | +1.4 | NEGATIVE_DIVERGENCE | **0.0%** | NEW |
| Energy | +0.3 | POSITIVE_DIVERGENCE | **0.0%** | NEW |
| Technology | +0.2 | ALIGNED | **0.0%** | NEW |
| Industrials | +0.2 | ALIGNED | **0.0%** | NEW |
| **Cash & Hedge** | - | - | **77.2%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** SOFT_RISK_OFF_DISINFLATION
- **Participation / Quality Cap Applied:**
  - Financials: 8.3% → 0.0% (-8.3%)
  - Energy: 6.0% → 0.0% (-6.0%)
  - Technology: 4.0% → 0.0% (-4.0%)
  - Industrials: 3.2% → 0.0% (-3.2%)
- **Strategic Cash (15):** 55.0%
- **Tactical Reserve (Cap / Unallocated):** 22.2%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=4.17, score=1.8, weight=10.9%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.21, score=2.1, weight=11.9%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| Consumer Staples | XLP | 10.9% | DEFENSIVE_BUFFER | NEGATIVE_DIVERGENCE | FLOW_WEAK |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7313812809272703
- **Z-Score (5d):** 0.33514372799045034
