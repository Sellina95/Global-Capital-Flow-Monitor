...
🧭 1. Executive Summary
Markets are operating in a TRANSITION / MIXED regime as liquidity conditions remain down and volatility pressures have increased. Participation remains 👀 EARLY TRACE, while positioning risk sits at 2.0. Maintain disciplined exposure and avoid adding marginal risk.
Rally Confidence: 🟢 HIGH
Participation and leadership support trend continuation. Risk exposure may be maintained, subject to volatility and positioning controls.
...
Current market is best described as 'UNKNOWN_TRANSITION'.
...
🟢 Preferred:
- Quality leaders
- Confirmed relative-strength sectors

🔴 Avoid:
- Weak breadth / theory-only sector bets

🎯 8. Tactical Recommendation
Recommendation: REDUCE / NONE
Confidence: LOW
Rationale:
...
Interpretation:
Leadership narrowed back toward mega-cap and semiconductor exposure.
Participation remains weak outside leadership groups.

🏁 10. Final PM View
Action: REDUCE
Exposure: 38%
Bias: TRANSITION / MIXED
...
- **[14번 구조·수급 괴리]:** 🚨 **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.05). 반전 가능성 상존.
### 🟢 Current SEW Status
- **SEW:** RISK_COMPRESSION | ⚠️ Risk Compression 발동 (권장 익스포저 55%)
- **Event Type:** NORMAL → 정상 상태 / 구조적 리스크 없음
- **Spike Monitor:** Spike 1 / Extreme 0
- **Current Reason:** ⚠️ CROWDING RISK: POS_Z Extreme (2.26) → Risk Compression (55%)
...
- **Structural Layer:**
  ...
  - Flow Authenticity → **SHORT_COVERING** (Price strength may be driven more by positioning than durable accumulation.)
  - Leadership Breadth → **BROAD_LEADERSHIP** (Leadership is broadening across sectors, confirming healthier market participation.)
  - Positioning Stress → **POSITIONING_STRESS_EVENT** (Positioning stress is elevated and market fragility has increased.)

## 🎯 Final Decision (War Room Override)
- **Final Action:** **REDUCE**
- **Final Exposure:** **38%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=REDUCE / base_exposure=38%
- **SEW:** RISK_COMPRESSION / NORMAL
- **Divergence:** N/A / **MONITOR REVERSAL (RUN 액션 준비)**
- **Drift:** 🔥 EXTREME DRIFT / NEUTRAL / NONE / score=8
- **Flow:** 👀 EARLY TRACE / score=4
- **Gamma:** 🟡 POSITIVE-TRANSITION
- **Tactical Action:** HOLD / NONE / LOW
- **Positioning:** pos_z=2.05
- **Warning Score:** 3 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 3+ → 공격적 확장 금지 / 총노출 추가 감산 없이 방어적 배분 → Tactical=HOLD / Flow=👀 EARLY TRACE(4) / Drift=🔥 EXTREME DRIFT(8) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음

### 🚩 Market Regime Status
- **국면 전환 감지:** 🚨 **RISK-OFF (부분 정렬)** → **TRANSITION / MIXED**
...
- **미국 10년물 금리**: 4.487  (+0.00% vs 4.487)
- **달러 인덱스**: 100.850  (+0.76% vs 100.090)
- **WTI 유가**: 76.600  (-0.25% vs 76.790)
- **변동성 지수 (VIX)**: 16.400 (-11.06% vs 18.440)
- **원/달러 환율**: 1525.420  (+0.96% vs 1510.960)
...
- **VIX 레벨:** 16.40 → **Mid (Neutral/Mixed)**
- **핵심 조합(전일 대비 방향):** US10Y(→) / DXY(↑) / VIX(↓)
- **판정:** **TRANSITION / MIXED | Flow:  (Flow Weak)**
- **근거:** Macro Narrative=UNKNOWN_TRANSITION / Policy=MIXED / Credit=COOL
...
- **현실(FCI):** value=-0.505 / level=EASY (완화) / update=low-frequency | as of: 2026-06-19 (latest available)
- **유인(Real Rates):** value=2.230 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-06-19 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.000 / FCI value=-0.505 (low-frequency) / DXYΔ +0.760 / US10YΔ +0.000**
...
- **Liquidity as of:** 2026-06-17 (FRED latest)
- **NET_LIQ level:** 5855704.2
- **TGA level:** 880713.0
- **RRP level:** 6.828
...
- **Spread as of:** 2026-06-17 (FRED latest)
- **HY_OAS level:** 2.63% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -2.95%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 80.010 / prev 79.730 / pct 0.35%
- **LQD:** today 109.070 / prev 108.770 / pct 0.28%
- **판정:** **CREDIT NEUTRAL**
...
- DXY **(Strong, +0.76%)** → 달러 강세/신흥국 부담
- WTI **(Mild, -0.25%)** → 물가 부담 완화
- VIX **(Strong, -11.06%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Strong, +0.96%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, +0.35%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Mild, +0.28%)** → 우량채 강세(리스크오프 성향)
...
- **SPY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.76% / 5D=+1.20% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-1.75% / 5D=-11.33% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.10% / 5D=+1.20% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-1.34% / 5D=-1.13% | Strength: LOW
...
So What?
- 결론: **공식이 깨진 구간** → 총노출 추가 감산보다 **추격 자제 + 퀄리티/리더 중심 배분**
...
- **Geo Stress Score (z-composite):** **-0.45**  *(Level: NORMAL)*
- **Coverage:** 100% *(used weight: 1.30 / defined weight: 1.30)*
- **3D Avg Score:** -0.12
- **Geo Momentum:** -0.33 *(Status: FALLING)*

**Historical Pattern Match (Cosine Similarity):**
- **Closest Historical Match:** Taiwan_Tension
- **Cosine Similarity Score:** -0.062
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.062
  - China_Trade_2018: -0.119
  - Ukraine_2022: -0.169
- **Top Drivers:**
  - VIX: z_used=-1.15 (z1d=-1.28, z5d=-0.96, raw_w=0.18, norm_w=0.14) → contrib=-0.16
  - EMB: z_used=-1.04 (z1d=+0.90, z5d=+1.25, raw_w=0.12, norm_w=0.09) → contrib=-0.10
  - EEM: z_used=-1.17 (z1d=+1.42, z5d=+0.81, raw_w=0.10, norm_w=0.08) → contrib=-0.09
  - BDRY: z_used=-1.52 (z1d=-1.26, z5d=-1.90, raw_w=0.05, norm_w=0.04) → contrib=-0.06
...
- **Country ETF Crash?** Yes (EIS, FXI)
- **Extreme Country Risk:** EIS, FXI
...
- **Dealer Gamma Bias:** 1.78 (STABILIZING / dealer gamma proxy supportive)
- **Bias:** VIX는 안정적이나 Drift가 형성 중
- **Strategy:** 초기 방향성 관찰 / 과도한 추격 금지

- **Drift Score:** 8 (🔥 EXTREME DRIFT)
...
- **Flow Delta:** +4 (prev=0 → current=4)
- **Persistence Days:** 1
- **Transition Note:** 기관성 흐름 초기 흔적 발생
- **Confidence:** **MEDIUM**
- **Action Bias:** **MONITOR**

- **Drift:** 🔥 EXTREME DRIFT / NEUTRAL / NONE
...
**핵심 신호:** 장단기차(27.00bp) | 실질금리(2.23%) | DXY(100.85)
*(as of: RealRate: 2026-06-19 / FRED last available)*
...
- **질문:** 무엇이 이 움직임을 만들었는가?
- **핵심 신호:** 달러↑ + 유가↓ + VIX↓
- **최종 판정:** **인플레이션 압력 둔화 및 비용 감소형 안도 랠리**

### 🔄 10) Direction Filter
- **질문:** 오늘 움직임은 ‘노이즈’인가 ‘의미 있는 변화’인가?
- **강도:** US10Y(Noise) / DXY(Strong) / WTI(Mild) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.487), DXY(100.850), VIX(16.40)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(→) / DXY(↑) / GOLD(↓) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=0.7593187771381286 / GOLD=-3.0925189315547046 / US10Y=0.0 / VIX=-11.062911369007717 / WTI=-0.24743122690578132
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.486999988555908, RealYield=2.23, T10Y2Y=0.27, WTI=76.5999984741211, DXY=100.8499984741211, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.63, DriftLabel=NEUTRAL, FredAsof=2026-06-18
...
- **Strategic Interpretation:** Positioning stress is elevated and market fragility has increased.

**Positioning Notes**
- Term Structure: VIX3M-VIX=4.11 → healthy contango / stable structure
- Short-Term Hedge: VIX9D/VIX=1.05 → front-end panic hedge
...
- **Strategic Interpretation:** Price strength may be driven more by positioning than durable accumulation.
- **Breadth / Participation:** -3
- **Breadth Note:** RSP-SPY return spread=-0.32%p → narrow cap-weight leadership
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.65%p → mega-cap concentrated Nasdaq rally
- **Positioning / Gamma:** -2
...
**Leadership Notes**
- QQQ-SPY spread=1.73%p → growth leadership
- SMH-QQQ spread=3.25%p → semiconductor participation strong
- SOXX-QQQ spread=4.12%p → SOX proxy confirms chip breadth
- IWM-SPY spread=1.19%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=-1.67%p → sector diffusion weak
- XLI-SPY spread=-0.05%p → sector diffusion neutral
- XLY-SPY spread=0.67%p → sector diffusion positive
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.000 / FCI value=-0.505 (low-frequency) / DXYΔ +0.760 / US10YΔ +0.000 (정상)
- **Sentiment (Fear&Greed):** 60.54242194894099 (NEUTRAL)
- **Credit Calm:** True
- **Liquidity (NET_LIQ):** DOWN (MID)
- **Structural Regime:** UNKNOWN_TRANSITION
- **Operational Phase:** TRANSITION / MIXED (Cap: 65)
- **Macro Tilt:** +0
- **Drift:** 🔥 EXTREME DRIFT / NEUTRAL / NONE
- **Drift Score:** 8
- **Flow Score:** 4
- **Flow Continuity:** FLOW_BREAK → 👀 EARLY TRACE (N/A, tilt=+0)
- **Flow Regime Tilt:** +2 / Flow-Gamma Tilt: +2

- **🎯 Final Risk Action:** **REDUCE**
- **Risk Budget (0~100):** **39**
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=🔥 EXTREME DRIFT (NEUTRAL) / 수급=2.05 ⚠️ 수급 과열 감지 → Phase=TRANSITION / MIXED
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `TRANSITION / MIXED` | **Bucket:** `MIXED` | **VIX:** `16.40`
- **Positioning Data:** Z-Score: `2.05` (>1.8 시 Run) | Gamma: `1.78` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
- **Status:** **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.05). 반전 가능성 상존.
...
- **Base Risk Budget (13):** 39
- **VIX Level:** 16.40 (NORMAL) | **Change:** -11.06%
- **⚠️ STATUS:** RISK COMPRESSION
- **Reason:** POS_Z Extreme (2.05)
- **Action:** 신규 추격 금지 / 일부 이익실현 / 베타 노출 축소
- **Final Multiplier:** 0.97x (VIX x Positioning x Credit/Convexity)
- **Slope Intensity:** -0.1050
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.05), Position Unwind, Positive Gamma(1.78)
...
**Context:** phase=TRANSITION / MIXED / T10Y2Y=0.27 (MODERATE STEEP) / VIX=16.40 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** BALANCED
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=+0.00% / dxy_pct=+0.76% / wti_pct=-0.25% / vix=16.40 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=4
...
**Overweight:** Technology, Consumer Staples, Health Care, Utilities, Industrials, Communication Services, Financials

**Underweight:** Real Estate, Consumer Discretionary, Energy

**Scoreboard:**
- Technology: +1.4  (-2 LIQ, +1.5 FLOW, +2 MOM, = +1.4)
- Consumer Staples: +1.0  (+2 LIQ, +0.5 PHASE, = +1.0)
- Health Care: +1.0  (+2 LIQ, +0.5 PHASE, = +1.0)
- Utilities: +0.4  (+1 LIQ, = +0.4)
- Industrials: +0.3  (+1 CURVE, +1 FLOW, +1 MOM, = +0.3)
- Communication Services: +0.3  (= +0.3)
- Financials: +0.2  (+2 CURVE, = +0.2)
- Energy: -0.6  (-2 MOM, = -0.6)
- Consumer Discretionary: -1.5  (-1 LIQ, -1 MOM, = -1.5)
- Real Estate: -1.7  (-1.5 LIQ, -1 MOM, = -1.7)
...
**Regime Controller:**
- DISLOCATION (avg_divergence=-0.40, dispersion=1.74)
- Correlation Break: True / Type=MACRO_TIGHTENING_TECH_RALLY
- Break Reasons: DXY ↑ but SPY ↑ | DXY ↑ but Technology ↑ | DXY ↑ but XLK ↑
...
- Technology: POSITIVE_DIVERGENCE (theory=-2.0, flow=+1.9, final=+1.4)
- Consumer Staples: FLOW_WEAK (theory=+2.5, flow=+0.0, final=+1.0)
- Health Care: FLOW_WEAK (theory=+2.5, flow=+0.0, final=+1.0)
- Communication Services: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.3)
- Financials: FLOW_WEAK (theory=+2.0, flow=+0.0, final=+0.2)
- Materials: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Consumer Discretionary: AVOID (theory=-1.0, flow=-0.7, final=-1.5)
- Real Estate: AVOID (theory=-1.5, flow=-0.7, final=-1.7)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **38.0%** → **Regime Adjusted:** **38.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +1.4 | POSITIVE_DIVERGENCE | **15.0%** | REBALANCE |
| Consumer Staples | +1.0 | NEGATIVE_DIVERGENCE | **5.4%** | SMALL ADJUST |
| Health Care | +1.0 | NEGATIVE_DIVERGENCE | **5.4%** | SMALL ADJUST |
| Utilities | +0.4 | ALIGNED | **3.8%** | NEW |
| Industrials | +0.3 | ALIGNED | **3.7%** | HOLD |
| Communication Services | +0.3 | ALIGNED | **2.8%** | NEW |
| Financials | +0.2 | NEGATIVE_DIVERGENCE | **1.3%** | SMALL ADJUST |
| **Cash & Hedge** | - | - | **62.6%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** BALANCED
- **Participation / Quality Cap Applied:**
  - Technology: 16.4% → 15.0% (-1.4%)
- **Strategic Cash (15):** 62.0%
- **Tactical Reserve (Cap / Unallocated):** 0.6%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Financials (priority_score=3.88, score=0.23, weight=1.3%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Staples (priority_score=3.52, score=0.97, weight=5.4%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Health Care (priority_score=3.52, score=0.97, weight=5.4%, div=NEGATIVE_DIVERGENCE, mom=0)
4. Communication Services (priority_score=-0.15, score=0.3, weight=2.8%, div=ALIGNED, mom=0)
5. Utilities (priority_score=-0.2, score=0.41, weight=3.8%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=5.39, score=1.39, weight=15.0%, div=POSITIVE_DIVERGENCE, mom=2)
2. Industrials (priority_score=1.81, score=0.31, weight=3.7%, div=ALIGNED, mom=1)
3. Utilities (priority_score=0.41, score=0.41, weight=3.8%, div=ALIGNED, mom=0)
4. Communication Services (priority_score=0.30, score=0.3, weight=2.8%, div=ALIGNED, mom=0)
5. Consumer Staples (priority_score=-2.03, score=0.97, weight=5.4%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 15.0% | TACTICAL_LEADER | POSITIVE_DIVERGENCE | POSITIVE_DIVERGENCE |
| Consumer Staples | XLP | 5.4% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 5.4% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Utilities | XLU | 3.8% | SMALL | ALIGNED | ALIGNED |
| Industrials | XLI | 3.7% | SMALL | ALIGNED | ALIGNED |
| Communication Services | XLC | 2.8% | NO_ACTION | ALIGNED | NEUTRAL |
| Financials | XLF | 1.3% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9751066735896321
- **Z-Score (5d):** -0.10247997690193715

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.404785680104362
- **Z-Score (5d):** 0.9300265353154578

### EIS
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 1.037761460833633
- **Z-Score (5d):** -0.929845879792897

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.850970529667351
- **Z-Score (5d):** 0.13645651551816643

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.1326189626042835
- **Z-Score (5d):** 1.508631244793492

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -0.7341739245618922
- **Z-Score (5d):** -1.6126679502857002

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.189728064678925
- **Z-Score (5d):** 0.21763939935543

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.841345814047055
- **Z-Score (5d):** 0.17054579831421443

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7567176266530208
- **Z-Score (5d):** -1.1140831078060278
