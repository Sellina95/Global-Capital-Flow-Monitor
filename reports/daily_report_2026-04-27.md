...
- **Final Action:** **HOLD**
- **Final Exposure:** **46%**
- **Base Context:** phase=RISK-ON (완화 기대·리스크 선호) / narrative=HOLD / base_exposure=46%
- **SEW:** STABLE / NORMAL
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-26 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-26 (FRED last available)
...
- **WTI:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-1.51% / 5D=+12.58% | Strength: HIGH
- **DXY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.29% / 5D=+0.42% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.76% / 5D=-2.40% | Strength: LOW
...
- **Cosine Similarity Score:** 0.270
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.270
  - China_Trade_2018: 0.228
  - Ukraine_2022: 0.166
- **Top Drivers:**
  - USDCNH: z_used=+0.69 (z1d=+0.61, z5d=+0.83, raw_w=0.18, norm_w=0.14) → contrib=+0.10
...
*(as of: RealRate: 2026-04-26 / FRED last available)*
...
- **Meaningful Move Check:** DXY=-0.29352318478714434 / GOLD=0.7608723288444584 / US10Y=-0.30071736252022396 / VIX=-3.107200404267048 / WTI=-1.5127772262131831
- **판정:** **NEUTRAL**
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=WEAK DRIFT (노이즈 가능) (DISINFLATION_RISK_ON) / 수급=1.64 ⚠️ 수급 다소 과열 → Phase=RISK-ON (완화 기대·리스크 선호)
...
| :--- | :---: | :---: | :---: | :--- |
| Technology | +4 | ALIGNED | **15.7%** | ACCUMULATE |
| Industrials | +2.2 | ALIGNED | **8.6%** | HOLD |
| Consumer Staples | +2 | ALIGNED | **7.9%** | HOLD |
| Health Care | +2 | ALIGNED | **7.9%** | HOLD |
| Utilities | +1 | ALIGNED | **3.9%** | HOLD |
| Communication Services | +0.5 | ALIGNED | **2.0%** | HOLD |
| **Cash & Hedge** | - | - | **54.0%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**

**Deleveraging Priority Preview:**
- 기준: Divergence → Score → Risk Sector → Current Weight
1. Technology (risk_score=1.5, score=4.0, weight=15.7%, div=ALIGNED)
2. Communication Services (risk_score=1.0, score=0.5, weight=2.0%, div=ALIGNED)
3. Utilities (risk_score=0.5, score=1.0, weight=3.9%, div=ALIGNED)
4. Industrials (risk_score=0.0, score=2.2, weight=8.6%, div=ALIGNED)
5. Consumer Staples (risk_score=-0.5, score=2.0, weight=7.9%, div=ALIGNED)

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action |
| :--- | :---: | :---: | :--- |
| Technology | XLK | 15.7% | ADD |
| Industrials | XLI | 8.6% | SMALL |
| Consumer Staples | XLP | 7.9% | SMALL |
| Health Care | XLV | 7.9% | SMALL |
| Utilities | XLU | 3.9% | SMALL |
| Communication Services | XLC | 2.0% | SMALL |
