...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 79%**
- **Final Exposure (실행 기준): 79%**

- **Portfolio Stance:** INCREASE / 79%
...
- **Final Exposure:** **79%**
- **Base Context:** phase=EARLY RISK-ON / narrative=INCREASE / base_exposure=79%
- **SEW:** STABLE / NORMAL
...
- **국면 전환 감지:** 🚨 **SOFT RISK-OFF (경계 강화)** → **EARLY RISK-ON**
...
- **미국 10년물 금리**: 4.947  (-1.18% vs 5.006)
- **달러 인덱스**: 100.220  (-0.09% vs 100.310)
- **WTI 유가**: 101.910  (-0.51% vs 102.430)
- **변동성 지수 (VIX)**: 15.440 (-12.82% vs 17.710)
- **원/달러 환율**: 1376.600  (+0.96% vs 1363.570)
...
- **VIX 레벨:** 15.44 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.560 / level=EASY (완화) / update=low-frequency | as of: 2026-09-18 (latest available)
- **유인(Real Rates):** value=2.680 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-18 (latest available)
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCI value=-0.560 (low-frequency) / DXYΔ -0.090 / US10YΔ -0.059**
...
- **Spread as of:** 2026-09-16 (FRED latest)
- **HY_OAS level:** 2.70% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -2.17%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 78.720 / prev 78.420 / pct 0.38%
- **LQD:** today 105.160 / prev 104.450 / pct 0.68%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, -1.18%)** → 완화 기대 강화
- DXY **(Mild, -0.09%)** → 달러 약세/리스크 선호
- WTI **(Mild, -0.51%)** → 물가 부담 완화
- VIX **(Strong, -12.82%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Strong, +0.96%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, +0.38%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Clear, +0.68%)** → 우량채 강세(리스크오프 성향)
...
- **SPY:** 🟢 UP | Short-term: SHORT UP | 1D=+1.14% / 5D=+0.64% | Strength: LOW
- **WTI:** 🟡 PULLBACK | Short-term: MIXED | 1D=-0.84% / 5D=+1.00% | Strength: LOW
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.06% / 5D=+1.17% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.18% / 5D=-0.03% | Strength: LOW
...
- **Geo Stress Score (z-composite):** **-1.00**  *(Level: N/A)*
- **Coverage:** 100% *(used weight: 1.30 / defined weight: 1.30)*
- **3D Avg Score:** -0.54
- **Geo Momentum:** -0.46 *(Status: FALLING)*
...
- **Top Similarity Matches:**
  - Red_Sea: -0.344
  - Taiwan_Tension: -0.424
  - Iran_Crisis_2020: -0.457
- **Top Drivers:**
  - VIX: z_used=-1.73 (z1d=-1.98, z5d=-1.36, raw_w=0.18, norm_w=0.14) → contrib=-0.24
  - EMB: z_used=-1.71 (z1d=+2.15, z5d=+1.04, raw_w=0.12, norm_w=0.09) → contrib=-0.16
  - KR10Y_SPREAD: z_used=-2.47 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.15
  - DE10Y_SPREAD: z_used=-2.64 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.12
...
**핵심 신호:** 장단기차(27.00bp) | 실질금리(2.68%) | DXY(100.22)
*(as of: RealRate: 2026-09-18 / FRED last available)*
...
- **Today snapshot:** US10Y(4.947), DXY(100.220), VIX(15.44)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↓) / DXY(↓) / GOLD(↑) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=-0.08971821361880697 / GOLD=0.27806712962962965 / US10Y=-1.178585992094181 / VIX=-12.817615027883264 / WTI=-0.507660491571951
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.947000026702881, RealYield=2.68, T10Y2Y=0.27, WTI=101.91000366210938, DXY=100.22000122070312, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.7, DriftLabel=NEUTRAL, FredAsof=2026-09-17
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=3.11 → healthy contango / stable structure
...
- **Breadth Note:** RSP-SPY return spread=-0.65%p → narrow cap-weight leadership
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.93%p → mega-cap concentrated Nasdaq rally
- **Positioning / Gamma:** 1
...
**Leadership Notes**
- QQQ-SPY spread=0.60%p → growth leadership
- SMH-QQQ spread=1.03%p → semiconductor participation strong
- SOXX-QQQ spread=1.66%p → SOX proxy confirms chip breadth
- IWM-SPY spread=-0.60%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=-1.22%p → sector diffusion weak
- XLI-SPY spread=-0.96%p → sector diffusion weak
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCI value=-0.560 (low-frequency) / DXYΔ -0.090 / US10YΔ -0.059 (정상)
- **Sentiment (Fear&Greed):** 64.56665508434591 (NEUTRAL)
- **Credit Calm:** True
...
- **Drift Score:** 7
- **Flow Score:** 6
- **Flow Continuity:** FLOW_FADE → ⚡ BUILDING (N/A, tilt=+0)
- **Flow Regime Tilt:** +3 / Flow-Gamma Tilt: +2

- **🎯 Final Risk Action:** **INCREASE**
- **Risk Budget (0~100):** **79**
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.60 ⚠️ 수급 다소 과열 → Phase=EARLY RISK-ON
...
- **Structure(3번):** `EASING` | **Price(Regime):** `RISK-ON` | **Bucket:** `RISK-ON` | **VIX:** `15.44`
- **Positioning Data:** Z-Score: `1.60` (>2.2 시 Run) | Gamma: `0.70` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Base Risk Budget (13):** 79
- **VIX Level:** 15.44 (NORMAL) | **Change:** -12.82%
- **Positioning Layer:** ⚠️ Positioning Heat(1.60)
- **Brake Drivers:** ⚠️ Positioning Heat

- **📊 Recommended Exposure:** **79%**
...
**Context:** phase=EARLY RISK-ON / T10Y2Y=0.27 (MODERATE STEEP) / VIX=15.44 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** DISINFLATION_RISK_ON
**Macro Inputs Debug:** phase=EARLY RISK-ON / us10y_pct=-1.18% / dxy_pct=-0.09% / wti_pct=-0.51% / vix=15.44 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=6
...
**Overweight:** Technology, Energy, Communication Services

**Underweight:** Consumer Discretionary, Industrials, Financials, Utilities, Real Estate

**Scoreboard:**
- Technology: +2.4  (+2 LIQ, +1.5 PHASE, +1.5 FLOW, +1 MOM, = +2.4)
- Energy: +0.8  (+2 MOM, = +0.8)
- Communication Services: +0.2  (+0.5 PHASE, = +0.2)
- Real Estate: -0.6  (-2 MOM, = -0.6)
- Utilities: -0.7  (-1 LIQ, -0.5 PHASE, = -0.7)
- Financials: -1.1  (+1 LIQ, +2 CURVE, -1 MOM, = -1.1)
- Industrials: -1.6  (+1.5 LIQ, +1 CURVE, +1 FLOW, -2 MOM, = -1.6)
- Consumer Discretionary: -1.7  (+1.5 LIQ, +1 PHASE, -2 MOM, = -1.7)
...
- UW Industrials: +1: 완만한 스티프닝(0.27) → 성장 기대 반영
- UW Financials: THEORY_TRAP → 거시/이론 우호 대비 실제 자금흐름 및 상대강도 약세
- UW Financials: +1: 유동성 완화 → 위험선호 회복
- UW Financials: +2: 완만한 스티프닝(0.27) → 예대마진 개선

**Regime Controller:**
- DISLOCATION (avg_divergence=-1.14, dispersion=1.89)
...
- Technology: HIGH_CONVICTION_ALIGNED (theory=+3.5, flow=+1.1, final=+2.4)
- Energy: TACTICAL_MOMENTUM_ONLY (theory=+0.0, flow=+1.4, final=+0.8)
...
- Financials: THEORY_TRAP (theory=+3.0, flow=-0.7, final=-1.1)
- Industrials: THEORY_TRAP (theory=+2.5, flow=-1.1, final=-1.6)
- Consumer Discretionary: THEORY_TRAP (theory=+2.5, flow=-1.4, final=-1.7)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **79.0%** → **Regime Adjusted:** **79.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.4 | ALIGNED | **20.0%** | NEW |
| Energy | +0.8 | POSITIVE_DIVERGENCE | **15.0%** | REBALANCE |
| Communication Services | +0.2 | ALIGNED | **4.8%** | NEW |
| **Cash & Hedge** | - | - | **60.2%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** DISINFLATION_RISK_ON
- **Participation / Quality Cap Applied:**
  - Technology: 56.2% → 35.0% (-21.2%)
  - Technology: 35.0% → 20.0% (-15.0%)
  - Energy: 18.1% → 15.0% (-3.1%)
- **Strategic Cash (15):** 21.0%
- **Tactical Reserve (Cap / Unallocated):** 39.2%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Communication Services (priority_score=-0.12, score=0.23, weight=4.8%, div=ALIGNED, mom=0)
2. Energy (priority_score=-4.12, score=0.76, weight=15.0%, div=POSITIVE_DIVERGENCE, mom=2)
3. Technology (priority_score=-5.99, score=2.36, weight=20.0%, div=ALIGNED, mom=1)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=5.86, score=2.36, weight=20.0%, div=ALIGNED, mom=1)
2. Energy (priority_score=4.76, score=0.76, weight=15.0%, div=POSITIVE_DIVERGENCE, mom=2)
3. Communication Services (priority_score=0.23, score=0.23, weight=4.8%, div=ALIGNED, mom=0)

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action | Divergence | Classification |
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 20.0% | CORE_LEADER | ALIGNED | HIGH_CONVICTION_ALIGNED |
| Energy | XLE | 15.0% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 2.1808002015038204
- **Z-Score (5d):** 0.9442474896071225

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.1634018004030393
- **Z-Score (5d):** 0.06458772563563295

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.2070980661184056
- **Z-Score (5d):** 1.2726859328219864

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 2.131981770392461
- **Z-Score (5d):** 0.8116178152854874

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.666676937057719
- **Z-Score (5d):** 0.5395034499727844

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6496346533638432
- **Z-Score (5d):** -0.23792571864155243

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.0284678670082354
- **Z-Score (5d):** 0.07771908379472807

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.5096142085524065
- **Z-Score (5d):** 0.2697029553484379

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.3889521704294203
- **Z-Score (5d):** -1.0801355215388768
