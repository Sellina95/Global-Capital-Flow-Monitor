...
- **미국 10년물 금리**: 4.052  (-0.10% vs 4.056)
- **달러 인덱스**: 97.133  (+0.05% vs 97.083)
- **WTI 유가**: 62.220  (-2.37% vs 63.730)
- **변동성 지수 (VIX)**: 20.290  (-4.29% vs 21.200)
- **원/달러 환율**: 1442.430  (-0.03% vs 1442.810)
...
- **VIX 레벨:** 20.29 → **High (Risk-off bias)**
...
- **Event Surprise Bias:** N/A (no usable CPI/NFP/Fed data)
...
- **방향(전일 대비):** HYG(↓) / LQD(↑)
- **HYG:** today 80.810 / prev 80.850 / pct -0.05%
- **LQD:** today 111.700 / prev 111.590 / pct 0.10%
...
- **판정:** **금리 하락(US10Y↓) + 달러 강세(DXY↑) + 유가 하락(WTI↓) + 변동성 완화(VIX↓)**
...
- **Today snapshot:** US10Y(4.052), DXY(97.133), VIX(20.29)
