...
- **달러 인덱스**: 97.255  (+0.02% vs 97.234)
- **WTI 유가**: 62.410  (-0.06% vs 62.450)
- **변동성 지수 (VIX)**: 19.540  (-3.70% vs 20.290)
- **원/달러 환율**: 1444.310  (+0.05% vs 1443.530)
...
- **VIX 레벨:** 19.54 → **Mid (Neutral/Mixed)**
...
- **Event Impulse Bias:** MIXED/WEAK (proxy tie)
  - Inflation: N/A (CPIΔ N/A / PCEΔ N/A) | Labor: N/A (URΔ N/A / PAYEMSΔ N/A) | Policy: N/A (FFRΔ N/A) | Infl. expectations(10y): N/A (T10YIEΔ N/A)
...
- **강도:** US10Y(Noise) / DXY(Noise) / WTI(Noise) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.052), DXY(97.255), VIX(19.54)
