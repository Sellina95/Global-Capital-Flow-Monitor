...
- **달러 인덱스**: 97.214  (+0.03% vs 97.189)
- **WTI 유가**: 63.930  (+0.06% vs 63.890)
- **변동성 지수 (VIX)**: 20.080  (-1.08% vs 20.300)
- **원/달러 환율**: 1445.890  (+0.17% vs 1443.480)
...
- **VIX 레벨:** 20.08 → **High (Risk-off bias)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.025 / US10YΔ +0.000**
...
- **Today snapshot:** US10Y(4.052), DXY(97.214), VIX(20.08)
...
### 🧠 13) Narrative Engine (v1.1)
- **질문:** 오늘 시장 스토리는 무엇이며, 나는 리스크를 늘려야 하는가 줄여야 하는가?

- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.025 / US10YΔ +0.000
