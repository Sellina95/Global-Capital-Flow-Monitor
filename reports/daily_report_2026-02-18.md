...
- **달러 인덱스**: 97.281  (+0.00% vs 97.279)
- **WTI 유가**: 62.490  (+0.18% vs 62.380)
- **변동성 지수 (VIX)**: 19.390  (-0.46% vs 19.480)
- **원/달러 환율**: 1444.680  (+0.17% vs 1442.290)
...
- **Policy Bias: MIXED (혼조) (score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.002 / US10YΔ +0.000**
...
- **Today snapshot:** US10Y(4.052), DXY(97.281), VIX(19.39)
