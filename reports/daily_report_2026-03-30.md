...
- **달러 인덱스**: 100.292  (+0.14% vs 100.150)
- **WTI 유가**: 102.850  (+3.22% vs 99.640)
- **변동성 지수 (VIX)**: 31.050  (+0.00% vs 31.050)
- **원/달러 환율**: 1507.950  (-0.01% vs 1508.060)
...
- **Policy Bias: TIGHTENING (긴축) (STRONG, score=+3.0) | REAL_RATEΔ +0.060 / FCIΔ +0.039 / DXYΔ +0.142 / US10YΔ +0.000**
...
- **Top Drivers:**
  ...
  - WTI: z_used=+0.65 (z1d=+0.55, z5d=+0.79, raw_w=0.10, norm_w=0.08) → contrib=+0.05
...
- **강도:** US10Y(Noise) / DXY(Mild) / WTI(Strong) / VIX(Noise)
...
- **Today snapshot:** US10Y(4.440), DXY(100.292), VIX(31.05)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (STRONG, score=+3.0) | REAL_RATEΔ +0.060 / FCIΔ +0.039 / DXYΔ +0.142 / US10YΔ +0.000 (스태그플레이션)
...
**Context:** phase=EVENT-WATCHING (이벤트 관망) / T10Y2Y=0.56 / VIX=27.44
