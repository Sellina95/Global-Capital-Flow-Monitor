...
- **미국 10년물 금리**: 4.440  (-0.31% vs 4.454)
- **달러 인덱스**: 100.193  (+0.19% vs 99.999)
- **WTI 유가**: 101.180  (+3.46% vs 97.800)
- **변동성 지수 (VIX)**: 31.050  (+3.47% vs 30.010)
- **원/달러 환율**: 1508.060  (-0.17% vs 1510.680)
...
- **Policy Bias: TIGHTENING (긴축) (STRONG, score=+2.5) | REAL_RATEΔ +0.060 / FCIΔ +0.039 / DXYΔ +0.194 / US10YΔ -0.014**
...
- **방향(전일 대비):** HYG(↓) / LQD(↑)
- **HYG:** today 78.720 / prev 78.725 / pct -0.01%
- **LQD:** today 107.620 / prev 107.565 / pct 0.05%
...
- DEBUG: pct XLK=-0.733501434941693, XLF=-0.6338985649714316, XLE=0.20823493109042415, XLRE=-0.6209637616062359
Correlation Break Detected:
- US10Y ↓ but XLK ↓ (Tech)
...
- **Cosine Similarity Score:** 0.500
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.500
  - Ukraine_2022: 0.481
  - Israel_2023: 0.376
- **Top Drivers:**
  ...
  - VIX: z_used=+0.42 (z1d=+0.21, z5d=+0.74, raw_w=0.18, norm_w=0.14) → contrib=+0.06
  - WTI: z_used=+0.61 (z1d=+0.62, z5d=+0.59, raw_w=0.10, norm_w=0.08) → contrib=+0.05
...
- **Today snapshot:** US10Y(4.440), DXY(100.193), VIX(31.05)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (STRONG, score=+2.5) | REAL_RATEΔ +0.060 / FCIΔ +0.039 / DXYΔ +0.194 / US10YΔ -0.014
- **Sentiment (Fear&Greed):** 23.298775499712352 (FEAR)
...
**Context:** phase=RISK-OFF (부분 정렬) / T10Y2Y=0.56 / VIX=27.44 / credit=True
