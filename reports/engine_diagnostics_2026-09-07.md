...
- **Final Exposure (실행 기준): 31%**

- **Portfolio Stance:** STRONG REDUCE / 31%
...
- **Final Exposure:** **31%**
- **Base Context:** phase=EVENT-WATCHING / INFLATION / narrative=STRONG REDUCE / base_exposure=31%
- **SEW:** STABLE / NORMAL
...
- **Positioning:** pos_z=1.68
- **Warning Score:** 2 (6.6 섹터 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=STRONG REDUCE 반영 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=HOLD / Flow=👀 EARLY TRACE(4) / Drift=👀 EARLY DRIFT(2) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 4.784  (+0.46% vs 4.762)
- **달러 인덱스**: 99.160  (+0.16% vs 99.000)
- **WTI 유가**: 91.480  (+0.20% vs 91.300)
- **변동성 지수 (VIX)**: 14.530 (+1.47% vs 14.320)
- **원/달러 환율**: 1355.410  (-0.22% vs 1358.390)
...
- **VIX 레벨:** 14.53 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.558 / level=EASY (완화) / update=low-frequency | as of: 2026-09-07 (latest available)
- **유인(Real Rates):** value=2.420 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-07 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.558 (low-frequency) / DXYΔ +0.160 / US10YΔ +0.022**
...
- **Spread as of:** 2026-09-03 (FRED latest)
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.160 / prev 79.210 / pct -0.06%
- **LQD:** today 105.480 / prev 105.500 / pct -0.02%
- **판정:** **CREDIT NEUTRAL**
...
- DXY **(Clear, +0.16%)** → 달러 강세/신흥국 부담
- WTI **(Mild, +0.20%)** → 인플레 재자극 가능성
- VIX **(Clear, +1.47%)** → 심리 악화/리스크오프
...
- **SPY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.38% / 5D=+0.12% | Strength: LOW
- **WTI:** ⚪ SIDEWAYS | Short-term: SHORT UP | 1D=+0.00% / 5D=+6.67% | Strength: MEDIUM
- **DXY:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.01% / 5D=-0.27% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT DOWN | 1D=+1.06% / 5D=+1.03% | Strength: LOW
...
- **Geo Stress Score (z-composite):** **-0.20**  *(Level: NORMAL)*
...
- **Cosine Similarity Score:** 0.086
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: 0.086
  - Iran_Crisis_2020: -0.126
  - Taiwan_Tension: -0.131
- **Top Drivers:**
  - USDJPY: z_used=+3.15 (z1d=-3.96, z5d=-1.93, raw_w=0.05, norm_w=0.04) → contrib=+0.12
  - KR10Y_SPREAD: z_used=-1.45 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.09
  - GOLD: z_used=-0.73 (z1d=-0.97, z5d=-0.36, raw_w=0.12, norm_w=0.09) → contrib=-0.07
  - JP10Y_SPREAD: z_used=-1.45 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.07
...
**핵심 신호:** 장단기차(41.00bp) | 실질금리(2.42%) | DXY(99.16)
*(as of: RealRate: 2026-09-07 / FRED last available)*
...
- **Today snapshot:** US10Y(4.784), DXY(99.160), VIX(14.53)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↑)
- **Meaningful Move Check:** DXY=0.1616198607165404 / GOLD=-1.3781060162830707 / US10Y=0.46198730744020156 / VIX=1.4664807445692383 / WTI=0.19715257301114616
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.783999919891357, RealYield=2.42, T10Y2Y=0.41, WTI=91.4800033569336, DXY=99.16000366210938, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.65, DriftLabel=NEUTRAL, FredAsof=2026-09-04
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=3.08 → healthy contango / stable structure
...
- **Breadth Note:** RSP-SPY return spread=-0.09%p → neutral breadth
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.33%p → mega-cap concentrated Nasdaq rally
- **Positioning / Gamma:** 1
...
**Leadership Notes**
- QQQ-SPY spread=0.57%p → growth leadership
- SMH-QQQ spread=2.43%p → semiconductor participation strong
- SOXX-QQQ spread=3.34%p → SOX proxy confirms chip breadth
- IWM-SPY spread=0.66%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=-0.40%p → sector diffusion weak
- XLI-SPY spread=0.79%p → sector diffusion positive
- XLY-SPY spread=-0.95%p → sector diffusion weak
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.558 (low-frequency) / DXYΔ +0.160 / US10YΔ +0.022 (정상)
- **Sentiment (Fear&Greed):** 68.892956604286 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=1.68 ⚠️ 수급 다소 과열 → Phase=EVENT-WATCHING / INFLATION
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `EVENT-WATCHING` | **Bucket:** `MIXED` | **VIX:** `14.53`
- **Positioning Data:** Z-Score: `1.68` (>1.8 시 Run) | Gamma: `0.91` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 14.53 (NORMAL) | **Change:** +1.47%
- **Positioning Layer:** ⚠️ Positioning Heat(1.68)
...
**Context:** phase=EVENT-WATCHING / INFLATION / T10Y2Y=0.41 (MODERATE STEEP) / VIX=14.53 (VOLATILITY CALM) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** EVENT_TRANSITION
**Macro Inputs Debug:** phase=EVENT-WATCHING / INFLATION / us10y_pct=+0.46% / dxy_pct=+0.16% / wti_pct=+0.20% / vix=14.53 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=4
...
**Overweight:** Consumer Staples, Health Care, Financials

**Underweight:** Real Estate, Industrials, Energy, Consumer Discretionary, Technology

**Scoreboard:**
- Consumer Staples: +1.8  (+2 LIQ, +1 PHASE, = +1.8)
- Health Care: +1.8  (+2 LIQ, +1 PHASE, = +1.8)
- Financials: +0.4  (+2 CURVE, +1 MOM, = +0.4)
- Technology: -0.1  (+2 VOL, -2 LIQ, -0.5 PHASE, +1.5 FLOW, = -0.1)
- Consumer Discretionary: -0.2  (+1 VOL, -1 LIQ, -1 MOM, = -0.2)
- Energy: -0.4  (-1 PHASE, +2 MOM, = -0.4)
- Industrials: -0.8  (+1 CURVE, -1.5 PHASE, +1 FLOW, -1 MOM, = -0.8)
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.52, dispersion=1.40)
- Correlation Break: True / Type=XLF_BETRAYAL
- Break Reasons: US10Y ↑ but XLF ↓ | US10Y ↑ but XLK ↑
- Interpretation: 균형 장세 / 강한 방향성보다 선별적 배분 필요

**Divergence / Classification Monitor (Theory vs Flow alignment: 이론과 실제 자금흐름 정렬 여부)**
- Consumer Staples: FLOW_WEAK (theory=+3.0, flow=+0.0, final=+1.8)
- Health Care: FLOW_WEAK (theory=+3.0, flow=+0.0, final=+1.8)
...
- **Strategic Exposure (15):** **31.0%** → **Regime Adjusted:** **31.0%**
- **Exposure Override:** BALANCED → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.8 | NEGATIVE_DIVERGENCE | **11.8%** | HOLD |
| Health Care | +1.8 | NEGATIVE_DIVERGENCE | **11.8%** | HOLD |
...
- **Strategic Cash (15):** 69.0%
- **Tactical Reserve (Cap / Unallocated):** 1.0%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=3.77, score=1.75, weight=11.8%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.77, score=1.75, weight=11.8%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.78, score=0.44, weight=3.0%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Technology (priority_score=0.22, score=-0.15, weight=3.4%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=-0.15, score=-0.15, weight=3.4%, div=ALIGNED, mom=0)
2. Financials (priority_score=-1.06, score=0.44, weight=3.0%, div=NEGATIVE_DIVERGENCE, mom=1)
3. Consumer Staples (priority_score=-1.25, score=1.75, weight=11.8%, div=NEGATIVE_DIVERGENCE, mom=0)
4. Health Care (priority_score=-1.25, score=1.75, weight=11.8%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 11.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 11.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.13413964939246634
- **Z-Score (5d):** -0.2810551592259911

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9240990998183949
- **Z-Score (5d):** 0.6543576368045644

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1033934324880006
- **Z-Score (5d):** 1.1106241175997207

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.04495474566273429
- **Z-Score (5d):** -0.008469002936875365

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.14707106761825445
- **Z-Score (5d):** 0.7343801673656155

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.2929008553132875
- **Z-Score (5d):** 0.2490277598145986

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6160860255263866
- **Z-Score (5d):** -0.22774962032307475

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6228600187829413
- **Z-Score (5d):** -0.14414213937009712

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.4459522630347509
- **Z-Score (5d):** -0.19393453854291678
