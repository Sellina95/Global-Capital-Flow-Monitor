...
- **달러 인덱스**: 97.761  (+0.03% vs 97.734)
- **WTI 유가**: 67.210  (+0.28% vs 67.020)
- **변동성 지수 (VIX)**: 20.550  (+0.69% vs 20.410)
- **원/달러 환율**: 1441.890  (-0.02% vs 1442.140)
...
- **VIX 레벨:** 20.55 → **High (Risk-off bias)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.010 / FCIΔ +0.000 / DXYΔ +0.027 / US10YΔ +0.000**
...
- WTI **(Mild, +0.28%)** → 인플레 재자극 가능성
- VIX **(Mild, +0.69%)** → 심리 악화/리스크오프
...
- **강도:** US10Y(Noise) / DXY(Noise) / WTI(Mild) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.017), DXY(97.761), VIX(20.55)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.010 / FCIΔ +0.000 / DXYΔ +0.027 / US10YΔ +0.000
