...
- **달러 인덱스**: 97.734  (-0.01% vs 97.747)
- **WTI 유가**: 67.020  (+0.16% vs 66.910)
- **변동성 지수 (VIX)**: 20.410  (+0.15% vs 20.380)
- **원/달러 환율**: 1442.140  (+0.05% vs 1441.480)
...
- **Context:** phase=TRANSITION / MIXED (전환·혼조) / liquidity=UP-MID / credit_calm=True
...
- **VIX 레벨:** 20.41 → **High (Risk-off bias)**
...
- **Policy Bias: EASING (완화) (MODERATE, score=-2.0) | REAL_RATEΔ -0.010 / FCIΔ +0.000 / DXYΔ -0.013 / US10YΔ +0.000**
...
- **Today snapshot:** US10Y(4.017), DXY(97.734), VIX(20.41)
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-2.0) | REAL_RATEΔ -0.010 / FCIΔ +0.000 / DXYΔ -0.013 / US10YΔ +0.000
...
- **Context:** phase=TRANSITION / MIXED (전환·혼조) / liquidity=UP-MID / structure=EASING / credit_calm=True
