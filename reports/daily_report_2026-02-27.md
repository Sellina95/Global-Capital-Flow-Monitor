...
- **미국 10년물 금리**: 4.017  (-0.77% vs 4.048)
- **달러 인덱스**: 97.799  (+0.17% vs 97.637)
- **WTI 유가**: 65.470  (+2.75% vs 63.720)
- **변동성 지수 (VIX)**: 18.630  (+5.02% vs 17.740)
- **원/달러 환율**: 1433.300  (+0.60% vs 1424.820)
...
- **VIX 레벨:** 18.63 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ -0.010 / FCIΔ +0.000 / DXYΔ +0.162 / US10YΔ -0.031**
...
- **방향(전일 대비):** HYG(↓) / LQD(↑)
- **HYG:** today 80.850 / prev 80.920 / pct -0.09%
- **LQD:** today 111.720 / prev 111.650 / pct 0.06%
...
- 미국 금리(US10Y) **(Strong, -0.77%)** → 완화 기대 강화
- DXY **(Clear, +0.17%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +2.75%)** → 인플레 재자극 가능성
- VIX **(Strong, +5.02%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, +0.60%)** → 원화 약세/수급 부담
...
- **Today snapshot:** US10Y(4.017), DXY(97.799), VIX(18.63)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ -0.010 / FCIΔ +0.000 / DXYΔ +0.162 / US10YΔ -0.031
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 → Phase=RISK-OFF (부분 정렬)
...
- **Risk Budget:** 35
- **Phase Cap:** 35
- **VIX Level:** 18.63 (NORMAL)
- **VIX Change (%):** +5.02%
- **Final Multiplier:** 0.85x
...
- **Context:** phase=RISK-OFF (부분 정렬) / liquidity=UP-MID / structure=MIXED / credit_calm=True
