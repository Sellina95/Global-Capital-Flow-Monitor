...
- **Portfolio Stance:** REDUCE (POS_OVERHEATED) / 49%

- **[14번 구조·수급 괴리]:** 🚨 **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.44). 반전 가능성 상존.
### 🟢 Current SEW Status
- **SEW:** RISK_COMPRESSION | ⚠️ Risk Compression 발동 (권장 익스포저 55%)
- **Event Type:** NORMAL → 정상 상태 / 구조적 리스크 없음
- **Spike Monitor:** Spike 0 / Extreme 0
- **Current Reason:** ⚠️ CROWDING RISK: POS_Z Extreme (2.22) → Risk Compression (55%)

- **[15번 Hard Deadman]:** ✅ PASS
- **[14번 수급 시그널]:** 🚨 **MONITOR REVERSAL (RUN 액션 준비)**

### 🧠 Strategic Interpretation (PM Summary)
- 금일 시장은 **EARLY RISK-ON 환경**입니다.
- **Structure:** 금리·달러·유가·변동성 압력이 한 방향으로 강하게 정렬되지는 않아 구조 판단은 중립적으로 유지합니다.
- **Liquidity:** 가격 환경과 실제 유동성 흐름이 모두 부담을 주고 있어, 리스크 자산의 방어력이 약해질 수 있습니다.
- **Participation:** 기관성 흐름은 **👀 EARLY TRACE**(score=4) 상태이며, Drift는 **👀 EARLY DRIFT / NEUTRAL**(score=4)로 관찰됩니다. 다만 breadth와 리더십 확산 여부는 추가 확인이 필요합니다.
- **Risk:** 포지셔닝 과열(POS_Z=2.44)이 관찰되며, 크레딧은 안정적입니다. 따라서 신규 추격보다는 sizing control과 exposure discipline이 중요합니다.
- **Allocation:** 현 수준에서는 포지션 유지와 관망이 적절하며, 추가 확대는 breadth와 flow confirmation 이후가 더 안전합니다. 현재 실행 기준 노출은 약 **49%**입니다.
...
- **Final Exposure:** **49%**
- **Base Context:** phase=EARLY RISK-ON / narrative=REDUCE (POS_OVERHEATED) / base_exposure=49%
...
- **Positioning:** pos_z=2.44
- **Warning Score:** 0 (No warning)
- **Tactical Why:** No actionable alignment / Positioning overheat
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Tactical=REDUCE / Flow=👀 EARLY TRACE(4) / Drift=👀 EARLY DRIFT(4) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화

### 🚩 Market Regime Status
- **Operational Phase:** ✅ **EARLY RISK-ON**
...
- **미국 10년물 금리**: 4.453  (-0.04% vs 4.455)
- **달러 인덱스**: 98.910  (-0.11% vs 99.020)
- **WTI 유가**: 87.360  (-1.73% vs 88.900)
- **변동성 지수 (VIX)**: 15.320 (-2.67% vs 15.740)
- **원/달러 환율**: 1507.130  (+0.27% vs 1503.110)
...
- **VIX 레벨:** 15.32 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.510 / level=EASY (완화) / update=low-frequency | as of: 2026-05-30 (latest available)
- **유인(Real Rates):** value=2.060 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-05-30 (latest available)
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCI value=-0.510 (low-frequency) / DXYΔ -0.110 / US10YΔ -0.002**
...
- **Liquidity as of:** 2026-05-27 (FRED latest)
- **NET_LIQ level:** 5874085.1
- **TGA level:** 830296.0
- **RRP level:** 1.853
...
- **Spread as of:** 2026-05-28 (FRED latest)
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 80.310 / prev 80.230 / pct 0.10%
- **LQD:** today 109.360 / prev 109.260 / pct 0.09%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Mild, -0.04%)** → 완화 기대 강화
- DXY **(Mild, -0.11%)** → 달러 약세/리스크 선호
- WTI **(Strong, -1.73%)** → 물가 부담 완화
- VIX **(Strong, -2.67%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Clear, +0.27%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, +0.10%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Noise, +0.09%)** → 우량채 강세(리스크오프 성향)
...
- **SPY:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.24% / 5D=+1.84% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: MIXED | 1D=-1.28% / 5D=-8.92% | Strength: HIGH
- **DXY:** 🔴 DOWN | Short-term: SHORT UP | 1D=-0.08% / 5D=-0.25% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT DOWN | 1D=+1.57% / 5D=+0.66% | Strength: LOW
...
- **Geo Stress Score (z-composite):** **-0.34**  *(Level: NORMAL)*
...
- **Cosine Similarity Score:** -0.013
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Israel_2023: -0.013
  - Ukraine_2022: -0.074
  - Iran_Crisis_2020: -0.120
- **Top Drivers:**
  - USDCNH: z_used=-0.94 (z1d=-0.83, z5d=-1.11, raw_w=0.18, norm_w=0.14) → contrib=-0.13
  - EMB: z_used=-0.83 (z1d=+0.41, z5d=+1.48, raw_w=0.12, norm_w=0.09) → contrib=-0.08
  - GOLD: z_used=+0.69 (z1d=+0.89, z5d=+0.40, raw_w=0.12, norm_w=0.09) → contrib=+0.06
  - VIX: z_used=-0.42 (z1d=-0.33, z5d=-0.56, raw_w=0.18, norm_w=0.14) → contrib=-0.06
...
**핵심 신호:** 장단기차(46.00bp) | 실질금리(2.06%) | DXY(98.91)
*(as of: RealRate: 2026-05-30 / FRED last available)*
...
- **강도:** US10Y(Mild) / DXY(Mild) / WTI(Strong) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.453), DXY(98.910), VIX(15.32)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↓) / DXY(↓) / GOLD(↑) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=-0.11108158421123639 / GOLD=1.3602159884686917 / US10Y=-0.044890125157179654 / VIX=-2.6683613875561503 / WTI=-1.732284464673544
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.453000068664551, RealYield=2.06, T10Y2Y=0.46, WTI=87.36000061035156, DXY=98.91000366210938, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.72, DriftLabel=NEUTRAL, FredAsof=2026-05-29
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=3.34 → healthy contango / stable structure
...
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=0.43%p → broad Nasdaq participation
- **Positioning / Gamma:** -1
...
- SMH-QQQ spread=-0.52%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-0.44%p → chip breadth lagging
- IWM-SPY spread=-0.80%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=0.36%p → sector diffusion positive
- XLI-SPY spread=-0.63%p → sector diffusion weak
- XLY-SPY spread=-1.22%p → sector diffusion weak
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCI value=-0.510 (low-frequency) / DXYΔ -0.110 / US10YΔ -0.002 (정상)
- **Sentiment (Fear&Greed):** 63.75332378781371 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=2.44 ⚠️ 수급 과열 감지 → Phase=EARLY RISK-ON
...
- **Structure(3번):** `EASING` | **Price(Regime):** `RISK-ON` | **Bucket:** `RISK-ON` | **VIX:** `15.32`
- **Positioning Data:** Z-Score: `2.44` (>2.2 시 Run) | Gamma: `0.91` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
- **Status:** **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.44). 반전 가능성 상존.
...
- **VIX Level:** 15.32 (NORMAL) | **Change:** -2.67%
- **⚠️ STATUS:** RISK COMPRESSION
- **Reason:** POS_Z Extreme (2.44)
- **Action:** 신규 추격 금지 / 일부 이익실현 / 베타 노출 축소
- **Final Multiplier:** 0.85x (VIX x Positioning x Credit/Convexity)
- **Slope Intensity:** 0.1100
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.44)
...
**Context:** phase=EARLY RISK-ON / T10Y2Y=0.46 (MODERATE STEEP) / VIX=15.32 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** DISINFLATION_RISK_ON
**Macro Inputs Debug:** phase=EARLY RISK-ON / us10y_pct=-0.04% / dxy_pct=-0.11% / wti_pct=-1.73% / vix=15.32 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=4
...
**Overweight:** Consumer Staples, Health Care, Technology, Communication Services, Utilities

**Underweight:** Real Estate, Industrials, Financials, Energy, Consumer Discretionary

**Scoreboard:**
- Consumer Staples: +1.1  (+2 LIQ, = +1.1)
- Health Care: +1.1  (+2 LIQ, = +1.1)
- Technology: +1.1  (-2 LIQ, +1.5 PHASE, +1.5 FLOW, +2 MOM, = +1.1)
...
- Financials: -0.9  (+2 CURVE, -2 MOM, = -0.9)
- Industrials: -1.4  (+1 CURVE, +1 FLOW, -2 MOM, = -1.4)
- Real Estate: -1.6  (-1.5 LIQ, -2 MOM, = -1.6)
...
- UW Industrials: +1: 완만한 스티프닝(0.46) → 성장 기대 반영
- UW Industrials: +0.5: Flow Overlay → 경기민감 확인용 가점

**Regime Controller:**
- BALANCED (avg_divergence=-0.92, dispersion=1.45)
...
- Technology: POSITIVE_DIVERGENCE (theory=-0.5, flow=+1.9, final=+1.1)
- Materials: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Financials: THEORY_TRAP (theory=+2.0, flow=-1.4, final=-0.9)
- Industrials: THEORY_TRAP (theory=+1.0, flow=-1.1, final=-1.4)
- Real Estate: AVOID (theory=-1.5, flow=-1.4, final=-1.6)
...
| :--- | :---: | :---: | :---: | :--- |
| Technology | +1.6 | POSITIVE_DIVERGENCE | **31.9%** | DELEVERAGE |
| Consumer Staples | +1.1 | NEGATIVE_DIVERGENCE | **3.1%** | DELEVERAGE |
| Health Care | +1.1 | NEGATIVE_DIVERGENCE | **4.4%** | DELEVERAGE |
| Communication Services | +0.3 | ALIGNED | **4.8%** | DELEVERAGE |
| Utilities | +0.3 | ALIGNED | **4.8%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **51.0%** | DEFENSIVE |
...
1. Consumer Staples (priority_score=5.96, score=1.08, weight=3.1%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=5.96, score=1.08, weight=4.4%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Communication Services (priority_score=-0.15, score=0.3, weight=4.8%, div=ALIGNED, mom=0)
4. Utilities (priority_score=-0.15, score=0.3, weight=4.8%, div=ALIGNED, mom=0)
5. Technology (priority_score=-2.97, score=1.57, weight=31.9%, div=POSITIVE_DIVERGENCE, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=5.57, score=1.57, weight=31.9%, div=POSITIVE_DIVERGENCE, mom=2)
2. Communication Services (priority_score=0.30, score=0.3, weight=4.8%, div=ALIGNED, mom=0)
3. Utilities (priority_score=0.30, score=0.3, weight=4.8%, div=ALIGNED, mom=0)
4. Consumer Staples (priority_score=-1.92, score=1.08, weight=3.1%, div=NEGATIVE_DIVERGENCE, mom=0)
5. Health Care (priority_score=-1.92, score=1.08, weight=4.4%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 31.9% | TACTICAL_LEADER | POSITIVE_DIVERGENCE | POSITIVE_DIVERGENCE |
| Consumer Staples | XLP | 3.1% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 4.4% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Communication Services | XLC | 4.8% | SMALL | ALIGNED | ALIGNED |
| Utilities | XLU | 4.8% | SMALL | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2305961480224355
- **Z-Score (5d):** 1.4845583376475966

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.15197782683059982
- **Z-Score (5d):** 0.7717577089923779

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.04293336945688646
- **Z-Score (5d):** 0.7037846924112539

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3759875283205635
- **Z-Score (5d):** 1.3705768131906535

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.12526951454783747
- **Z-Score (5d):** 0.5101397046433592

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.17224158412249696
- **Z-Score (5d):** -0.8632916264024119

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.7478330046450973
- **Z-Score (5d):** 0.28938956915697284

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.08306700792625155
- **Z-Score (5d):** 0.493459182145669

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.3499300030973154
- **Z-Score (5d):** -0.9206983311410233
