...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 54%**
- **Final Exposure (실행 기준): 54%**

- **Portfolio Stance:** HOLD / 54%
...
- **Final Action:** **HOLD**
- **Final Exposure:** **54%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=HOLD / base_exposure=54%
- **SEW:** STABLE / NORMAL
- **Divergence:** ALIGNED / **STAY (포지션 유지)**
- **Drift:** ⚡ STRUCTURAL DRIFT / NEUTRAL / 🟢 EARLY FLOW WITHOUT SHOCK / score=6
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=HOLD 반영 → Warning Score 1 → 경미한 이상신호, 모니터링 강화 → Tactical=HOLD / Flow=🔥 BUILDING HARD(7) / Drift=⚡ STRUCTURAL DRIFT(6) / Gamma=🟡 TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음

### 🚩 Market Regime Status
- **국면 전환 감지:** 🚨 **EVENT-WATCHING (이벤트 관망)** → **TRANSITION / MIXED**
...
- **미국 10년물 금리**: 4.641  (-0.81% vs 4.679)
- **달러 인덱스**: 101.475  (+0.00% vs 101.470)
- **WTI 유가**: 81.500  (-8.74% vs 89.310)
- **변동성 지수 (VIX)**: 18.670 (+0.48% vs 18.580)
- **원/달러 환율**: 1458.010  (-1.09% vs 1474.040)
...
- **VIX 레벨:** 18.67 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.552 / level=EASY (완화) / update=low-frequency | as of: 2026-07-28 (latest available)
- **유인(Real Rates):** value=2.430 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-07-28 (latest available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCI value=-0.552 (low-frequency) / DXYΔ +0.005 / US10YΔ -0.038**
...
- **Spread as of:** 2026-07-24 (FRED latest)
- **HY_OAS level:** 2.79% → **COOL (낮은 공포)**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 79.270 / prev 79.230 / pct 0.05%
- **LQD:** today 106.510 / prev 106.230 / pct 0.26%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, -0.81%)** → 완화 기대 강화
- DXY **(Noise, +0.00%)** → 달러 강세/신흥국 부담
- WTI **(Strong, -8.74%)** → 물가 부담 완화
- VIX **(Mild, +0.48%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, -1.09%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Noise, +0.05%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Mild, +0.26%)** → 우량채 강세(리스크오프 성향)
...
- **SPY:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.01% / 5D=-0.41% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: SHORT UP | 1D=-8.74% / 5D=-2.08% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.04% / 5D=+0.72% | Strength: LOW
- **GOLD:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.43% / 5D=+0.99% | Strength: LOW
...
- **Market Drift Summary:**
  - Equity (SPY): 🟡 REBOUND / MIXED
  - Oil (WTI): 🔴 DOWN / SHORT UP
...
- **Cosine Similarity Score:** -0.141
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.141
  - Ukraine_2022: -0.265
  - Iran_Crisis_2020: -0.265
- **Top Drivers:**
  - WTI: z_used=-1.45 (z1d=-2.30, z5d=-0.16, raw_w=0.10, norm_w=0.08) → contrib=-0.11
  - DE10Y_SPREAD: z_used=-2.09 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.10
  - JP10Y_SPREAD: z_used=-2.09 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.10
  - KR10Y_SPREAD: z_used=-1.45 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.09
...
- **Dealer Gamma Bias:** 0.82 (NEUTRAL / transition zone)
- **Bias:** 초기 방향성 형성 / 감마 전환 구간
- **Strategy:** 포지션 확대 신중 / 초기 진입 구간

- **Drift Score:** 6 (⚡ STRUCTURAL DRIFT)
...
**핵심 신호:** 장단기차(34.00bp) | 실질금리(2.43%) | DXY(101.47)
*(as of: RealRate: 2026-07-28 / FRED last available)*
...
- **Today snapshot:** US10Y(4.641), DXY(101.475), VIX(18.67)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↓) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↓)
- **Meaningful Move Check:** DXY=0.004924857946044008 / GOLD=-0.4671058989045603 / US10Y=-0.8121416460145932 / VIX=0.4843926423975051 / WTI=-8.744818913996536
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.640999794006348, RealYield=2.43, T10Y2Y=0.34, WTI=81.5, DXY=101.4749984741211, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.79, DriftLabel=NEUTRAL, FredAsof=2026-07-27
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=1.53 → mild contango
- Short-Term Hedge: VIX9D/VIX=0.97 → neutral short-term hedge
...
- **Breadth Note:** RSP-SPY return spread=0.73%p → broad participation
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=1.08%p → broad Nasdaq participation
- **Positioning / Gamma:** 0
...
**Leadership Notes**
- QQQ-SPY spread=-0.33%p → growth leadership weak
- SMH-QQQ spread=-1.94%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-1.74%p → chip breadth lagging
- IWM-SPY spread=0.58%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=0.99%p → sector diffusion positive
- XLI-SPY spread=0.27%p → sector diffusion neutral
- XLY-SPY spread=1.29%p → sector diffusion positive
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCI value=-0.552 (low-frequency) / DXYΔ +0.005 / US10YΔ -0.038 (정상)
- **Sentiment (Fear&Greed):** 62.29074833457673 (NEUTRAL)
- **Credit Calm:** True
...
- **Drift Score:** 6
- **Flow Score:** 7
- **Flow Continuity:** FLOW_FADE → 🔥 BUILDING HARD (FLOW_PERSISTENCE, tilt=+1)
- **Flow Regime Tilt:** +4 / Flow-Gamma Tilt: +2

- **🎯 Final Risk Action:** **HOLD**
- **Risk Budget (0~100):** **60**
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.41 → Phase=TRANSITION / MIXED
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `TRANSITION / MIXED` | **Bucket:** `MIXED` | **VIX:** `18.67`
- **Positioning Data:** Z-Score: `1.41` (>1.8 시 Run) | Gamma: `0.82` (<0.5 시 Run) | CTA: `0.0` (추세 변곡점 확인)
...
- **Base Risk Budget (13):** 60
- **VIX Level:** 18.67 (NORMAL) | **Change:** +0.48%
...
**Context:** phase=TRANSITION / MIXED / T10Y2Y=0.34 (MODERATE STEEP) / VIX=18.67 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** GROWTH_SCARE
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=-0.81% / dxy_pct=+0.00% / wti_pct=-8.74% / vix=18.67 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=7
...
**Overweight:** Consumer Staples, Health Care, Financials, Utilities, Industrials, Energy
...
- Financials: +1.2  (+2 CURVE, -0.5 PHASE, +2 MOM, = +1.2)
- Utilities: +0.9  (+1 LIQ, +0.5 PHASE, = +0.9)
- Industrials: +0.6  (+1 CURVE, -0.5 PHASE, +0.5 FLOW, +1 MOM, = +0.6)
...
- OW Financials: +2: 완만한 스티프닝(0.34) → 예대마진 개선
- OW Financials: +2: Relative Strength 강세 (vs SPY) → 자금 유입 확인
...
**Regime Controller:**
- DISLOCATION (avg_divergence=-0.33, dispersion=1.75)
- Correlation Break: True / Type=GROWTH_FAILED_ON_RATE_RELIEF
- Break Reasons: US10Y ↓ but XLK ↓
...
- Industrials: TACTICAL_MOMENTUM_ONLY (theory=+0.5, flow=+0.8, final=+0.6)
...
- **Strategic Exposure (15):** **54.0%** → **Regime Adjusted:** **54.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.8 | NEGATIVE_DIVERGENCE | **7.8%** | SMALL ADJUST |
| Health Care | +1.8 | NEGATIVE_DIVERGENCE | **7.0%** | HOLD |
| Financials | +1.2 | ALIGNED | **5.0%** | NEW |
| Utilities | +0.9 | ALIGNED | **11.5%** | HOLD |
| Industrials | +0.6 | POSITIVE_DIVERGENCE | **5.0%** | NEW |
| Energy | +0.3 | POSITIVE_DIVERGENCE | **4.8%** | NEW |
| **Cash & Hedge** | - | - | **58.9%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** GROWTH_SCARE
- **Participation / Quality Cap Applied:**
  - Industrials: 8.2% → 8.0% (-0.2%)
  - Financials: 14.3% → 5.0% (-9.3%)
  - Industrials: 8.0% → 5.0% (-3.0%)
- **Strategic Cash (15):** 46.0%
- **Tactical Reserve (Cap / Unallocated):** 12.9%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=3.26, score=1.76, weight=7.8%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.14, score=1.76, weight=7.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Utilities (priority_score=0.24, score=0.91, weight=11.5%, div=ALIGNED, mom=0)
4. Financials (priority_score=-2.58, score=1.17, weight=5.0%, div=ALIGNED, mom=2)
5. Energy (priority_score=-3.17, score=0.34, weight=4.8%, div=POSITIVE_DIVERGENCE, mom=1)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Financials (priority_score=4.17, score=1.17, weight=5.0%, div=ALIGNED, mom=2)
2. Industrials (priority_score=3.08, score=0.58, weight=5.0%, div=POSITIVE_DIVERGENCE, mom=1)
3. Energy (priority_score=2.84, score=0.34, weight=4.8%, div=POSITIVE_DIVERGENCE, mom=1)
4. Utilities (priority_score=0.91, score=0.91, weight=11.5%, div=ALIGNED, mom=0)
5. Consumer Staples (priority_score=-1.24, score=1.76, weight=7.8%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 7.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 7.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
...
| Energy | XLE | 4.8% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.1862951052137338
- **Z-Score (5d):** -0.9437653219994704

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.18947782064888985
- **Z-Score (5d):** -0.04952779061064278

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2401598357473012
- **Z-Score (5d):** 0.046893491352435264

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.216306642278291
- **Z-Score (5d):** -0.790994911472703

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2531556222157097
- **Z-Score (5d):** 0.2657557197736052

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.5242855362236927
- **Z-Score (5d):** 0.3249061037667684

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.593142067091308
- **Z-Score (5d):** 1.0296066284659224

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.059624798906848145
- **Z-Score (5d):** -0.4791210871957273

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.09469623924346972
- **Z-Score (5d):** 0.5565242364244466
