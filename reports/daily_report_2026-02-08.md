...
- **미국 10년물 금리**: 4.206  (-0.00% vs 4.206)
- **달러 인덱스**: 97.630  (-0.05% vs 97.681)
- **WTI 유가**: 63.550  (+0.08% vs 63.500)
- **변동성 지수 (VIX)**: 20.370  (+14.70% vs 17.760)
- **원/달러 환율**: 1470.680  (+0.50% vs 1463.330)
...
- **VIX 레벨:** 20.37 → **High (Risk-off bias)**
...
- WTI **(Noise, +0.08%)** → 인플레 재자극 가능성
- VIX **(Strong, +14.70%)** → 심리 악화/리스크오프
...
- **강도:** US10Y(Noise) / DXY(Mild) / WTI(Noise) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.206), DXY(97.630), VIX(20.37)
