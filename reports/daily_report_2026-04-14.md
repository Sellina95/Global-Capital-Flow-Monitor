...
- **미국 10년물 금리**: 4.281  (-0.37% vs 4.297)
- **달러 인덱스**: 98.019  (-0.36% vs 98.370)
- **WTI 유가**: 93.520  (-5.61% vs 99.080)
- **변동성 지수 (VIX)**: 18.030  (-5.70% vs 19.120)
- **원/달러 환율**: 1469.270  (-0.87% vs 1482.180)
...
- **Context:** phase=RISK-ON (완화 기대·리스크 선호) / liquidity=UP-MID / credit_calm=True / geo=N/A
...
- **VIX 레벨:** 18.03 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.351 / US10YΔ -0.016**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 80.495 / prev 80.260 / pct 0.29%
- **LQD:** today 109.960 / prev 109.620 / pct 0.31%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, -0.37%)** → 완화 기대 강화
- DXY **(Strong, -0.36%)** → 달러 약세/리스크 선호
- WTI **(Strong, -5.61%)** → 물가 부담 완화
- VIX **(Strong, -5.70%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Strong, -0.87%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Mild, +0.29%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Mild, +0.31%)** → 우량채 강세(리스크오프 성향)
...
- **Geo Stress Score (z-composite):** **-0.80**  *(Level: N/A)*
...
- **Top Drivers:**
  - USDCNH: z_used=-1.53 (z1d=-1.06, z5d=-2.23, raw_w=0.18, norm_w=0.14) → contrib=-0.21
  - VIX: z_used=-1.29 (z1d=-0.67, z5d=-2.21, raw_w=0.18, norm_w=0.14) → contrib=-0.18
  - WTI: z_used=-1.72 (z1d=-1.37, z5d=-2.24, raw_w=0.10, norm_w=0.08) → contrib=-0.13
  - EMB: z_used=-1.43 (z1d=+0.65, z5d=+2.59, raw_w=0.12, norm_w=0.09) → contrib=-0.13
...
- **Today snapshot:** US10Y(4.281), DXY(98.019), VIX(18.03)
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.351 / US10YΔ -0.016 (정상)
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=1.07 → Phase=RISK-ON (완화 기대·리스크 선호)
...
- **Structure(3번):** `EASING` | **Price(Regime):** `RISK-ON` | **VIX:** `18.03`
- **Positioning Data:** Z-Score: `1.07` (>2.2 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 18.03 (NORMAL) | **Change:** -5.70%
...
**Context:** phase=RISK-ON (완화 기대·리스크 선호) / T10Y2Y=0.52 (MODERATE STEEP) / VIX=18.03 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.4957478839330366
- **Z-Score (5d):** 0.8237805745051319

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8223003776477804
- **Z-Score (5d):** 2.1825345212019007

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.1127967256454077
- **Z-Score (5d):** 2.139111122268706

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6246676612989864
- **Z-Score (5d):** 2.498846138910276

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.623371476228059
- **Z-Score (5d):** 1.2025305281840881

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9005382725735845
- **Z-Score (5d):** 1.7578532327216938

### GLD
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.5416299560249145
- **Z-Score (5d):** 0.33904978865107743

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.7600798359404384
- **Z-Score (5d):** 2.592652184175011

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.5655066093134324
- **Z-Score (5d):** -2.506562665472142
