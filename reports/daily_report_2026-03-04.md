...
- **달러 인덱스**: 98.983  (-0.07% vs 99.050)
- **WTI 유가**: 76.490  (+2.59% vs 74.560)
- **변동성 지수 (VIX)**: 24.010  (+1.87% vs 23.570)
- **원/달러 환율**: 1466.230  (+0.96% vs 1452.270)
...
- **VIX 레벨:** 24.01 → **High (Risk-off bias)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.040 / FCIΔ +0.000 / DXYΔ -0.067 / US10YΔ +0.000**
...
- **Top Drivers:**
  - USDCNH: z_used=+2.99 (w=0.18) → contrib=+0.54
  - WTI: z_used=+1.00 (w=0.10) → contrib=+0.10
  - GOLD: z_used=+0.55 (w=0.12) → contrib=+0.07
  - VIX: z_used=+0.12 (w=0.18) → contrib=+0.02
...
- **Today snapshot:** US10Y(4.056), DXY(98.983), VIX(24.01)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.040 / FCIΔ +0.000 / DXYΔ -0.067 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 22.828954146418035 (FEAR)
...
- **Narrative:** 구조=MIXED / 심리=FEAR / 유동성=증가/중간 / 크레딧=안정 → Phase=TRANSITION / MIXED (전환·혼조)
...
- **Context:** phase=TRANSITION / MIXED (전환·혼조) / liquidity=UP-MID / structure=MIXED / credit_calm=True
