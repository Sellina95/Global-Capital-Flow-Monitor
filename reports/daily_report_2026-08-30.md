...
Final Portfolio Decision: REDUCE / 43%
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **43%**
- **Base Context:** phase=SOFT RISK-OFF / narrative=REDUCE / base_exposure=43%
- **SEW:** STABLE / NORMAL
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=REDUCE 반영 → Tactical=REDUCE / Flow=⚡ BUILDING(5) / Drift=👀 EARLY DRIFT(2) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화

### 🚩 Market Regime Status
- **국면 전환 감지:** 🚨 **RISK-ON (부분 정렬)** → **SOFT RISK-OFF**
...
- **미국 10년물 금리**: 4.720  (+1.03% vs 4.672)
- **달러 인덱스**: 99.700  (+0.54% vs 99.160)
- **WTI 유가**: 83.400  (-0.16% vs 83.530)
- **변동성 지수 (VIX)**: 14.430 (-0.55% vs 14.510)
- **원/달러 환율**: 1380.450  (-0.22% vs 1383.490)
...
- **VIX 레벨:** 14.43 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.566 / level=EASY (완화) / update=low-frequency | as of: 2026-08-30 (latest available)
- **유인(Real Rates):** value=2.340 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-30 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.566 (low-frequency) / DXYΔ +0.540 / US10YΔ +0.048**
...
- **Liquidity as of:** 2026-08-26 (FRED latest)
- **NET_LIQ level:** 5780175.3
- **TGA level:** 950736.0
- **RRP level:** 0.702
...
- **Spread as of:** 2026-08-27 (FRED latest)
- **HY_OAS level:** 2.63% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -1.50%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.740 / prev 79.870 / pct -0.16%
- **LQD:** today 106.350 / prev 106.730 / pct -0.36%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +1.03%)** → 완화 기대 약화/금리 부담
- DXY **(Strong, +0.54%)** → 달러 강세/신흥국 부담
- WTI **(Mild, -0.16%)** → 물가 부담 완화
- VIX **(Mild, -0.55%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Clear, -0.22%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Mild, -0.16%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Mild, -0.36%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.22% / 5D=+0.48% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: MIXED | 1D=-0.16% / 5D=-4.20% | Strength: MEDIUM
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.52% / 5D=+0.89% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT UP | 1D=-1.73% / 5D=-2.04% | Strength: LOW
...
- **Cosine Similarity Score:** 0.237
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - China_Trade_2018: 0.237
  - Red_Sea: 0.204
  - Taiwan_Tension: 0.151
- **Top Drivers:**
  - USDCNH: z_used=+1.08 (z1d=+1.26, z5d=+0.80, raw_w=0.18, norm_w=0.14) → contrib=+0.15
  - GOLD: z_used=-0.91 (z1d=-1.11, z5d=-0.61, raw_w=0.12, norm_w=0.09) → contrib=-0.08
  - BDRY: z_used=+1.58 (z1d=+2.12, z5d=+0.77, raw_w=0.05, norm_w=0.04) → contrib=+0.06
  - KR10Y_SPREAD: z_used=-0.82 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.05
...
**핵심 신호:** 장단기차(39.00bp) | 실질금리(2.34%) | DXY(99.70)
*(as of: RealRate: 2026-08-30 / FRED last available)*
...
- **강도:** US10Y(Strong) / DXY(Strong) / WTI(Mild) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.720), DXY(99.700), VIX(14.43)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=0.5445676343184392 / GOLD=-1.731138459934924 / US10Y=1.0273942543162848 / VIX=-0.5513433662586605 / WTI=-0.1556294209478534
...
- **Input Check:** US10Y=4.71999979019165, RealYield=2.34, T10Y2Y=0.39, WTI=83.4000015258789, DXY=99.6999969482422, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.63, DriftLabel=NEUTRAL, FredAsof=2026-08-28
...
- **Breadth Note:** RSP-SPY return spread=-0.12%p → neutral breadth
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.26%p → neutral Nasdaq breadth
- **Positioning / Gamma:** 1
...
**Leadership Notes**
- QQQ-SPY spread=-0.42%p → growth leadership weak
- SMH-QQQ spread=-2.82%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-2.55%p → chip breadth lagging
- IWM-SPY spread=-1.13%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=0.61%p → sector diffusion positive
- XLI-SPY spread=-0.70%p → sector diffusion weak
- XLY-SPY spread=1.37%p → sector diffusion positive
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.566 (low-frequency) / DXYΔ +0.540 / US10YΔ +0.048 (정상)
- **Sentiment (Fear&Greed):** 70.23384586037146 (GREED)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=1.76 ⚠️ 수급 다소 과열 → Phase=SOFT RISK-OFF
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `SOFT RISK-OFF` | **Bucket:** `RISK-OFF` | **VIX:** `14.43`
- **Positioning Data:** Z-Score: `1.76` (>1.8 시 Run) | Gamma: `0.71` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 14.43 (NORMAL) | **Change:** -0.55%
...
**Context:** phase=SOFT RISK-OFF / T10Y2Y=0.39 (MODERATE STEEP) / VIX=14.43 (VOLATILITY CALM) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** SOFT_RISK_OFF_DISINFLATION
**Macro Inputs Debug:** phase=SOFT RISK-OFF / us10y_pct=+1.03% / dxy_pct=+0.54% / wti_pct=-0.16% / vix=14.43 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=5
...
**Overweight:** Health Care, Consumer Staples, Financials, Energy, Technology, Industrials

**Underweight:** Real Estate, Consumer Discretionary

**Scoreboard:**
- Health Care: +2.1  (+2 LIQ, +1.2 PHASE, = +2.1)
- Consumer Staples: +1.8  (+2 LIQ, +0.8 PHASE, = +1.8)
- Financials: +1.4  (+2 CURVE, +1 MOM, = +1.4)
- Energy: +0.3  (+1 MOM, = +0.3)
- Technology: +0.2  (+2 VOL, -2 LIQ, +0.5 PHASE, +1.5 FLOW, -1 MOM, = +0.2)
- Industrials: +0.2  (+1 CURVE, -0.5 PHASE, +1 FLOW, -1 MOM, = +0.2)
- Consumer Discretionary: -0.9  (+1 VOL, -1 LIQ, -0.5 PHASE, -1 MOM, = -0.9)
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.70, dispersion=1.24)
...
- Health Care: FLOW_WEAK (theory=+3.2, flow=+0.0, final=+2.1)
- Consumer Staples: FLOW_WEAK (theory=+2.8, flow=+0.0, final=+1.8)
...
- Consumer Discretionary: AVOID (theory=-0.5, flow=-0.7, final=-0.9)
...
| :--- | :---: | :---: | :---: | :--- |
| Health Care | +2.1 | NEGATIVE_DIVERGENCE | **11.9%** | DELEVERAGE |
| Consumer Staples | +1.8 | NEGATIVE_DIVERGENCE | **6.3%** | DELEVERAGE |
| Financials | +1.4 | NEGATIVE_DIVERGENCE | **0.0%** | DELEVERAGE |
| Energy | +0.3 | POSITIVE_DIVERGENCE | **0.0%** | DELEVERAGE |
| Technology | +0.2 | ALIGNED | **0.0%** | DELEVERAGE |
| Industrials | +0.2 | ALIGNED | **0.0%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **81.8%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** SOFT_RISK_OFF_DISINFLATION
- **Participation / Quality Cap Applied:**
  - Financials: 9.6% → 0.0% (-9.6%)
  - Energy: 6.9% → 0.0% (-6.9%)
  - Technology: 4.6% → 0.0% (-4.6%)
  - Industrials: 3.7% → 0.0% (-3.7%)
- **Strategic Cash (15):** 57.0%
- **Tactical Reserve (Cap / Unallocated):** 24.8%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=3.59, score=1.8, weight=6.3%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.33, score=2.1, weight=11.9%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.31, score=1.38, weight=0.0%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Industrials (priority_score=1.41, score=0.19, weight=0.0%, div=ALIGNED, mom=-1)
5. Technology (priority_score=1.38, score=0.24, weight=0.0%, div=ALIGNED, mom=-1)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Energy (priority_score=2.81, score=0.31, weight=0.0%, div=POSITIVE_DIVERGENCE, mom=1)
2. Technology (priority_score=0.24, score=0.24, weight=0.0%, div=ALIGNED, mom=-1)
3. Industrials (priority_score=0.19, score=0.19, weight=0.0%, div=ALIGNED, mom=-1)
4. Financials (priority_score=-0.12, score=1.38, weight=0.0%, div=NEGATIVE_DIVERGENCE, mom=1)
5. Health Care (priority_score=-0.90, score=2.1, weight=11.9%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Health Care | XLV | 11.9% | DEFENSIVE_QUALITY | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Consumer Staples | XLP | 6.3% | DEFENSIVE_BUFFER | NEGATIVE_DIVERGENCE | FLOW_WEAK |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.2604516722442574
- **Z-Score (5d):** 0.32909069375563105

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.32236521898388987
- **Z-Score (5d):** 0.06531796088040343

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8511595248034624
- **Z-Score (5d):** 0.3383043469873779

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7313828904921816
- **Z-Score (5d):** 0.33514374021059257

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.015259784679008659
- **Z-Score (5d):** 0.15594625709613727

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6588611393654351
- **Z-Score (5d):** -0.34019380544127603

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.9047581475284125
- **Z-Score (5d):** -1.006072697799981

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.3076937994739024
- **Z-Score (5d):** 0.17279188476907778

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6268495427409767
- **Z-Score (5d):** -0.19589248668374723
