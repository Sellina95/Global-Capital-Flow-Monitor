...
- **Portfolio Stance:** REDUCE (POS_OVERHEATED) / 54%
...
- **Final Exposure:** **54%**
- **Base Context:** phase=TRANSITION / MIXED (전환·혼조) / narrative=REDUCE (POS_OVERHEATED) / base_exposure=54%
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 1 → 경미한 이상신호, 모니터링 강화 → Tactical=HOLD / Flow=NO CLEAR FLOW(0) / Drift=NO DRIFT(0) / Gamma=🟢 POSITIVE GAMMA → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 4.364  (-0.64% vs 4.392)
- **달러 인덱스**: 97.840  (-0.42% vs 98.250)
- **WTI 유가**: 95.420  (+0.64% vs 94.810)
- **변동성 지수 (VIX)**: 17.190  (+0.64% vs 17.080)
- **원/달러 환율**: 1454.790  (+0.72% vs 1444.450)
...
- **VIX 레벨:** 17.19 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-05-11 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-05-11 (FRED last available)
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.410 / US10YΔ -0.028**
...
- **Spread as of:** 2026-05-07 (FRED latest)
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 80.140 / prev 79.860 / pct 0.35%
- **LQD:** today 109.200 / prev 108.740 / pct 0.42%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, -0.64%)** → 완화 기대 강화
- DXY **(Strong, -0.42%)** → 달러 약세/리스크 선호
- WTI **(Clear, +0.64%)** → 인플레 재자극 가능성
- VIX **(Mild, +0.64%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, +0.72%)** → 원화 약세/수급 부담
...
- **SPY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.81% / 5D=+2.34% | Strength: LOW
- **WTI:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+4.94% / 5D=-5.91% | Strength: HIGH
- **DXY:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.30% / 5D=-0.35% | Strength: LOW
- **GOLD:** 🟡 PULLBACK | Short-term: MIXED | 1D=-0.82% / 5D=+3.59% | Strength: MEDIUM
...
- **Cosine Similarity Score:** -0.077
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Ukraine_2022: -0.077
  - Red_Sea: -0.080
  - Taiwan_Tension: -0.100
- **Top Drivers:**
  - EEM: z_used=-1.15 (z1d=+1.00, z5d=+1.39, raw_w=0.10, norm_w=0.08) → contrib=-0.09
  - KR10Y_SPREAD: z_used=-1.33 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.08
  - USDCNH: z_used=-0.51 (z1d=-0.45, z5d=-0.59, raw_w=0.18, norm_w=0.14) → contrib=-0.07
  - DE10Y_SPREAD: z_used=-1.35 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.06
...
- **Dealer Gamma Bias:** 1.69 (STABILIZING / dealer gamma proxy supportive)
...
**핵심 신호:** 장단기차(48.00bp) | 실질금리(1.96%) | DXY(97.84)
...
- **Today snapshot:** US10Y(4.364), DXY(97.840), VIX(17.19)
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.410 / US10YΔ -0.028 (정상)
- **Sentiment (Fear&Greed):** 59.979083849552666 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=NO DRIFT (REOPENING / DEMAND_BOOM) / 수급=2.17 ⚠️ 수급 과열 감지 → Phase=TRANSITION / MIXED (전환·혼조)
...
- **Structure(3번):** `EASING` | **Price(Regime):** `TRANSITION / MIXED` | **Bucket:** `MIXED` | **VIX:** `17.19`
- **Positioning Data:** Z-Score: `2.17` (>1.8 시 Run) | Gamma: `1.69` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.17), Position Unwind, Positive Gamma(1.69)
...
**Context:** phase=TRANSITION / MIXED (전환·혼조) / T10Y2Y=0.48 (MODERATE STEEP) / VIX=17.19 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** BALANCED
**Macro Inputs Debug:** phase=TRANSITION / MIXED (전환·혼조) / us10y_pct=-0.64% / dxy_pct=-0.42% / wti_pct=+0.64% / vix=17.19 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=0
...
- **Strategic Exposure (15):** **54.0%** → **Regime Adjusted:** **48.6%**
- **Exposure Override:** THEORY_MARKET → 거시 논리 우세, 총노출 10% 축소

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.4 | ALIGNED | **27.5%** | HOLD |
| Industrials | +1.3 | NEGATIVE_DIVERGENCE | **4.7%** | HOLD |
| Consumer Discretionary | +0.7 | ALIGNED | **7.0%** | HOLD |
| Consumer Staples | +0.3 | ALIGNED | **3.3%** | HOLD |
| Health Care | +0.3 | ALIGNED | **3.3%** | HOLD |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9999048283402424
- **Z-Score (5d):** 1.38539021248396

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.7423524137368928
- **Z-Score (5d):** 0.8795706121235422

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.4979207939309331
- **Z-Score (5d):** 0.5714989157655872

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8393557942324323
- **Z-Score (5d):** 1.3845294146646998

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.18358893845831184
- **Z-Score (5d):** 0.6659785205104298

### GLD
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.30653155168498203
- **Z-Score (5d):** 0.7262043895568938

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.7580532530269136
- **Z-Score (5d):** 0.8740150829349346

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.09664020720736885
- **Z-Score (5d):** -0.2258118090957132
