...
- **달러 인덱스**: 97.053  (+0.00% vs 97.049)
- **WTI 유가**: 63.370  (-0.06% vs 63.410)
- **변동성 지수 (VIX)**: 20.980  (-0.33% vs 21.050)
- **원/달러 환율**: 1443.860  (+0.02% vs 1443.610)
...
- **VIX 레벨:** 20.98 → **High (Risk-off bias)**
...
- **Today snapshot:** US10Y(4.056), DXY(97.053), VIX(20.98)
