...
- **달러 인덱스**: 97.049  (+0.04% vs 97.008)
- **WTI 유가**: 63.410  (+0.38% vs 63.170)
- **변동성 지수 (VIX)**: 21.050  (+1.89% vs 20.660)
- **원/달러 환율**: 1443.610  (+0.03% vs 1443.150)
...
- **VIX 레벨:** 21.05 → **High (Risk-off bias)**
...
- **Policy Bias: MIXED (혼조) (Real rates → / DXY ↑ / FCI →)**
- **Expectations:** N/A (no data attached)
...
- WTI **(Mild, +0.38%)** → 인플레 재자극 가능성
- VIX **(Clear, +1.89%)** → 심리 악화/리스크오프
...
- **Today snapshot:** US10Y(4.056), DXY(97.049), VIX(21.05)
