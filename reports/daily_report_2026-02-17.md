...
- **달러 인덱스**: 97.083  (+0.03% vs 97.053)
- **WTI 유가**: 63.730  (+0.57% vs 63.370)
- **변동성 지수 (VIX)**: 21.200  (+1.05% vs 20.980)
- **원/달러 환율**: 1442.810  (-0.07% vs 1443.860)
...
- **VIX 레벨:** 21.20 → **High (Risk-off bias)**
...
- WTI **(Mild, +0.57%)** → 인플레 재자극 가능성
- VIX **(Mild, +1.05%)** → 심리 악화/리스크오프
...
- **Today snapshot:** US10Y(4.056), DXY(97.083), VIX(21.20)
