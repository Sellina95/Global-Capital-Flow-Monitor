...
🧭 1. Executive Summary
Markets are operating in a RISK-ON / REFLATION regime as liquidity conditions remain down and volatility pressures have increased. Participation remains ⚡ BUILDING, while positioning risk sits at 1.6. Maintain disciplined exposure and avoid adding marginal risk.
...
- **Final Action:** **EXIT**
- **Final Exposure:** **0%**
- **Base Context:** phase=RISK-ON / REFLATION / narrative=HOLD / base_exposure=74%
- **SEW:** DEADMAN / NORMAL
...
- **Why:** SEW DEADMAN 발동 → 즉시 EXIT / 익스포저 0% → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=HOLD / Flow=⚡ BUILDING(5) / Drift=⚡ STRUCTURAL DRIFT(5) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **현실(FCI):** value=-0.554 / level=EASY (완화) / update=low-frequency | as of: 2026-08-02 (latest available)
- **유인(Real Rates):** value=2.410 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-02 (latest available)
...
- **WTI:** 🟡 REBOUND | Short-term: MIXED | 1D=+1.29% / 5D=-5.20% | Strength: MEDIUM
- **DXY:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-0.21% / 5D=-1.64% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: MIXED | 1D=+0.17% / 5D=+0.97% | Strength: LOW
...
- **Top Similarity Matches:**
  - Red_Sea: -0.130
  - Iran_Crisis_2020: -0.231
  - Ukraine_2022: -0.322
- **Top Drivers:**
  - USDJPY: z_used=+5.01 (z1d=-5.68, z5d=-4.00, raw_w=0.05, norm_w=0.04) → contrib=+0.19
  - USDCNH: z_used=-1.28 (z1d=-1.58, z5d=-0.84, raw_w=0.18, norm_w=0.14) → contrib=-0.18
...
*(as of: RealRate: 2026-08-02 / FRED last available)*
...
- **Meaningful Move Check:** DXY=-0.209978082178851 / GOLD=0.16828619251745117 / US10Y=1.7585197698746908 / VIX=-6.436514755110501 / WTI=1.2920228237468314
- **판정:** **NEUTRAL**
...
- **Narrative:** 구조=MIXED / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.60 ⚠️ 수급 다소 과열 → Phase=RISK-ON / REFLATION
...
- **Positioning Data:** Z-Score: `1.60` (>2.2 시 Run) | Gamma: `0.96` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Strategic Exposure (15):** **74.0%** → **Regime Adjusted:** **74.0%**
- **Exposure Override:** BALANCED → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.1 | NEGATIVE_DIVERGENCE | **10.0%** | HOLD |
| Health Care | +1.1 | NEGATIVE_DIVERGENCE | **10.0%** | HOLD |
| Financials | +1.0 | NEGATIVE_DIVERGENCE | **0.0%** | NEW |
| Energy | +0.6 | POSITIVE_DIVERGENCE | **0.0%** | NEW |
| Industrials | +0.5 | ALIGNED | **0.0%** | NEW |
| Communication Services | +0.3 | ALIGNED | **0.0%** | NEW |
| Utilities | +0.3 | ALIGNED | **7.7%** | HOLD |
| **Cash & Hedge** | - | - | **72.3%** | DEFENSIVE |
...
- **Strategic Cash (15):** 26.0%
- **Tactical Reserve (Cap / Unallocated):** 46.3%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=4.37, score=1.08, weight=10.0%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=4.37, score=1.08, weight=10.0%, div=NEGATIVE_DIVERGENCE, mom=0)
...
5. Utilities (priority_score=0.41, score=0.3, weight=7.7%, div=ALIGNED, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 10.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
