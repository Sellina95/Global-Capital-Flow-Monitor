...
- **현실(FCI):** value=-0.494 / level=EASY (완화) / update=low-frequency | as of: 2026-06-08 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ N/A / FCI value=-0.494 (low-frequency) / DXYΔ +0.660 / US10YΔ +0.059**
...
- **Top Drivers:**
  ...
  - GOLD: z_used=-1.37 (z1d=-1.63, z5d=-0.98, raw_w=0.12, norm_w=0.09) → contrib=-0.13
...
- **Meaningful Move Check:** DXY=0.6639130956660497 / GOLD=-3.0988809393572505 / US10Y=1.3178363927808552 / VIX=39.67532962143467 / WTI=-2.687016310618692
...
- **Input Check:** US10Y=4.535999774932861, RealYield=nan, T10Y2Y=nan, WTI=90.54000091552734, DXY=100.06999969482422, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.74, DriftLabel=NEUTRAL, FredAsof=2026-06-05
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ N/A / FCI value=-0.494 (low-frequency) / DXYΔ +0.660 / US10YΔ +0.059 (정상)
...
- **Positioning Data:** Z-Score: `1.76` (>1.8 시 Run) | Gamma: `0.94` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.4176732278691357
- **Z-Score (5d):** -0.7050733065175234
