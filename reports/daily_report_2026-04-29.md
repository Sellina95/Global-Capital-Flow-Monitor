...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=HOLD 반영 → Tactical=WAIT / Flow=NO CLEAR FLOW(0) / Drift=NO DRIFT(0) / Gamma=🟢 POSITIVE GAMMA (WEAK) → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-29 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-29 (FRED last available)
...
- **Spread as of:** 2026-04-27 (FRED latest)
...
- **방향(전일 대비):** HYG(↑) / LQD(↓)
- **HYG:** today 80.510 / prev 80.480 / pct 0.04%
- **LQD:** today 109.290 / prev 109.600 / pct -0.28%
...
- **SPY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.49% / 5D=+1.08% | Strength: LOW
- **WTI:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.57% / 5D=+6.88% | Strength: MEDIUM
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.05% / 5D=+0.08% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.46% / 5D=-2.54% | Strength: LOW
...
- **Cosine Similarity Score:** 0.357
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - China_Trade_2018: 0.357
  - Taiwan_Tension: 0.309
  - Red_Sea: 0.194
- **Top Drivers:**
  ...
  - KR10Y_SPREAD: z_used=-0.84 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.05
  - IL10Y_SPREAD: z_used=-1.08 (mode=level, raw_w=0.05, norm_w=0.04) → contrib=-0.04
...
**핵심 신호:** 장단기차(52.00bp) | 실질금리(1.91%) | DXY(98.48)
*(as of: RealRate: 2026-04-29 / FRED last available)*
...
- **Sentiment (Fear&Greed):** 64.36463139414272 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=NO DRIFT (GROWTH_SCARE) / 수급=1.58 ⚠️ 수급 다소 과열 → Phase=RISK-ON (부분 정렬)
...
- **Positioning Data:** Z-Score: `1.58` (>2.2 시 Run) | Gamma: `2.20` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
**Context:** phase=RISK-ON (부분 정렬) / T10Y2Y=0.52 (MODERATE STEEP) / VIX=18.02 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True
...
**Underweight:** Real Estate, Energy, Consumer Discretionary
...
- Energy: -2  (-2 MOM, = -2)
- Real Estate: -2.5  (-1.5 LIQ, -1 MOM, = -2.5)
...
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +2 | ALIGNED | **11.2%** | SMALL ADJUST |
| Health Care | +2 | ALIGNED | **10.5%** | HOLD |
| Industrials | +1.7 | ALIGNED | **9.5%** | SMALL ADJUST |
| Technology | +1.5 | ALIGNED | **10.2%** | HOLD |
| Utilities | +1 | ALIGNED | **6.8%** | HOLD |
| **Cash & Hedge** | - | - | **51.8%** | DEFENSIVE |
...
1. Consumer Staples (priority_score=0.18, score=2, weight=11.2%, div=ALIGNED, mom=0)
2. Health Care (priority_score=-0.17, score=2, weight=10.5%, div=ALIGNED, mom=0)
3. Utilities (priority_score=-0.3, score=1, weight=6.8%, div=ALIGNED, mom=0)
4. Industrials (priority_score=-0.51, score=1.7, weight=9.5%, div=ALIGNED, mom=0)
5. Technology (priority_score=-1.17, score=1.5, weight=10.2%, div=ALIGNED, mom=2)
...
2. Consumer Staples (priority_score=2.00, score=2, weight=11.2%, div=ALIGNED, mom=0)
3. Health Care (priority_score=2.00, score=2, weight=10.5%, div=ALIGNED, mom=0)
4. Industrials (priority_score=1.70, score=1.7, weight=9.5%, div=ALIGNED, mom=0)
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.12209609778716983
- **Z-Score (5d):** -0.21488402478427163

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6374913919044541
- **Z-Score (5d):** 0.1926917694609943

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.19936718072048545
- **Z-Score (5d):** 0.12708954913325415

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.19919675599539194
- **Z-Score (5d):** -0.2518551405284462

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.11130299710486842
- **Z-Score (5d):** 0.06698504994724963

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -0.33423635253986567
- **Z-Score (5d):** -0.6121552457993188

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8186739440924183
- **Z-Score (5d):** -0.22759264388729933

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.5644081359478434
- **Z-Score (5d):** 0.3921757781218523

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.45657748986920266
- **Z-Score (5d):** -0.8222959432698105
