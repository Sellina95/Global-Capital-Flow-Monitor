...
- **미국 10년물 금리**: 4.147  (-1.21% vs 4.198)
- **달러 인덱스**: 96.856  (-0.01% vs 96.866)
- **WTI 유가**: 64.200  (-0.34% vs 64.420)
- **변동성 지수 (VIX)**: 17.790  (+2.48% vs 17.360)
- **원/달러 환율**: 1456.210  (-0.23% vs 1459.500)
...
- **VIX 레벨:** 17.79 → **Mid (Neutral/Mixed)**
...
- **근거:** 금리↓ + 달러↓ → 통화환경 완화 기대 확대 / 정책 불확실성 확대(VIX↑)
...
- **Spread as of:** 2026-02-09 (FRED latest)
...
- **방향(전일 대비):** HYG(↓) / LQD(↑)
- **HYG:** today 80.840 / prev 80.920 / pct -0.10%
- **LQD:** today 110.820 / prev 110.560 / pct 0.24%
...
- 미국 금리(US10Y) **(Strong, -1.21%)** → 완화 기대 강화
- DXY **(Noise, -0.01%)** → 달러 약세/리스크 선호
- WTI **(Mild, -0.34%)** → 물가 부담 완화
- VIX **(Clear, +2.48%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Clear, -0.23%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Noise, -0.10%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Mild, +0.24%)** → 우량채 강세(리스크오프 성향)
...
- **강도:** US10Y(Strong) / DXY(Noise) / WTI(Mild) / VIX(Clear)
...
- **Today snapshot:** US10Y(4.147), DXY(96.856), VIX(17.79)
