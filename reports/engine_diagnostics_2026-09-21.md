...
- **현실(FCI):** value=-0.560 / level=EASY (완화) / update=low-frequency | as of: 2026-09-21 (latest available)
- **유인(Real Rates):** value=2.610 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-21 (latest available)
...
- **WTI:** 🔴 DOWN | Short-term: MIXED | 1D=-6.06% / 5D=-7.07% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.11% / 5D=+0.87% | Strength: LOW
- **GOLD:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.72% / 5D=+0.95% | Strength: LOW
...
- **Cosine Similarity Score:** -0.097
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.097
  - China_Trade_2018: -0.227
  - Iran_Crisis_2020: -0.266
- **Top Drivers:**
  ...
  - VIX: z_used=-0.62 (z1d=-0.61, z5d=-0.63, raw_w=0.18, norm_w=0.14) → contrib=-0.09
...
*(as of: RealRate: 2026-09-21 / FRED last available)*
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.64 ⚠️ 수급 다소 과열 → Phase=TRANSITION / MIXED
...
- **Positioning Data:** Z-Score: `1.64` (>1.8 시 Run) | Gamma: `1.62` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Positioning Heat(1.64), Positive Gamma(1.62)
...
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=+1.03% / dxy_pct=+0.00% / wti_pct=-1.58% / vix=14.81 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=6
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.4287026336249575
- **Z-Score (5d):** 0.2709456074019906
