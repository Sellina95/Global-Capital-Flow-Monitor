...
- **국면 전환 감지:** 🚨 **RISK-OFF (부분 정렬)** → **RISK-OFF (긴축/불안·리스크 회피)**

---

## 📊 Daily Macro Signals

- **미국 10년물 금리**: 4.292  (+0.99% vs 4.250)
- **달러 인덱스**: 98.399  (+0.36% vs 98.050)
- **WTI 유가**: 89.270  (-0.38% vs 89.610)
- **변동성 지수 (VIX)**: 19.500  (+3.34% vs 18.870)
- **원/달러 환율**: 1479.580  (+0.98% vs 1465.150)
...
- **VIX 레벨:** 19.50 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-22 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-22 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.349 / US10YΔ +0.042**
...
- **Spread as of:** 2026-04-20 (FRED latest)
- **HY_OAS level:** 2.87% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↑) / +1.41%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 80.370 / prev 80.580 / pct -0.26%
- **LQD:** today 109.610 / prev 110.030 / pct -0.38%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +0.99%)** → 완화 기대 약화/금리 부담
- DXY **(Strong, +0.36%)** → 달러 강세/신흥국 부담
- WTI **(Mild, -0.38%)** → 물가 부담 완화
- VIX **(Strong, +3.34%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, +0.98%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, -0.26%)** → 크레딧 스트레스↑
...
- **SPY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.65% / 5D=+1.39% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-0.40% / 5D=-2.22% | Strength: LOW
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.36% / 5D=+0.28% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT UP | 1D=-0.62% / 5D=-0.99% | Strength: LOW
...
- **Cosine Similarity Score:** 0.465
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - China_Trade_2018: 0.465
  - Taiwan_Tension: 0.378
  - Ukraine_2022: 0.224
- **Top Drivers:**
  - EMB: z_used=+0.72 (z1d=-0.97, z5d=-0.34, raw_w=0.12, norm_w=0.09) → contrib=+0.07
  - USDCNH: z_used=+0.40 (z1d=+0.54, z5d=+0.20, raw_w=0.18, norm_w=0.14) → contrib=+0.06
  - EEM: z_used=+0.60 (z1d=-0.88, z5d=-0.18, raw_w=0.10, norm_w=0.08) → contrib=+0.05
  - ITA: z_used=-2.01 (z1d=-2.25, z5d=-1.65, raw_w=0.03, norm_w=0.02) → contrib=-0.05
...
- **Country ETF Crash?** Yes (EWJ, VXX)
- **Extreme Country Risk:** EWJ, VXX
...
**핵심 신호:** 장단기차(52.00bp) | 실질금리(1.91%) | DXY(98.40)
*(as of: RealRate: 2026-04-22 / FRED last available)*
...
- **Today snapshot:** US10Y(4.292), DXY(98.399), VIX(19.50)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↓)
- **Meaningful Move Check:** DXY=0.3559398394442699 / GOLD=-0.6054195702787822 / US10Y=0.9882309857536764 / VIX=3.3386281544659195 / WTI=-0.3794263642108264
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.349 / US10YΔ +0.042 (정상)
- **Sentiment (Fear&Greed):** 57.89136598889938 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=NO DRIFT (GROWTH_SCARE) / 수급=1.47 → Phase=RISK-OFF (긴축/불안·리스크 회피)
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `RISK-OFF` | **VIX:** `19.50`
- **Positioning Data:** Z-Score: `1.47` (>1.8 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 19.50 (NORMAL) | **Change:** +3.34%
...
**Context:** phase=RISK-OFF (긴축/불안·리스크 회피) / T10Y2Y=0.52 (MODERATE STEEP) / VIX=19.50 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
**Overweight:** Industrials, Technology, Consumer Discretionary, Consumer Staples, Financials, Health Care, Real Estate

**Underweight:** Energy, Utilities

**Scoreboard:**
- Industrials: +3  (+2 LIQ, +1 CURVE, = +3)
- Technology: +3  (+2 LIQ, -1 PHASE, +2 MOM, = +3)
...
| :--- | :---: | :---: | :---: | :--- |
| Industrials | +2.7 | ALIGNED | **8.1%** | HOLD |
| Technology | +3.5 | ALIGNED | **10.6%** | ACCUMULATE |
| Consumer Discretionary | +1.7 | ALIGNED | **5.1%** | HOLD |
| Consumer Staples | +1 | ALIGNED | **3.0%** | HOLD |
| Financials | +1 | NEGATIVE_DIVERGENCE | **2.1%** | HOLD |
| Health Care | +1 | ALIGNED | **3.0%** | HOLD |
| Real Estate | +1 | ALIGNED | **3.0%** | HOLD |
| **Cash & Hedge** | - | - | **65.1%** | DEFENSIVE |
...
| Technology | XLK | 10.6% | ADD |
| Consumer Discretionary | XLY | 5.1% | SMALL |
| Consumer Staples | XLP | 3.0% | SMALL |
| Financials | XLF | 2.1% | SMALL |
| Health Care | XLV | 3.0% | SMALL |
| Real Estate | XLRE | 3.0% | SMALL |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.2117291133219226
- **Z-Score (5d):** -0.6461565956835518

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.882943879748281
- **Z-Score (5d):** -0.1848338311310454

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.1405250810485352
- **Z-Score (5d):** -0.43097261046971613

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.032134411263096
- **Z-Score (5d):** -0.45710410352279823

### EWJ
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -1.4932609374721115
- **Z-Score (5d):** -0.8851191930035714

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0690695404285666
- **Z-Score (5d):** 0.36742910073574303

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0569268501555318
- **Z-Score (5d):** -0.6592227287114313

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7369355289886014
- **Z-Score (5d):** 0.5313996490358343

### VXX
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.35270315590285406
- **Z-Score (5d):** 0.17292605972105438
