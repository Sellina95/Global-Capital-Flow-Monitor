...
- **WTI:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+0.91% / 5D=-3.24% | Strength: MEDIUM
- **DXY:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.22% / 5D=-0.33% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.32% / 5D=+3.90% | Strength: MEDIUM
...
- **Meaningful Move Check:** DXY=0.10221392810588373 / GOLD=-0.03600769143322094 / US10Y=1.0540789519547211 / VIX=6.9226212317521725 / WTI=2.77719720889844
- **판정:** **NEUTRAL**
...
**Macro Inputs Debug:** phase=SOFT RISK-OFF (경계 강화) / us10y_pct=+1.05% / dxy_pct=+0.10% / wti_pct=+2.78% / vix=18.38 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=0
