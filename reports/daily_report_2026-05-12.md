...
- **Final Action:** **REDUCE**
- **Final Exposure:** **23%**
- **Base Context:** phase=SOFT RISK-OFF (경계 강화) / narrative=REDUCE / base_exposure=30%
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 2 → 익스포저 15% haircut → Tactical=REDUCE / Flow=NO CLEAR FLOW(0) / Drift=WEAK DRIFT (노이즈 가능)(1) / Gamma=🟢 POSITIVE GAMMA (WEAK) → Tactical REDUCE → 방어 기조 유지 / 익스포저 5% 추가 축소
...
- **달러 인덱스**: 97.996  (+0.16% vs 97.840)
- **WTI 유가**: 98.320  (+3.04% vs 95.420)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.156 / US10YΔ +0.046**
...
- **WTI:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+3.06% / 5D=-7.59% | Strength: HIGH
- **DXY:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.16% / 5D=-0.48% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT UP | 1D=+1.08% / 5D=+5.57% | Strength: MEDIUM
...
- **Top Similarity Matches:**
  - Red_Sea: 0.436
  - Ukraine_2022: 0.350
  - Iran_Crisis_2020: 0.301
- **Top Drivers:**
  - GOLD: z_used=+0.93 (z1d=+0.58, z5d=+1.46, raw_w=0.12, norm_w=0.09) → contrib=+0.09
...
**핵심 신호:** 장단기차(47.00bp) | 실질금리(1.93%) | DXY(98.00)
...
- **Today snapshot:** US10Y(4.410), DXY(97.996), VIX(18.38)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↑) / VIX(↑) / WTI(↑)
- **Meaningful Move Check:** DXY=0.15944998488780954 / GOLD=1.0613528237591596 / US10Y=1.0540789519547211 / VIX=6.9226212317521725 / WTI=3.039196794726731
- **판정:** **NEUTRAL**
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.156 / US10YΔ +0.046 (정상)
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=WEAK DRIFT (노이즈 가능) (REOPENING / DEMAND_BOOM) / 수급=2.24 ⚠️ 수급 과열 감지 → Phase=SOFT RISK-OFF (경계 강화)
...
- **Positioning Data:** Z-Score: `2.24` (>1.8 시 Run) | Gamma: `1.90` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.24), Positive Gamma(1.90)
...
**Macro Inputs Debug:** phase=SOFT RISK-OFF (경계 강화) / us10y_pct=+1.05% / dxy_pct=+0.16% / wti_pct=+3.04% / vix=18.38 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=0
...
- **Strategic Exposure (15):** **30.0%** → **Regime Adjusted:** **25.5%**
...
| Industrials | +0.7 | NEGATIVE_DIVERGENCE | **2.7%** | HOLD |
| Materials | +0.2 | ALIGNED | **2.6%** | SMALL ADJUST |
| Consumer Discretionary | +0.1 | ALIGNED | **1.4%** | HOLD |
| **Cash & Hedge** | - | - | **81.3%** | DEFENSIVE |
...
1. Industrials (priority_score=6.17, score=0.6699999999999999, weight=2.7%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Discretionary (priority_score=-0.05, score=0.10999999999999999, weight=1.4%, div=ALIGNED, mom=0)
3. Materials (priority_score=-0.1, score=0.21, weight=2.6%, div=ALIGNED, mom=0)
4. Technology (priority_score=-1.64, score=1.47, weight=12.0%, div=ALIGNED, mom=2)
...
2. Materials (priority_score=0.21, score=0.21, weight=2.6%, div=ALIGNED, mom=0)
3. Consumer Discretionary (priority_score=0.11, score=0.10999999999999999, weight=1.4%, div=ALIGNED, mom=0)
4. Industrials (priority_score=-2.33, score=0.6699999999999999, weight=2.7%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| Materials | XLB | 2.6% | MICRO | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.37354811001761207
- **Z-Score (5d):** 0.8954428393186871
