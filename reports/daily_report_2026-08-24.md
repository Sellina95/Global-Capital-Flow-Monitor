...
🧭 1. Executive Summary
Markets are operating in a EVENT-WATCHING / INFLATION regime as liquidity conditions are tightening and volatility pressures have eased. Participation remains 🔥 BUILDING HARD, while positioning risk sits at 1.8. Maintain disciplined exposure and avoid adding marginal risk.
...
Equities: ⚪ N/A — no canonical PM state
US10Y Yield: 🔺 Rising
USD: 🔺 Stronger
Oil: 🔺 Rising
Volatility: 🔻 Falling
...
Current market is best described as 'INFLATION_PRESSURE'.
...
Final Portfolio Decision: HOLD / 54%
Tactical Signal: HOLD / NONE
Tactical Confidence: LOW
Tactical Rationale:
...
🏁 10. Final PM View
Final Portfolio Action: HOLD
Final Portfolio Exposure: 54%
Strategic Phase: EVENT-WATCHING / INFLATION
...
- **Final Action:** **HOLD**
- **Final Exposure:** **54%**
- **Base Context:** phase=EVENT-WATCHING / INFLATION / narrative=HOLD / base_exposure=54%
- **SEW:** STABLE / NORMAL
...
- **Warning Score:** 2 (6.5 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=HOLD 반영 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=HOLD / Flow=🔥 BUILDING HARD(7) / Drift=⚡ STRUCTURAL DRIFT(6) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 4.738  (+0.89% vs 4.696)
- **달러 인덱스**: 98.800  (+0.03% vs 98.769)
- **WTI 유가**: 87.060  (+0.32% vs 86.780)
- **변동성 지수 (VIX)**: 15.130 (-5.50% vs 16.010)
- **원/달러 환율**: 1390.790  (+0.10% vs 1389.400)
...
- **VIX 레벨:** 15.13 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.559 / level=EASY (완화) / update=low-frequency | as of: 2026-08-24 (latest available)
- **유인(Real Rates):** value=2.350 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-24 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.559 (low-frequency) / DXYΔ +0.031 / US10YΔ +0.042**
...
- **Liquidity as of:** 2026-08-19 (FRED latest)
- **NET_LIQ level:** 5792086.7
- **TGA level:** 953612.0
- **RRP level:** 0.317
...
- **Spread as of:** 2026-08-20 (FRED latest)
- **HY_OAS level:** 2.75% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↑) / +0.73%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↑) / LQD(↓)
- **HYG:** today 79.610 / prev 79.560 / pct 0.06%
- **LQD:** today 105.920 / prev 106.060 / pct -0.13%
...
- 미국 금리(US10Y) **(Strong, +0.89%)** → 완화 기대 약화/금리 부담
- DXY **(Noise, +0.03%)** → 달러 강세/신흥국 부담
- WTI **(Mild, +0.32%)** → 인플레 재자극 가능성
- VIX **(Strong, -5.50%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Mild, +0.10%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, +0.06%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Mild, -0.13%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+0.41% / 5D=-1.37% | Strength: LOW
- **WTI:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-1.87% / 5D=+1.10% | Strength: LOW
- **DXY:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+0.01% / 5D=-0.83% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT UP | 1D=+1.79% / 5D=+6.54% | Strength: MEDIUM
...
- **Geo Stress Score (z-composite):** **-0.38**  *(Level: NORMAL)*
...
- **Cosine Similarity Score:** 0.248
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: 0.248
  - China_Trade_2018: 0.189
  - Ukraine_2022: 0.166
- **Top Drivers:**
  - USDCNH: z_used=-0.94 (z1d=-0.92, z5d=-0.96, raw_w=0.18, norm_w=0.14) → contrib=-0.13
  - GOLD: z_used=+0.92 (z1d=+0.59, z5d=+1.40, raw_w=0.12, norm_w=0.09) → contrib=+0.08
  - SEA: z_used=-2.19 (z1d=+2.19, z5d=+2.18, raw_w=0.05, norm_w=0.04) → contrib=-0.08
  - KR10Y_SPREAD: z_used=-1.23 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.08
...
- **Country ETF Crash?** Yes (EWJ, GLD)
- **Extreme Country Risk:** EWJ, GLD
...
- **Dealer Gamma Bias:** 1.19 (NEUTRAL / transition zone)
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(2.35%) | DXY(98.80)
*(as of: RealRate: 2026-08-24 / FRED last available)*
...
- **강도:** US10Y(Strong) / DXY(Noise) / WTI(Mild) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.738), DXY(98.800), VIX(15.13)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↑) / VIX(↓) / WTI(↑)
- **Meaningful Move Check:** DXY=0.0313922994627622 / GOLD=1.051138497732736 / US10Y=0.894374276138667 / VIX=-5.496565283324662 / WTI=0.32265358750347706
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.73799991607666, RealYield=2.35, T10Y2Y=0.5, WTI=87.05999755859375, DXY=98.8000030517578, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.75, DriftLabel=NEUTRAL, FredAsof=2026-08-21
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=3.37 → healthy contango / stable structure
- Short-Term Hedge: VIX9D/VIX=0.83 → calm front-end hedge
...
- **Breadth Note:** RSP-SPY return spread=0.22%p → broad participation
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=0.08%p → neutral Nasdaq breadth
- **Positioning / Gamma:** 0
...
**Leadership Notes**
- QQQ-SPY spread=-0.06%p → neutral growth leadership
- SMH-QQQ spread=-0.75%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-0.79%p → chip breadth lagging
- IWM-SPY spread=0.36%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=0.52%p → sector diffusion positive
- XLI-SPY spread=-0.14%p → sector diffusion neutral
- XLY-SPY spread=0.74%p → sector diffusion positive
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.559 (low-frequency) / DXYΔ +0.031 / US10YΔ +0.042 (정상)
- **Sentiment (Fear&Greed):** 71.18131038022835 (GREED)
- **Credit Calm:** True
...
- **Drift Score:** 6
- **Flow Score:** 7
- **Flow Continuity:** CONFIRMED_FLOW → 🔥 BUILDING HARD (FLOW_PERSISTENCE, tilt=+1)
- **Flow Regime Tilt:** +6 / Flow-Gamma Tilt: +2

- **🎯 Final Risk Action:** **HOLD**
- **Risk Budget (0~100):** **57**
- **Narrative:** 구조=TIGHTENING / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.75 ⚠️ 수급 다소 과열 → Phase=EVENT-WATCHING / INFLATION
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `EVENT-WATCHING` | **Bucket:** `MIXED` | **VIX:** `15.13`
- **Positioning Data:** Z-Score: `1.75` (>1.8 시 Run) | Gamma: `1.19` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 15.13 (NORMAL) | **Change:** -5.50%
- **Positioning Layer:** ⚠️ Elevated Positioning Heat(1.75)
...
**Context:** phase=EVENT-WATCHING / INFLATION / T10Y2Y=0.50 (MODERATE STEEP) / VIX=15.13 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** EVENT_TRANSITION
**Macro Inputs Debug:** phase=EVENT-WATCHING / INFLATION / us10y_pct=+0.89% / dxy_pct=+0.03% / wti_pct=+0.32% / vix=15.13 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=7

**Flow Overlay:** flow_score=7 / flow_state=🔥 BUILDING HARD / drift_label=NEUTRAL / gamma=🟡 POSITIVE-TRANSITION
**Flow Notes:** NEUTRAL + FLOW ACTIVE → XLK/XLI 소폭 가점 | Gamma POSITIVE → 리더 섹터 가점

**Overweight:** Consumer Staples, Health Care, Financials, Utilities

**Underweight:** Real Estate, Technology, Industrials, Energy, Consumer Discretionary

**Scoreboard:**
- Consumer Staples: +1.2  (+2 LIQ, +1 PHASE, = +1.2)
- Health Care: +1.2  (+2 LIQ, +1 PHASE, = +1.2)
- Financials: +0.8  (+2 CURVE, +1 MOM, = +0.8)
- Utilities: +0.4  (+1 LIQ, = +0.4)
- Consumer Discretionary: -0.6  (-1 LIQ, = -0.6)
- Energy: -0.7  (-1 PHASE, +1 MOM, = -0.7)
- Industrials: -0.7  (+1 CURVE, -1.5 PHASE, +1 FLOW, = -0.7)
- Technology: -0.8  (-2 LIQ, -0.5 PHASE, +1.5 FLOW, = -0.8)
...
**Regime Controller:**
- DISLOCATION (avg_divergence=-0.28, dispersion=1.67)
- Correlation Break: True / Type=NONE
- Break Reasons: US10Y ↑ but Technology ↑ | US10Y ↑ but SPY ↑
...
- Consumer Staples: FLOW_WEAK (theory=+3.0, flow=+0.0, final=+1.2)
- Health Care: FLOW_WEAK (theory=+3.0, flow=+0.0, final=+1.2)
- Financials: FLOW_WEAK (theory=+2.0, flow=+0.7, final=+0.8)
- Communication Services: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Materials: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Energy: TACTICAL_MOMENTUM_ONLY (theory=+0.0, flow=+0.7, final=-0.7)
...
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.2 | NEGATIVE_DIVERGENCE | **14.7%** | HOLD |
| Health Care | +1.2 | NEGATIVE_DIVERGENCE | **14.8%** | HOLD |
| Financials | +0.8 | NEGATIVE_DIVERGENCE | **9.1%** | HOLD |
| Utilities | +0.4 | ALIGNED | **8.3%** | HOLD |
| **Cash & Hedge** | - | - | **47.0%** | DEFENSIVE |
...
- **Tactical Reserve (Cap / Unallocated):** 1.0%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Health Care (priority_score=4.02, score=1.22, weight=14.8%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Staples (priority_score=4.0, score=1.22, weight=14.7%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.62, score=0.75, weight=9.1%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Technology (priority_score=1.24, score=-0.83, weight=6.1%, div=ALIGNED, mom=0)
5. Utilities (priority_score=-0.2, score=0.41, weight=8.3%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Utilities (priority_score=0.41, score=0.41, weight=8.3%, div=ALIGNED, mom=0)
2. Financials (priority_score=-0.75, score=0.75, weight=9.1%, div=NEGATIVE_DIVERGENCE, mom=1)
3. Technology (priority_score=-0.83, score=-0.83, weight=6.1%, div=ALIGNED, mom=0)
4. Consumer Staples (priority_score=-1.78, score=1.22, weight=14.7%, div=NEGATIVE_DIVERGENCE, mom=0)
5. Health Care (priority_score=-1.78, score=1.22, weight=14.8%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 14.7% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 14.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Financials | XLF | 9.1% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Utilities | XLU | 8.3% | SMALL | ALIGNED | ALIGNED |
| Technology | XLK | 6.1% | SMALL | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6088790815613133
- **Z-Score (5d):** -0.2647318207967714

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3679676406969899
- **Z-Score (5d):** 0.18462023599078567

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8988320222304532
- **Z-Score (5d):** -0.2653019902934658

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.15667334265396174
- **Z-Score (5d):** -0.6381464835162547

### EWJ
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.5911646199427179
- **Z-Score (5d):** -1.258803895146907

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.39735446839708344
- **Z-Score (5d):** 0.8352198858116503

### GLD
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 1.1245997691405325
- **Z-Score (5d):** 1.5911489045248812

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.42043738718676005
- **Z-Score (5d):** -0.8743762217608516

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.2792239243242115
- **Z-Score (5d):** 0.05258651050391821
