...
- **달러 인덱스**: 98.635  (+0.03% vs 98.604)
- **WTI 유가**: 59.590  (-0.48% vs 59.880)
- **변동성 지수 (VIX)**: 19.240  (-4.23% vs 20.090)
- **원/달러 환율**: 1468.940  (-0.07% vs 1469.980)
...
- **VIX 레벨:** 19.24 → **Mid (Neutral/Mixed)**
...
- **핵심 신호:** US10Y(→, Noise) / DXY(↑, Noise) / VIX(↓, Strong)
...
- **Today snapshot:** US10Y(4.295), DXY(98.635), VIX(19.24)
