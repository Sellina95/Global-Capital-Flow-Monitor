...
- **미국 10년물 금리**: 3.962  (-0.63% vs 3.987)
- **달러 인덱스**: 97.646  (-0.17% vs 97.814)
- **WTI 유가**: 67.290  (-0.55% vs 67.660)
- **변동성 지수 (VIX)**: 19.860  (-6.45% vs 21.230)
- **원/달러 환율**: 1439.230  (-0.23% vs 1442.530)
...
- **Policy Bias: EASING (완화) (STRONG, score=-2.5) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ -0.168 / US10YΔ -0.025**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 80.720 / prev 80.850 / pct -0.16%
- **LQD:** today 111.680 / prev 111.720 / pct -0.04%
- **판정:** **CREDIT NEUTRAL**
...
- WTI **(Mild, -0.55%)** → 물가 부담 완화
- VIX **(Strong, -6.45%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Clear, -0.23%)** → 원화 강세/수급 개선
...
So What?
- 금리 하락에도 기술 약세 → 실적/성장 우려 우위 (퀄리티만)
- 결론: **섹터 공식이 깨진 구간** → 방향 베팅보다 **사이징 축소 + 리더 중심**
...
- **Today snapshot:** US10Y(3.962), DXY(97.646), VIX(19.86)
...
- **Structure Bias:** Policy Bias: EASING (완화) (STRONG, score=-2.5) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ -0.168 / US10YΔ -0.025
