...
🧭 1. Executive Summary
Markets are operating in a SOFT RISK-OFF regime as liquidity conditions remain up and volatility pressures have increased. Participation remains ⚡ BUILDING, while positioning risk sits at 2.0. Maintain disciplined exposure and avoid adding marginal risk.
...
Recommendation: REDUCE / DEFENSIVE
Confidence: MEDIUM
Rationale:
...
> **시스템 상태: 🚨 ALERT**
> **판단 요약: 구조·수급 괴리 및 추세 피로 감지 / 반전 가능성 모니터링 필요**
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 49%**
- **Final Exposure (실행 기준): 49%**

- **Portfolio Stance:** REDUCE / 49%

- **[14번 구조·수급 괴리]:** 🚨 **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:1.96). 반전 가능성 상존.
### 🟢 Current SEW Status
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **49%**
- **Base Context:** phase=SOFT RISK-OFF / narrative=REDUCE / base_exposure=49%
- **SEW:** STABLE / NORMAL
- **Divergence:** N/A / **MONITOR REVERSAL (RUN 액션 준비)**
- **Drift:** 🔥 EXTREME DRIFT / NEUTRAL / 🟢 EARLY FLOW WITHOUT SHOCK / score=8
- **Flow:** ⚡ BUILDING / score=6
- **Gamma:** 🟡 POSITIVE-TRANSITION
- **Tactical Action:** REDUCE / DEFENSIVE / MEDIUM
- **Positioning:** pos_z=1.96
- **Warning Score:** 2 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
- **Tactical Why:** Risk-off environment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=REDUCE / Flow=⚡ BUILDING(6) / Drift=🔥 EXTREME DRIFT(8) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화
...
- **미국 10년물 금리**: 4.569  (+0.66% vs 4.539)
- **달러 인덱스**: 100.970  (+0.03% vs 100.940)
- **WTI 유가**: 71.410  (-0.93% vs 72.080)
- **변동성 지수 (VIX)**: 15.030 (-5.11% vs 15.840)
- **원/달러 환율**: 1505.910  (+0.17% vs 1503.350)
...
- **VIX 레벨:** 15.03 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.515 / level=EASY (완화) / update=low-frequency | as of: 2026-07-13 (latest available)
- **유인(Real Rates):** value=2.310 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-07-13 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.515 (low-frequency) / DXYΔ +0.030 / US10YΔ +0.030**
...
- **Liquidity as of:** 2026-07-08 (FRED latest)
- **NET_LIQ level:** 5961543.7
- **TGA level:** 774062.0
- **RRP level:** 3.347
...
- **Spread as of:** 2026-07-09 (FRED latest)
- **HY_OAS level:** 2.70% → **COOL (낮은 공포)**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.710 / prev 79.750 / pct -0.05%
- **LQD:** today 107.460 / prev 107.710 / pct -0.23%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +0.66%)** → 완화 기대 약화/금리 부담
- DXY **(Noise, +0.03%)** → 달러 강세/신흥국 부담
- WTI **(Clear, -0.93%)** → 물가 부담 완화
- VIX **(Strong, -5.11%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Mild, +0.17%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, -0.05%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Mild, -0.23%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🟢 UP | Short-term: MIXED | 1D=+0.42% / 5D=+1.36% | Strength: LOW
- **WTI:** 🟢 UP | Short-term: SHORT UP | 1D=+4.19% / 5D=+8.53% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.14% / 5D=+0.26% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-0.96% / 5D=-2.17% | Strength: LOW
...
- **3D Avg Score:** -0.15
- **Geo Momentum:** -0.23 *(Status: FLAT)*

**Historical Pattern Match (Cosine Similarity):**
- **Closest Historical Match:** Red_Sea
- **Cosine Similarity Score:** -0.322
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: -0.322
  - Iran_Crisis_2020: -0.424
  - China_Trade_2018: -0.461
- **Top Drivers:**
  - USDCNH: z_used=-0.69 (z1d=-1.20, z5d=+0.07, raw_w=0.18, norm_w=0.14) → contrib=-0.10
  - VIX: z_used=-0.59 (z1d=-0.66, z5d=-0.48, raw_w=0.18, norm_w=0.14) → contrib=-0.08
  - SEA: z_used=-1.39 (z1d=+1.19, z5d=+1.69, raw_w=0.05, norm_w=0.04) → contrib=-0.05
...
- **Dealer Gamma Bias:** 2.00 (STABILIZING / dealer gamma proxy supportive)
...
- **Flow Delta:** +1 (prev=5 → current=6)
- **Persistence Days:** 4
- **Transition Note:** 기관성 흐름이 전일 대비 강화
- **Confidence:** **MEDIUM-HIGH**
- **Action Bias:** **WATCHLIST**

- **Drift:** 🔥 EXTREME DRIFT / NEUTRAL / 🟢 EARLY FLOW WITHOUT SHOCK
...
**핵심 신호:** 장단기차(35.00bp) | 실질금리(2.31%) | DXY(100.97)
*(as of: RealRate: 2026-07-13 / FRED last available)*
...
- **강도:** US10Y(Strong) / DXY(Noise) / WTI(Clear) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.569), DXY(100.970), VIX(15.03)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=0.02971941606035024 / GOLD=-0.6415532700693153 / US10Y=0.6609326447296363 / VIX=-5.113638963471625 / WTI=-0.9295201885755959
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.568999767303467, RealYield=2.31, T10Y2Y=0.35, WTI=71.41000366210938, DXY=100.97000122070312, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.7, DriftLabel=NEUTRAL, FredAsof=2026-07-10
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=3.54 → healthy contango / stable structure
- Short-Term Hedge: VIX9D/VIX=0.74 → calm front-end hedge
...
- **Breadth Note:** RSP-SPY return spread=-0.06%p → neutral breadth
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.28%p → neutral Nasdaq breadth
- **Positioning / Gamma:** 0
...
**Leadership Notes**
- QQQ-SPY spread=-0.12%p → neutral growth leadership
- SMH-QQQ spread=0.23%p → semiconductor participation neutral
- SOXX-QQQ spread=-0.37%p → chip breadth lagging
- IWM-SPY spread=-0.85%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=-0.12%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.515 (low-frequency) / DXYΔ +0.030 / US10YΔ +0.030 (정상)
- **Sentiment (Fear&Greed):** 73.57187183829596 (GREED)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=GREED / 유동성=증가/중간 / 크레딧=안정 / 드리프트=🔥 EXTREME DRIFT (NEUTRAL) / 수급=1.96 ⚠️ 수급 다소 과열 → Phase=SOFT RISK-OFF
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `SOFT RISK-OFF` | **Bucket:** `RISK-OFF` | **VIX:** `15.03`
- **Positioning Data:** Z-Score: `1.96` (>1.8 시 Run) | Gamma: `2.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
- **Status:** **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:1.96). 반전 가능성 상존.
...
- **VIX Level:** 15.03 (NORMAL) | **Change:** -5.11%
- **Positioning Layer:** ⚠️ Elevated Positioning Heat(1.96), Positive Gamma(2.00)
- **Brake Drivers:** ⚠️ Elevated Positioning Heat

- **📊 Recommended Exposure:** **49%**
...
**Context:** phase=SOFT RISK-OFF / T10Y2Y=0.35 (MODERATE STEEP) / VIX=15.03 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** SOFT_RISK_OFF_DISINFLATION
**Macro Inputs Debug:** phase=SOFT RISK-OFF / us10y_pct=+0.66% / dxy_pct=+0.03% / wti_pct=-0.93% / vix=15.03 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=6
...
**Overweight:** Technology, Financials, Industrials, Health Care, Consumer Staples

**Underweight:** Consumer Discretionary, Real Estate, Utilities, Energy

**Scoreboard:**
- Technology: +2.3  (+2 LIQ, +0.5 PHASE, +1.5 FLOW, +2 MOM, = +2.3)
- Financials: +1.7  (+1 LIQ, +2 CURVE, +1 MOM, = +1.7)
- Industrials: +1.1  (+1.5 LIQ, +1 CURVE, -0.5 PHASE, +1 FLOW, = +1.1)
- Health Care: +0.7  (+1.2 PHASE, = +0.7)
- Consumer Staples: +0.5  (+0.8 PHASE, = +0.5)
- Energy: -0.4  (-2 MOM, = -0.4)
- Utilities: -0.6  (-1 LIQ, = -0.6)
- Real Estate: -0.6  (-2 MOM, = -0.6)
- Consumer Discretionary: -1.5  (+1.5 LIQ, -0.5 PHASE, -1 MOM, = -1.5)
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.92, dispersion=0.91)
- Correlation Break: True / Type=UNCLASSIFIED_SECTOR_BREAK
- Break Reasons: US10Y ↑ but SPY ↑ | US10Y ↑ but XLRE ↑
- Interpretation: 소프트 리스크오프 / 디스인플레이션 / 선택적 성장 허용

**Divergence / Classification Monitor (Theory vs Flow alignment: 이론과 실제 자금흐름 정렬 여부)**
- Technology: HIGH_CONVICTION_ALIGNED (theory=+2.5, flow=+1.9, final=+2.3)
- Financials: FLOW_WEAK (theory=+3.0, flow=+0.7, final=+1.7)
- Industrials: FLOW_WEAK (theory=+2.0, flow=+0.3, final=+1.1)
- Communication Services: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Materials: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Consumer Discretionary: THEORY_TRAP (theory=+1.0, flow=-0.7, final=-1.5)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **49.0%** → **Regime Adjusted:** **49.0%**
- **Exposure Override:** BALANCED → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.3 | ALIGNED | **25.0%** | HOLD |
| Financials | +1.7 | NEGATIVE_DIVERGENCE | **5.0%** | HOLD |
| Industrials | +1.1 | NEGATIVE_DIVERGENCE | **3.8%** | HOLD |
| Health Care | +0.7 | ALIGNED | **6.5%** | HOLD |
| Consumer Staples | +0.5 | ALIGNED | **4.4%** | HOLD |
| **Cash & Hedge** | - | - | **55.3%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** SOFT_RISK_OFF_DISINFLATION
- **Participation / Quality Cap Applied:**
  - Technology: 26.8% → 25.0% (-1.8%)
  - Financials: 6.2% → 5.0% (-1.2%)
- **Strategic Cash (15):** 51.0%
- **Tactical Reserve (Cap / Unallocated):** 4.3%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Industrials (priority_score=3.43, score=1.14, weight=3.8%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Financials (priority_score=2.15, score=1.71, weight=5.0%, div=NEGATIVE_DIVERGENCE, mom=1)
3. Consumer Staples (priority_score=-0.23, score=0.47, weight=4.4%, div=ALIGNED, mom=0)
4. Health Care (priority_score=-0.35, score=0.7, weight=6.5%, div=ALIGNED, mom=0)
5. Technology (priority_score=-5.59, score=2.31, weight=25.0%, div=ALIGNED, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=7.31, score=2.31, weight=25.0%, div=ALIGNED, mom=2)
2. Health Care (priority_score=0.70, score=0.7, weight=6.5%, div=ALIGNED, mom=0)
3. Consumer Staples (priority_score=0.47, score=0.47, weight=4.4%, div=ALIGNED, mom=0)
4. Financials (priority_score=0.21, score=1.71, weight=5.0%, div=NEGATIVE_DIVERGENCE, mom=1)
5. Industrials (priority_score=-1.86, score=1.14, weight=3.8%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 25.0% | CONTROLLED_LEADER | ALIGNED | HIGH_CONVICTION_ALIGNED |
| Financials | XLF | 5.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Industrials | XLI | 3.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 6.5% | DEFENSIVE_QUALITY | ALIGNED | ALIGNED |
| Consumer Staples | XLP | 4.4% | DEFENSIVE_BUFFER | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.28609780448006444
- **Z-Score (5d):** -0.9049984652267896

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.014351832902025291
- **Z-Score (5d):** 0.24721946393024816

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.050503147411726415
- **Z-Score (5d):** -0.19450584126246753

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.047010567458350486
- **Z-Score (5d):** -0.4549079462859191

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.7328499736121219
- **Z-Score (5d):** 0.3922144594810557

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2743077631905481
- **Z-Score (5d):** 1.9029618057386786

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.029707681282109447
- **Z-Score (5d):** 0.30980981802136365

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3467667671895836
- **Z-Score (5d):** 0.31333119610003446

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6086420269413777
- **Z-Score (5d):** -0.32127926733930384
