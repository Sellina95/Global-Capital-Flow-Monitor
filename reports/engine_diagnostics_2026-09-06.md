...
- **현실(FCI):** value=-0.558 / level=EASY (완화) / update=low-frequency | as of: 2026-09-06 (latest available)
- **유인(Real Rates):** value=2.420 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-06 (latest available)
...
- **WTI:** 🟢 UP | Short-term: SHORT UP | 1D=+0.20% / 5D=+9.69% | Strength: MEDIUM
- **DXY:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.16% / 5D=-0.54% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-0.34% / 5D=-0.03% | Strength: LOW
...
- **Top Similarity Matches:**
  - Red_Sea: 0.024
  - Iran_Crisis_2020: -0.137
  - Ukraine_2022: -0.226
- **Top Drivers:**
  - USDCNH: z_used=-1.47 (z1d=-1.89, z5d=-0.85, raw_w=0.18, norm_w=0.14) → contrib=-0.20
  - USDJPY: z_used=+2.71 (z1d=-3.42, z5d=-1.65, raw_w=0.05, norm_w=0.04) → contrib=+0.10
...
*(as of: RealRate: 2026-09-06 / FRED last available)*
...
- **Meaningful Move Check:** DXY=0.1616198607165404 / GOLD=-0.33617777232791124 / US10Y=0.46198730744020156 / VIX=1.4664807445692383 / WTI=0.19715257301114616
- **판정:** **NEUTRAL**
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=1.69 ⚠️ 수급 다소 과열 → Phase=EVENT-WATCHING / INFLATION
...
- **Positioning Data:** Z-Score: `1.69` (>1.8 시 Run) | Gamma: `0.91` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Positioning Heat(1.69)
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.13413970203331502
- **Z-Score (5d):** -0.2810566431327046
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.044954382221946136
- **Z-Score (5d):** -0.008469493629414241
