...
- **Final Action:** **REDUCE**
- **Final Exposure:** **52%**
- **Base Context:** phase=SOFT RISK-OFF / narrative=REDUCE / base_exposure=52%
- **SEW:** STABLE / NORMAL
...
- **Positioning:** pos_z=1.36
- **Warning Score:** 4 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
- **Tactical Why:** Risk-off environment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=REDUCE 반영 → Warning Score 3+ → 공격적 확장 금지 / 총노출 추가 감산 없이 방어적 배분 → Tactical=REDUCE / Flow=🔥 BUILDING HARD(7) / Drift=🔥 EXTREME DRIFT(8) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화
...
- **미국 10년물 금리**: 4.975  (+0.63% vs 4.944)
- **달러 인덱스**: 99.120  (+0.03% vs 99.090)
- **WTI 유가**: 100.050  (-2.37% vs 102.480)
- **변동성 지수 (VIX)**: 15.840 (-11.21% vs 17.840)
- **원/달러 환율**: 1348.170  (+0.67% vs 1339.170)
...
- **VIX 레벨:** 15.84 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.564 / level=EASY (완화) / update=low-frequency | as of: 2026-09-14 (latest available)
- **유인(Real Rates):** value=2.550 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-14 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.564 (low-frequency) / DXYΔ +0.030 / US10YΔ +0.031**
...
- **Spread as of:** 2026-09-10 (FRED latest)
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 78.600 / prev 78.620 / pct -0.03%
- **LQD:** today 104.320 / prev 104.360 / pct -0.04%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +0.63%)** → 완화 기대 약화/금리 부담
- DXY **(Noise, +0.03%)** → 달러 강세/신흥국 부담
- WTI **(Strong, -2.37%)** → 물가 부담 완화
- VIX **(Strong, -11.21%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Strong, +0.67%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, -0.03%)** → 크레딧 스트레스↑
...
- **SPY:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+0.84% / 5D=-1.16% | Strength: LOW
- **WTI:** 🟢 UP | Short-term: MIXED | 1D=+2.24% / 5D=+11.82% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.28% / 5D=+0.24% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.12% / 5D=-1.32% | Strength: LOW
...
- **Geo Stress Score (z-composite):** **-0.65**  *(Level: NORMAL)*
- **Coverage:** 100% *(used weight: 1.30 / defined weight: 1.30)*
- **3D Avg Score:** -0.31
- **Geo Momentum:** -0.34 *(Status: FALLING)*

**Historical Pattern Match (Cosine Similarity):**
- **Closest Historical Match:** Taiwan_Tension
- **Cosine Similarity Score:** 0.176
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.176
  - China_Trade_2018: 0.096
  - Ukraine_2022: 0.093
- **Top Drivers:**
  - KR10Y_SPREAD: z_used=-2.51 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.15
  - JP10Y_SPREAD: z_used=-2.51 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.12
  - DE10Y_SPREAD: z_used=-2.51 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.12
  - IL10Y_SPREAD: z_used=-2.51 (mode=level, raw_w=0.05, norm_w=0.04) → contrib=-0.10
...
**핵심 신호:** 장단기차(33.00bp) | 실질금리(2.55%) | DXY(99.12)
*(as of: RealRate: 2026-09-14 / FRED last available)*
...
- **Today snapshot:** US10Y(4.975), DXY(99.120), VIX(15.84)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↑) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=0.030281975779977332 / GOLD=0.038955099381372434 / US10Y=0.6270254609257296 / VIX=-11.210762235951426 / WTI=-2.3711945995085553
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.974999904632568, RealYield=2.55, T10Y2Y=0.33, WTI=100.0500030517578, DXY=99.12000274658205, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.7, DriftLabel=NEUTRAL, FredAsof=2026-09-11
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=2.76 → healthy contango / stable structure
...
- **Breadth Note:** RSP-SPY return spread=-0.05%p → neutral breadth
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.30%p → mega-cap concentrated Nasdaq rally
- **Positioning / Gamma:** 1
...
**Leadership Notes**
- QQQ-SPY spread=0.02%p → neutral growth leadership
- SMH-QQQ spread=0.60%p → semiconductor participation strong
- SOXX-QQQ spread=0.99%p → SOX proxy confirms chip breadth
- IWM-SPY spread=-0.44%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=-0.18%p → sector diffusion neutral
- XLI-SPY spread=0.21%p → sector diffusion neutral
- XLY-SPY spread=0.04%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.564 (low-frequency) / DXYΔ +0.030 / US10YΔ +0.031 (정상)
- **Sentiment (Fear&Greed):** 65.88879629102424 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=🔥 EXTREME DRIFT (NEUTRAL) / 수급=1.36 → Phase=SOFT RISK-OFF
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `SOFT RISK-OFF` | **Bucket:** `RISK-OFF` | **VIX:** `15.84`
- **Positioning Data:** Z-Score: `1.36` (>1.8 시 Run) | Gamma: `0.70` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 15.84 (NORMAL) | **Change:** -11.21%
- **Brake Drivers:** None
...
**Context:** phase=SOFT RISK-OFF / T10Y2Y=0.33 (MODERATE STEEP) / VIX=15.84 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** SOFT_RISK_OFF_DISINFLATION
**Macro Inputs Debug:** phase=SOFT RISK-OFF / us10y_pct=+0.63% / dxy_pct=+0.03% / wti_pct=-2.37% / vix=15.84 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=7
...
**Overweight:** Financials, Technology, Health Care, Energy, Consumer Staples

**Underweight:** Consumer Discretionary, Industrials, Utilities, Real Estate
...
- Industrials: -0.8  (+1.5 LIQ, +1 CURVE, -0.5 PHASE, +1 FLOW, -2 MOM, = -0.8)
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.86, dispersion=1.33)
...
- Industrials: THEORY_TRAP (theory=+2.0, flow=-1.1, final=-0.8)
...
| :--- | :---: | :---: | :---: | :--- |
| Financials | +1.7 | NEGATIVE_DIVERGENCE | **14.0%** | HOLD |
| Technology | +1.5 | NEGATIVE_DIVERGENCE | **12.4%** | HOLD |
| Health Care | +0.7 | ALIGNED | **8.3%** | HOLD |
| Energy | +0.6 | POSITIVE_DIVERGENCE | **9.0%** | HOLD |
| Consumer Staples | +0.5 | ALIGNED | **8.3%** | HOLD |
| **Cash & Hedge** | - | - | **48.0%** | DEFENSIVE |
...
1. Technology (priority_score=3.54, score=1.52, weight=12.4%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Financials (priority_score=2.69, score=1.71, weight=14.0%, div=NEGATIVE_DIVERGENCE, mom=1)
3. Consumer Staples (priority_score=-0.23, score=0.47, weight=8.3%, div=ALIGNED, mom=0)
4. Health Care (priority_score=-0.35, score=0.7, weight=8.3%, div=ALIGNED, mom=0)
5. Energy (priority_score=-4.29, score=0.57, weight=9.0%, div=POSITIVE_DIVERGENCE, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Energy (priority_score=4.57, score=0.57, weight=9.0%, div=POSITIVE_DIVERGENCE, mom=2)
2. Health Care (priority_score=0.70, score=0.7, weight=8.3%, div=ALIGNED, mom=0)
3. Consumer Staples (priority_score=0.47, score=0.47, weight=8.3%, div=ALIGNED, mom=0)
4. Financials (priority_score=0.21, score=1.71, weight=14.0%, div=NEGATIVE_DIVERGENCE, mom=1)
5. Technology (priority_score=-1.48, score=1.52, weight=12.4%, div=NEGATIVE_DIVERGENCE, mom=0)
- **Divergence Adjustment:** Financials, Technology penalized in weight sizing

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action | Divergence | Classification |
| :--- | :---: | :---: | :--- | :--- | :--- |
| Financials | XLF | 14.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Technology | XLK | 12.4% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 8.3% | DEFENSIVE_QUALITY | ALIGNED | ALIGNED |
| Energy | XLE | 9.0% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
| Consumer Staples | XLP | 8.3% | DEFENSIVE_BUFFER | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** HIGH
- **Z-Score (1d):** -0.15336966538134636
- **Z-Score (5d):** -2.1689353058457557

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.7332348839917477
- **Z-Score (5d):** 0.14390874478229485

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8915885370261518
- **Z-Score (5d):** -0.796554223041688

### EMB
- **Crash?** False
- **Risk Level:** HIGH
- **Z-Score (1d):** -0.1232348486090289
- **Z-Score (5d):** -2.1590146551124785

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.5318846732936198
- **Z-Score (5d):** 0.06033366072181318

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.34866200923457774
- **Z-Score (5d):** -0.7773226250637191

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.37716247211336434
- **Z-Score (5d):** -0.8903495559718883

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.0967985852490336
- **Z-Score (5d):** -0.8876871238792243

### VXX
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -1.5287308082162059
- **Z-Score (5d):** 1.1354651193028942
