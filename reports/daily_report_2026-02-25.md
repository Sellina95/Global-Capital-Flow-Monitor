...
- **미국 10년물 금리**: 4.033  (+0.00% vs 4.033)
- **달러 인덱스**: 97.980  (+0.24% vs 97.750)
- **WTI 유가**: 65.860  (-0.38% vs 66.110)
- **변동성 지수 (VIX)**: 19.390  (-0.82% vs 19.550)
- **원/달러 환율**: 1432.160  (+0.03% vs 1431.750)
...
- **VIX 레벨:** 19.39 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.230 / US10YΔ +0.000**
...
- **강도:** US10Y(Noise) / DXY(Clear) / WTI(Mild) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.033), DXY(97.980), VIX(19.39)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.230 / US10YΔ +0.000
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/낮음 / 크레딧=안정 → Phase=TRANSITION / MIXED (전환·혼조)
