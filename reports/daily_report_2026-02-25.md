...
- **달러 인덱스**: 97.702  (-0.18% vs 97.874)
- **WTI 유가**: 66.200  (+0.18% vs 66.080)
- **변동성 지수 (VIX)**: 19.550  (+0.00% vs 19.550)
- **원/달러 환율**: 1435.900  (-0.37% vs 1441.290)
...
- **Policy Bias: EASING (완화) (MODERATE, score=-2.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ -0.172 / US10YΔ +0.000**
...
- 원/달러(USDKRW) **(Clear, -0.37%)** → 원화 강세/수급 개선
...
- **강도:** US10Y(Noise) / DXY(Clear) / WTI(Mild) / VIX(Noise)
...
- **Today snapshot:** US10Y(4.033), DXY(97.702), VIX(19.55)
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-2.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ -0.172 / US10YΔ +0.000
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=비우호 / 크레딧=안정 → Phase=EVENT-WATCHING (이벤트 관망)
