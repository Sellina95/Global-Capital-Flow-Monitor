...
- **달러 인덱스**: 97.750  (+0.05% vs 97.702)
- **WTI 유가**: 66.110  (-0.14% vs 66.200)
- **변동성 지수 (VIX)**: 19.550  (+0.00% vs 19.550)
- **원/달러 환율**: 1431.750  (-0.29% vs 1435.900)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.048 / US10YΔ +0.000**
...
- **Today snapshot:** US10Y(4.033), DXY(97.750), VIX(19.55)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.048 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 50.0 (NEUTRAL)
- **Credit Calm (HY OAS<4):** True
- **Liquidity (NET_LIQ):** dir=DOWN / level=N/A
- **Phase:** EVENT-WATCHING (이벤트 관망)

- **🎯 Final Risk Action:** **HOLD**
- **Risk Budget (0~100):** **55**
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/N/A / 크레딧=안정 → Phase=EVENT-WATCHING (이벤트 관망)
