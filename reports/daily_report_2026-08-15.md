...
- **Portfolio Stance:** REDUCE (POS_OVERHEATED) / 52%
...
- **Final Exposure:** **52%**
- **Base Context:** phase=RISK-ON / REFLATION / narrative=REDUCE (POS_OVERHEATED) / base_exposure=52%
...
- **국면 전환 감지:** 🚨 **TRANSITION / MIXED (전환·혼조)** → **RISK-ON / REFLATION**
...
- **현실(FCI):** value=-0.549 / level=EASY (완화) / update=low-frequency | as of: 2026-08-15 (latest available)
- **유인(Real Rates):** value=2.390 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-15 (latest available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCI value=-0.549 (low-frequency) / DXYΔ -0.273 / US10YΔ +0.055**
...
- **WTI:** 🟢 UP | Short-term: SHORT UP | 1D=+1.42% / 5D=+5.40% | Strength: MEDIUM
- **DXY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.32% / 5D=+0.04% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: MIXED | 1D=+1.57% / 5D=+2.10% | Strength: LOW
...
- **3D Avg Score:** -0.29
- **Geo Momentum:** +0.27 *(Status: RISING)*

**Historical Pattern Match (Cosine Similarity):**
- **Closest Historical Match:** Red_Sea
- **Cosine Similarity Score:** 0.534
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: 0.534
  - Ukraine_2022: 0.470
  - China_Trade_2018: 0.455
- **Top Drivers:**
  - GOLD: z_used=+0.76 (z1d=+0.84, z5d=+0.63, raw_w=0.12, norm_w=0.09) → contrib=+0.07
...
**핵심 신호:** 장단기차(51.00bp) | 실질금리(2.39%) | DXY(99.64)
*(as of: RealRate: 2026-08-15 / FRED last available)*
...
- **Today snapshot:** US10Y(4.696), DXY(99.636), VIX(14.25)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↓) / GOLD(↑) / VIX(↓) / WTI(↑)
- **Meaningful Move Check:** DXY=-0.2732436561836833 / GOLD=1.3352821712036653 / US10Y=1.185096048631844 / VIX=-2.5974033593193826 / WTI=1.3779561557613005
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.696000099182129, RealYield=2.39, T10Y2Y=0.51, WTI=82.4000015258789, DXY=99.63600158691406, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.71, DriftLabel=NEUTRAL, FredAsof=2026-08-14
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCI value=-0.549 (low-frequency) / DXYΔ -0.273 / US10YΔ +0.055 (정상)
...
- **Drift Score:** 2
- **Flow Score:** 1
- **Flow Continuity:** 👀 EARLY TRACE → 🌱 LIGHT TRACE (FLOW_FADE, tilt=-3)
- **Flow Regime Tilt:** +1 / Flow-Gamma Tilt: +0

- **🎯 Final Risk Action:** **REDUCE (POS_OVERHEATED)**
- **Risk Budget (0~100):** **61**
- **Narrative:** 구조=MIXED / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=2.15 ⚠️ 수급 과열 감지 → Phase=RISK-ON / REFLATION
...
- **Positioning Data:** Z-Score: `2.15` (>2.2 시 Run) | Gamma: `1.22` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
**Macro Inputs Debug:** phase=RISK-ON / REFLATION / us10y_pct=+1.19% / dxy_pct=-0.27% / wti_pct=+1.38% / vix=14.25 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=1
...
| :--- | :---: | :---: | :---: | :--- |
| Financials | +1.4 | NEGATIVE_DIVERGENCE | **5.8%** | DELEVERAGE |
| Technology | +1.2 | ALIGNED | **10.0%** | DELEVERAGE |
| Consumer Staples | +1.2 | NEGATIVE_DIVERGENCE | **5.0%** | DELEVERAGE |
| Health Care | +1.2 | NEGATIVE_DIVERGENCE | **5.0%** | DELEVERAGE |
| Industrials | +0.9 | ALIGNED | **10.0%** | DELEVERAGE |
| Communication Services | +0.3 | ALIGNED | **2.3%** | DELEVERAGE |
| Energy | +0.3 | POSITIVE_DIVERGENCE | **5.0%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **56.9%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** DISINFLATION_RISK_ON
- **Participation / Quality Cap Applied:**
  - Technology: 16.2% → 10.0% (-6.2%)
  - Industrials: 12.6% → 10.0% (-2.6%)
- **Strategic Cash (15):** 48.0%
- **Tactical Reserve (Cap / Unallocated):** 8.9%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Consumer Staples (priority_score=3.4, score=1.2, weight=5.0%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.4, score=1.2, weight=5.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.31, score=1.38, weight=5.8%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Communication Services (priority_score=-0.17, score=0.33, weight=2.3%, div=ALIGNED, mom=0)
5. Industrials (priority_score=-0.87, score=0.9, weight=10.0%, div=ALIGNED, mom=1)
...
5. Financials (priority_score=-0.12, score=1.38, weight=5.8%, div=NEGATIVE_DIVERGENCE, mom=1)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Financials | XLF | 5.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0386267210354048
- **Z-Score (5d):** -0.3214204031063739
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.11401714760462785
- **Z-Score (5d):** 0.3860812123585393

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0495982899736598
- **Z-Score (5d):** -0.4573240878892354
...
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.1068820803507589
- **Z-Score (5d):** -1.006552292142356
