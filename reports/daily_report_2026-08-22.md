...
🧭 1. Executive Summary
Markets are operating in a SOFT RISK-OFF regime as liquidity conditions are tightening and volatility pressures have eased. Participation remains ⚡ BUILDING, while positioning risk sits at 1.8. Maintain disciplined exposure and avoid adding marginal risk.
...
Final Portfolio Decision: REDUCE / 47%
Tactical Signal: REDUCE / DEFENSIVE
Tactical Confidence: MEDIUM
Tactical Rationale:
...
🏁 10. Final PM View
Final Portfolio Action: REDUCE
Final Portfolio Exposure: 47%
Strategic Phase: SOFT RISK-OFF
...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 47%**
- **Final Exposure (실행 기준): 47%**

- **Portfolio Stance:** REDUCE / 47%
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **47%**
- **Base Context:** phase=SOFT RISK-OFF / narrative=REDUCE / base_exposure=47%
- **SEW:** STABLE / NORMAL
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=REDUCE 반영 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=REDUCE / Flow=⚡ BUILDING(6) / Drift=⚡ STRUCTURAL DRIFT(7) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화

### 🚩 Market Regime Status
- **국면 전환 감지:** 🚨 **SOFT RISK-OFF (부분 경계)** → **SOFT RISK-OFF**
...
- **달러 인덱스**: 98.839  (+0.07% vs 98.769)
- **WTI 유가**: 86.640  (-0.16% vs 86.780)
...
- **현실(FCI):** value=-0.559 / level=EASY (완화) / update=low-frequency | as of: 2026-08-22 (latest available)
- **유인(Real Rates):** value=2.350 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-22 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.559 (low-frequency) / DXYΔ +0.070 / US10YΔ +0.042**
...
- **WTI:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-1.35% / 5D=+5.15% | Strength: MEDIUM
- **DXY:** 🔴 DOWN | Short-term: MIXED | 1D=-0.06% / 5D=-0.83% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT DOWN | 1D=+3.22% / 5D=+6.42% | Strength: MEDIUM
...
- **Top Similarity Matches:**
  - Red_Sea: 0.234
  - China_Trade_2018: 0.160
  - Ukraine_2022: 0.154
- **Top Drivers:**
  - USDCNH: z_used=-1.22 (z1d=-1.29, z5d=-1.12, raw_w=0.18, norm_w=0.14) → contrib=-0.17
  - GOLD: z_used=+1.28 (z1d=+1.06, z5d=+1.61, raw_w=0.12, norm_w=0.09) → contrib=+0.12
...
- **Dealer Gamma Bias:** 1.16 (NEUTRAL / transition zone)
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(2.35%) | DXY(98.84)
*(as of: RealRate: 2026-08-22 / FRED last available)*
...
- **Today snapshot:** US10Y(4.738), DXY(98.839), VIX(15.13)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↑) / VIX(↓) / WTI(↓)
- **Meaningful Move Check:** DXY=0.07087213276844492 / GOLD=1.8706315047257431 / US10Y=0.894374276138667 / VIX=-5.496565283324662 / WTI=-0.16132679375173853
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.73799991607666, RealYield=2.35, T10Y2Y=0.5, WTI=86.63999938964844, DXY=98.83899688720705, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.75, DriftLabel=NEUTRAL, FredAsof=2026-08-21
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.559 (low-frequency) / DXYΔ +0.070 / US10YΔ +0.042 (정상)
...
- **Narrative:** 구조=TIGHTENING / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.75 ⚠️ 수급 다소 과열 → Phase=SOFT RISK-OFF
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `SOFT RISK-OFF` | **Bucket:** `RISK-OFF` | **VIX:** `15.13`
- **Positioning Data:** Z-Score: `1.75` (>1.8 시 Run) | Gamma: `1.16` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
**Context:** phase=SOFT RISK-OFF / T10Y2Y=0.50 (MODERATE STEEP) / VIX=15.13 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** SOFT_RISK_OFF_DISINFLATION
**Macro Inputs Debug:** phase=SOFT RISK-OFF / us10y_pct=+0.89% / dxy_pct=+0.07% / wti_pct=-0.16% / vix=15.13 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=6
...
**Overweight:** Health Care, Consumer Staples, Financials, Utilities, Energy, Industrials

**Underweight:** Real Estate, Consumer Discretionary, Technology

**Scoreboard:**
- Health Care: +1.3  (+2 LIQ, +1.2 PHASE, = +1.3)
- Consumer Staples: +1.1  (+2 LIQ, +0.8 PHASE, = +1.1)
- Financials: +0.8  (+2 CURVE, +1 MOM, = +0.8)
- Utilities: +0.4  (+1 LIQ, = +0.4)
- Energy: +0.3  (+1 MOM, = +0.3)
- Industrials: +0.3  (+1 CURVE, -0.5 PHASE, +1 FLOW, = +0.3)
- Technology: -0.4  (-2 LIQ, +0.5 PHASE, +1.5 FLOW, = -0.4)
- Consumer Discretionary: -0.8  (-1 LIQ, -0.5 PHASE, = -0.8)
...
**Regime Controller:**
- DISLOCATION (avg_divergence=-0.32, dispersion=1.56)
...
- Health Care: FLOW_WEAK (theory=+3.2, flow=+0.0, final=+1.3)
- Consumer Staples: FLOW_WEAK (theory=+2.8, flow=+0.0, final=+1.1)
...
- **Strategic Exposure (15):** **47.0%** → **Regime Adjusted:** **47.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Health Care | +1.3 | NEGATIVE_DIVERGENCE | **11.1%** | REBALANCE |
| Consumer Staples | +1.1 | NEGATIVE_DIVERGENCE | **9.5%** | SMALL ADJUST |
| Financials | +0.8 | NEGATIVE_DIVERGENCE | **6.4%** | SMALL ADJUST |
| Utilities | +0.4 | ALIGNED | **5.8%** | SMALL ADJUST |
| Energy | +0.3 | POSITIVE_DIVERGENCE | **5.5%** | REBALANCE |
| Industrials | +0.3 | ALIGNED | **6.2%** | HOLD |
| **Cash & Hedge** | - | - | **51.3%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** SOFT_RISK_OFF_DISINFLATION
- **Regime Cap Applied:** None
- **Strategic Cash (15):** 53.0%
- **Tactical Reserve (Cap / Unallocated):** -1.7%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Health Care (priority_score=3.97, score=1.31, weight=11.1%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Staples (priority_score=3.82, score=1.12, weight=9.5%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.62, score=0.75, weight=6.4%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Technology (priority_score=0.63, score=-0.42, weight=4.2%, div=ALIGNED, mom=0)
5. Industrials (priority_score=-0.16, score=0.32, weight=6.2%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Energy (priority_score=2.84, score=0.34, weight=5.5%, div=POSITIVE_DIVERGENCE, mom=1)
2. Utilities (priority_score=0.41, score=0.41, weight=5.8%, div=ALIGNED, mom=0)
3. Industrials (priority_score=0.32, score=0.32, weight=6.2%, div=ALIGNED, mom=0)
4. Technology (priority_score=-0.42, score=-0.42, weight=4.2%, div=ALIGNED, mom=0)
5. Financials (priority_score=-0.75, score=0.75, weight=6.4%, div=NEGATIVE_DIVERGENCE, mom=1)
- **Divergence Adjustment:** Health Care, Consumer Staples, Financials penalized in weight sizing

### 🧬 19) Execution Layer (ETF Mapping)

| Sector | ETF | Weight | Action | Divergence | Classification |
| :--- | :---: | :---: | :--- | :--- | :--- |
| Health Care | XLV | 10.6% | DEFENSIVE_QUALITY | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Consumer Staples | XLP | 9.2% | DEFENSIVE_BUFFER | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Financials | XLF | 6.2% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Utilities | XLU | 5.6% | SMALL | ALIGNED | ALIGNED |
| Energy | XLE | 5.3% | TACTICAL_ONLY | POSITIVE_DIVERGENCE | TACTICAL_MOMENTUM_ONLY |
| Industrials | XLI | 6.0% | SMALL | ALIGNED | ALIGNED |
| Technology | XLK | 4.1% | SMALL | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6088784142764576
- **Z-Score (5d):** -0.2647315866553561
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8997639871217317
- **Z-Score (5d):** -0.26478939399870466

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1566736511450153
- **Z-Score (5d):** -0.6381469451998617
