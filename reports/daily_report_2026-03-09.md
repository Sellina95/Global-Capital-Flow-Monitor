...
- **달러 인덱스**: 99.338  (+0.35% vs 98.990)
- **WTI 유가**: 101.830  (+12.02% vs 90.900)
- **변동성 지수 (VIX)**: 31.650  (+7.32% vs 29.490)
- **원/달러 환율**: 1488.860  (+0.63% vs 1479.510)
...
- **VIX 레벨:** 31.65 → **High (Risk-off bias)**
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.348 / US10YΔ +0.000**
...
- DXY **(Strong, +0.35%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +12.02%)** → 인플레 재자극 가능성
- VIX **(Strong, +7.32%)** → 심리 악화/리스크오프
...
- **Top Drivers:**
  - USDCNH: z_used=+3.07 (z1d=+2.63, z5d=+3.74, raw_w=0.18, norm_w=0.13) → contrib=+0.41
  - WTI: z_used=+4.00 (z1d=+3.53, z5d=+4.71, raw_w=0.10, norm_w=0.07) → contrib=+0.30
  - VIX: z_used=+1.70 (z1d=+0.73, z5d=+3.15, raw_w=0.18, norm_w=0.13) → contrib=+0.23
  - USDMXN: z_used=+2.32 (z1d=+1.88, z5d=+2.99, raw_w=0.05, norm_w=0.04) → contrib=+0.09
...
- **Today snapshot:** US10Y(4.133), DXY(99.338), VIX(31.65)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.020 / FCIΔ +0.000 / DXYΔ +0.348 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 11.63024524111185 (FEAR)
