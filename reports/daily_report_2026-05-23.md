...
- **[14번 구조·수급 괴리]:** 🚨 **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.23). 반전 가능성 상존.
### 🟢 Current SEW Status
- **SEW:** RISK_COMPRESSION | ⚠️ Risk Compression 발동 (권장 익스포저 55%)
- **Event Type:** NORMAL → 정상 상태 / 구조적 리스크 없음
- **Spike Monitor:** Spike 0 / Extreme 0
- **Current Reason:** ⚠️ CROWDING RISK: POS_Z Extreme (2.13) → Risk Compression (55%)
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-05-23 (FRED last available)
- **유인(Real Rates):** level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-05-23 (FRED last available)
...
- **WTI:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.67% / 5D=-7.99% | Strength: MEDIUM
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.13% / 5D=+0.05% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: MIXED | 1D=-0.65% / 5D=-0.99% | Strength: LOW
...
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.142
  - Iran_Crisis_2020: -0.191
  - Red_Sea: -0.213
- **Top Drivers:**
...
*(as of: RealRate: 2026-05-23 / FRED last available)*
...
- **Meaningful Move Check:** DXY=0.13105882671469363 / GOLD=-0.4141108748471365 / US10Y=-0.6105512023398085 / VIX=-0.35799203534011975 / WTI=0.2594706839223751
- **판정:** **NEUTRAL**
...
- **Sentiment (Fear&Greed):** 63.8119007626446 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=2.23 ⚠️ 수급 과열 감지 → Phase=TRANSITION / MIXED
...
- **Positioning Data:** Z-Score: `2.23` (>1.8 시 Run) | Gamma: `1.81` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
- **Status:** **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.23). 반전 가능성 상존.
...
3. Technology (priority_score=-3.7, score=2.12, weight=46.9%, div=ALIGNED, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=7.12, score=2.12, weight=46.9%, div=ALIGNED, mom=2)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 46.9% | CORE_LEADER | ALIGNED | HIGH_CONVICTION_ALIGNED |
