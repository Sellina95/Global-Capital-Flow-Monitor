...
- **달러 인덱스**: 100.186  (+0.16% vs 100.030)
- **WTI 유가**: 111.540  (+0.00% vs 111.540)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ -0.050 / FCIΔ +0.020 / DXYΔ +0.156 / US10YΔ +0.000**
...
- **강도:** US10Y(Noise) / DXY(Clear) / WTI(Noise) / VIX(Noise)
...
- **Today snapshot:** US10Y(4.313), DXY(100.186), VIX(23.87)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ -0.050 / FCIΔ +0.020 / DXYΔ +0.156 / US10YΔ +0.000 (정상)
...
- **Structure(3번 결과):** TIGHTENING | **Price(현재 국면):** MIXED | **VIX:** 23.8700008392334
...
**Context:** phase=EVENT-WATCHING (이벤트 관망) / T10Y2Y=0.51 (MODERATE STEEP) / VIX=24.54 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
