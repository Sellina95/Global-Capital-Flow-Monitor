...
- **미국 10년물 금리**: 4.140  (-1.12% vs 4.187)
- **달러 인덱스**: 99.061  (+0.33% vs 98.738)
- **WTI 유가**: 61.050  (+7.01% vs 57.050)
- **변동성 지수 (VIX)**: 16.750  (+15.44% vs 14.510)
- **원/달러 환율**: 1463.730  (+1.18% vs 1446.670)

---

## 🚨 Regime Change Monitor (always-on)
- **Status:** ❎ NOT DETECTED
- **Current Regime:** RISK-OFF (부분 정렬)
- **File:** not created
- **Email:** not sent
...
- **VIX 레벨:** 16.75 → **Mid (Neutral/Mixed)**
...
- 미국 금리(US10Y) **(Strong, -1.12%)** → 완화 기대 강화
- DXY **(Clear, +0.33%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +7.01%)** → 인플레 재자극 가능성
- VIX **(Strong, +15.44%)** → 심리 악화/리스크오프
...
- **판정:** **금리 하락(US10Y 하락) 달러 강세(DXY 상승) 유가 상승(WTI 상승) 변동성 증가(VIX 상승) **
- **이유:** 직접적인 원인 파악

### 🔄 9) Direction Filter
- **질문:** 시장이 어느 방향으로, 얼마나 움직였는가?
- **핵심 신호:** US10Y(Strong, ↓) / DXY(Clear, ↑) / WTI(Strong, ↑) / VIX(Strong, ↑)
- **판정:** **SIGNIFICANT MOVEMENT (의미 있는 움직임)**
- **근거:** 금리나 달러의 변동이 크고 뚜렷함

### ⏳ 10) Timing Filter
- **질문:** 시장 변화가 단기, 중기, 장기 관점에서 어떤 영향을 미치는지?
- **핵심 신호:** US10Y(-1.12% short-term, 4.19% medium-term, 4.14% long-term) / DXY(0.33% short-term, 98.74% medium-term, 99.06% long-term) / VIX(15.44% short-term, 14.51% medium-term, 16.75% long-term)
