...
🧭 1. Executive Summary
Markets are operating in a RISK-ON / REFLATION regime as liquidity conditions remain down and volatility pressures have increased. Participation remains ⚡ BUILDING, while positioning risk sits at 1.7. Maintain disciplined exposure and avoid adding marginal risk.
...
Interpretation:
Leadership narrowed and participation weakened simultaneously.
Market internals remain fragile.
...
- [2026-08-03 04:27:13] ALERT | SEW=DEADMAN | EVENT=NORMAL | credit=CREDIT_CALM(2.84%) | flow=FLOW_FADE -> CONFIRMED_FLOW | flow_delta=0 | persistence=5 | flow_alert=CONFIRMED_FLOW | Exp=0% | 🚨 HARD DEADMAN: Real-time Cross-Asset Shock (spike=2, extreme=0) | spike=2 extreme=0 | corr_break=NO | email=YES | z={'SPY': -3.2738035347697645, 'QQQ': -3.432781890760108, 'VIX': 0.21885040586048746, 'DXY': 1.53386687862278, 'WTI': 0.07680321668558458}
...
- **Spike Monitor:** Spike 2 / Extreme 0
- **Current Reason:** 🚨 HARD DEADMAN: Real-time Cross-Asset Shock (spike=2, extreme=0)
...
- **Final Action:** **EXIT**
- **Final Exposure:** **0%**
- **Base Context:** phase=RISK-ON / REFLATION / narrative=INCREASE / base_exposure=72%
- **SEW:** DEADMAN / NORMAL
...
- **Positioning:** pos_z=1.71
- **Warning Score:** 2 (6.5 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW DEADMAN 발동 → 즉시 EXIT / 익스포저 0% → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=HOLD / Flow=⚡ BUILDING(5) / Drift=⚡ STRUCTURAL DRIFT(7) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 4.745  (+1.76% vs 4.663)
- **달러 인덱스**: 99.800  (-0.21% vs 100.010)
- **WTI 유가**: 84.670  (+1.29% vs 83.590)
- **변동성 지수 (VIX)**: 15.990 (-6.44% vs 17.090)
- **원/달러 환율**: 1420.600  (-1.50% vs 1442.280)
...
- **VIX 레벨:** 15.99 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.554 / level=EASY (완화) / update=low-frequency | as of: 2026-08-03 (latest available)
- **유인(Real Rates):** value=2.410 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-08-03 (latest available)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCI value=-0.554 (low-frequency) / DXYΔ -0.210 / US10YΔ +0.082**
...
- **Liquidity as of:** 2026-07-29 (FRED latest)
- **NET_LIQ level:** 5827411.4
- **TGA level:** 910776.0
- **RRP level:** 2.576
...
- **Spread as of:** 2026-07-30 (FRED latest)
- **HY_OAS level:** 2.84% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -1.05%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↑) / LQD(↓)
- **HYG:** today 79.480 / prev 79.470 / pct 0.01%
- **LQD:** today 106.250 / prev 106.410 / pct -0.15%
...
- 미국 금리(US10Y) **(Strong, +1.76%)** → 완화 기대 약화/금리 부담
- DXY **(Clear, -0.21%)** → 달러 약세/리스크 선호
- WTI **(Clear, +1.29%)** → 인플레 재자극 가능성
- VIX **(Strong, -6.44%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Strong, -1.50%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Noise, +0.01%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Mild, -0.15%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🟢 UP | Short-term: MIXED | 1D=+0.69% / 5D=+1.07% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-5.83% / 5D=-3.49% | Strength: MEDIUM
- **DXY:** 🔴 DOWN | Short-term: MIXED | 1D=-0.08% / 5D=-1.76% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: MIXED | 1D=+1.84% / 5D=+1.20% | Strength: LOW
...
- **Top Similarity Matches:**
  - Red_Sea: -0.192
  - Iran_Crisis_2020: -0.346
  - Ukraine_2022: -0.394
- **Top Drivers:**
  - USDJPY: z_used=+5.01 (z1d=-5.68, z5d=-4.00, raw_w=0.05, norm_w=0.04) → contrib=+0.19
  - USDCNH: z_used=-1.04 (z1d=-1.26, z5d=-0.69, raw_w=0.18, norm_w=0.14) → contrib=-0.14
  - VIX: z_used=-0.92 (z1d=-0.78, z5d=-1.13, raw_w=0.18, norm_w=0.14) → contrib=-0.13
  - KR10Y_SPREAD: z_used=-1.38 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.09
...
- **Dealer Gamma Bias:** 0.96 (NEUTRAL / transition zone)
...
- **Gamma:** 🟡 POSITIVE-TRANSITION / ⚠️ SHOCK but gamma not fully negative
- **SEW:** DEADMAN / NORMAL
- **Positioning (POS_Z):** 1.71
...
**핵심 신호:** 장단기차(47.00bp) | 실질금리(2.41%) | DXY(99.80)
*(as of: RealRate: 2026-08-03 / FRED last available)*
...
- **Today snapshot:** US10Y(4.745), DXY(99.800), VIX(15.99)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↓) / GOLD(↓) / VIX(↓) / WTI(↑)
- **Meaningful Move Check:** DXY=-0.209978082178851 / GOLD=-1.2438720710539055 / US10Y=1.7585197698746908 / VIX=-6.436514755110501 / WTI=1.2920228237468314
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.744999885559082, RealYield=2.41, T10Y2Y=0.47, WTI=84.66999816894531, DXY=99.8000030517578, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.84, DriftLabel=NEUTRAL, FredAsof=2026-07-31
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=3.03 → healthy contango / stable structure
...
- **Breadth Note:** RSP-SPY return spread=-0.89%p → narrow cap-weight leadership
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.36%p → mega-cap concentrated Nasdaq rally
- **Positioning / Gamma:** 1
...
**Leadership Notes**
- QQQ-SPY spread=-0.07%p → neutral growth leadership
- SMH-QQQ spread=-0.35%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-0.58%p → chip breadth lagging
- IWM-SPY spread=-1.20%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=-0.83%p → sector diffusion weak
- XLI-SPY spread=0.09%p → sector diffusion neutral
- XLY-SPY spread=2.57%p → sector diffusion positive
...
- **Risk Budget (0~100):** **76**
- **Narrative:** 구조=MIXED / 심리=GREED / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.71 ⚠️ 수급 다소 과열 → Phase=RISK-ON / REFLATION
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `RISK-ON` | **Bucket:** `RISK-ON` | **VIX:** `15.99`
- **Positioning Data:** Z-Score: `1.71` (>2.2 시 Run) | Gamma: `0.96` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Base Risk Budget (13):** 76
- **VIX Level:** 15.99 (NORMAL) | **Change:** -6.44%
- **Positioning Layer:** ⚠️ Elevated Positioning Heat(1.71)
...
**Context:** phase=RISK-ON / REFLATION / T10Y2Y=0.47 (MODERATE STEEP) / VIX=15.99 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** DISINFLATION_RISK_ON
**Macro Inputs Debug:** phase=RISK-ON / REFLATION / us10y_pct=+1.76% / dxy_pct=-0.21% / wti_pct=+1.29% / vix=15.99 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=5
...
**Overweight:** Consumer Staples, Health Care, Financials, Energy, Industrials, Communication Services, Utilities
...
- Technology: -0.1  (-2 LIQ, +1.5 PHASE, +1.5 FLOW, = -0.1)
- Consumer Discretionary: -0.4  (-1 LIQ, +1 PHASE, -1 MOM, = -0.4)
- Real Estate: -1.1  (-1.5 LIQ, = -1.1)
...
- OW Financials: +2: 완만한 스티프닝(0.47) → 예대마진 개선
...
**Regime Controller:**
- BALANCED (avg_divergence=-0.41, dispersion=1.20)
...
- Financials: FLOW_WEAK (theory=+2.0, flow=+0.7, final=+1.0)
...
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.1 | NEGATIVE_DIVERGENCE | **8.0%** | DELEVERAGE |
| Health Care | +1.1 | NEGATIVE_DIVERGENCE | **10.0%** | DELEVERAGE |
| Financials | +1.0 | NEGATIVE_DIVERGENCE | **0.0%** | DELEVERAGE |
...
| Utilities | +0.3 | ALIGNED | **7.7%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **74.3%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** DISINFLATION_RISK_ON
- **Participation / Quality Cap Applied:**
  - Financials: 9.7% → 0.0% (-9.7%)
  - Energy: 16.9% → 0.0% (-16.9%)
  - Industrials: 11.9% → 0.0% (-11.9%)
  - Communication Services: 7.7% → 0.0% (-7.7%)
- **Strategic Cash (15):** 28.0%
- **Tactical Reserve (Cap / Unallocated):** 46.3%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Health Care (priority_score=4.41, score=1.08, weight=10.0%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Staples (priority_score=4.11, score=1.08, weight=8.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.48, score=1.04, weight=0.0%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Industrials (priority_score=1.27, score=0.46, weight=0.0%, div=ALIGNED, mom=-1)
5. Utilities (priority_score=0.45, score=0.3, weight=7.7%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Energy (priority_score=4.57, score=0.57, weight=0.0%, div=POSITIVE_DIVERGENCE, mom=2)
2. Industrials (priority_score=0.46, score=0.46, weight=0.0%, div=ALIGNED, mom=-1)
3. Communication Services (priority_score=0.30, score=0.3, weight=0.0%, div=ALIGNED, mom=0)
4. Utilities (priority_score=0.30, score=0.3, weight=7.7%, div=ALIGNED, mom=0)
5. Financials (priority_score=-0.46, score=1.04, weight=0.0%, div=NEGATIVE_DIVERGENCE, mom=1)
...
| Health Care | XLV | 10.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Utilities | XLU | 7.7% | SMALL | ALIGNED | ALIGNED |
...
- **Z-Score (5d):** -0.15113249181120456

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3595201664018698
- **Z-Score (5d):** 0.3013443625034084

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.24089875017726967
- **Z-Score (5d):** 0.1694704113696281
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6987652910566428
- **Z-Score (5d):** 0.36510358594585407

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.056606747449171914
- **Z-Score (5d):** 1.6678559298764297

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8581497396026866
- **Z-Score (5d):** 0.29282252986661855

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.761123049352747
- **Z-Score (5d):** 0.48998131541178175

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7115628728529152
- **Z-Score (5d):** -0.6075851115347983
