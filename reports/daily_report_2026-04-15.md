...
- **Final Action:** **REDUCE**
- **Final Exposure:** **25%**
- **Base Context:** phase=TRANSITION / MIXED (전환·혼조) / narrative=REDUCE / base_exposure=30%
- **SEW:** STABLE / NORMAL
- **Divergence:** ALIGNED / **STAY (포지션 유지)**
- **Warning Score:** 2 (6.6 섹터 상관관계 붕괴)
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=REDUCE 반영 → Warning Score 2 → 익스포저 15% haircut
...
- **미국 10년물 금리**: 4.270  (+0.33% vs 4.256)
- **달러 인덱스**: 98.149  (+0.03% vs 98.120)
- **WTI 유가**: 90.930  (-0.38% vs 91.280)
- **변동성 지수 (VIX)**: 17.530  (-4.52% vs 18.360)
- **원/달러 환율**: 1475.780  (-0.07% vs 1476.840)

---

## 🧭 So What? (Decision Layer)
- **Strategic View:** **REDUCE** *(base exposure: 30%)*
- **Execution View:** **REDUCE** *(final exposure: 25%)*
...
- **Warning Score:** 2 (6.6 섹터 상관관계 붕괴)
- **Do:** 실행 레이어 기준 방어 우선, 현금/단기자산 비중 확대; 레버리지·저품질 크레딧·고베타 익스포저 축소
- **Don't:** 공격적 베타 확대; 고변동성 자산 비중 확대
- **Triggers:** SEW 안정화 / Warning 정상화 확인 전까지 방어적 운용 유지

## 🗺️ Scenario Framework (Base / Bull / Bear)

- **Strategic View:** REDUCE (30%) | **Execution View:** REDUCE (25%)
- **Context:** phase=TRANSITION / MIXED (전환·혼조) / liquidity=UP-MID / credit_calm=True / geo=NORMAL

### 🔹 Base Case
- 조건: 현재 Execution View=REDUCE 유지 / SEW=STABLE / Divergence=ALIGNED / Warning Score 2 지속
- 전략: 실행 노출 25% 유지, 퀄리티 중심 선별적 접근 (전략 기준 30% 대비 방어적 사이징)

### 🔼 Bull Case
- 조건: Warning Score ≤ 1 / SEW: STABLE 유지 / Divergence: ALIGNED 유지 / NET_LIQ 우호 / 크레딧 안정 지속
- 전략: 실행 노출 25% → 30%로 복귀, 성장/리스크 자산 베타 단계적 재확대

### 🔻 Bear Case
- 조건: SEW WATCH/ALERT/DEADMAN 재발 / HY OAS 4% 상회 또는 급등 / VIX 22 이상 또는 급등 전환 / 상관관계 붕괴 심화 / Divergence 비정렬 전환
- 전략: 실행 노출 25% 이하 방어 유지, 현금/방어자산 중심으로 생존 우선
...
- **VIX 레벨:** 17.53 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-15 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-15 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.029 / US10YΔ +0.014**
...
- **Spread as of:** 2026-04-13 (FRED latest)
- **HY_OAS level:** 2.95% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↑) / +0.34%
- **판정:** **CREDIT CALM**
...
- **Geo Stress Score (z-composite):** **-0.40**  *(Level: NORMAL)*
...
- **Cosine Similarity Score:** -0.369
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: -0.369
  - Iran_Crisis_2020: -0.465
  - Israel_2023: -0.500
- **Top Drivers:**
  - VIX: z_used=-0.84 (z1d=-0.54, z5d=-1.27, raw_w=0.18, norm_w=0.14) → contrib=-0.12
  - USDCNH: z_used=-0.81 (z1d=-0.67, z5d=-1.02, raw_w=0.18, norm_w=0.14) → contrib=-0.11
  - JP10Y_SPREAD: z_used=-0.86 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.04
  - WTI: z_used=-0.48 (z1d=-0.25, z5d=-0.82, raw_w=0.10, norm_w=0.08) → contrib=-0.04
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(1.92%) | DXY(98.15)
*(as of: RealRate: 2026-04-15 / FRED last available)*
...
- **Today snapshot:** US10Y(4.270), DXY(98.149), VIX(17.53)

### 🏗️ 12) Structural Filter (v2)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↑) / VIX(↓) / WTI(↓)
- **판정:** **SYSTEMIC HEDGE (시스템적 위험 회피)**
- **근거:** 달러와 금의 동반 상승은 법정 화폐 가치 전반에 대한 의구심과 구조적 불확실성을 시사함

### 🧠 13) Narrative Engine (v2 + Risk Budget)
- **정의:** 구조·심리·크레딧·유동성·국면을 통합해 오늘의 리스크 액션을 결정
- **추가 이유:** 지표는 많지만 전략가는 결국 ‘리스크를 늘릴지/줄일지/유지할지’를 판단해야 하기 때문

- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.029 / US10YΔ +0.014 (시스템위기)
- **Sentiment (Fear&Greed):** 59.04830771359157 (NEUTRAL)
- **Credit Calm:** True
- **Liquidity (NET_LIQ):** UP (MID)
- **Phase:** TRANSITION / MIXED (전환·혼조) (Cap: 30)
- **[SPECIAL ALERT]**: **🚨 시스템 불신 감지** (Structural Cap: 30)

- **🎯 Final Risk Action:** **REDUCE**
- **Risk Budget (0~100):** **30**
- **Narrative:** 구조=TIGHTENING(시스템위기) / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=1.17 → Phase=TRANSITION / MIXED (전환·혼조)
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `MIXED` | **VIX:** `17.53`
- **Positioning Data:** Z-Score: `1.17` (>1.8 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Risk Budget:** 30 | **Phase Cap:** 70
- **VIX Level:** 17.53 (NORMAL) | **Change:** -4.52%
...
**Context:** phase=TRANSITION / MIXED (전환·혼조) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=17.53 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE

**Overweight:** Financials, Industrials, Technology, Consumer Discretionary, Energy
...
- **Total Target Exposure:** **30%** (from Filter 15)

| Sector | Score | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :--- |
| Financials | +3 | **7.5%** | STRONG BUY |
| Industrials | +3 | **7.5%** | STRONG BUY |
| Technology | +3 | **7.5%** | STRONG BUY |
| Consumer Discretionary | +2 | **5.0%** | ACCUMULATE |
| Energy | +1 | **2.5%** | ACCUMULATE |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.3780421374943232
- **Z-Score (5d):** 0.4663012596601791

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.2865173807352665
- **Z-Score (5d):** 0.5748350590838562

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.001415011240679351
- **Z-Score (5d):** 1.0658850240111295

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.3376819329035564
- **Z-Score (5d):** 1.205160565126758

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.43354685778638774
- **Z-Score (5d):** -0.3059125759355629

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.4365666870344848
- **Z-Score (5d):** 0.5916960296931199

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.24874799438648126
- **Z-Score (5d):** 0.2484090615298089

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1835441628593123
- **Z-Score (5d):** 1.5054062787447322

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.20875733042293657
- **Z-Score (5d):** -1.2612051500830266
