...
- **Final Action:** **REDUCE**
- **Final Exposure:** **22%**
- **Base Context:** phase=RISK-OFF (부분 정렬) / narrative=REDUCE / base_exposure=30%
- **SEW:** STABLE / NORMAL
...
- **미국 10년물 금리**: 4.256  (-0.58% vs 4.281)
- **달러 인덱스**: 98.106  (+0.09% vs 98.019)
- **WTI 유가**: 91.500  (-2.16% vs 93.520)
- **변동성 지수 (VIX)**: 18.360  (+1.83% vs 18.030)
- **원/달러 환율**: 1470.310  (+0.07% vs 1469.270)
...
- **Context:** phase=RISK-OFF (부분 정렬) / liquidity=UP-MID / credit_calm=True / geo=NORMAL
...
### 🔹 Base Case
- 조건: 현재 Execution View=REDUCE 유지 / SEW=STABLE / Divergence=ALIGNED / Warning Score 4 지속
...
- **VIX 레벨:** 18.36 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.087 / US10YΔ -0.025**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 80.500 / prev 80.495 / pct 0.01%
- **LQD:** today 109.980 / prev 109.960 / pct 0.02%
- **판정:** **CREDIT NEUTRAL**
...
- WTI **(Strong, -2.16%)** → 물가 부담 완화
- VIX **(Clear, +1.83%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Mild, +0.07%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, +0.01%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Noise, +0.02%)** → 우량채 강세(리스크오프 성향)
...
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.014
  - China_Trade_2018: -0.008
  - Red_Sea: -0.022
- **Top Drivers:**
  - EMB: z_used=-0.74 (z1d=+0.27, z5d=+1.45, raw_w=0.12, norm_w=0.09) → contrib=-0.07
  - WTI: z_used=-0.69 (z1d=-0.63, z5d=-0.77, raw_w=0.10, norm_w=0.08) → contrib=-0.05
  - VIX: z_used=-0.33 (z1d=+0.12, z5d=-1.02, raw_w=0.18, norm_w=0.14) → contrib=-0.05
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(1.92%) | DXY(98.11)
...
- **판정:** **금리 하락(US10Y↓) + 달러 강세(DXY↑) + 유가 하락(WTI↓) + 변동성 확대(VIX↑)**
...
- **Today snapshot:** US10Y(4.256), DXY(98.106), VIX(18.36)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.087 / US10YΔ -0.025 (시스템위기)
- **Sentiment (Fear&Greed):** 57.991070084620574 (NEUTRAL)
- **Credit Calm:** True
- **Liquidity (NET_LIQ):** UP (MID)
- **Phase:** RISK-OFF (부분 정렬) (Cap: 30)
- **[SPECIAL ALERT]**: **🚨 시스템 불신 감지** (Structural Cap: 30)

- **🎯 Final Risk Action:** **REDUCE**
- **Risk Budget (0~100):** **30**
- **Narrative:** 구조=MIXED(시스템위기) / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=1.16 → Phase=RISK-OFF (부분 정렬)
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `RISK-OFF` | **VIX:** `18.36`
- **Positioning Data:** Z-Score: `1.16` (>1.8 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Risk Budget:** 30 | **Phase Cap:** 35
- **VIX Level:** 18.36 (NORMAL) | **Change:** +1.83%
...
**Context:** phase=RISK-OFF (부분 정렬) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=18.36 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
| :--- | :---: | :---: | :--- |
| Financials | +3 | **8.2%** | STRONG BUY |
| Industrials | +3 | **8.2%** | STRONG BUY |
| Consumer Discretionary | +2 | **5.5%** | ACCUMULATE |
| Consumer Staples | +1 | **2.7%** | ACCUMULATE |
| Health Care | +1 | **2.7%** | ACCUMULATE |
| Technology | +1 | **2.7%** | ACCUMULATE |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9039189505856517
- **Z-Score (5d):** 1.0334400443492238

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.005952550970408
- **Z-Score (5d):** 2.273296782672993

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.031080751405633
- **Z-Score (5d):** 2.099296496735067

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8921837539454629
- **Z-Score (5d):** 2.6179176150960606

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.663002344712792
- **Z-Score (5d):** 1.2223819607418018

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.0140430224338732
- **Z-Score (5d):** 1.8132640670928952

### GLD
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.8007297995870252
- **Z-Score (5d):** 0.462527706767628

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.2321589994840125
- **Z-Score (5d):** 2.814983950810126

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.3068570678492308
- **Z-Score (5d):** -2.3787776541197387
