...
- **미국 10년물 금리**: 4.320  (+1.43% vs 4.259)
- **달러 인덱스**: 100.112  (+0.02% vs 100.090)
- **WTI 유가**: 95.650  (-0.70% vs 96.320)
- **변동성 지수 (VIX)**: 26.640  (+6.18% vs 25.090)
- **원/달러 환율**: 1501.980  (+1.15% vs 1484.870)
...
- **VIX 레벨:** 26.64 → **High (Risk-off bias)**
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ N/A / FCIΔ N/A / DXYΔ +0.022 / US10YΔ +0.061**
...
- 미국 금리(US10Y) **(Strong, +1.43%)** → 완화 기대 약화/금리 부담
- DXY **(Noise, +0.02%)** → 달러 강세/신흥국 부담
- WTI **(Clear, -0.70%)** → 물가 부담 완화
- VIX **(Strong, +6.18%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, +1.15%)** → 원화 약세/수급 부담
...
- **Top Similarity Matches:**
  ...
  - Israel_2023: 0.121
- **Top Drivers:**
  - GOLD: z_used=-2.41 (z1d=-2.38, z5d=-2.45, raw_w=0.12, norm_w=0.09) → contrib=-0.22
  - USDCNH: z_used=+1.54 (z1d=+1.13, z5d=+2.16, raw_w=0.18, norm_w=0.14) → contrib=+0.21
...
- **Today snapshot:** US10Y(4.320), DXY(100.112), VIX(26.64)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ N/A / FCIΔ N/A / DXYΔ +0.022 / US10YΔ +0.061
- **Sentiment (Fear&Greed):** 28.98681048465538 (FEAR)
