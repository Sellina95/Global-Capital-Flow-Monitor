...
- **WTI:** 🟢 UP | Short-term: SHORT DOWN | 1D=+1.77% / 5D=+7.65% | Strength: MEDIUM
- **DXY:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.20% / 5D=-0.08% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: MIXED | 1D=-1.22% / 5D=-2.18% | Strength: LOW
...
| :--- | :---: | :---: | :---: | :--- |
| Technology | +3.1 | ALIGNED | **25.6%** | DELEVERAGE |
| Industrials | +1 | NEGATIVE_DIVERGENCE | **1.3%** | DELEVERAGE |
| Health Care | +0.8 | ALIGNED | **5.6%** | DELEVERAGE |
| Consumer Staples | +0.5 | ALIGNED | **3.7%** | DELEVERAGE |
| Consumer Discretionary | +0.4 | ALIGNED | **1.8%** | DELEVERAGE |
...
1. Industrials (priority_score=6.0, score=1.0, weight=1.3%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Discretionary (priority_score=-0.18, score=0.35000000000000003, weight=1.8%, div=ALIGNED, mom=0)
3. Consumer Staples (priority_score=-0.26, score=0.52, weight=3.7%, div=ALIGNED, mom=0)
4. Health Care (priority_score=-0.39, score=0.78, weight=5.6%, div=ALIGNED, mom=0)
5. Technology (priority_score=-5.3, score=3.1, weight=25.6%, div=ALIGNED, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=8.10, score=3.1, weight=25.6%, div=ALIGNED, mom=2)
2. Health Care (priority_score=0.78, score=0.78, weight=5.6%, div=ALIGNED, mom=0)
3. Consumer Staples (priority_score=0.52, score=0.52, weight=3.7%, div=ALIGNED, mom=0)
4. Consumer Discretionary (priority_score=0.35, score=0.35000000000000003, weight=1.8%, div=ALIGNED, mom=0)
5. Industrials (priority_score=-2.00, score=1.0, weight=1.3%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- |
| Technology | XLK | 25.6% | DEFENSIVE_PRIMARY | ALIGNED |
| Industrials | XLI | 1.3% | SMALL | NEGATIVE_DIVERGENCE |
| Health Care | XLV | 5.6% | SMALL | ALIGNED |
| Consumer Staples | XLP | 3.7% | SMALL | ALIGNED |
| Consumer Discretionary | XLY | 1.8% | SMALL | ALIGNED |
