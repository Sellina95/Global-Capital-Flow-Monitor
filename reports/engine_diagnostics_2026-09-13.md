...
- **현실(FCI):** value=-0.564 / level=EASY (완화) / update=low-frequency | as of: 2026-09-13 (latest available)
- **유인(Real Rates):** value=2.550 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-13 (latest available)
...
- **WTI:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-2.37% / 5D=+9.58% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.01% / 5D=+0.10% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+1.02% / 5D=-1.84% | Strength: LOW
...
- **Cosine Similarity Score:** 0.214
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.214
  - China_Trade_2018: 0.128
  - Ukraine_2022: 0.127
- **Top Drivers:**
...
*(as of: RealRate: 2026-09-13 / FRED last available)*
...
- **Meaningful Move Check:** DXY=0.030281975779977332 / GOLD=1.0172964221273915 / US10Y=0.6270254609257296 / VIX=-11.210762235951426 / WTI=-2.3711945995085553
- **판정:** **NEUTRAL**
...
- **Sentiment (Fear&Greed):** 65.8145272557228 (NEUTRAL)
- **Credit Calm:** True
...
- **Drift Score:** 8
- **Flow Score:** 7
- **Flow Continuity:** TRACE_BUILDING → 🔥 BUILDING HARD (FLOW_PERSISTENCE, tilt=+1)
- **Flow Regime Tilt:** +5 / Flow-Gamma Tilt: +2

- **🎯 Final Risk Action:** **REDUCE**
- **Risk Budget (0~100):** **50**
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=🔥 EXTREME DRIFT (NEUTRAL) / 수급=1.48 → Phase=SOFT RISK-OFF
...
- **Crash?** False
- **Risk Level:** HIGH
- **Z-Score (1d):** -0.15336943803196743
- **Z-Score (5d):** -2.16893881536964
...
- **Crash?** False
- **Risk Level:** HIGH
- **Z-Score (1d):** -0.12323469026699996
- **Z-Score (5d):** -2.1590161012404283
