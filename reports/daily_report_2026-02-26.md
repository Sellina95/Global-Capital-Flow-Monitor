...
- **달러 인덱스**: 97.695  (-0.05% vs 97.747)
- **WTI 유가**: 64.390  (+0.22% vs 64.250)
- **변동성 지수 (VIX)**: 18.010  (-0.17% vs 18.040)
- **원/달러 환율**: 1426.680  (-0.05% vs 1427.380)
...
- **VIX 레벨:** 18.01 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ -0.052 / US10YΔ +0.000**
...
- WTI **(Mild, +0.22%)** → 인플레 재자극 가능성
- VIX **(Noise, -0.17%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Noise, -0.05%)** → 원화 강세/수급 개선
...
- **Today snapshot:** US10Y(4.048), DXY(97.695), VIX(18.01)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ -0.052 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 39.80719595848272 (NEUTRAL)
