...
- **미국 10년물 금리**: 4.046  (-0.05% vs 4.048)
- **달러 인덱스**: 97.708  (-0.06% vs 97.771)
- **WTI 유가**: 65.390  (-0.02% vs 65.400)
- **변동성 지수 (VIX)**: 18.630  (-0.59% vs 18.740)
- **원/달러 환율**: 1426.930  (+0.02% vs 1426.610)
...
- **Policy Bias: EASING (완화) (STRONG, score=-2.5) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ -0.063 / US10YΔ -0.002**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 80.885 / prev 80.865 / pct 0.02%
- **LQD:** today 111.675 / prev 111.670 / pct 0.00%
- **판정:** **CREDIT NEUTRAL**
...
- VIX **(Mild, -0.59%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Noise, +0.02%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, +0.02%)** → 크레딧 위험선호↑
...
- **강도:** US10Y(Mild) / DXY(Mild) / WTI(Noise) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.046), DXY(97.708), VIX(18.63)
...
- **Structure Bias:** Policy Bias: EASING (완화) (STRONG, score=-2.5) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ -0.063 / US10YΔ -0.002
- **Sentiment (Fear&Greed):** 37.50027785583779 (NEUTRAL)
