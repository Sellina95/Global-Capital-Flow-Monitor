...
- **달러 인덱스**: 97.565  (-0.11% vs 97.677)
- **WTI 유가**: 65.470  (-0.15% vs 65.570)
- **변동성 지수 (VIX)**: 17.930  (+0.00% vs 17.930)
- **원/달러 환율**: 1422.490  (-0.33% vs 1427.240)
...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ -0.112 / US10YΔ +0.000**
...
- WTI **(Mild, -0.15%)** → 물가 부담 완화
- VIX **(Noise, +0.00%)** → 변동성 보합(심리 변화 제한)
- 원/달러(USDKRW) **(Clear, -0.33%)** → 원화 강세/수급 개선
...
- **Today snapshot:** US10Y(4.048), DXY(97.565), VIX(17.93)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ -0.112 / US10YΔ +0.000
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/낮음 / 크레딧=안정 → Phase=EVENT-WATCHING (이벤트 관망)
