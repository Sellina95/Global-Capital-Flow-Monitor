...
- **달러 인덱스**: 97.578  (+0.01% vs 97.564)
- **WTI 유가**: 65.480  (-0.06% vs 65.520)
- **변동성 지수 (VIX)**: 17.930  (+0.00% vs 17.930)
- **원/달러 환율**: 1427.570  (+0.14% vs 1425.570)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ +0.014 / US10YΔ +0.000**
...
- **Today snapshot:** US10Y(4.048), DXY(97.578), VIX(17.93)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ +0.014 / US10YΔ +0.000
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=감소/낮음 / 크레딧=안정 → Phase=EVENT-WATCHING (이벤트 관망)
...
- **Context:** phase=EVENT-WATCHING (이벤트 관망) / liquidity=DOWN-LOW / structure=TIGHTENING / credit_calm=True
