...
- **달러 인덱스**: 97.747  (+0.17% vs 97.578)
- **WTI 유가**: 64.250  (-1.88% vs 65.480)
- **변동성 지수 (VIX)**: 18.040  (+0.61% vs 17.930)
- **원/달러 환율**: 1427.380  (-0.01% vs 1427.570)
...
- **Context:** phase=RISK-OFF (부분 정렬) / liquidity=DOWN-LOW / credit_calm=True
...
- **VIX 레벨:** 18.04 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ +0.169 / US10YΔ +0.000**
...
- WTI **(Strong, -1.88%)** → 물가 부담 완화
- VIX **(Mild, +0.61%)** → 심리 악화/리스크오프
...
- **강도:** US10Y(Noise) / DXY(Clear) / WTI(Strong) / VIX(Mild)
...
- **Today snapshot:** US10Y(4.048), DXY(97.747), VIX(18.04)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+2.0) | REAL_RATEΔ +0.010 / FCIΔ +0.000 / DXYΔ +0.169 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 39.71171012866283 (NEUTRAL)
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=감소/낮음 / 크레딧=안정 → Phase=RISK-OFF (부분 정렬)
...
- **Context:** phase=RISK-OFF (부분 정렬) / liquidity=DOWN-LOW / structure=TIGHTENING / credit_calm=True
