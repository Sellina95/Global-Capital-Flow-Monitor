...
- **미국 10년물 금리**: 4.293  (+0.05% vs 4.291)
- **달러 인덱스**: 98.794  (-0.13% vs 98.927)
- **WTI 유가**: 98.200  (-1.10% vs 99.290)
- **변동성 지수 (VIX)**: 19.490  (-8.02% vs 21.190)
- **원/달러 환율**: 1474.170  (-0.42% vs 1480.450)
...
- **VIX 레벨:** 19.49 → **Mid (Neutral/Mixed)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.133 / US10YΔ +0.002**
...
- **Spread as of:** 2026-04-08 (FRED latest)
- **HY_OAS level:** 2.94% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -5.77%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↑) / LQD(→)
- **HYG:** today 80.280 / prev 80.190 / pct 0.11%
...
- DXY **(Mild, -0.13%)** → 달러 약세/리스크 선호
- WTI **(Clear, -1.10%)** → 물가 부담 완화
- VIX **(Strong, -8.02%)** → 심리 개선/리스크온
...
- DEBUG: pct XLK=0.26819456296476896, XLF=0.25390833237903815, XLE=-1.2403056252689755, XLRE=0.6833198042208303
...
- **Top Similarity Matches:**
  - Israel_2023: -0.465
  - Taiwan_Tension: -0.533
  - Iran_Crisis_2020: -0.536
- **Top Drivers:**
  - VIX: z_used=-1.21 (z1d=-0.93, z5d=-1.63, raw_w=0.18, norm_w=0.14) → contrib=-0.17
  - EMB: z_used=-1.36 (z1d=+0.91, z5d=+2.05, raw_w=0.12, norm_w=0.09) → contrib=-0.13
  - USDCNH: z_used=-0.77 (z1d=-0.46, z5d=-1.24, raw_w=0.18, norm_w=0.14) → contrib=-0.11
  - WTI: z_used=-1.02 (z1d=-0.42, z5d=-1.91, raw_w=0.10, norm_w=0.08) → contrib=-0.08
...
**핵심 신호:** 장단기차(51.00bp) | 실질금리(1.96%) | DXY(98.79)
...
- **강도:** US10Y(Mild) / DXY(Mild) / WTI(Clear) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.293), DXY(98.794), VIX(19.49)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.133 / US10YΔ +0.002 (정상)
- **Sentiment (Fear&Greed):** 55.574296838274215 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=0.83 → Phase=RISK-ON (부분 정렬)
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `RISK-ON` | **VIX:** `19.49`
- **Positioning Data:** Z-Score: `0.83` (>2.2 시 Run) | Gamma: `1.00` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
**Context:** phase=RISK-ON (부분 정렬) / T10Y2Y=0.51 (MODERATE STEEP) / VIX=19.49 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.13446866672895835
- **Z-Score (5d):** 0.8717097571217216

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.1966349367733921
- **Z-Score (5d):** 1.607582893545627

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.7096514533186835
- **Z-Score (5d):** 1.397798144374118

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8790277721531182
- **Z-Score (5d):** 2.1091122846406707

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8363653159444402
- **Z-Score (5d):** 0.49686949630986477

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.01194534909166466
- **Z-Score (5d):** 1.1390620882564158

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2591085070434113
- **Z-Score (5d):** -0.08848584814379666

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6307611768119304
- **Z-Score (5d):** 2.4789607746489617

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8937386314968108
- **Z-Score (5d):** -2.184100290573273
