...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-05-10 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-05-10 (FRED last available)
...
- **WTI:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.64% / 5D=-6.40% | Strength: MEDIUM
- **DXY:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-0.41% / 5D=-0.37% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT UP | 1D=+0.66% / 5D=+2.18% | Strength: LOW
...
*(as of: RealRate: 2026-05-10 / FRED last available)*
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=WEAK DRIFT (노이즈 가능) (REOPENING / DEMAND_BOOM) / 수급=2.22 ⚠️ 수급 과열 감지 → Phase=TRANSITION / MIXED (전환·혼조)
...
- **Positioning Data:** Z-Score: `2.22` (>1.8 시 Run) | Gamma: `1.69` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.49792034733873614
- **Z-Score (5d):** 0.5714985361088698
