...
- **WTI 유가**: 94.880  (-1.01% vs 95.850)
- **변동성 지수 (VIX)**: 18.710  (-3.11% vs 19.310)
- **원/달러 환율**: 1476.320  (-0.11% vs 1477.960)
...
- **Cosine Similarity Score:** 0.266
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.266
  - China_Trade_2018: 0.225
  - Ukraine_2022: 0.167
- **Top Drivers:**
...
- **Meaningful Move Check:** DXY=-0.29352318478714434 / GOLD=0.43144256798302627 / US10Y=-0.30071736252022396 / VIX=-3.107200404267048 / WTI=-1.0119992030725316
- **판정:** **NEUTRAL**
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=WEAK DRIFT (노이즈 가능) (DISINFLATION_RISK_ON) / 수급=1.62 ⚠️ 수급 다소 과열 → Phase=RISK-ON (완화 기대·리스크 선호)
...
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +3 | ALIGNED | **19.3%** | ACCUMULATE |
| Health Care | +3 | ALIGNED | **19.3%** | ACCUMULATE |
| Industrials | +1.7 | ALIGNED | **10.9%** | ACCUMULATE |
| Utilities | +1 | ALIGNED | **6.4%** | HOLD |
...
| :--- | :---: | :---: | :--- |
| Consumer Staples | XLP | 19.3% | ADD |
| Health Care | XLV | 19.3% | ADD |
| Industrials | XLI | 10.9% | ADD |
| Utilities | XLU | 6.4% | SMALL |
