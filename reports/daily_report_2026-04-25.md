...
### 📌 Interpretation
- 금일 시장은 **WAITING / RANGE (대기·박스권) 환경**이며 유동성과 정책은 완화적 상태
...
- **Final Action:** **HOLD**
- **Final Exposure:** **46%**
- **Base Context:** phase=WAITING / RANGE (대기·박스권) / narrative=HOLD / base_exposure=46%
- **SEW:** STABLE / NORMAL
...
- **국면 전환 감지:** 🚨 **RISK-ON (완화 기대·리스크 선호)** → **WAITING / RANGE (대기·박스권)**

---

## 📊 Daily Macro Signals

- **미국 10년물 금리**: 4.310  (+0.00% vs 4.310)
- **달러 인덱스**: 98.510  (+0.00% vs 98.510)
- **WTI 유가**: 94.880  (+0.00% vs 94.880)
- **변동성 지수 (VIX)**: 18.710  (+0.00% vs 18.710)
- **원/달러 환율**: 1476.320  (+0.00% vs 1476.320)
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-04-25 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-04-25 (FRED last available)
...
- **방향(전일 대비):** HYG(→) / LQD(→)
- **HYG:** today 80.480 / prev 80.480 / pct 0.00%
- **LQD:** today 109.600 / prev 109.600 / pct 0.00%
- **판정:** **CREDIT NEUTRAL**
...
- **WTI:** 🟡 PULLBACK | Short-term: MIXED | 1D=-1.01% / 5D=+13.15% | Strength: HIGH
- **DXY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.29% / 5D=+0.42% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.43% / 5D=-2.72% | Strength: LOW
...
- **Cosine Similarity Score:** 0.363
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - China_Trade_2018: 0.363
  - Taiwan_Tension: 0.352
  - Ukraine_2022: 0.274
- **Top Drivers:**
  - USDCNH: z_used=+0.45 (z1d=+0.12, z5d=+0.95, raw_w=0.18, norm_w=0.14) → contrib=+0.06
  - KR10Y_SPREAD: z_used=-0.74 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.05
  - IL10Y_SPREAD: z_used=-0.99 (mode=level, raw_w=0.05, norm_w=0.04) → contrib=-0.04
  - DE10Y_SPREAD: z_used=-0.65 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.03
...
*(as of: RealRate: 2026-04-25 / FRED last available)*
...
- **Meaningful Move Check:** DXY=0.0 / GOLD=0.0 / US10Y=0.0 / VIX=0.0 / WTI=0.0
- **판정:** **NEUTRAL**
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=WEAK DRIFT (노이즈 가능) (DISINFLATION_RISK_ON) / 수급=1.62 ⚠️ 수급 다소 과열 → Phase=WAITING / RANGE (대기·박스권)
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `MIXED` | **VIX:** `18.71`
- **Positioning Data:** Z-Score: `1.62` (>1.8 시 Run) | Gamma: `1.80` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Risk Budget:** 46 | **Phase Cap:** 60
- **VIX Level:** 18.71 (NORMAL) | **Change:** +0.00%
...
**Context:** phase=WAITING / RANGE (대기·박스권) / T10Y2Y=0.53 (MODERATE STEEP) / VIX=18.71 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Flow Overlay:** flow_score=3 / flow_state=👀 EARLY TRACE / drift_label=DISINFLATION_RISK_ON / gamma=🟢 POSITIVE GAMMA (WEAK)

**Overweight:** Consumer Staples, Health Care, Utilities

**Underweight:** Energy, Real Estate, Consumer Discretionary, Technology
...
- **Total Target Exposure:** **46.0%** (from Filter 15)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +4 | ALIGNED | **20.4%** | STRONG BUY |
| Health Care | +4 | ALIGNED | **20.4%** | STRONG BUY |
| Utilities | +1 | ALIGNED | **5.1%** | HOLD |
...
| :--- | :---: | :---: | :--- |
| Consumer Staples | XLP | 20.4% | PRIMARY |
| Health Care | XLV | 20.4% | PRIMARY |
| Utilities | XLU | 5.1% | SMALL |
