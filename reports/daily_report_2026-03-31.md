...
- **달러 인덱스**: 100.441  (-0.07% vs 100.510)
- **WTI 유가**: 102.950  (+0.07% vs 102.880)
- **변동성 지수 (VIX)**: 30.610  (+0.00% vs 30.610)
- **원/달러 환율**: 1533.480  (+1.76% vs 1507.020)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ -0.069 / US10YΔ +0.000**
...
- WTI **(Noise, +0.07%)** → 인플레 재자극 가능성
- VIX **(Noise, +0.00%)** → 변동성 보합(심리 변화 제한)
- 원/달러(USDKRW) **(Strong, +1.76%)** → 원화 약세/수급 부담
...
- **Cosine Similarity Score:** 0.450
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.450
  - Ukraine_2022: 0.415
  - Israel_2023: 0.350
- **Top Drivers:**
  - USDCNH: z_used=+0.86 (z1d=+0.28, z5d=+1.73, raw_w=0.18, norm_w=0.14) → contrib=+0.12
  - KR10Y_SPREAD: z_used=-1.00 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.06
  - GOLD: z_used=+0.60 (z1d=+0.50, z5d=+0.74, raw_w=0.12, norm_w=0.09) → contrib=+0.06
...
- **강도:** US10Y(Noise) / DXY(Mild) / WTI(Noise) / VIX(Noise)
...
- **Today snapshot:** US10Y(4.342), DXY(100.441), VIX(30.61)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ -0.069 / US10YΔ +0.000 (스태그플레이션)
