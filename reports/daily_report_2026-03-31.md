...
- **달러 인덱스**: 100.046  (+0.00% vs 100.044)
- **WTI 유가**: 102.160  (-0.04% vs 102.200)
- **변동성 지수 (VIX)**: 27.540  (+0.07% vs 27.520)
- **원/달러 환율**: 1523.380  (+0.00% vs 1523.380)
...
- **VIX 레벨:** 27.54 → **High (Risk-off bias)**
...
- **Policy Bias: TIGHTENING (긴축) (STRONG, score=+3.0) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ +0.002 / US10YΔ +0.000**
- **Expectations: dict received.**

- **판정:** **POLICY MIXED (정책 신호 혼조)**
- **근거:** 금리/달러/변동성 신호가 완전히 정렬되지 않음
- **한줄요약 ~~** 구조=TIGHTENING (긴축)(STRONG)는 참고, 가격=POLICY MIXED (정책 신호 혼조) 중심 → 최종 POLICY MIXED (정책 신호 혼조)
...
- **방향(전일 대비):** HYG(→) / LQD(↓)
- **HYG:** today 79.290 / prev 79.290 / pct 0.00%
- **LQD:** today 108.780 / prev 108.785 / pct -0.00%
- **판정:** **CREDIT NEUTRAL**
...
- WTI **(Noise, -0.04%)** → 물가 부담 완화
- VIX **(Noise, +0.07%)** → 심리 악화/리스크오프
...
- DEBUG: pct XLK=-0.015339522965407096, XLF=0.0, XLE=0.0, XLRE=0.0
...
- **Cosine Similarity Score:** 0.427
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.427
  - Ukraine_2022: 0.390
  - Israel_2023: 0.317
- **Top Drivers:**
  - KR10Y_SPREAD: z_used=-1.00 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.06
  - USDCNH: z_used=+0.41 (z1d=+0.32, z5d=+0.53, raw_w=0.18, norm_w=0.14) → contrib=+0.06
  - DE10Y_SPREAD: z_used=+1.00 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=+0.05
  - EEM: z_used=+0.44 (z1d=+0.01, z5d=-1.10, raw_w=0.10, norm_w=0.08) → contrib=+0.03
...
- **Country ETF Crash?** Yes (EIS, GLD, VXX)
- **Extreme Country Risk:** EIS, GLD, VXX
...
- **판정:** **달러 강세(DXY↑) + 유가 하락(WTI↓) + 변동성 확대(VIX↑)**
...
- **Today snapshot:** US10Y(4.317), DXY(100.046), VIX(27.54)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (STRONG, score=+3.0) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ +0.002 / US10YΔ +0.000 (시스템위기)
- **Sentiment (Fear&Greed):** 30.551118214058835 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING(시스템위기) / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 → Phase=RISK-OFF (부분 정렬)
...
**Context:** phase=RISK-OFF (부분 정렬) / T10Y2Y=0.53 (MODERATE STEEP) / VIX=30.61 (VOLATILITY SHOCK) / liquidity=DOWN-MID / credit=True
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8497316704890835
- **Z-Score (5d):** -0.6440263446042342

### EIS
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 2.1151680695883397
- **Z-Score (5d):** -1.5585791678238936

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.4124074697195335
- **Z-Score (5d):** 0.35746940107479197

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9928463649476171
- **Z-Score (5d):** -0.25404765945243124

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.003751107313145
- **Z-Score (5d):** 0.34792704661419116

### GLD
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.8310753996712746
- **Z-Score (5d):** 0.8197844473634266

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 2.070444179646946
- **Z-Score (5d):** -0.9197578568986129

### VXX
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -1.381617553926328
- **Z-Score (5d):** 0.44260999258866135
