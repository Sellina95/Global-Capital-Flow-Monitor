...
- **달러 인덱스**: 100.451  (-0.06% vs 100.510)
- **WTI 유가**: 102.760  (-0.12% vs 102.880)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ -0.059 / US10YΔ +0.000**
...
- **Top Drivers:**
  ...
  - GOLD: z_used=+0.61 (z1d=+0.51, z5d=+0.75, raw_w=0.12, norm_w=0.09) → contrib=+0.06
...
- **Today snapshot:** US10Y(4.342), DXY(100.451), VIX(30.61)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ -0.059 / US10YΔ +0.000 (스태그플레이션)
