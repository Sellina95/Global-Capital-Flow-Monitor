...
- **Risk Budget (0~100):** **20**
- **Narrative:** 구조=MIXED(스태그플레이션) / 심리=FEAR / 유동성=감소/중간 / 크레딧=안정 → Phase=RISK-ON (완화 기대·리스크 선호)
...
**Context:** phase=RISK-ON (완화 기대·리스크 선호) / T10Y2Y=0.53 (MODERATE STEEP) / VIX=31.05 (VOLATILITY SHOCK) / liquidity=DOWN-MID / credit=True
...
- **Risk Stance:** **STRONG REDUCE** *(target exposure: 20%)*
