...
- **미국 10년물 금리**: 4.082  (+0.00% vs 4.082)
- **달러 인덱스**: 98.928  (-0.00% vs 98.930)
- **WTI 유가**: 74.410  (+0.01% vs 74.400)
- **변동성 지수 (VIX)**: 22.100  (-0.23% vs 22.150)
- **원/달러 환율**: 1466.380  (+0.01% vs 1466.200)
...
- **VIX 레벨:** 22.10 → **High (Risk-off bias)**
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.040 / FCIΔ -0.039 / DXYΔ -0.002 / US10YΔ +0.000**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 80.325 / prev 80.120 / pct 0.26%
- **LQD:** today 111.000 / prev 110.990 / pct 0.01%
- **판정:** **CREDIT NEUTRAL**
...
- VIX **(Noise, -0.23%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Noise, +0.01%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, +0.26%)** → 크레딧 위험선호↑
...
- DEBUG: pct XLK=0.025149923804720815, XLF=0.0, XLE=-0.026810956707941813, XLRE=0.0
...
- **Top Drivers:**
  - USDMXN: z_used=-2.59 (w=0.05) → contrib=-0.13
  - KR10Y_SPREAD: z_used=+1.55 (w=0.08) → contrib=+0.12
  - TR10Y_SPREAD: z_used=+1.80 (w=0.05) → contrib=+0.09
  - USDCNH: z_used=+0.31 (w=0.18) → contrib=+0.06
...
- **Today snapshot:** US10Y(4.082), DXY(98.928), VIX(22.10)
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.040 / FCIΔ -0.039 / DXYΔ -0.002 / US10YΔ +0.000
- **Sentiment (Fear&Greed):** 27.443140455932294 (FEAR)
...
- **Narrative:** 구조=EASING / 심리=FEAR / 유동성=증가/중간 / 크레딧=안정 → Phase=RISK-ON (부분 정렬)
...
- **Context:** phase=RISK-ON (부분 정렬) / liquidity=UP-MID / structure=EASING / credit_calm=True
