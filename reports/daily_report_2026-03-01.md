...
- **Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.036 / US10YΔ +0.000**
...
- **Top Drivers:**
  - DXY: z_used=+0.58 (w=0.10) → contrib=+0.06
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=+0.0) | REAL_RATEΔ -0.030 / FCIΔ +0.000 / DXYΔ +0.036 / US10YΔ +0.000
...
- **Context:** phase=EVENT-WATCHING (이벤트 관망) / liquidity=UP-MID / structure=MIXED / credit_calm=True
