...
- **현실(FCI):** value=-0.505 / level=EASY (완화) / update=low-frequency | as of: 2026-06-22 (latest available)
- **유인(Real Rates):** value=2.230 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-06-22 (latest available)
...
- **WTI:** 🔴 DOWN | Short-term: MIXED | 1D=-1.80% / 5D=-11.38% | Strength: HIGH
- **DXY:** 🟢 UP | Short-term: MIXED | 1D=+0.05% / 5D=+1.15% | Strength: LOW
- **GOLD:** 🔴 DOWN | Short-term: SHORT UP | 1D=-0.25% / 5D=-0.03% | Strength: LOW
...
*(as of: RealRate: 2026-06-22 / FRED last available)*
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9751058126456076
- **Z-Score (5d):** -0.10247989118113178
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8509717481952473
- **Z-Score (5d):** 0.13645637582784337
