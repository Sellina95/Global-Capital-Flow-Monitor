...
- **달러 인덱스**: 98.167  (-0.11% vs 98.280)
- **WTI 유가**: 57.710  (+0.51% vs 57.420)
- **변동성 지수 (VIX)**: 14.950  (+0.00% vs 14.950)
- **원/달러 환율**: 1442.180  (-0.03% vs 1442.630)
...
- **핵심 신호:** US10Y(→, Noise) / DXY(↓, Mild) / VIX(→, Noise)
