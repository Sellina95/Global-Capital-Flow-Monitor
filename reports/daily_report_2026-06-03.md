...
- **[14번 구조·수급 괴리]:** 🚨 **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.43). 반전 가능성 상존.
### 🟢 Current SEW Status
- **SEW:** RISK_COMPRESSION | ⚠️ Risk Compression 발동 (권장 익스포저 55%)
- **Event Type:** NORMAL → 정상 상태 / 구조적 리스크 없음
- **Spike Monitor:** Spike 0 / Extreme 0
- **Current Reason:** ⚠️ CROWDING RISK: POS_Z Extreme (2.48) → Risk Compression (55%)
...
- **Risk:** 포지셔닝 과열(POS_Z=2.43)이 관찰되며, 크레딧은 안정적입니다. 따라서 신규 추격보다는 sizing control과 exposure discipline이 중요합니다.
- **Allocation:** 이에 따라 전체 베타 노출은 낮게 유지하며, 현금을 전략 자산으로 보유하는 접근이 적절합니다. 현재 실행 기준 노출은 약 **42%**입니다.
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **42%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=REDUCE / base_exposure=42%
...
- **WTI:** 🟢 UP | Short-term: SHORT UP | 1D=+1.39% / 5D=+7.19% | Strength: MEDIUM
- **DXY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.05% / 5D=+0.06% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT DOWN | 1D=+0.20% / 5D=+1.14% | Strength: LOW
...
- **Drift Score:** 5
- **Flow Score:** 4
- **Flow Continuity:** FLOW_FADE → 👀 EARLY TRACE (N/A, tilt=+0)
- **Flow Regime Tilt:** +2 / Flow-Gamma Tilt: +2

- **🎯 Final Risk Action:** **REDUCE**
- **Risk Budget (0~100):** **47**
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=2.43 ⚠️ 수급 과열 감지 → Phase=TRANSITION / MIXED
...
- **Positioning Data:** Z-Score: `2.43` (>1.8 시 Run) | Gamma: `0.91` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
- **Status:** **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.43). 반전 가능성 상존.
...
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.5 | NEGATIVE_DIVERGENCE | **6.9%** | SMALL ADJUST |
| Health Care | +1.5 | NEGATIVE_DIVERGENCE | **6.9%** | SMALL ADJUST |
| Technology | +1.4 | POSITIVE_DIVERGENCE | **22.9%** | REBALANCE |
| Utilities | +0.4 | ALIGNED | **5.3%** | SMALL ADJUST |
| **Cash & Hedge** | - | - | **58.0%** | DEFENSIVE |
...
1. Consumer Staples (priority_score=5.77, score=1.46, weight=6.9%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=5.77, score=1.46, weight=6.9%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Utilities (priority_score=-0.2, score=0.41, weight=5.3%, div=ALIGNED, mom=0)
4. Technology (priority_score=-4.34, score=1.3900000000000001, weight=22.9%, div=POSITIVE_DIVERGENCE, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=5.39, score=1.3900000000000001, weight=22.9%, div=POSITIVE_DIVERGENCE, mom=2)
2. Utilities (priority_score=0.41, score=0.41, weight=5.3%, div=ALIGNED, mom=0)
3. Consumer Staples (priority_score=-1.54, score=1.46, weight=6.9%, div=NEGATIVE_DIVERGENCE, mom=0)
4. Health Care (priority_score=-1.54, score=1.46, weight=6.9%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 6.9% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 6.9% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Technology | XLK | 22.9% | TACTICAL_LEADER | POSITIVE_DIVERGENCE | POSITIVE_DIVERGENCE |
| Utilities | XLU | 5.3% | SMALL | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1173032958376604
- **Z-Score (5d):** 0.6967536183469357
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.43998904300719427
- **Z-Score (5d):** 0.9071151747520705
