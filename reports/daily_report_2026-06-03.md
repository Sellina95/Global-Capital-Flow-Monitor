...
- **Allocation:** 이에 따라 전체 베타 노출은 낮게 유지하며, 현금을 전략 자산으로 보유하는 접근이 적절합니다. 현재 실행 기준 노출은 약 **43%**입니다.
...
- **Final Action:** **REDUCE**
- **Final Exposure:** **43%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=REDUCE / base_exposure=43%
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Tactical=REDUCE / Flow=👀 EARLY TRACE(4) / Drift=⚡ STRUCTURAL DRIFT(5) / Gamma=🟡 POSITIVE-TRANSITION → Tactical REDUCE → 방어 기조 유지 / 총노출 추가 감산 없이 배분 보수화
...
- **WTI:** 🟢 UP | Short-term: SHORT UP | 1D=+1.87% / 5D=+7.70% | Strength: MEDIUM
- **DXY:** 🟢 UP | Short-term: MIXED | 1D=+0.11% / 5D=+0.12% | Strength: LOW
- **GOLD:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.04% / 5D=+0.90% | Strength: LOW
...
- **Drift Score:** 5
- **Flow Score:** 4
- **Flow Continuity:** EARLY_TRACE → 👀 EARLY TRACE (FLOW_PERSISTENCE, tilt=+1)
...
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=-0.45% / dxy_pct=+0.02% / wti_pct=+1.74% / vix=15.77 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=4
...
**Scoreboard:**
- Consumer Staples: +1.5  (+2 LIQ, +1 CURVE, +0.5 PHASE, = +1.5)
- Health Care: +1.5  (+2 LIQ, +1 CURVE, +0.5 PHASE, = +1.5)
- Technology: +0.9  (-2 LIQ, +1.5 FLOW, +2 MOM, = +0.9)
...
- Real Estate: -1.5  (-1.5 LIQ, -2 MOM, = -1.5)
...
- Consumer Staples: FLOW_WEAK (theory=+3.5, flow=+0.0, final=+1.5)
- Health Care: FLOW_WEAK (theory=+3.5, flow=+0.0, final=+1.5)
- Technology: POSITIVE_DIVERGENCE (theory=-2.0, flow=+1.9, final=+0.9)
...
- Real Estate: AVOID (theory=-1.5, flow=-1.4, final=-1.5)
...
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.5 | NEGATIVE_DIVERGENCE | **7.0%** | SMALL ADJUST |
| Health Care | +1.5 | NEGATIVE_DIVERGENCE | **7.0%** | SMALL ADJUST |
| Technology | +1.4 | POSITIVE_DIVERGENCE | **23.5%** | REBALANCE |
| Utilities | +0.4 | ALIGNED | **5.5%** | SMALL ADJUST |
| **Cash & Hedge** | - | - | **57.0%** | DEFENSIVE |
...
1. Consumer Staples (priority_score=5.77, score=1.46, weight=7.0%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=5.77, score=1.46, weight=7.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Utilities (priority_score=-0.2, score=0.41, weight=5.5%, div=ALIGNED, mom=0)
4. Technology (priority_score=-4.28, score=1.3900000000000001, weight=23.5%, div=POSITIVE_DIVERGENCE, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=5.39, score=1.3900000000000001, weight=23.5%, div=POSITIVE_DIVERGENCE, mom=2)
2. Utilities (priority_score=0.41, score=0.41, weight=5.5%, div=ALIGNED, mom=0)
3. Consumer Staples (priority_score=-1.54, score=1.46, weight=7.0%, div=NEGATIVE_DIVERGENCE, mom=0)
4. Health Care (priority_score=-1.54, score=1.46, weight=7.0%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 7.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 7.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Technology | XLK | 23.5% | TACTICAL_LEADER | POSITIVE_DIVERGENCE | POSITIVE_DIVERGENCE |
| Utilities | XLU | 5.5% | SMALL | ALIGNED | ALIGNED |
