...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 65%**
- **Final Exposure (실행 기준): 65%**

- **Portfolio Stance:** HOLD / 65%
...
- **Final Action:** **HOLD**
- **Final Exposure:** **65%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=HOLD / base_exposure=65%
- **SEW:** STABLE / NORMAL
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=HOLD 반영 → Tactical=HOLD / Flow=⚡ BUILDING(6) / Drift=⚡ STRUCTURAL DRIFT(6) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 4.796  (+0.00% vs 4.796)
- **달러 인덱스**: 99.560  (-0.11% vs 99.670)
- **WTI 유가**: 91.010  (+0.88% vs 90.220)
- **변동성 지수 (VIX)**: 15.200 (-6.98% vs 16.340)
- **원/달러 환율**: 1372.860  (+0.46% vs 1366.620)
...
- **VIX 레벨:** 15.20 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.558 / level=EASY (완화) / update=low-frequency | as of: 2026-09-03 (latest available)
- **유인(Real Rates):** value=2.440 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-03 (latest available)
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.000 / FCI value=-0.558 (low-frequency) / DXYΔ -0.110 / US10YΔ +0.000**
...
- **Spread as of:** 2026-09-01 (FRED latest)
- **HY_OAS level:** 2.65% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↑) / +0.76%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 79.110 / prev 79.100 / pct 0.01%
- **LQD:** today 105.350 / prev 105.220 / pct 0.12%
- **판정:** **CREDIT NEUTRAL**
...
- WTI **(Clear, +0.88%)** → 인플레 재자극 가능성
- VIX **(Strong, -6.98%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Clear, +0.46%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, +0.01%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Mild, +0.12%)** → 우량채 강세(리스크오프 성향)
...
- **SPY:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+0.44% / 5D=-0.12% | Strength: LOW
- **WTI:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.58% / 5D=+8.32% | Strength: MEDIUM
- **DXY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.15% / 5D=+0.25% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+2.47% / 5D=-2.94% | Strength: MEDIUM
...
- **3D Avg Score:** -0.17
- **Geo Momentum:** -0.21 *(Status: FLAT)*

**Historical Pattern Match (Cosine Similarity):**
- **Closest Historical Match:** Red_Sea
- **Cosine Similarity Score:** 0.145
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: 0.145
  - China_Trade_2018: -0.086
  - Iran_Crisis_2020: -0.157
- **Top Drivers:**
  - KR10Y_SPREAD: z_used=-1.75 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.11
  - VIX: z_used=-0.59 (z1d=-1.00, z5d=+0.03, raw_w=0.18, norm_w=0.14) → contrib=-0.08
  - DE10Y_SPREAD: z_used=-1.75 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.08
  - JP10Y_SPREAD: z_used=-1.75 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.08
...
**핵심 신호:** 장단기차(40.00bp) | 실질금리(2.44%) | DXY(99.56)
*(as of: RealRate: 2026-09-03 / FRED last available)*
...
- **강도:** US10Y(Noise) / DXY(Mild) / WTI(Clear) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.796), DXY(99.560), VIX(15.20)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(→) / DXY(↓) / GOLD(↑) / VIX(↓) / WTI(↑)
- **Meaningful Move Check:** DXY=-0.11036481626608069 / GOLD=0.4208786726655934 / US10Y=0.0 / VIX=-6.976746222013978 / WTI=0.8756383338931649
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.796000003814697, RealYield=2.44, T10Y2Y=0.4, WTI=91.01000213623048, DXY=99.55999755859376, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.65, DriftLabel=NEUTRAL, FredAsof=2026-09-02
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=2.53 → healthy contango / stable structure
...
- **Breadth Note:** RSP-SPY return spread=0.02%p → neutral breadth
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=-0.24%p → neutral Nasdaq breadth
- **Positioning / Gamma:** 1
...
**Leadership Notes**
- QQQ-SPY spread=-0.22%p → neutral growth leadership
- SMH-QQQ spread=0.74%p → semiconductor participation strong
- SOXX-QQQ spread=-0.00%p → chip breadth neutral
- IWM-SPY spread=0.74%p → small-cap participation confirms broader risk-on
- XLF-SPY spread=0.36%p → sector diffusion positive
- XLI-SPY spread=-0.41%p → sector diffusion weak
- XLY-SPY spread=-0.21%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.000 / FCI value=-0.558 (low-frequency) / DXYΔ -0.110 / US10YΔ +0.000 (정상)
- **Sentiment (Fear&Greed):** 67.92507304602282 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=EASING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.58 ⚠️ 수급 다소 과열 → Phase=TRANSITION / MIXED
...
- **Structure(3번):** `EASING` | **Price(Regime):** `TRANSITION / MIXED` | **Bucket:** `MIXED` | **VIX:** `15.20`
- **Positioning Data:** Z-Score: `1.58` (>1.8 시 Run) | Gamma: `0.71` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **VIX Level:** 15.20 (NORMAL) | **Change:** -6.98%
...
**Context:** phase=TRANSITION / MIXED / T10Y2Y=0.40 (MODERATE STEEP) / VIX=15.20 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** BALANCED
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=+0.00% / dxy_pct=-0.11% / wti_pct=+0.88% / vix=15.20 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=6
...
**Overweight:** Consumer Staples, Health Care, Financials, Utilities, Energy

**Underweight:** Industrials, Technology, Real Estate, Consumer Discretionary

**Scoreboard:**
- Consumer Staples: +1.6  (+2 LIQ, +0.5 PHASE, = +1.6)
- Health Care: +1.6  (+2 LIQ, +0.5 PHASE, = +1.6)
- Financials: +1.4  (+2 CURVE, +1 MOM, = +1.4)
- Utilities: +0.7  (+1 LIQ, = +0.7)
- Energy: +0.6  (+2 MOM, = +0.6)
- Consumer Discretionary: -1.1  (-1 LIQ, -1 MOM, = -1.1)
- Real Estate: -1.4  (-1.5 LIQ, -1 MOM, = -1.4)
- Technology: -1.4  (-2 LIQ, +1.5 FLOW, -1 MOM, = -1.4)
...
- OW Financials: +2: 완만한 스티프닝(0.40) → 예대마진 개선
...
- UW Industrials: +1: 완만한 스티프닝(0.40) → 성장 기대 반영
- UW Industrials: +0.5: Flow Overlay → 경기민감 확인용 가점

**Regime Controller:**
- BALANCED (avg_divergence=-0.47, dispersion=1.44)
...
- Consumer Staples: FLOW_WEAK (theory=+2.5, flow=+0.0, final=+1.6)
- Health Care: FLOW_WEAK (theory=+2.5, flow=+0.0, final=+1.6)
...
- Consumer Discretionary: AVOID (theory=-1.0, flow=-0.7, final=-1.1)
- Real Estate: AVOID (theory=-1.5, flow=-0.7, final=-1.4)
- Technology: AVOID (theory=-2.0, flow=-0.2, final=-1.4)
...
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.6 | NEGATIVE_DIVERGENCE | **15.0%** | REBALANCE |
| Health Care | +1.6 | NEGATIVE_DIVERGENCE | **15.0%** | REBALANCE |
| Financials | +1.4 | NEGATIVE_DIVERGENCE | **13.2%** | NEW |
| Utilities | +0.7 | ALIGNED | **10.3%** | SMALL ADJUST |
| Energy | +0.6 | POSITIVE_DIVERGENCE | **11.5%** | NEW |
...
1. Consumer Staples (priority_score=3.51, score=1.57, weight=15.0%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Health Care (priority_score=3.51, score=1.57, weight=15.0%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Financials (priority_score=2.34, score=1.38, weight=13.2%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Utilities (priority_score=-0.33, score=0.65, weight=10.3%, div=ALIGNED, mom=0)
5. Energy (priority_score=-4.32, score=0.63, weight=11.5%, div=POSITIVE_DIVERGENCE, mom=2)
...
2. Utilities (priority_score=0.65, score=0.65, weight=10.3%, div=ALIGNED, mom=0)
3. Financials (priority_score=-0.12, score=1.38, weight=13.2%, div=NEGATIVE_DIVERGENCE, mom=1)
4. Consumer Staples (priority_score=-1.43, score=1.57, weight=15.0%, div=NEGATIVE_DIVERGENCE, mom=0)
5. Health Care (priority_score=-1.43, score=1.57, weight=15.0%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 15.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 15.0% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Financials | XLF | 13.2% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Utilities | XLU | 10.3% | ADD | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.25060264832444545
- **Z-Score (5d):** -1.6015680767633904

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.2767564594228606
- **Z-Score (5d):** -0.007611633624179557

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 1.4699103153482684
- **Z-Score (5d):** 0.25339596178875645

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.19245216571618837
- **Z-Score (5d):** -1.5035992417912425

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.536874007415661
- **Z-Score (5d):** 0.1072700313881575

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.45744757994601937
- **Z-Score (5d):** -0.04760193612217017

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.8746095684821972
- **Z-Score (5d):** -1.2001222846304402

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.4678198161722494
- **Z-Score (5d):** -0.19483896516198954

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8318159241878486
- **Z-Score (5d):** -0.24884159843441708
