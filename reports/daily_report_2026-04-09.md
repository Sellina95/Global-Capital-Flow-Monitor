...
## ⚡ Strategic War Room
> **[14번 수격괴리]: ✅ **ALIGNED** -> **해석:** 구조와 가격, 수급이 조화를 이루며 추세 유지 중**
> **[액션]: 🚨 **STAY (포지션 유지)****
...
- **달러 인덱스**: 99.020  (-0.62% vs 99.640)
- **WTI 유가**: 97.700  (-13.50% vs 112.950)
- **변동성 지수 (VIX)**: 25.780  (+0.00% vs 25.780)
- **원/달러 환율**: 1480.680  (-1.80% vs 1507.850)

---

## 🚨 Regime Change Monitor (always-on)
- **Status:** ✅ DETECTED
- **Prev → Current:** RISK-ON (완화 기대·리스크 선호) → EVENT-WATCHING (이벤트 관망)
...
- **VIX 레벨:** 25.78 → **High (Risk-off bias)**
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.620 / US10YΔ +0.000**
...
- **Top Similarity Matches:**
  ...
  - Ukraine_2022: -0.294
- **Top Drivers:**
  - USDCNH: z_used=-2.61 (z1d=-2.62, z5d=-2.60, raw_w=0.18, norm_w=0.14) → contrib=-0.36
  - WTI: z_used=-2.35 (z1d=-3.19, z5d=-1.07, raw_w=0.10, norm_w=0.08) → contrib=-0.18
  - USDMXN: z_used=-2.42 (z1d=-2.26, z5d=-2.66, raw_w=0.05, norm_w=0.04) → contrib=-0.09
...
- **Today snapshot:** US10Y(4.343), DXY(99.020), VIX(25.78)
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.620 / US10YΔ +0.000 (정상)
...
**Context:** phase=EVENT-WATCHING (이벤트 관망) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=25.78 (VOLATILITY ELEVATED) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE

**Overweight:** Consumer Staples, Financials, Consumer Discretionary, Industrials, Utilities, Health Care

**Underweight:** Technology

**Scoreboard:**
- Consumer Staples: +3  (+2 VOL, +1 PHASE, = +3)
- Financials: +3  (+1 LIQ, +2 CURVE, = +3)
- Consumer Discretionary: +2  (+2 LIQ, = +2)
- Industrials: +2  (+2 LIQ, +1 CURVE, -1 PHASE, = +2)
- Utilities: +2  (+3 VOL, -1 LIQ, = +2)
- Health Care: +1  (+1 PHASE, = +1)
- Technology: -1  (-3 VOL, +2 LIQ, = -1)

**Rationale (top drivers):**
- OW Consumer Staples: +2: VOLATILITY ELEVATED → 필수소비 선호 (absolute mode: VIX 25.8)
...
- UW Technology: -3: VOLATILITY ELEVATED → 위험자산 회피 (absolute mode: VIX 25.8)
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.5626382603800831
- **Z-Score (5d):** 0.953238799006474
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.14879736855705333
- **Z-Score (5d):** 1.9570241539342084
