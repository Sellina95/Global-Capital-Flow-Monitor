...
- **달러 인덱스**: 99.044  (+0.00% vs 99.044)
- **WTI 유가**: 96.970  (-0.01% vs 96.980)
- **변동성 지수 (VIX)**: 21.040  (+0.00% vs 21.040)
- **원/달러 환율**: 1480.780  (-1.22% vs 1499.130)
...
- 원/달러(USDKRW) **(Strong, -1.22%)** → 원화 강세/수급 개선
...
- **Top Similarity Matches:**
  - Israel_2023: -0.300
  - Red_Sea: -0.387
  - Iran_Crisis_2020: -0.449
- **Top Drivers:**
  - USDCNH: z_used=-1.44 (z1d=-1.14, z5d=-1.88, raw_w=0.18, norm_w=0.14) → contrib=-0.20
...
- **Today snapshot:** US10Y(4.291), DXY(99.044), VIX(21.04)
...
- **Structure(3번):** `MIXED` | **Price(Regime):** `MIXED` | **VIX:** `21.04`
...
**Context:** phase=WAITING / RANGE (대기·박스권) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=21.04 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
