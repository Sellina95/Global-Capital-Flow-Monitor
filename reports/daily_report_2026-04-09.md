...
- **달러 인덱스**: 99.046  (+0.00% vs 99.044)
- **WTI 유가**: 97.000  (-0.04% vs 97.040)
- **변동성 지수 (VIX)**: 21.040  (+0.00% vs 21.040)
- **원/달러 환율**: 1481.190  (-1.20% vs 1499.130)

---

## 🚨 Regime Change Monitor (always-on)
- **Status:** ❎ NOT DETECTED
- **Current Regime:** EVENT-WATCHING (이벤트 관망)
- **File:** not created
- **Email:** not sent
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.002 / US10YΔ +0.000**
...
- 원/달러(USDKRW) **(Strong, -1.20%)** → 원화 강세/수급 개선
...
- **Cosine Similarity Score:** -0.301
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Israel_2023: -0.301
  - Red_Sea: -0.388
  - Iran_Crisis_2020: -0.450
- **Top Drivers:**
  - USDCNH: z_used=-1.45 (z1d=-1.15, z5d=-1.89, raw_w=0.18, norm_w=0.14) → contrib=-0.20
  - VIX: z_used=-0.62 (z1d=-0.10, z5d=-1.40, raw_w=0.18, norm_w=0.14) → contrib=-0.09
...
- **Today snapshot:** US10Y(4.291), DXY(99.046), VIX(21.04)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.002 / US10YΔ +0.000 (정상)
- **Sentiment (Fear&Greed):** 50.7557043275231 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 수급=0.71 → Phase=EVENT-WATCHING (이벤트 관망)
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `MIXED` | **VIX:** `21.04`
...
**Context:** phase=EVENT-WATCHING (이벤트 관망) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=21.04 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 2.563413692977413
- **Z-Score (5d):** 2.221722356372153
