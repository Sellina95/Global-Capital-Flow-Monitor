...
- **달러 인덱스**: 98.898  (-0.13% vs 99.030)
- **WTI 유가**: 98.720  (+4.57% vs 94.410)
- **변동성 지수 (VIX)**: 21.320  (+1.33% vs 21.040)
- **원/달러 환율**: 1479.520  (-1.31% vs 1499.130)
...
- **VIX 레벨:** 21.32 → **High (Risk-off bias)**
...
- **Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.132 / US10YΔ +0.000**
...
- WTI **(Strong, +4.57%)** → 인플레 재자극 가능성
- VIX **(Clear, +1.33%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, -1.31%)** → 원화 강세/수급 개선
...
- **Cosine Similarity Score:** -0.255
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Iran_Crisis_2020: -0.255
  - Red_Sea: -0.258
  - Ukraine_2022: -0.378
- **Top Drivers:**
  - USDCNH: z_used=-1.45 (z1d=-1.16, z5d=-1.89, raw_w=0.18, norm_w=0.14) → contrib=-0.20
  - VIX: z_used=-0.51 (z1d=+0.03, z5d=-1.31, raw_w=0.18, norm_w=0.14) → contrib=-0.07
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(1.96%) | DXY(98.90)
...
- **Today snapshot:** US10Y(4.291), DXY(98.898), VIX(21.32)
...
- **Structure Bias:** Policy Bias: EASING (완화) (MODERATE, score=-1.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ -0.132 / US10YΔ +0.000 (정상)
- **Sentiment (Fear&Greed):** 50.12145709469072 (NEUTRAL)
- **Credit Calm:** True
...
- **Structure(3번):** `EASING` | **Price(Regime):** `MIXED` | **VIX:** `21.32`
...
- **VIX Level:** 21.32 (HIGH) | **Change:** +1.33%
...
**Context:** phase=TRANSITION / MIXED (전환·혼조) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=21.32 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 2.563412281719147
- **Z-Score (5d):** 2.2217221911250085
