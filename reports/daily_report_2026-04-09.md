...
- **달러 인덱스**: 99.037  (+0.00% vs 99.036)
- **WTI 유가**: 96.930  (+0.05% vs 96.880)
...
- **Status:** ✅ DETECTED
- **Prev → Current:** WAITING / RANGE (대기·박스권) → EVENT-WATCHING (이벤트 관망)
...
- **Cosine Similarity Score:** -0.300
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Israel_2023: -0.300
  - Red_Sea: -0.386
  - Iran_Crisis_2020: -0.447
- **Top Drivers:**
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(1.96%) | DXY(99.04)
...
- **Today snapshot:** US10Y(4.291), DXY(99.037), VIX(21.04)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.0) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.001 / US10YΔ +0.000 (정상)
