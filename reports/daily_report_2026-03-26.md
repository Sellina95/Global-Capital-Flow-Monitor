...
- **미국 10년물 금리**: 4.364  (-0.05% vs 4.366)
- **달러 인덱스**: 99.782  (+0.00% vs 99.782)
- **WTI 유가**: 93.850  (+0.03% vs 93.820)
- **변동성 지수 (VIX)**: 26.980  (-0.07% vs 27.000)
- **원/달러 환율**: 1505.620  (+0.55% vs 1497.310)
...
- **VIX 레벨:** 26.98 → **High (Risk-off bias)**
...
- **유인(Real Rates):** level=RESTRICTIVE (유인↓) / dir(↓) | as of: 2026-03-24 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ +0.000 / US10YΔ -0.002**
...
- **Spread as of:** 2026-03-24 (FRED latest)
- **HY_OAS level:** 3.19% → **WARM (경계)**
- **방향(전일 대비):** HY_OAS(→) / +0.00%
- **판정:** **CREDIT WATCH**
- **근거:** 스프레드 상승 구간 진입 → 리스크 프리미엄 확대 가능 / 방향성 제한 → 레벨 중심 해석
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.175 / prev 79.190 / pct -0.02%
- **LQD:** today 108.280 / prev 108.310 / pct -0.03%
- **판정:** **CREDIT NEUTRAL**
...
- WTI **(Noise, +0.03%)** → 인플레 재자극 가능성
- VIX **(Noise, -0.07%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Strong, +0.55%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Noise, -0.02%)** → 크레딧 스트레스↑
...
- DEBUG: pct XLK=-0.02224768622931593, XLF=-0.030447902346230352, XLE=-0.12298231071382909, XLRE=-0.04983916578951446
Correlation Break Detected:
- US10Y ↓ but XLK ↓ (Tech)
- WTI ↑ but XLE ↓ (Energy)
...
- **Cosine Similarity Score:** 0.327
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.327
  - Ukraine_2022: 0.263
  - Israel_2023: 0.251
- **Top Drivers:**
  - USDCNH: z_used=+0.47 (z1d=+0.06, z5d=+1.09, raw_w=0.18, norm_w=0.14) → contrib=+0.07
  - KR10Y_SPREAD: z_used=-1.00 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.06
  - EMB: z_used=-0.66 (z1d=+0.10, z5d=+1.49, raw_w=0.12, norm_w=0.09) → contrib=-0.06
...
- **판정:** **금리 하락(US10Y↓) + 유가 상승(WTI↑) + 변동성 완화(VIX↓)**

### 🔄 10) Direction Filter
- **질문:** 오늘 움직임은 ‘노이즈’인가 ‘의미 있는 변화’인가?
- **강도:** US10Y(Mild) / DXY(Noise) / WTI(Noise) / VIX(Noise)
...
- **Today snapshot:** US10Y(4.364), DXY(99.782), VIX(26.98)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.050 / FCIΔ +0.039 / DXYΔ +0.000 / US10YΔ -0.002
- **Sentiment (Fear&Greed):** 31.723898288725707 (NEUTRAL)
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 → Phase=RISK-ON (부분 정렬)
...
- **Status:** **DIVERGENCE**
- **해석:** 구조는 긴축인데 가격은 리스크온 → 과열/되돌림 가능성
...
- **Context:** phase=RISK-ON (부분 정렬) / T10Y2Y=0.00 / VIX=20.00 / credit=True
...
- **Rationale (top drivers):**
  ...
  - OW Financials: +2: 긴축 → 금리 환경 우호
  - UW Technology: -3: 유동성 흡수 → 고베타 부담
  - UW Real Estate: -2: 유동성 흡수 → 레버리지 부담
  - UW Consumer Discretionary: -2: 유동성 흡수 → 소비 압박
...
- **Risk Stance:** **HOLD** *(target exposure: 45%)*
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.135745447176026
- **Z-Score (5d):** -1.219279804991654

### EEM
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -1.3489506215865186
- **Z-Score (5d):** -0.9051319602942945

### EIS
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -0.9071841604436676
- **Z-Score (5d):** -1.2939132127159523

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.1384312941512098
- **Z-Score (5d):** -0.7858751253713823

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.961434106108855
- **Z-Score (5d):** -0.2678900367617783

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -1.6420174729201582
- **Z-Score (5d):** -0.8410591840367169

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.7917584245501647
- **Z-Score (5d):** -0.7943524899223693

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0155963651287683
- **Z-Score (5d):** -0.56418115284503

### VXX
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.5069032709009405
- **Z-Score (5d):** 0.35191906229469344
