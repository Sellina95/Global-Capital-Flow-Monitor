...
- **Final Action:** **HOLD**
- **Final Exposure:** **64%**
- **Base Context:** phase=TRANSITION / MIXED / narrative=HOLD / base_exposure=64%
- **SEW:** STABLE / NORMAL
...
- **Positioning:** pos_z=1.56
- **Warning Score:** 2 (6.5 상관관계 붕괴, 6.6 섹터 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=HOLD 반영 → Warning Score 2 → 섹터/상관관계 경고, 총노출 추가 감산 없이 배분 보수화 → Tactical=HOLD / Flow=⚡ BUILDING(6) / Drift=⚡ STRUCTURAL DRIFT(6) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **현실(FCI):** value=-0.560 / level=EASY (완화) / update=low-frequency | as of: 2026-09-20 (latest available)
- **유인(Real Rates):** value=2.610 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-20 (latest available)
...
- **WTI:** 🔴 DOWN | Short-term: SHORT UP | 1D=-5.72% / 5D=-3.97% | Strength: MEDIUM
- **DXY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.00% / 5D=+1.10% | Strength: LOW
- **GOLD:** 🟢 UP | Short-term: SHORT UP | 1D=+0.57% / 5D=+0.36% | Strength: LOW
...
- **Geo Stress Score (z-composite):** **-0.77**  *(Level: N/A)*
...
- **Cosine Similarity Score:** -0.426
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: -0.426
  - Iran_Crisis_2020: -0.469
  - Ukraine_2022: -0.499
- **Top Drivers:**
  - USDCNH: z_used=-1.41 (z1d=-2.01, z5d=-0.50, raw_w=0.18, norm_w=0.14) → contrib=-0.19
  - WTI: z_used=-1.55 (z1d=-1.95, z5d=-0.96, raw_w=0.10, norm_w=0.08) → contrib=-0.12
...
*(as of: RealRate: 2026-09-20 / FRED last available)*
...
- **Meaningful Move Check:** DXY=0.0 / GOLD=0.5727596407159312 / US10Y=1.030930219937885 / VIX=-4.080305556271018 / WTI=-5.720735572127474
- **판정:** **NEUTRAL**
...
- **Input Check:** US10Y=4.998000144958496, RealYield=2.61, T10Y2Y=0.25, WTI=96.08000183105467, DXY=100.22000122070312, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.7, DriftLabel=NEUTRAL, FredAsof=2026-09-18
...
- **Narrative:** 구조=MIXED / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=1.56 ⚠️ 수급 다소 과열 → Phase=TRANSITION / MIXED
...
- **Positioning Data:** Z-Score: `1.56` (>1.8 시 Run) | Gamma: `1.62` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Positioning Heat(1.56), Positive Gamma(1.62)
...
**Macro Inputs Debug:** phase=TRANSITION / MIXED / us10y_pct=+1.03% / dxy_pct=+0.00% / wti_pct=-5.72% / vix=14.81 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=6
...
| :--- | :---: | :---: | :---: | :--- |
| Technology | +2.3 | ALIGNED | **10.0%** | HOLD |
| Energy | +0.7 | POSITIVE_DIVERGENCE | **10.0%** | HOLD |
| Consumer Staples | +0.2 | ALIGNED | **3.6%** | HOLD |
| Health Care | +0.2 | ALIGNED | **3.6%** | HOLD |
...
- **Participation / Quality Cap Applied:**
  - Technology: 44.2% → 10.0% (-34.2%)
  - Energy: 12.9% → 10.0% (-2.9%)
- **Strategic Cash (15):** 36.0%
- **Tactical Reserve (Cap / Unallocated):** 36.8%
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.4287043436223583
- **Z-Score (5d):** 0.270946290699504
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.8489181403949234
- **Z-Score (5d):** 0.3927354542168205
