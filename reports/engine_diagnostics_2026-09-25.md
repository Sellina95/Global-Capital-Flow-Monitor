...
### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 24%**
- **Final Exposure (실행 기준): 24%**

- **Portfolio Stance:** STRONG REDUCE / 24%
...
- **Final Exposure:** **24%**
- **Base Context:** phase=EVENT-WATCHING / INFLATION / narrative=STRONG REDUCE / base_exposure=24%
- **SEW:** STABLE / NORMAL
...
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence ALIGNED → 구조·가격·수급 정렬 → Narrative Action=STRONG REDUCE 반영 → Tactical=HOLD / Flow=👀 EARLY TRACE(4) / Drift=👀 EARLY DRIFT(3) / Gamma=🟡 POSITIVE-TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 5.162  (+0.94% vs 5.114)
- **달러 인덱스**: 101.290  (+0.19% vs 101.100)
- **WTI 유가**: 94.610  (+2.66% vs 92.160)
- **변동성 지수 (VIX)**: 15.670 (+3.23% vs 15.180)
- **원/달러 환율**: 1362.500  (+0.90% vs 1350.360)
...
- **VIX 레벨:** 15.67 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** value=-0.555 / level=EASY (완화) / update=low-frequency | as of: 2026-09-25 (latest available)
- **유인(Real Rates):** value=2.760 / level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-09-25 (latest available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.555 (low-frequency) / DXYΔ +0.190 / US10YΔ +0.048**
...
- **Spread as of:** 2026-09-23 (FRED latest)
- **HY_OAS level:** 2.73% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↑) / +1.87%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 77.890 / prev 78.100 / pct -0.27%
- **LQD:** today 103.150 / prev 103.890 / pct -0.71%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +0.94%)** → 완화 기대 약화/금리 부담
- DXY **(Clear, +0.19%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +2.66%)** → 인플레 재자극 가능성
- VIX **(Strong, +3.23%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Strong, +0.90%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Mild, -0.27%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Clear, -0.71%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.07% / 5D=+0.61% | Strength: LOW
- **WTI:** 🔴 DOWN | Short-term: SHORT DOWN | 1D=-2.04% / 5D=-7.60% | Strength: MEDIUM
- **DXY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.07% / 5D=+1.00% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.13% / 5D=-2.74% | Strength: LOW
...
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.130
  - China_Trade_2018: 0.027
  - Ukraine_2022: -0.071
- **Top Drivers:**
  - USDCNH: z_used=+1.84 (z1d=+2.57, z5d=+0.75, raw_w=0.18, norm_w=0.14) → contrib=+0.26
  - KR10Y_SPREAD: z_used=-2.60 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.16
  - USDMXN: z_used=+3.44 (z1d=+3.69, z5d=+3.08, raw_w=0.05, norm_w=0.04) → contrib=+0.13
  - DE10Y_SPREAD: z_used=-2.79 (mode=level, raw_w=0.06, norm_w=0.05) → contrib=-0.13
...
**핵심 신호:** 장단기차(31.00bp) | 실질금리(2.76%) | DXY(101.29)
*(as of: RealRate: 2026-09-25 / FRED last available)*
...
- **Today snapshot:** US10Y(5.162), DXY(101.290), VIX(15.67)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↑)
- **Meaningful Move Check:** DXY=0.18793515754096235 / GOLD=-0.472394933426111 / US10Y=0.9386065146923179 / VIX=3.2279299161218957 / WTI=2.658416721883745
- **판정:** **ENERGY-DRIVEN STAGFLATION (에너지 주도 스태그)**
- **근거:** 긴축적인 실질금리(2.76%) 환경에서도 고유가가 의미 있게 유지/상승. 공급 측 구조 압박 가능성
...
- **Input Check:** US10Y=5.162000179290772, RealYield=2.76, T10Y2Y=0.31, WTI=94.61000061035156, DXY=101.29000091552734, LiquidityDir=DOWN, CreditCalm=True, HY_OAS=2.73, DriftLabel=NEUTRAL, FredAsof=2026-09-24
...
- **Breadth Note:** RSP-SPY return spread=-0.41%p → narrow cap-weight leadership
...
- SMH-QQQ spread=-0.13%p → semiconductor participation neutral
- SOXX-QQQ spread=0.08%p → chip breadth neutral
- IWM-SPY spread=-0.01%p → small-cap participation neutral
- XLF-SPY spread=0.06%p → sector diffusion neutral
- XLI-SPY spread=-0.66%p → sector diffusion weak
- XLY-SPY spread=-0.22%p → sector diffusion neutral
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCI value=-0.555 (low-frequency) / DXYΔ +0.190 / US10YΔ +0.048 (스태그플레이션)
- **Sentiment (Fear&Greed):** 66.83522044537881 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING(스태그플레이션) / 심리=NEUTRAL / 유동성=감소/중간 / 크레딧=안정 / 드리프트=👀 EARLY DRIFT (NEUTRAL) / 수급=1.64 ⚠️ 수급 다소 과열 → Phase=EVENT-WATCHING / INFLATION
...
- **Structure(3번):** `TIGHTENING` | **Price(Regime):** `EVENT-WATCHING` | **Bucket:** `MIXED` | **VIX:** `15.67`
...
**Context:** phase=EVENT-WATCHING / INFLATION / T10Y2Y=0.31 (MODERATE STEEP) / VIX=15.67 (VOLATILITY NORMAL) / liquidity=DOWN-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** EVENT_TRANSITION
**Macro Inputs Debug:** phase=EVENT-WATCHING / INFLATION / us10y_pct=+0.94% / dxy_pct=+0.19% / wti_pct=+2.66% / vix=15.67 / liq_easy=False / liq_tight=True / credit_calm=True / flow_score=4
...
**Underweight:** Real Estate, Financials, Consumer Discretionary, Technology, Industrials, Energy

**Scoreboard:**
- Consumer Staples: +1.4  (+2 LIQ, +1 PHASE, = +1.4)
- Health Care: +1.4  (+2 LIQ, +1 PHASE, = +1.4)
- Utilities: +0.5  (+1 LIQ, = +0.5)
- Energy: -0.2  (-1 PHASE, +2 MOM, = -0.2)
- Industrials: -0.3  (+1 CURVE, -0.5 PHASE, +1 FLOW, -2 MOM, = -0.3)
- Technology: -0.6  (-2 LIQ, -0.5 PHASE, +1.5 FLOW, +1 MOM, = -0.6)
- Consumer Discretionary: -1.4  (-1 LIQ, -2 MOM, = -1.4)
- Financials: -1.6  (+2 CURVE, -1 MOM, = -1.6)
...
- UW Financials: +2: 완만한 스티프닝(0.31) → 예대마진 개선
- UW Financials: -1: Relative Strength 약세 (vs SPY) → 소외 섹터

**Regime Controller:**
- DISLOCATION (avg_divergence=-0.60, dispersion=1.92)
...
- Consumer Staples: FLOW_WEAK (theory=+3.0, flow=+0.0, final=+1.4)
- Health Care: FLOW_WEAK (theory=+3.0, flow=+0.0, final=+1.4)
- Communication Services: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Materials: NEUTRAL (theory=+0.0, flow=+0.0, final=+0.0)
- Energy: TACTICAL_MOMENTUM_ONLY (theory=+0.0, flow=+1.4, final=-0.2)
- Consumer Discretionary: AVOID (theory=-1.0, flow=-1.4, final=-1.4)
- Financials: THEORY_TRAP (theory=+2.0, flow=-0.7, final=-1.6)
- Real Estate: AVOID (theory=-1.5, flow=-1.4, final=-1.7)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **24.0%** → **Regime Adjusted:** **24.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Consumer Staples | +1.4 | NEGATIVE_DIVERGENCE | **6.8%** | DELEVERAGE |
| Health Care | +1.4 | NEGATIVE_DIVERGENCE | **8.9%** | DELEVERAGE |
| Utilities | +0.5 | ALIGNED | **8.3%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **76.0%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** EVENT_TRANSITION
- **Regime Cap Applied:** None
- **Strategic Cash (15):** 76.0%
- **Tactical Reserve (Cap / Unallocated):** 0.0%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Health Care (priority_score=3.46, score=1.35, weight=8.9%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Staples (priority_score=3.33, score=1.35, weight=6.8%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Utilities (priority_score=-0.18, score=0.45, weight=8.3%, div=ALIGNED, mom=0)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Utilities (priority_score=0.45, score=0.45, weight=8.3%, div=ALIGNED, mom=0)
2. Consumer Staples (priority_score=-1.65, score=1.35, weight=6.8%, div=NEGATIVE_DIVERGENCE, mom=0)
3. Health Care (priority_score=-1.65, score=1.35, weight=8.9%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Consumer Staples | XLP | 6.8% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Health Care | XLV | 8.9% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.6822000941232782
- **Z-Score (5d):** -1.691926859289792

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.4316444647463365
- **Z-Score (5d):** 0.8606415991942793

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.2304475582502712
- **Z-Score (5d):** -0.4262375124683183

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.2967846015451887
- **Z-Score (5d):** -1.363954629032455

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0507162002349504
- **Z-Score (5d):** -0.7335498488299108

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.4399345308371366
- **Z-Score (5d):** 0.12322255548144652

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.2784764658211553
- **Z-Score (5d):** -0.7432313506111065

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.19162143887864252
- **Z-Score (5d):** 0.3014862696515659

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.3620994788455441
- **Z-Score (5d):** -0.6502194920758927
