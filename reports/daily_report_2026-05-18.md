...
- **WTI:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-4.95% / 5D=+2.17% | Strength: MEDIUM
- **DXY:** 🟡 PULLBACK | Short-term: SHORT DOWN | 1D=-0.23% / 5D=+1.13% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: SHORT UP | 1D=+0.20% / 5D=-3.26% | Strength: LOW
...
- **Dealer Gamma Bias:** 1.48 (NEUTRAL / transition zone)
...
- **Input Check:** US10Y=4.59499979019165, RealYield=missing, T10Y2Y=missing, WTI=105.41999816894533, DXY=99.2699966430664, LiquidityDir=UP, CreditCalm=None, DriftLabel=UNKNOWN
...
- **Positioning Data:** Z-Score: `2.12` (>1.8 시 Run) | Gamma: `1.48` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
