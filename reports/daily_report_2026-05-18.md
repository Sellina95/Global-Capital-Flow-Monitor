...
- [2026-05-18 13:34:37] ALERT | SEW=DEADMAN | EVENT=NORMAL | credit=CREDIT_CALM(2.76%) | flow=👀 EARLY TRACE -> 👀 EARLY TRACE | flow_delta=0 | persistence=1 | flow_alert=NONE | Exp=0% | 🚨 HARD DEADMAN: Real-time Cross-Asset Shock (spike=1, extreme=2) | spike=1 extreme=2 | corr_break=NO | email=YES | z={'SPY': -0.1113396993100014, 'QQQ': 2.6330406074917376, 'VIX': 0.7472213181660198, 'DXY': -3.9888002239850193, 'WTI': -4.038704496618738}
👉 해석: 오늘 장중 데드맨/리스크 이벤트 이력이 있었으나, 현재 상태는 아래 SEW 현재값을 기준으로 별도 판단합니다.

### 🎯 Exposure Framework
- **Base Exposure (전략 기준): 21%**
- **Final Exposure (실행 기준): 21%**

- **Portfolio Stance:** STRONG REDUCE / 21%

- **[14번 구조·수급 괴리]:** 🚨 **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.12). 반전 가능성 상존.
### 🟢 Current SEW Status
- **SEW:** RISK_COMPRESSION | ⚠️ Risk Compression 발동 (권장 익스포저 55%)
- **Event Type:** NORMAL → 정상 상태 / 구조적 리스크 없음
- **Spike Monitor:** Spike 0 / Extreme 0
- **Current Reason:** ⚠️ CROWDING RISK: POS_Z Extreme (2.15) → Risk Compression (55%)
...
- 전일 SEW 기준 기관성 초기 흐름이 관찰되었습니다 (👀 EARLY TRACE, score=4). 금일은 리더 섹터 지속 여부와 흐름의 강화 여부를 확인해야 합니다.
...
- **Final Exposure:** **21%**
- **Base Context:** phase=EVENT-WATCHING / INFLATION / narrative=STRONG REDUCE / base_exposure=21%
...
- **Positioning:** pos_z=2.12
- **Warning Score:** 1 (6.6 섹터 상관관계 붕괴)
- **Tactical Why:** No actionable alignment
- **Why:** SEW STABLE → 실시간 이상징후 없음 → Divergence 비정렬 → 방어적 태도 유지 → 상위 레이어(SEW/Divergence)가 Narrative보다 우선 → Warning Score 1 → 경미한 이상신호, 모니터링 강화 → Tactical=HOLD / Flow=👀 EARLY TRACE(4) / Drift=⚡ STRUCTURAL DRIFT(5) / Gamma=🟡 TRANSITION → Tactical HOLD/MONITOR → 최종판단 변경 없음
...
- **미국 10년물 금리**: 4.595  (+3.00% vs 4.461)
- **달러 인덱스**: 99.270  (+0.39% vs 98.880)
- **WTI 유가**: 105.420  (+4.20% vs 101.170)
- **변동성 지수 (VIX)**: 18.430 (+6.78% vs 17.260)
- **원/달러 환율**: 1493.340  (+0.23% vs 1489.840)
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-05-18 (FRED last available)
- **유인(Real Rates):** level=RESTRICTIVE (유인↓) / dir(→) | as of: 2026-05-18 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.390 / US10YΔ +0.134**
...
- **Spread as of:** 2026-05-14 (FRED latest)
- **HY_OAS level:** 2.76% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -2.13%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.460 / prev 79.850 / pct -0.49%
- **LQD:** today 107.860 / prev 108.550 / pct -0.64%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +3.00%)** → 완화 기대 약화/금리 부담
- DXY **(Strong, +0.39%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +4.20%)** → 인플레 재자극 가능성
- VIX **(Strong, +6.78%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Clear, +0.23%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Clear, -0.49%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Clear, -0.64%)** → 우량채 약세(리스크온 성향)
...
- **SPY:** 🟢 UP | Short-term: SHORT UP | 1D=+0.19% / 5D=+0.17% | Strength: LOW
- **WTI:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-5.18% / 5D=+1.93% | Strength: MEDIUM
- **DXY:** 🟡 PULLBACK | Short-term: SHORT UP | 1D=-0.20% / 5D=+1.15% | Strength: LOW
- **GOLD:** 🟡 REBOUND | Short-term: MIXED | 1D=+0.39% / 5D=-3.08% | Strength: LOW
...
- **Top Similarity Matches:**
  - China_Trade_2018: 0.441
  - Taiwan_Tension: 0.348
  - Ukraine_2022: 0.337
- **Top Drivers:**
  - EMB: z_used=+1.48 (z1d=-1.58, z5d=-1.33, raw_w=0.12, norm_w=0.09) → contrib=+0.14
  - EEM: z_used=+1.63 (z1d=-1.82, z5d=-1.34, raw_w=0.10, norm_w=0.08) → contrib=+0.13
  - GOLD: z_used=-1.11 (z1d=-1.35, z5d=-0.75, raw_w=0.12, norm_w=0.09) → contrib=-0.10
  - VIX: z_used=+0.73 (z1d=+0.84, z5d=+0.55, raw_w=0.18, norm_w=0.14) → contrib=+0.10
...
- **Country ETF Crash?** Yes (EEM, EIS, FXI)
- **Extreme Country Risk:** EEM, EIS, FXI
...
- **Dealer Gamma Bias:** 1.47 (NEUTRAL / transition zone)
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(2.00%) | DXY(99.27)
*(as of: RealRate: 2026-05-18 / FRED last available)*
...
- **Today snapshot:** US10Y(4.595), DXY(99.270), VIX(18.43)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↑)
- **Meaningful Move Check:** DXY=0.3944168694189266 / GOLD=-2.6143154360896004 / US10Y=3.003806894310716 / VIX=6.77867937878783 / WTI=4.20085013039425
...
- **Input Check:** US10Y=4.59499979019165, RealYield=2.0, T10Y2Y=0.5, WTI=105.41999816894533, DXY=99.2699966430664, LiquidityDir=UP, CreditCalm=True, HY_OAS=2.76, DriftLabel=NEUTRAL, FredAsof=2026-05-15
...
**Positioning Notes**
- Term Structure: VIX3M-VIX=2.93 → healthy contango / stable structure
...
- **Breadth Note:** RSP-SPY return spread=0.17%p → neutral breadth
- **Nasdaq Breadth Note:** QQQE-QQQ return spread=0.54%p → broad Nasdaq participation
- **Positioning / Gamma:** -2
...
**Leadership Notes**
- QQQ-SPY spread=-0.31%p → growth leadership weak
- SMH-QQQ spread=-2.30%p → AI/tech rally not semiconductor-broad
- SOXX-QQQ spread=-2.55%p → chip breadth lagging
- IWM-SPY spread=-1.21%p → small-cap lag, narrow leadership risk
- XLF-SPY spread=0.83%p → sector diffusion positive
- XLI-SPY spread=-0.58%p → sector diffusion weak
- XLY-SPY spread=-0.60%p → sector diffusion weak
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.390 / US10YΔ +0.134 (스태그플레이션)
- **Sentiment (Fear&Greed):** 59.56700362162455 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING(스태그플레이션) / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=⚡ STRUCTURAL DRIFT (NEUTRAL) / 수급=2.12 ⚠️ 수급 과열 감지 → Phase=EVENT-WATCHING / INFLATION
...
- **Positioning Data:** Z-Score: `2.12` (>1.8 시 Run) | Gamma: `1.47` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
- **Status:** **⚡ TREND EXHAUSTION** -> **해석:** 추세와 정책은 일치하나 포지션 에너지 고갈(Z:2.12). 반전 가능성 상존.
...
- **Reason:** POS_Z Extreme (2.12)
- **Action:** 신규 추격 금지 / 일부 이익실현 / 베타 노출 축소
- **Final Multiplier:** 0.76x (VIX x Positioning x Credit/Convexity)
- **Slope Intensity:** -0.0150
- **Positioning Layer:** ⚠️ Extreme Positioning Heat(2.12), Position Unwind
- **Brake Drivers:** ⚠️ Extreme Positioning Heat, VIX Spike, VIX Convexity Warning

- **📊 Recommended Exposure:** **21%**
...
**Context:** phase=EVENT-WATCHING / INFLATION / T10Y2Y=0.50 (MODERATE STEEP) / VIX=18.43 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** STAGFLATION_STRESS
**Macro Inputs Debug:** phase=EVENT-WATCHING / INFLATION / us10y_pct=+3.00% / dxy_pct=+0.39% / wti_pct=+4.20% / vix=18.43 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=4
...
**Overweight:** Technology, Materials

**Underweight:** Consumer Discretionary, Industrials, Financials, Real Estate, Utilities, Energy

**Scoreboard:**
- Technology: +1.1  (+2 LIQ, -1 PHASE, +1 FLOW, +2 MOM, = +1.1)
- Materials: +0.2  (+0.5 PHASE, = +0.2)
- Energy: -0.1  (+0.5 PHASE, +1 MOM, = -0.1)
- Utilities: -0.8  (-1 LIQ, -1 PHASE, = -0.8)
- Real Estate: -1.3  (-1 PHASE, -2 MOM, = -1.3)
- Financials: -1.3  (+1 LIQ, +2 CURVE, -2 MOM, = -1.3)
- Industrials: -1.5  (+1.5 LIQ, +1 CURVE, +0.5 FLOW, -2 MOM, = -1.5)
- Consumer Discretionary: -2.1  (+1.5 LIQ, -0.5 PHASE, -2 MOM, = -2.1)
...
- UW Industrials: +1: 완만한 스티프닝(0.50) → 성장 기대 반영
- UW Financials: THEORY_TRAP → 거시/이론 우호 대비 실제 자금흐름 및 상대강도 약세
- UW Financials: +1: 유동성 완화 → 위험선호 회복
- UW Financials: +2: 완만한 스티프닝(0.50) → 예대마진 개선

**Regime Controller:**
- DISLOCATION (avg_divergence=-0.87, dispersion=1.82)
...
- Real Estate: AVOID (theory=-1.0, flow=-1.4, final=-1.3)
- Financials: THEORY_TRAP (theory=+3.0, flow=-1.4, final=-1.3)
- Industrials: THEORY_TRAP (theory=+2.5, flow=-1.2, final=-1.5)
- Consumer Discretionary: THEORY_TRAP (theory=+1.0, flow=-1.4, final=-2.1)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **21.0%** → **Regime Adjusted:** **21.0%**
- **Exposure Override:** DISLOCATION → Sector Weight Only (No Exposure Change)

| Sector | Score | Divergence | **Weight in Portfolio** | **Action** |
| :--- | :---: | :---: | :---: | :--- |
| Technology | +1.6 | ALIGNED | **12.0%** | DELEVERAGE |
| Materials | +0.2 | ALIGNED | **1.9%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **86.1%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** STAGFLATION_STRESS
- **Regime Cap Applied:**
  - Technology: 19.1% → 12.0% (-7.1%)
- **Strategic Cash (15):** 79.0%
- **Tactical Reserve (Cap / Unallocated):** 7.1%


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Materials (priority_score=-0.1, score=0.21, weight=1.9%, div=ALIGNED, mom=0)
2. Technology (priority_score=-2.04, score=1.6, weight=12.0%, div=ALIGNED, mom=2)

**Leveraging Priority Preview:**
- 기준: Score → Momentum → Positive Divergence
1. Technology (priority_score=4.60, score=1.6, weight=12.0%, div=ALIGNED, mom=2)
2. Materials (priority_score=0.21, score=0.21, weight=1.9%, div=ALIGNED, mom=0)
...
| Materials | XLB | 1.9% | MICRO | ALIGNED | ALIGNED |
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.6110723907204509
- **Z-Score (5d):** -1.2201122605239347

### EEM
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.3043329060451141
- **Z-Score (5d):** -1.1104864366180804

### EIS
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.2699632550937572
- **Z-Score (5d):** -1.247575864612475

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.4645781765790593
- **Z-Score (5d):** -0.9964846299094817

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.1161737092625355
- **Z-Score (5d):** -0.3799950766914132

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** 0.2761423035276493
- **Z-Score (5d):** -1.1376874547159679

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.5257977383623463
- **Z-Score (5d):** -0.6422924688412291

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.05951525001156673
- **Z-Score (5d):** -0.2595242320068418

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.3269004708568727
- **Z-Score (5d):** -0.4713071543272884
