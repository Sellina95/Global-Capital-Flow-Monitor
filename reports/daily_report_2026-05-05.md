...
- **미국 10년물 금리**: 4.446  (+1.55% vs 4.378)
- **달러 인덱스**: 98.470  (+0.26% vs 98.210)
- **WTI 유가**: 106.420  (+4.39% vs 101.940)
- **변동성 지수 (VIX)**: 18.290  (+7.65% vs 16.990)
- **원/달러 환율**: 1471.730  (-0.15% vs 1474.010)
...
- **VIX 레벨:** 18.29 → **Mid (Neutral/Mixed)**
...
- **현실(FCI):** level=EASY (완화) / dir(→) | as of: 2026-05-05 (FRED last available)
- **유인(Real Rates):** level=NEUTRAL (중립) / dir(→) | as of: 2026-05-05 (FRED last available)
...
- **Policy Bias: TIGHTENING (긴축) (MODERATE, score=+1.5) | REAL_RATEΔ +0.000 / FCIΔ +0.000 / DXYΔ +0.260 / US10YΔ +0.068**
...
- **Spread as of:** 2026-05-01 (FRED latest)
- **HY_OAS level:** 2.77% → **COOL (낮은 공포)**
- **방향(전일 대비):** HY_OAS(↓) / -2.12%
- **판정:** **CREDIT CALM**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.800 / prev 80.060 / pct -0.32%
- **LQD:** today 108.250 / prev 108.600 / pct -0.32%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +1.55%)** → 완화 기대 약화/금리 부담
- DXY **(Clear, +0.26%)** → 달러 강세/신흥국 부담
- WTI **(Strong, +4.39%)** → 인플레 재자극 가능성
- VIX **(Strong, +7.65%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Mild, -0.15%)** → 원화 강세/수급 개선
- HYG (High Yield ETF) **(Mild, -0.32%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Mild, -0.32%)** → 우량채 약세(리스크온 성향)
...
- **GOLD:** 🟡 REBOUND | Short-term: SHORT DOWN | 1D=+0.55% / 5D=-1.03% | Strength: LOW
...
- **Cosine Similarity Score:** 0.127
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Red_Sea: 0.127
  - Ukraine_2022: 0.059
  - Iran_Crisis_2020: 0.045
- **Top Drivers:**
  - GOLD: z_used=-0.99 (z1d=-1.18, z5d=-0.71, raw_w=0.12, norm_w=0.09) → contrib=-0.09
  - EMB: z_used=+0.96 (z1d=-0.99, z5d=-0.92, raw_w=0.12, norm_w=0.09) → contrib=+0.09
  - KR10Y_SPREAD: z_used=-1.30 (mode=level, raw_w=0.08, norm_w=0.06) → contrib=-0.08
  - VIX: z_used=+0.57 (z1d=+0.91, z5d=+0.06, raw_w=0.18, norm_w=0.14) → contrib=+0.08
...
**핵심 신호:** 장단기차(50.00bp) | 실질금리(1.91%) | DXY(98.47)
*(as of: RealRate: 2026-05-05 / FRED last available)*
...
- **Today snapshot:** US10Y(4.446), DXY(98.470), VIX(18.29)

### 🏗️ 12) Structural Filter (v3)
- **질문:** 글로벌 화폐 가치와 에너지 패권 등 '판'의 변화가 있는가?
- **핵심 신호:** US10Y(↑) / DXY(↑) / GOLD(↓) / VIX(↑) / WTI(↑)
- **Meaningful Move Check:** DXY=0.2647410026007993 / GOLD=-2.3844986861997453 / US10Y=1.5532279579071924 / VIX=7.651566579883612 / WTI=4.394737708696969
...
- **Sentiment (Fear&Greed):** 62.42848346134511 (NEUTRAL)
- **Credit Calm:** True
...
- **Narrative:** 구조=TIGHTENING / 심리=NEUTRAL / 유동성=증가/중간 / 크레딧=안정 / 드리프트=NO DRIFT (GROWTH_SCARE) / 수급=1.70 ⚠️ 수급 다소 과열 → Phase=SOFT RISK-OFF (경계 강화)
...
- **Positioning Data:** Z-Score: `1.70` (>1.8 시 Run) | Gamma: `1.63` (<0.5 시 Run) | CTA: `1.0` (추세 변곡점 확인)
...
- **Positioning Layer:** ⚠️ Elevated Positioning Heat(1.70), Positive Gamma(1.63)
...
**Context:** phase=SOFT RISK-OFF (경계 강화) / T10Y2Y=0.50 (MODERATE STEEP) / VIX=18.29 (VOLATILITY NORMAL) / liquidity=UP-MID / credit=True

**Signal Priority:** VOL > LIQ > CURVE > CREDIT > PHASE > FLOW > MOM

**Macro Profile:** STAGFLATION_STRESS
**Macro Inputs Debug:** phase=SOFT RISK-OFF (경계 강화) / us10y_pct=+1.55% / dxy_pct=+0.26% / wti_pct=+4.39% / vix=18.29 / liq_easy=True / liq_tight=False / credit_calm=True / flow_score=0

**Flow Overlay:** flow_score=0 / flow_state=NO CLEAR FLOW / drift_label=GROWTH_SCARE / gamma=🟢 POSITIVE GAMMA (WEAK)

**Overweight:** Industrials, Technology, Consumer Discretionary, Materials

**Underweight:** Energy, Financials, Real Estate, Utilities
...
- Energy: -1.6  (+1.5 PHASE, -1 MOM, = -1.6)
...
**Regime Controller:**
- DISLOCATION (avg_divergence=-0.72, dispersion=1.66)
...
- Energy: THEORY_TRAP (theory=+1.5, flow=-0.7, final=-1.6)

### 💰 18.5) Tactical Asset Allocation (Execution Weight)
- **Strategic Exposure (15):** **32.0%** → **Regime Adjusted:** **27.2%**
...
| Industrials | +0.7 | NEGATIVE_DIVERGENCE | **2.4%** | DELEVERAGE |
| Materials | +0.2 | ALIGNED | **4.1%** | DELEVERAGE |
| Consumer Discretionary | +0.1 | ALIGNED | **2.2%** | DELEVERAGE |
| **Cash & Hedge** | - | - | **79.3%** | DEFENSIVE |

- **Allocation Check:** Sector Weights + Cash = **100.0%**
- **Regime Cap Profile:** STAGFLATION_STRESS
- **Regime Cap Applied:**
  - Technology: 18.5% → 12.0% (-6.5%)


**Deleveraging Priority Preview:**
- 기준: Divergence → Momentum → Score → Current Weight
1. Industrials (priority_score=6.17, score=0.6699999999999999, weight=2.4%, div=NEGATIVE_DIVERGENCE, mom=0)
2. Consumer Discretionary (priority_score=-0.05, score=0.10999999999999999, weight=2.2%, div=ALIGNED, mom=0)
3. Materials (priority_score=-0.1, score=0.21, weight=4.1%, div=ALIGNED, mom=0)
4. Technology (priority_score=-1.71, score=1.47, weight=12.0%, div=ALIGNED, mom=2)
...
2. Materials (priority_score=0.21, score=0.21, weight=4.1%, div=ALIGNED, mom=0)
3. Consumer Discretionary (priority_score=0.11, score=0.10999999999999999, weight=2.2%, div=ALIGNED, mom=0)
4. Industrials (priority_score=-2.33, score=0.6699999999999999, weight=2.4%, div=NEGATIVE_DIVERGENCE, mom=0)
...
| :--- | :---: | :---: | :--- | :--- | :--- |
| Technology | XLK | 12.0% | CONTROLLED_ADD | ALIGNED | ALIGNED |
| Industrials | XLI | 2.4% | WATCHLIST_SMALL | NEGATIVE_DIVERGENCE | FLOW_WEAK |
| Materials | XLB | 4.1% | SMALL | ALIGNED | ALIGNED |
| Consumer Discretionary | XLY | 2.2% | MICRO | ALIGNED | ALIGNED |
...
- **Z-Score (5d):** -1.019172901836284

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.11918736610117582
- **Z-Score (5d):** 0.013136045587750061

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.5470704729680801
- **Z-Score (5d):** 1.1082888197954919

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.0453491933663286
- **Z-Score (5d):** -0.5987425903526001

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.1515896191295311
- **Z-Score (5d):** 0.08379674822552674

### FXI
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.5264518226432079
- **Z-Score (5d):** 0.30487728902248784

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.9760489588616633
- **Z-Score (5d):** -0.7260966703888346

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.5001023395272497
- **Z-Score (5d):** 0.010037185994366123

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.19985678926113123
- **Z-Score (5d):** -0.1772283829710721
