...
- **Final Action:** **REDUCE**
- **Final Exposure:** **29%**
- **Base Context:** phase=SOFT RISK-OFF (경계 강화) / narrative=REDUCE / base_exposure=31%
- **SEW:** STABLE / NORMAL
- **Divergence:** ALIGNED / **STAY (포지션 유지)**
- **Drift:** WEAK DRIFT (노이즈 가능) / GROWTH_SCARE / NONE / score=1
...
- **Strategic Exposure (15):** **31.0%** → **Regime Adjusted:** **26.3%**
