...
- **원/달러 환율**: 1440.090  (+0.06% vs 1439.230)
...
- **Top Drivers:**
  - USDCNH: z_used=+3.39 (w=0.15) → contrib=+0.51
  - USDMXN: z_used=+1.69 (w=0.05) → contrib=+0.08
...
- **Sentiment (Fear&Greed):** 34.65420104027587 (NEUTRAL)
