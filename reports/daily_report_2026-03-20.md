...
- **미국 10년물 금리**: 4.281  (-0.05% vs 4.283)
- **달러 인덱스**: 99.160  (-0.52% vs 99.683)
- **WTI 유가**: 94.740  (-1.68% vs 96.360)
- **변동성 지수 (VIX)**: 24.060  (-7.03% vs 25.880)
- **원/달러 환율**: 1494.410  (+0.02% vs 1494.180)
...
- **VIX 레벨:** 24.06 → **High (Risk-off bias)**
...
- **Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.030 / FCIΔ +0.000 / DXYΔ -0.523 / US10YΔ -0.002**
...
- **방향(전일 대비):** HYG(↑) / LQD(↑)
- **HYG:** today 79.660 / prev 79.255 / pct 0.51%
- **LQD:** today 109.190 / prev 108.715 / pct 0.44%
- **판정:** **CREDIT NEUTRAL**
...
- DXY **(Strong, -0.52%)** → 달러 약세/리스크 선호
- WTI **(Strong, -1.68%)** → 물가 부담 완화
- VIX **(Strong, -7.03%)** → 심리 개선/리스크온
- 원/달러(USDKRW) **(Noise, +0.02%)** → 원화 약세/수급 부담
- HYG (High Yield ETF) **(Clear, +0.51%)** → 크레딧 위험선호↑
- LQD (IG Bond ETF) **(Clear, +0.44%)** → 우량채 강세(리스크오프 성향)
...
- DEBUG: pct XLK=0.3406682654697359, XLF=0.040842265193198016, XLE=0.5590408908672031, XLRE=-0.19048055013020831
...
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.059
  - Israel_2023: -0.057
  - Ukraine_2022: -0.109
- **Top Drivers:**
  - VIX: z_used=-1.08 (z1d=-0.98, z5d=-1.24, raw_w=0.18, norm_w=0.14) → contrib=-0.15
  - EMB: z_used=-1.28 (z1d=+1.73, z5d=+0.61, raw_w=0.12, norm_w=0.09) → contrib=-0.12
  - WTI: z_used=-0.87 (z1d=-0.72, z5d=-1.09, raw_w=0.10, norm_w=0.08) → contrib=-0.07
...
- **강도:** US10Y(Mild) / DXY(Strong) / WTI(Strong) / VIX(Strong)
...
- **Today snapshot:** US10Y(4.281), DXY(99.160), VIX(24.06)
...
- **Structure Bias:** Policy Bias: MIXED (혼조) (WEAK, score=-0.5) | REAL_RATEΔ +0.030 / FCIΔ +0.000 / DXYΔ -0.523 / US10YΔ -0.002
- **Sentiment (Fear&Greed):** 36.13763266857961 (NEUTRAL)
