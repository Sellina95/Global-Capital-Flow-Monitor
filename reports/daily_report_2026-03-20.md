...
- **미국 10년물 금리**: 4.354  (+1.71% vs 4.281)
- **달러 인덱스**: 99.684  (+0.46% vs 99.230)
- **WTI 유가**: 95.780  (-0.37% vs 96.140)
- **변동성 지수 (VIX)**: 25.810  (+7.27% vs 24.060)
- **원/달러 환율**: 1505.250  (+0.00% vs 1505.250)
...
- **VIX 레벨:** 25.81 → **High (Risk-off bias)**
...
- **Policy Bias: TIGHTENING (긴축) (STRONG, score=+2.5) | REAL_RATEΔ +0.030 / FCIΔ +0.000 / DXYΔ +0.454 / US10YΔ +0.073**
...
- **방향(전일 대비):** HYG(↓) / LQD(↓)
- **HYG:** today 79.195 / prev 79.660 / pct -0.58%
- **LQD:** today 108.315 / prev 109.190 / pct -0.80%
- **판정:** **CREDIT NEUTRAL**
- **근거:** HYG/LQD 방향성이 뚜렷하지 않음

### 📌 5) Directional Signals (Legacy Filters)
**추가 이유:** 개별 자산의 단기 방향성과 노이즈 강도를 구분해 과도한 해석을 방지하기 위함
- 미국 금리(US10Y) **(Strong, +1.71%)** → 완화 기대 약화/금리 부담
- DXY **(Strong, +0.46%)** → 달러 강세/신흥국 부담
- WTI **(Mild, -0.37%)** → 물가 부담 완화
- VIX **(Strong, +7.27%)** → 심리 악화/리스크오프
- 원/달러(USDKRW) **(Noise, +0.00%)** → 환율 보합(수급 압력 제한)
- HYG (High Yield ETF) **(Clear, -0.58%)** → 크레딧 스트레스↑
- LQD (IG Bond ETF) **(Clear, -0.80%)** → 우량채 약세(리스크온 성향)
...
- DEBUG: pct XLK=-1.5820178418606046, XLF=-0.09185952663961314, XLE=0.1516175061699643, XLRE=-1.3239420675587283
...
- **Cosine Similarity Score:** 0.398
- **Similarity Signal:** Weak Historical Match
- **Top Similarity Matches:**
  - Taiwan_Tension: 0.398
  - Ukraine_2022: 0.194
  - Israel_2023: 0.079
- **Top Drivers:**
  - EMB: z_used=+2.02 (z1d=-2.83, z5d=-0.80, raw_w=0.12, norm_w=0.09) → contrib=+0.19
  - USDCNH: z_used=+1.07 (z1d=+0.94, z5d=+1.27, raw_w=0.18, norm_w=0.14) → contrib=+0.15
  - EEM: z_used=+1.34 (z1d=-1.82, z5d=-0.61, raw_w=0.10, norm_w=0.08) → contrib=+0.10
  - GOLD: z_used=-0.90 (z1d=-0.09, z5d=-2.11, raw_w=0.12, norm_w=0.09) → contrib=-0.08
...
- **판정:** **금리 상승(US10Y↑) + 달러 강세(DXY↑) + 유가 하락(WTI↓) + 변동성 확대(VIX↑)**
...
- **Today snapshot:** US10Y(4.354), DXY(99.684), VIX(25.81)
...
- **Structure Bias:** Policy Bias: TIGHTENING (긴축) (STRONG, score=+2.5) | REAL_RATEΔ +0.030 / FCIΔ +0.000 / DXYΔ +0.454 / US10YΔ +0.073
- **Sentiment (Fear&Greed):** 32.58046899772272 (NEUTRAL)
...
- **Context:** phase=RISK-OFF (긴축/불안·리스크 회피) / liquidity=DOWN-MID / structure=TIGHTENING / credit_calm=True
...
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -2.7588874963686276
- **Z-Score (5d):** -0.8152682624767201

### EEM
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.814963983305991
- **Z-Score (5d):** -0.6059019582588386

### EIS
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.1171082973502102
- **Z-Score (5d):** 0.7030282835297457

### EMB
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -2.9885251132795294
- **Z-Score (5d):** -0.9730125728892437

### EWJ
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.2477294965703485
- **Z-Score (5d):** -0.3861973352492811

### FXI
- **Crash?** True
- **Risk Level:** EXTREME
- **Z-Score (1d):** -1.4589891899369611
- **Z-Score (5d):** -0.687924022951814

### GLD
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -0.6472929724480917
- **Z-Score (5d):** -1.9986178637484042

### SPY
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** -1.5020363469786844
- **Z-Score (5d):** -1.1214352572180917

### VXX
- **Crash?** False
- **Risk Level:** NORMAL
- **Z-Score (1d):** 0.9744299613269545
- **Z-Score (5d):** -0.13162441743801248
